...
(BW1W100, BW1W110, BW1W120). Designed so a small model can run a loop with
...
def analyze(query):
    ...
    # BW1W100 drops dead code via /OPT:REF, so missing there is expected.
    e100_only_missing = (not not_found["BW1W110"] and not not_found["BW1W120"])
    non_contig = any(
