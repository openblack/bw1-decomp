...
enum LH_RETURN __fastcall DoAttemptReadPacketNonBlocking__11LHSocketTCPFv(struct LHSocketTCP* this);
// win1.41 10020e40 mac 10113960 LHSocketTCP::DecompressPacketIfCompressed(void)
enum LH_RETURN __fastcall DecompressPacketIfCompressed__11LHSocketTCPFv(struct LHSocketTCP* this);
// win1.41 10020f80 mac 10113770 LHSocketTCP::ReceiveRaw(void *, long *)
enum LH_RETURN __fastcall ReceiveRaw__11LHSocketTCPFPvPl(struct LHSocketTCP* this, const void* edx, void* data, long* data_len);
// win1.41 10021120 mac 10113390 LHSocketTCP::ReceivePacket(LHPacket **)
enum LH_RETURN __fastcall ReceivePacket__11LHSocketTCPFPP8LHPacket(struct LHSocketTCP* this, const void* edx, struct LHPacket** packet);
// win1.41 10021470 mac 10112f10 LHSocketTCP::ReceiveUDPPacket(LHPacket **, unsigned long, LHTransportInfo *)
enum LH_RETURN __fastcall ReceiveUDPPacket__11LHSocketTCPFPP8LHPacketUlP15LHTransportInfo(struct LHSocketTCP* this, const void* edx, struct LHPacket** packet, uint32_t size, struct LHTransportInfo* transport_info);
