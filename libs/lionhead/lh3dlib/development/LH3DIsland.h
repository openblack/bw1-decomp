...
bool __fastcall IsWater__8LandCellFv(struct LandCell* this);
...
uint32_t __cdecl Create__10LH3DIslandFv(void);
// win1.41 00516aa0 mac 100484b0 LH3DIsland::GetCell(long, long)
struct LandCell* __cdecl GetCell__10LH3DIslandFll(int x, int z);
// win1.41 0060d3a0 mac inlined LH3DIsland::IsWater(long, long)
bool __cdecl IsWater__10LH3DIslandFll(int x, int y);
// win1.41 00803090 mac 10048554 LH3DIsland::GetAltitude(LH3DMapCoords const &)
float __fastcall GetAltitude__10LH3DIslandFRC13LH3DMapCoords(const struct LH3DMapCoords* this);
// win1.41 00803340 mac 10048110 LH3DIsland::GetAltitudeAndSetColorSpecular(LH3DMapCoords const &, ulong *, ulong *)
float __fastcall GetAltitudeAndSetColorSpecular__10LH3DIslandFRC13LH3DMapCoordsPUlPUl(const struct LH3DMapCoords* this, struct LH3DColor* param_2, struct LH3DColor* param_3);
...
void __cdecl PreDraw__10LH3DIslandFv(void);
