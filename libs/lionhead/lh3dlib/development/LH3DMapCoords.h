...
void __fastcall AddToMapX__13LH3DMapCoordsFs(struct LH3DMapCoords* this, const void* edx, uint16_t x);
// win1.41 inlined mac 1006a880 LH3DMapCoords::AddToMapZ(void) const
void __fastcall AddToMapZ__13LH3DMapCoordsFs(struct LH3DMapCoords* this, const void* edx, uint16_t z);
// win1.41 inlined mac inlined LH3DMapCoords::CentreOnMap(void)
void __fastcall CentreOnMap__13LH3DMapCoordsFv(struct LH3DMapCoords* this);
// win1.41 inlined mac inlined LH3DMapCoords::SetFractionX(short)
void __fastcall SetCellX__13LH3DMapCoordsFs(struct LH3DMapCoords* this, const void* edx, uint16_t x);
...
uint32_t __fastcall WholeZ__13LH3DMapCoordsCFv(const struct LH3DMapCoords* this);
// win1.41 inlined mac inlined LH3DMapCoords::SetMapX(short) const
void __fastcall SetMapX__13LH3DMapCoordsCFs(struct LH3DMapCoords* this, const void* edx, uint16_t x);
// win1.41 inlined mac inlined LH3DMapCoords::SetMapZ(short) const
void __fastcall SetMapZ__13LH3DMapCoordsCFs(struct LH3DMapCoords* this, const void* edx, uint16_t z);
// win1.41 inlined mac 1004ae60 LH3DMapCoords::SetWholeX(int)
void __fastcall SetWholeX__13LH3DMapCoordsFl(struct LH3DMapCoords* this, const void* edx, int x);
// win1.41 inlined mac 1004aea0 LH3DMapCoords::SetWholeZ(int)
void __fastcall SetWholeZ__13LH3DMapCoordsFl(struct LH3DMapCoords* this, const void* edx, int z);
// win1.41 inlined mac 1004aee0 LH3DMapCoords::SetAltitude(float)
void __fastcall SetAltitude__13LH3DMapCoordsFf(struct LH3DMapCoords* this, const void* edx, float altitude);
