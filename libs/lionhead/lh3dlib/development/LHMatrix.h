...
// win1.41 00403530 mac inlined LHMatrix::Translation(const LHPoint&)
void __fastcall Translation__8LHMatrixFv(struct LHMatrix* this, const struct LHPoint* translation) asm("?Translation@LHMatrix@@QAEXABULHPoint@@@Z");
// win1.41 00403570 mac inlined LHMatrix::PostTranslation(const LHPoint&)
void __fastcall PostTranslation__8LHMatrixFRC7LHPoint(struct LHMatrix* this, struct LHPoint* translation) asm("?PostTranslation@LHMatrix@@QAEXABULHPoint@@@Z");

// Non-virtual methods

// win1.41 00403500 mac 100417d0 LHMatrix::SetIdentityMatrix(void)
void __fastcall SetIdentity__8LHMatrixFv(struct LHMatrix* this) asm("?SetIdentityMatrix@LHMatrix@@QAEXXZ");
// win1.41 007fb290 mac 1004f05c LHMatrix::SetInverse(LHMatrix const &)
