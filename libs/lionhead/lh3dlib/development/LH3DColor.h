...
void __fastcall __ct__9LH3DColorFUl(struct LH3DColor* this, const void* edx, uint32_t color);
// win1.41 inlined mac 100530b0 LH3DColor::LH3DColor(LH3DColor const &)
void __fastcall __ct__9LH3DColorFRC9LH3DColor(struct LH3DColor* this, const void* edx, const struct LH3DColor* other);

// Non-virtual methods

// win1.41 inlined mac 1047dc00 LH3DColor::operator=(LH3DColor const &)
void __fastcall __as__9LH3DColorFRC9LH3DColor(struct LH3DColor* this, const void* edx, const struct LH3DColor* other);
