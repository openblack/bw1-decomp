...
struct LH3DRender
{
    ...
    void DrawTriangle(Vertex3D* vertices, uint32_t param_2, uint16_t* param_3, uint32_t param_4);
    // win1.41 00412940 mac 10046ae0 LH3DRender::SetRenderState(D3DRENDERSTATETYPE, unsigned long)
    int SetRenderState(D3DRENDERSTATETYPE type, uint32_t value);
    // win1.41 inlined mac inlined LH3DRender::GetRenderState(D3DRENDERSTATETYPE, unsigned long&)
    int GetRenderState(D3DRENDERSTATETYPE type, uint32_t* value);
    // win1.41 0082b220 mac 1003c460 LH3DRender::SetD3DMatrix(D3DMATRIX &, LHMatrix &)
    void SetD3DMatrix(D3DMATRIX* param_1, LHMatrix* param_2);
    // win1.41 0082b2d0 mac inlined LH3DRender::SetProjMatrix(D3DMATRIX *, D3DMATRIX *, float, float, float)
    void SetProjMatrix(D3DMATRIX* param_1, D3DMATRIX* projection, float near_plane, float far_plane, float fov);
    ...
    void DrawAndClip(D3DPRIMITIVETYPE primitive_type, uint32_t fvf, D3DTLVERTEX* vertices, uint32_t vertex_count, uint16_t* indices, uint32_t index_count);
    ...
    void DrawAndClip2D(D3DPRIMITIVETYPE primitive_type, uint32_t fvf, D3DTLVERTEX* vertices, uint32_t vertex_count, uint16_t* indices, uint32_t index_count);
