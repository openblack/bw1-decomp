...
void __fastcall UpdateViewPort__8LH3DTechFll(int32_t param_1, int32_t param_2);
// win1.41 00819390 mac 10be2a38 LH3DTech::ProjectPoint(LHPoint *, int *, int *, float *)
uint32_t __fastcall ProjectPoint__8LH3DTechFP7LHPointPiPiPf(struct LHPoint* param_1, int* param_2, int* param_3, float* param_4);
...
void __fastcall UpdateWorldToCamera__8LH3DTechFR8LHMatrixR7LHPointR7LHPointb(struct LHMatrix* param_1_00, struct LHPoint* param_2_00, struct LHPoint* param_1, bool param_2);
// win1.41 inlined mac 10093230 LH3DTech::GetDeltaTime(void)
uint32_t __cdecl GetDeltaTime__8LH3DTechFv(void);
// win1.41 00819920 mac 10034c10 LH3DTech::UpdateCamera(LHPoint const &, LHPoint const &)
void __fastcall UpdateCamera__8LH3DTechFRC7LHPointRC7LHPoint(const struct LHPoint* param_1, const struct LHPoint* param_2);
// win1.41 00818c60 mac 100c0a80 LH3DTech::RenderInitialization(long, long)
void __cdecl RenderInitialization__8LH3DTechFll(int32_t param_0, int32_t param_1);
// win1.41 0081c5c0 mac 100337d0 LH3DTech::Draw3DScreenTriangle(long, LHPoint *, LH3DColor *, float *, long, long *, LH3DMaterial *, int)
void __fastcall Draw3DScreenTriangle__8LH3DTechFlP7LHPointP9LH3DColorPflPlP12LH3DMateriali(uint32_t num_points, struct LHPoint* positions, struct LH3DColor* colors, float* uvs, uint32_t num_indices, uint32_t* indices, struct LH3DMaterial* material, uint32_t param_8);
