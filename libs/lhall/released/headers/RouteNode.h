...
struct RouteNode* __fastcall __ct__9RouteNodeFP9RouteNode(struct RouteNode* this, const void* edx, struct RouteNode* param_1);
// win1.41 00869150 mac 100a8c10 RouteNode::RouteNode(RouteNode *, int, Point2D const &, Point2D const &, int, int)
struct RouteNode* __fastcall __ct__9RouteNodeFP9RouteNodeiRC7Point2DRC7Point2Dii(struct RouteNode* this, const void* edx, struct RouteNode* param_1, int param_2, struct Point2D* param_3, struct Point2D* param_4, int param_5, int param_6);

// Non-virtual methods

// win1.41 008691a0 mac 100a8ba0 RouteNode::GetLength(RPAvoid* )
float __fastcall GetLength__9RouteNodeFP7RPAvoid(struct RouteNode* this, const void* edx, struct RPAvoid* target);
// win1.41 008691c0 mac 100a89f0 RouteNode::GetArcLength(RPAvoid* )
float __fastcall GetArcLength__9RouteNodeFP7RPAvoid(struct RouteNode* this, const void* edx, struct RPAvoid* target);
