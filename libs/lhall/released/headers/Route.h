...
struct Route* __fastcall __ct__5RouteFv(struct Route* this);
// win1.41 008693a0 mac 100a8690 Route::Route(Route *)
struct Route* __fastcall __ct__5RouteFP5Route(struct Route* this, const void* edx, struct Route* other);

// Non-virtual methods

// win1.41 00869430 mac 100a85f0 Route::~Route(void)
void __fastcall __dt__5RouteFv(struct Route* this);
