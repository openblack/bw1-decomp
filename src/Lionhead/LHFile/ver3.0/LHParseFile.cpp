...
{
    LHEnumPair* v3 = (LHEnumPair*)bsearch(
        key,
        enum_sorted,
        enum_count,
        8,
...
uint32_t LHParseFile::ParseEnumListInternal()
{
    ...
    qsort(
        ...
        enum_count,
        8,
        (int (__cdecl*)(const void*, const void*))LHEnumPairCompare);
    v20 = 0;
...
uint32_t LHParseFile::GetNextToken(int* token_out)
{
    ...
    if (isdigit((unsigned char)v15) || v15 == '-')
    {
        char v17_hex = 0;
        if (*scan_ptr == '0'
            && ((v18 = scan_ptr[1], v18 == 'x') || v18 == 'X')
            && (isdigit((unsigned char)scan_ptr[2])
                || (v19 = scan_ptr[2], v19 == 'a')
                || v19 == 'b' || v19 == 'c' || v19 == 'd' || v19 == 'e' || v19 == 'f'
                || v19 == 'A' || v19 == 'B' || v19 == 'C' || v19 == 'D' || v19 == 'E' || v19 == 'F'))
        {
            v17_hex = 1;
            scan_ptr += 2;
            do
            {
                ...
                v21 = *scan_ptr;
            } while (v21 == 'a' || v21 == 'b' || v21 == 'c' || v21 == 'd' || v21 == 'e' || v21 == 'f'
                     || v21 == 'A' || v21 == 'B' || v21 == 'C' || v21 == 'D' || v21 == 'E' || v21 == 'F');
        }
        else
        {
            scan_ptr = scan_ptr + 1;
