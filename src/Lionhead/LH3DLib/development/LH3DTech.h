...
uint32_t __fastcall ProjectPoint__8LH3DTechFP7LHPointPiPiPf(
	struct LHPoint* param_1, int* param_2, int* param_3,
	float* param_4) asm("?ProjectPoint@LH3DTech@@SAIPAULHPoint@@PAH1PAM@Z");
...
void __fastcall UpdateWorldToCamera__8LH3DTechFR8LHMatrixR7LHPointR7LHPointb(
	struct LHMatrix* param_1_00, struct LHPoint* param_2_00, struct LHPoint* param_1,
	bool param_2) asm("?UpdateWorldToCamera@LH3DTech@@SAXAAULHMatrix@@AAULHPoint@@1_N@Z");
...
void __fastcall UpdateCamera__8LH3DTechFRC7LHPointRC7LHPoint(
	const struct LHPoint* param_1, const struct LHPoint* param_2) asm("?UpdateCamera@LH3DTech@@SAXABULHPoint@@0@Z");
// BW1W120 00818c60 BW1M100 100c0a80 LH3DTech::RenderInitialization(long, long)
void __cdecl RenderInitialization__8LH3DTechFll(int param_0,
                                                int param_1) asm("?RenderInitialization@LH3DTech@@SAXJJ@Z");
// BW1W120 0081c5c0 BW1M100 100337d0 LH3DTech::Draw3DScreenTriangle(long, LHPoint *, LH3DColor *, float *, long, long *, LH3DMaterial *, int)
void __fastcall Draw3DScreenTriangle__8LH3DTechFlP7LHPointP9LH3DColorPflPlP12LH3DMateriali(
	uint32_t num_points, struct LHPoint* positions, struct LH3DColor* colors, float* uvs, uint32_t num_indices,
	uint32_t* indices, struct LH3DMaterial* material,
