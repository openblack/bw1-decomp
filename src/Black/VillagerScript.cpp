...
bool32_t Living::ExitNoChangeState(uint8_t state)
{
...
bool32_t Living::EnterScriptWander(uint8_t param_1, uint8_t param_2)
{
...
bool32_t Living::ExitScriptWander(uint8_t state)
{
...
bool32_t Living::EnterPlayAnim(uint8_t param_1, uint8_t param_2)
{
	return 1;
}
...
bool32_t Living::ExitPlayAnim(uint8_t state)
{
	return ExitInScript(state);
}
...
uint32_t Villager::ScriptAnimation()
{
	return WanderArea.x;
}
