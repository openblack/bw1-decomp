...
public:
	...
	// BW1W120 inlined SetupStaticText::SetupStaticText(int, int, int, int, int, unsigned short const *, TEXTJUSTIFY)
	...
	// BW1W120 00409430 BW1M100 105436e0 void SetupStaticText::Draw(bool, bool)
