...
public:
	...
	// BW1W120 0040c580 BW1M100 1055c840 void SetupEdit::Draw(bool, bool)
	...
	// BW1W120 0040baf0 BW1M100 103813a0 void SetupEdit::KeyDown(LHKey, LHKeyMod)
	virtual void KeyDown(LHKey key, LHKeyMod mod);
	// BW1W120 0040b5f0 BW1M100 103e3630 void SetupEdit::Char(int)
	...
	// BW1W120 0040c220 BW1M100 101bc370 SetupEdit::SetupEdit(int, int, int, int, int, unsigned short const *, int)
	SetupEdit(int id, int x, int y, int width, int height, const char16_t* label, int editable);

	// Non-virtual methods

	// BW1W120 inlined BW1M100 inlined void SetupEdit::ClampCursor(void)
	void ClampCursor();
	// BW1W120 inlined BW1M100 inlined void SetupEdit::FixCursor(void)
	void FixCursor();
	// BW1W120 inlined BW1M100 inlined void SetupEdit::FixSelect(void)
	void FixSelect();
	// BW1W120 0040c090 BW1M100 103dc2c0 int SetupEdit::CalcCharpos(int)
