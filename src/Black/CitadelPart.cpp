...
CitadelPart::CitadelPart()
    ...
    , citadel(NULL)
    , next(NULL)
    , game_thing_0x88(NULL)
    , field_0x7c(0.0f)
{
}

CitadelPart::CitadelPart(const MapCoords& coords, const GCitadelPartInfo* info, Citadel* citadel, float y_angle, float scale, float param_6, int param_7)
    : MultiMapFixed(coords, info, y_angle, scale, param_6, param_7)
    , citadel(citadel)
    , next(NULL)
    , game_thing_0x88(NULL)
{
