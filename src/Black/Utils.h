...
struct GUtils
{
	// BW1W120 0074cca0 BW1M100 103c80c0 GUtils::SetupUtils(void)
	static void SetupUtils();
	// BW1W120 0074ccb0 BW1M100 100495f0 GUtils::GetDistance(const MapCoords&, const MapCoords&)
	static void GetDistance(const MapCoords& param_1, const MapCoords& param_2);
	// BW1W120 0074cde0 BW1M100 10033ca0 GUtils::GetDistance(const LHPoint&, const LHPoint&)
	...
	// BW1W120 0074cd70 BW1M100 10049550 GUtils::GetDistanceInMetres(const MapCoords&, const MapCoords&)
	...
	// BW1W120 0074d240 BW1M100 1004ede0 GUtils::GetAngleFromXZ(const MapCoords&, const MapCoords&)
	static uint16_t GetAngleFromXZ(const MapCoords& param_1, const MapCoords& param_2);
	// BW1W120 0074d270 BW1M100 100112f0 GUtils::Get3DAngleFromXZ(const MapCoords&, const MapCoords&)
	...
	// BW1W120 0074d450 BW1M100 10564e40 GUtils::GetZByAngleMetersDistance(unsigned short, float)
	static int GetZByAngleMetersDistance(unsigned short angle, float distance);
	// BW1W120 0074ce10 BW1M100 103cac30 GUtils::FastDistance(const MapCoords&, const MapCoords&)
...
// BW1W120 0074f620 float FUN_0074f620(unsigned int)
