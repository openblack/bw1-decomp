...
public:
	...
	// BW1W120 0055f640 BW1M119 inlined
...
public:
	...
	// BW1W120 0055f6c0 BW1M119 inlined
	virtual ~AddSoundToAtom__AtomData();
	// BW1W120 0055f6b0 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00696c10 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cd770 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055f6a0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055fc10 BW1M119 inlined
	virtual ~AddSubCollectionsToAtom__AtomData();
	// BW1W120 0055fc00 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00696f30 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cdaa0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055fbf0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055f7c0 BW1M119 inlined
...
public:
	...
	// BW1W120 0055fd10 BW1M119 inlined
	virtual ~CheckShieldDeflections__AtomData();
	// BW1W120 0055fd00 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00698980 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cf460 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055fcf0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055fc90 BW1M119 inlined
	virtual ~CreateNewBaseAtom__AtomData();
	// BW1W120 0055fc80 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00696f90 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cdb00 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055fc70 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055ff10 BW1M119 inlined
...
public:
	...
	// BW1W120 00560090 BW1M119 inlined
...
public:
	...
	// BW1W120 00560010 BW1M119 inlined
	virtual ~ER_GlintsOnTarget__AtomData();
	// BW1W120 0055ffd0 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 006970e0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cdc50 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055ffc0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055ffe0 BW1M119 inlined
	virtual ~ER_GlintsOnTarget__ParentAtomData();
	// BW1W120 0055ff80 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00696ff0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cdb60 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055ff70 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055fd90 BW1M119 inlined
	virtual ~EmitterRule__CollectionData();
	// BW1W120 0055fd80 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 006993d0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cfee0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055fd70 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055fe10 BW1M119 inlined
	virtual ~EmitterRuleLightningSprite__CollectionData();
	// BW1W120 0055fe00 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00699ac0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006d0490 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055fdf0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 005603b0 BW1M119 inlined
...
public:
	...
	// BW1W120 00560430 BW1M119 inlined
	virtual ~RemoveRuleAfterConditionTrue__AtomData();
	// BW1W120 00560420 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00697480 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cdff0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560410 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055f740 BW1M119 inlined
...
public:
	...
	// BW1W120 0055f9a0 BW1M119 inlined
	virtual ~UR_AddDefensiveSphere__CollectionData();
	// BW1W120 0055f990 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00697bb0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006ce6a0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055f980 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560e90 BW1M119 inlined
	virtual ~UR_AtomsAtEPTarget__CollectionData();
	// BW1W120 00560e80 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00697800 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006ce340 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560e70 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055f8b0 BW1M119 inlined
	virtual ~UR_BankedTurning__AtomData();
	// BW1W120 0055f8a0 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00696d30 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cd890 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055f890 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055f540 BW1M119 inlined
	virtual ~UR_BeliefSprite__AtomData();
	// BW1W120 0055f530 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00695f20 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cca70 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055f520 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560be0 BW1M119 inlined
	virtual ~UR_CloudGather__AtomData();
	// BW1W120 00560bb0 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00698da0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cf870 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560ba0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560bc0 BW1M119 inlined
	virtual ~UR_CloudGather__CollectionData();
	// BW1W120 00560b50 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00698b30 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cf610 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560b40 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560c60 BW1M119 inlined
	virtual ~UR_CloudMoverNew__CollectionData();
	// BW1W120 00560c50 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00697c20 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006ce710 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560c40 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 005605b0 BW1M119 inlined
	virtual ~UR_CreatureSpell__CollectionData();
	// BW1W120 005605a0 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00698030 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006ceb40 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560590 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560870 BW1M119 inlined
	virtual ~UR_CreatureSpellCompassion__CollectionData();
	// BW1W120 00560860 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00697c80 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006ce770 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560850 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 005606b0 BW1M119 inlined
...
public:
	...
	// BW1W120 005607f0 BW1M119 inlined
	virtual ~UR_CreatureSpellGeneric__AtomData();
	// BW1W120 005607b0 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00697d60 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006ce850 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 005607a0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 005607c0 BW1M119 inlined
	virtual ~UR_CreatureSpellGeneric__CollectionData();
	// BW1W120 00560750 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00697ea0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006ce9a0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560740 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560630 BW1M119 inlined
	virtual ~UR_CreatureSpellItch__CollectionData();
	// BW1W120 00560620 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 006980e0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cebf0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560610 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560d90 BW1M119 inlined
	virtual ~UR_Explosion__AtomData();
	// BW1W120 00560d80 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00698770 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cf250 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560d70 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560f10 BW1M119 inlined
...
public:
	...
	// BW1W120 00560290 BW1M119 inlined
...
public:
	...
	// BW1W120 00560260 BW1M119 inlined
...
public:
	...
	// BW1W120 0055fb10 BW1M119 inlined
...
public:
	...
	// BW1W120 0055f930 BW1M119 inlined
	virtual ~UR_HandSprinkle__CollectionData();
	// BW1W120 0055f920 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00699c00 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006d05e0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055f910 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560190 BW1M119 inlined
	virtual ~UR_InitialSpin__AtomData();
	// BW1W120 00560180 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 006973e0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cdf50 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560170 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055f5c0 BW1M119 inlined
	virtual ~UR_LightSheetOnObject__CollectionData();
	// BW1W120 0055f5b0 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 006967f0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cd350 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055f5a0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055f4c0 BW1M119 inlined
	virtual ~UR_ManaPathNew__AtomData();
	// BW1W120 0055f4b0 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00695fc0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006ccb10 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055f4a0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 005604b0 BW1M119 inlined
	virtual ~UR_OrientSpriteWithRandomAngle__AtomData();
	// BW1W120 005604a0 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 006972a0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cde10 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560490 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560e10 BW1M119 inlined
	virtual ~UR_OrientSpriteWithVelocity__AtomData();
	// BW1W120 00560e00 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00696940 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cd4a0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560df0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560530 BW1M119 inlined
	virtual ~UR_OrientWithVelocity__AtomData();
	// BW1W120 00560520 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00697520 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006ce090 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560510 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560110 BW1M119 inlined
	virtual ~UR_SideSpin__AtomData();
	// BW1W120 00560100 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00697340 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cdeb0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 005600f0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055f1c0 BW1M119 inlined
	virtual ~UR_SimpleBeam__AtomData();
	// BW1W120 0055f150 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00696850 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cd3b0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055f140 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055f240 BW1M119 inlined
	virtual ~UR_SimpleBeam__SubCollectionData();
	// BW1W120 0055f1b0 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00697670 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006ce1e0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055f1a0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055fa90 BW1M119 inlined
	virtual ~UR_SphereSurfaceTracer__AtomData();
	// BW1W120 0055fa80 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00698870 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cf350 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055fa70 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560320 BW1M119 inlined
	virtual ~UR_Trail__CollectionData();
	// BW1W120 00560310 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 006997e0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006d02f0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560300 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055fb90 BW1M119 inlined
	virtual ~UR_VapourEndEffect__AtomData();
	// BW1W120 0055fb80 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00696ed0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cda40 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055fb70 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 00560d10 BW1M119 inlined
	virtual ~UR_VortexAttract__AtomData();
	// BW1W120 00560d00 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00698350 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cee70 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 00560cf0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055fe90 BW1M119 inlined
	virtual ~UR_WillowWisp__CollectionData();
	// BW1W120 0055fe80 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 006994b0 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cffc0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055fe70 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
...
public:
	...
	// BW1W120 0055f830 BW1M119 inlined
...
public:
	...
	// BW1W120 0055fa10 BW1M119 inlined
	virtual ~UpdateRuleShieldSpark__AtomData();
	// BW1W120 0055fa00 BW1M119 inlined
	virtual char* GetDebugText();
	// BW1W120 00696d90 BW1M119 inlined
	virtual uint32_t Load(GameOSFile& file);
	// BW1W120 006cd8f0 BW1M119 inlined
	virtual uint32_t Save(GameOSFile& file);
	// BW1W120 0055f9f0 BW1M119 inlined
	virtual uint32_t GetSaveType();
};
