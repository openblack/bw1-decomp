...
// PlannedAbode::PlannedAbode(Abode* abode)
// {
// }
...
PlannedAbode* PlannedAbode::CreateNoInit(MapCoords& coords, GAbodeInfo* info, Town* town, float param_4, float param_5)
{
    return NULL;
}

// win1.41 00405600 mac 10479fb0 PlannedAbode::Create(MapCoords const &, GAbodeInfo const *, Town *, float, float)
PlannedAbode* PlannedAbode::Create(MapCoords& coords, GAbodeInfo* info, Town* town, float param_4, float param_5)
{
    return NULL;
}
...
MultiMapFixed* PlannedAbode::CreatePlanned(float param_1)
{
    return NULL;
}

// win1.41 00405770 mac 10282ed0 PlannedAbode::CreatePlannedNoFixedCheck(float)
MultiMapFixed* PlannedAbode::CreatePlannedNoFixedCheck(float param_1)
{
    return NULL;
}

// win1.41 004057f0 mac inlined PlannedAbode::IsOkToBuild(void)
bool32_t PlannedAbode::IsOkToBuild()
{
    return false;
}
