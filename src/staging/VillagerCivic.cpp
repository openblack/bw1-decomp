...
bool32_t Villager::CheckNeededForBuilding()
{
    return false;
}
...
bool32_t Villager::SetupBuildingObject(BuildingSite* param_1)
{
    return false;
}

// win1.41 00758530 mac 105767a0 Villager::SetupBuildingObject(MultiMapFixed *)
bool32_t Villager::SetupBuildingObject(MultiMapFixed* param_1)
{
    return false;
}

// win1.41 007585a0 mac 10576630 Villager::SetupWaitForWood(BuildingSite *)
bool32_t Villager::SetupWaitForWood(BuildingSite* param_1)
{
    return false;
}
...
bool32_t Villager::ReenterBuildingState()
{
    return false;
}

// win1.41 007590a0 mac 10574e20 Villager::CheckForClearArea(MapCoords const &, float)
bool32_t Villager::CheckForClearArea(const MapCoords* param_1, float param_2)
{
    return false;
}

// win1.41 007591e0 mac 10575000 ClearAreaPoint::ProcessPoint(LHPoint const &)
bool32_t ClearAreaPoint::ProcessPoint(const LHPoint* param_1)
{
    return false;
}
...
bool32_t Villager::EnterBuilding(unsigned char param_1, unsigned char param_2)
{
    return false;
}

// win1.41 007597b0 mac 10574130 Villager::ExitBuilding(unsigned char)
bool32_t Villager::ExitBuilding(unsigned char param_1)
{
    return false;
}
