...
char s_VillagerHome_cpp[] = "C:\\dev\\MP\\Black\\VillagerHome.cpp";
uint8_t villager_home_unknown_data_0x00c24488[] = {
...
Town* Villager::GetTentPos(MapCoords* coords)
{
    return NULL;
}
...
void Villager::SetupAfterTapOnAbode(MapCoords* param_1, VILLAGER_STATES param_2)
{
}
