...
void Villager::AssignFootballAttackerSubState()
{
}
...
float Villager::FootballAttackerDribblePriority(Football* param_1)
{
    return 0;
}

// win1.41 0075de70 mac 10581aa0 Villager::FootballAttackerMoveToBePassedPriority(Football *)
float Villager::FootballAttackerMoveToBePassedPriority(Football* param_1)
{
    return 0;
}
...
float Villager::FootballAttackerGoHomePriority(Football* param_1)
{
    return 0;
}

// win1.41 0075dfb0 mac 10581740 Villager::FootballAttackerIdlePriority(Football *)
float Villager::FootballAttackerIdlePriority(Football* param_1)
{
    return 0;
}

// win1.41 0075e0b0 mac 105803c0 Villager::AssignFootballDefenderSubState(void)
void Villager::AssignFootballDefenderSubState()
{
}
...
float Villager::FootballDefenderPassPriority(Football* param_1)
{
    return 0;
}
