...
uint32_t SpellSeed::ValidToApplyThisToObject(GInterfaceStatus* param_1, Object* param_2)
{
    return 0;
}
...
uint32_t SpellSeed::ValidForLockedApplyProcess(GInterfaceStatus* param_1)
{
    return 0;
}
...
uint32_t SpellSeed::ApplyThisToObject(GInterfaceStatus* param_1, Object* param_2, GestureSystemPacketData* param_3)
{
    return 0;
}
...
uint32_t SpellSeed::ApplyUnlockProcess(GInterfaceStatus* param_1)
{
    return 0;
}

// win1.41 00728f00 mac 1052a460 SpellSeed::RemoveFromHand(GInterfaceStatus *, MapCoords const &)
uint32_t SpellSeed::RemoveFromHand(GInterfaceStatus* param_1, const MapCoords* param_2)
{
    return 0;
}
