...
uint32_t Villager::GetDiscipleInteractState()
{
    return 0;
}
...
bool32_t Villager::FindCloseObjectsForInteract(LHOrderedLinkedList<SortedObject>* param_1, const MapCoords* param_2)
{
    return 0;
}

// win1.41 00757180 mac 10572de0 Villager::CheckMoveHouse(Object *)
bool32_t Villager::CheckMoveHouse(struct Object* object)
{
    return 0;
}

// win1.41 00757210 mac 10572cf0 Villager::CheckMoveIntoTown(Town &)
bool32_t Villager::CheckMoveIntoTown(struct Town* param_1)
{
    return 0;
}
...
void Villager::SetDiscipleFollower(enum VILLAGER_DISCIPLE param_1)
{
}
