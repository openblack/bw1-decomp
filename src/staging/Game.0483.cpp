...
void GGame::KeyHandler(unsigned short param_1, LH_KEY param_2, unsigned short param_3, unsigned short param_4, void* param_5)
{
}
...
int GGame::MyPlayerID(unsigned long param_1)
{
    return 0;
}

// win1.41 005508a0 mac 10064420 GGame::GetNextPlayer(GPlayer *)
GPlayer* GGame::GetNextPlayer(GPlayer* param_1)
{
    return NULL;
}

// win1.41 005508d0 mac 100c0950 GGame::GetNextActivePlayer(GPlayer *)
GPlayer* GGame::GetNextActivePlayer(GPlayer* param_1)
{
    return NULL;
}
...
GPlayer* GGame::GetPlayerFromReal(unsigned long param_1)
{
    return NULL;
}

// win1.41 00550a10 mac inlined GGame::GetPlayerInterfaceFromReal(unsigned long)
GInterface* GGame::GetPlayerInterfaceFromReal(unsigned long param_1)
{
    return NULL;
}

// win1.41 00550a30 mac inlined GGame::GetNextPlayerWithNoCreature(GPlayer *)
GPlayer* GGame::GetNextPlayerWithNoCreature(GPlayer* param_1)
{
    return NULL;
}

// win1.41 00550a60 mac inlined GGame::GetPlayer(PLAYER_NAME)
GPlayer* GGame::GetPlayer(PLAYER_NAME param_1)
{
    return NULL;
}
