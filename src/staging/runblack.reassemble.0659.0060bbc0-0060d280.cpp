...
void MobileWallHug::SetNewWander(const MapCoords* param_1, int param_2, int param_3)
{
}
...
void MobileWallHug::GetMovementDirection(LHPoint* param_1)
{
}
...
void MobileWallHug::SetSpeedInMetres(float param_1, int param_2)
{
}
...
bool32_t MobileWallHug::Save(GameOSFile& file)
{
    return 0;
}

// win1.41 0060c740 mac 103c23a0 MobileWallHug::Load(GameOSFile &)
bool32_t MobileWallHug::Load(GameOSFile& file)
{
    return 0;
}

// win1.41 0060ca50 mac 10076600 MobileWallHug::MoveToCircleHugLinearSquareSweep(MapCoords const &)
uint32_t MobileWallHug::MoveToCircleHugLinearSquareSweep(MapCoords* dest)
{
    return 0;
}
