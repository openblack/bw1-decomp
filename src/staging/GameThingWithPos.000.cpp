...
// MapCoords GameThingWithPos::GetPos() const
// {
//     return 0;
// }
...
bool GameThingWithPos::IsReadyForNewScriptAction()
{
    return 0;
}
...
bool GameThingWithPos::IsInScript()
{
    return 0;
}
...
bool GameThingWithPos::IsAnyKindOfTree()
{
    return 0;
}

// win1.41 00402340 mac 1055e120 GameThingWithPos::IsDeadTree(void)
bool GameThingWithPos::IsDeadTree()
{
    return 0;
}
