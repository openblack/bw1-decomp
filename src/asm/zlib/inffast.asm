...
_inflate_fast:           sub              esp, 0x14                                     // 0x007c4d70    83ec14
                         ...
                         {disp8} jae      .Lbl_addr_0x007c4da5                          // 0x007c4d9a    7309
                         sub.s            esi, ebx                                      // 0x007c4d9c    2bf3
                         dec              esi                                           // 0x007c4d9e    4e
                         {disp8} mov      dword ptr [esp + 0x18], esi                   // 0x007c4d9f    89742418
                         {disp8} jmp      .Lbl_addr_0x007c4dae                          // 0x007c4da3    eb09
.Lbl_addr_0x007c4da5:    {disp8} mov      ecx, dword ptr [ecx + 0x2c]                   // 0x007c4da5    8b492c
                         sub.s            ecx, ebx                                      // 0x007c4da8    2bcb
                         {disp8} mov      dword ptr [esp + 0x18], ecx                   // 0x007c4daa    894c2418
.Lbl_addr_0x007c4dae:    {disp8} mov      ecx, dword ptr [esp + 0x28]                   // 0x007c4dae    8b4c2428
...
.Lbl_addr_0x007c4dcc:    cmp              eax, 0x14                                     // 0x007c4dcc    83f814
                         {disp8} jae      .Lbl_addr_0x007c4df0                          // 0x007c4dcf    731f
.Lbl_addr_0x007c4dd1:    {disp8} mov      ecx, dword ptr [esp + 0x10]                   // 0x007c4dd1    8b4c2410
                         ...
                         .byte            0x72, 0xe1// {disp8} jb .Lbl_addr_0x007c4dd1  // 0x007c4dee    72e1
.Lbl_addr_0x007c4df0:    {disp8} mov      ecx, dword ptr [esp + 0x1c]                   // 0x007c4df0    8b4c241c
                         ...
                         {disp32} je      .Lbl_addr_0x007c4fa8                          // 0x007c4e04    0f849e010000
                         ...
                         {disp8} jne      .Lbl_addr_0x007c4e55                          // 0x007c4e1a    7539
.Lbl_addr_0x007c4e1c:    test             bl, 0x40                                      // 0x007c4e1c    f6c340
                         {disp32} jne     .Lbl_addr_0x007c504f                          // 0x007c4e1f    0f852a020000
                         ...
                         {disp32} je      .Lbl_addr_0x007c4fa8                          // 0x007c4e3d    0f8465010000
                         ...
                         {disp8} je       .Lbl_addr_0x007c4e1c                          // 0x007c4e53    74c7
.Lbl_addr_0x007c4e55:    and              ebx, 0x0f                                     // 0x007c4e55    83e30f
                         ...
                         {disp8} jae      .Lbl_addr_0x007c4e92                          // 0x007c4e71    731f
.Lbl_addr_0x007c4e73:    {disp8} mov      ecx, dword ptr [esp + 0x10]                   // 0x007c4e73    8b4c2410
                         ...
                         .byte            0x72, 0xe1// {disp8} jb .Lbl_addr_0x007c4e73  // 0x007c4e90    72e1
.Lbl_addr_0x007c4e92:    {disp8} mov      ecx, dword ptr [esp + 0x20]                   // 0x007c4e92    8b4c2420
                         ...
                         {disp8} jne      .Lbl_addr_0x007c4ee7                          // 0x007c4eb4    7531
.Lbl_addr_0x007c4eb6:    test             bl, 0x40                                      // 0x007c4eb6    f6c340
                         {disp32} jne     .Lbl_addr_0x007c4fe2                          // 0x007c4eb9    0f8523010000
                         ...
                         {disp8} je       .Lbl_addr_0x007c4eb6                          // 0x007c4ee5    74cf
.Lbl_addr_0x007c4ee7:    and              ebx, 0x0f                                     // 0x007c4ee7    83e30f
                         cmp.s            eax, ebx                                      // 0x007c4eea    3bc3
                         {disp8} jae      .Lbl_addr_0x007c4f0c                          // 0x007c4eec    731e
.Lbl_addr_0x007c4eee:    {disp8} mov      edi, dword ptr [esp + 0x10]                   // 0x007c4eee    8b7c2410
                         ...
                         .byte            0x72, 0xe2// {disp8} jb .Lbl_addr_0x007c4eee  // 0x007c4f0a    72e2
.Lbl_addr_0x007c4f0c:    {disp32} mov     edi, dword ptr [ebx * 0x4 + 0x00c2d350]       // 0x007c4f0c    8b3c9d50d3c200
                         ...
                         .byte            0x72, 0x1f// {disp8} jb .Lbl_addr_0x007c4f60  // 0x007c4f3f    721f
                         ...
                         {disp8} jmp      .Lbl_addr_0x007c4f8d                          // 0x007c4f5e    eb2d
.Lbl_addr_0x007c4f60:    sub.s            esi, ecx                                      // 0x007c4f60    2bf1
...
.Lbl_addr_0x007c4f8d:    mov              bl, byte ptr [esi]                            // 0x007c4f8d    8a1e
                         ...
                         {disp8} jne      .Lbl_addr_0x007c4f8d                          // 0x007c4f9c    75ef
                         {disp8} mov      edi, dword ptr [esp + 0x3c]                   // 0x007c4f9e    8b7c243c
                         {disp8} mov      dword ptr [esp + 0x14], ecx                   // 0x007c4fa2    894c2414
                         {disp8} jmp      .Lbl_addr_0x007c4fc8                          // 0x007c4fa6    eb20
.Lbl_addr_0x007c4fa8:    xor.s            ecx, ecx                                      // 0x007c4fa8    33c9
...
.Lbl_addr_0x007c4fc8:    {disp8} mov      ecx, dword ptr [esp + 0x18]                   // 0x007c4fc8    8b4c2418
                         {disp8} mov      ebx, dword ptr [esp + 0x10]                   // 0x007c4fcc    8b5c2410
                         cmp              ecx, 0x00000102                               // 0x007c4fd0    81f902010000
                         .byte            0x72, 0x2c// {disp8} jb .Lbl_addr_0x007c5004  // 0x007c4fd6    722c
                         cmp              ebx, 0x0a                                     // 0x007c4fd8    83fb0a
                         .byte            0x72, 0x27// {disp8} jb .Lbl_addr_0x007c5004  // 0x007c4fdb    7227
                         {disp32} jmp     .Lbl_addr_0x007c4dcc                          // 0x007c4fdd    e9eafdffff
.Lbl_addr_0x007c4fe2:    {disp8} mov      ecx, dword ptr [edi + 0x04]                   // 0x007c4fe2    8b4f04
                         ...
                         {disp32} jae     .Lbl_addr_0x007c50c1                          // 0x007c4ff9    0f83c2000000
                         {disp32} jmp     .Lbl_addr_0x007c50bf                          // 0x007c4fff    e9bb000000
.Lbl_addr_0x007c5004:    {disp8} mov      ecx, dword ptr [edi + 0x04]                   // 0x007c5004    8b4f04
                         mov.s            esi, eax                                      // 0x007c5007    8bf0
                         sub.s            ecx, ebx                                      // 0x007c5009    2bcb
                         shr              esi, 3                                        // 0x007c500b    c1ee03
                         cmp.s            esi, ecx                                      // 0x007c500e    3bf1
                         {disp8} jae      .Lbl_addr_0x007c5014                          // 0x007c5010    7302
                         mov.s            ecx, esi                                      // 0x007c5012    8bce
.Lbl_addr_0x007c5014:    {disp8} mov      esi, dword ptr [esp + 0x38]                   // 0x007c5014    8b742438
                         ...
                         ret                                                            // 0x007c504e    c3
.Lbl_addr_0x007c504f:    test             bl, 0x20                                      // 0x007c504f    f6c320
                         {disp8} je       .Lbl_addr_0x007c50a6                          // 0x007c5052    7452
                         ...
                         {disp8} jae      .Lbl_addr_0x007c5068                          // 0x007c5064    7302
                         mov.s            ecx, esi                                      // 0x007c5066    8bce
.Lbl_addr_0x007c5068:    {disp8} mov      esi, dword ptr [esp + 0x38]                   // 0x007c5068    8b742438
                         ...
                         ret                                                            // 0x007c50a5    c3
.Lbl_addr_0x007c50a6:    {disp8} mov      ecx, dword ptr [edi + 0x04]                   // 0x007c50a6    8b4f04
                         ...
                         {disp8} jae      .Lbl_addr_0x007c50c1                          // 0x007c50bd    7302
.Lbl_addr_0x007c50bf:    mov.s            ecx, esi                                      // 0x007c50bf    8bce
.Lbl_addr_0x007c50c1:    {disp8} mov      esi, dword ptr [esp + 0x38]                   // 0x007c50c1    8b742438
