...
_inflate_flush:          push             ecx                                           // 0x007c4c30    51
                         ...
                         {disp8} jbe      .Lbl_addr_0x007c4c55                          // 0x007c4c50    7603
                         {disp8} mov      ebp, dword ptr [ebx + 0x2c]                   // 0x007c4c52    8b6b2c
.Lbl_addr_0x007c4c55:    {disp8} mov      eax, dword ptr [esi + 0x10]                   // 0x007c4c55    8b4610
                         sub.s            ebp, edi                                      // 0x007c4c58    2bef
                         cmp.s            ebp, eax                                      // 0x007c4c5a    3be8
                         {disp8} jbe      .Lbl_addr_0x007c4c60                          // 0x007c4c5c    7602
                         mov.s            ebp, eax                                      // 0x007c4c5e    8be8
.Lbl_addr_0x007c4c60:    test             ebp, ebp                                      // 0x007c4c60    85ed
                         {disp8} je       .Lbl_addr_0x007c4c73                          // 0x007c4c62    740f
                         cmp              dword ptr [esp + 0x20], -0x05                 // 0x007c4c64    837c2420fb
                         {disp8} jne      .Lbl_addr_0x007c4c73                          // 0x007c4c69    7508
                         {disp8} mov      dword ptr [esp + 0x20], 0x00000000            // 0x007c4c6b    c744242000000000
.Lbl_addr_0x007c4c73:    {disp8} mov      edx, dword ptr [esi + 0x14]                   // 0x007c4c73    8b5614
                         ...
                         {disp8} je       .Lbl_addr_0x007c4c98                          // 0x007c4c85    7411
...
.Lbl_addr_0x007c4c98:    mov.s            ecx, ebp                                      // 0x007c4c98    8bcd
                         ...
                         {disp32} jne     .Lbl_addr_0x007c4d4a                          // 0x007c4cc3    0f8581000000
                         ...
                         {disp8} jne      .Lbl_addr_0x007c4cda                          // 0x007c4cd5    7503
                         {disp8} mov      dword ptr [ebx + 0x34], esi                   // 0x007c4cd7    897334
.Lbl_addr_0x007c4cda:    {disp8} mov      edi, dword ptr [esp + 0x1c]                   // 0x007c4cda    8b7c241c
                         ...
                         {disp8} jbe      .Lbl_addr_0x007c4cec                          // 0x007c4ce8    7602
                         mov.s            ebp, eax                                      // 0x007c4cea    8be8
.Lbl_addr_0x007c4cec:    test             ebp, ebp                                      // 0x007c4cec    85ed
                         {disp8} je       .Lbl_addr_0x007c4cff                          // 0x007c4cee    740f
                         cmp              dword ptr [esp + 0x20], -0x05                 // 0x007c4cf0    837c2420fb
                         {disp8} jne      .Lbl_addr_0x007c4cff                          // 0x007c4cf5    7508
                         {disp8} mov      dword ptr [esp + 0x20], 0x00000000            // 0x007c4cf7    c744242000000000
.Lbl_addr_0x007c4cff:    {disp8} mov      edx, dword ptr [edi + 0x14]                   // 0x007c4cff    8b5714
                         ...
                         {disp8} je       .Lbl_addr_0x007c4d24                          // 0x007c4d11    7411
...
.Lbl_addr_0x007c4d24:    {disp8} mov      eax, dword ptr [esp + 0x10]                   // 0x007c4d24    8b442410
...
.Lbl_addr_0x007c4d4a:    {disp8} mov      ecx, dword ptr [esp + 0x1c]                   // 0x007c4d4a    8b4c241c
