...
_jmp_addr_0x00893f30:    {disp8} mov     eax, dword ptr [esp + 0x08]        // 0x00893f30    8b442408
                         ...
                         {disp8} je      .Lbl_addr_0x00893faa               // 0x00893f37    7471
...
.Lbl_addr_0x00893f42:    {disp8} mov     eax, dword ptr [esi + -0x04]       // 0x00893f42    8b46fc
                         add             eax, -0x02                         // 0x00893f45    83c0fe
                         cmp             eax, 0x07                          // 0x00893f48    83f807
                         {disp8} ja      .Lbl_addr_0x00893f9e               // 0x00893f4b    7751
                         ...
                         {disp8} jmp     .Lbl_addr_0x00893f9e               // 0x00893f58    eb44
                         cmp             dword ptr [esi], 0x00              // 0x00893f5a    833e00
                         {disp8} je      .Lbl_addr_0x00893f74               // 0x00893f5d    7415
                         {disp8} mov     eax, dword ptr [esi + 0x04]        // 0x00893f5f    8b4604
                         test            eax, eax                           // 0x00893f62    85c0
                         {disp8} je      .Lbl_addr_0x00893f74               // 0x00893f64    740e
