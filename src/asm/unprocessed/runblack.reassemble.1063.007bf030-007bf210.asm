...
.Lbl_addr_0x007bf030:    push             esi                                            // 0x007bf030    56
...
.Lbl_addr_0x007bf03d:    {disp32} mov     eax, dword ptr [esi + 0x000002ac]              // 0x007bf03d    8b86ac020000
                         ...
                         {disp8} je       .Lbl_addr_0x007bf0be                           // 0x007bf061    745b
                         ...
                         {disp8} jae      .Lbl_addr_0x007bf0be                           // 0x007bf075    7347
                         ...
                         {disp8} jne      .Lbl_addr_0x007bf098                           // 0x007bf086    7510
...
.Lbl_addr_0x007bf098:    mov.s            edi, esi                                       // 0x007bf098    8bfe
                         ...
                         {disp8} je       .Lbl_addr_0x007bf03d                           // 0x007bf0b4    7487
                         pop              edi                                            // 0x007bf0b6    5f
                         mov              eax, 0x00000001                                // 0x007bf0b7    b801000000
                         pop              esi                                            // 0x007bf0bc    5e
                         ret                                                             // 0x007bf0bd    c3
.Lbl_addr_0x007bf0be:    pop              edi                                            // 0x007bf0be    5f
...
_jmp_addr_0x007bf0d0:    push             esi                                            // 0x007bf0d0    56
                         ...
                         {disp8} jne      .Lbl_addr_0x007bf0e1                           // 0x007bf0db    7504
                         xor.s            eax, eax                                       // 0x007bf0dd    33c0
                         pop              esi                                            // 0x007bf0df    5e
                         ret                                                             // 0x007bf0e0    c3
.Lbl_addr_0x007bf0e1:    {disp32} mov     ax, word ptr [esi + 0x000002b4]                // 0x007bf0e1    668b86b4020000
                         test             ax, ax                                         // 0x007bf0e8    6685c0
                         {disp8} je       .Lbl_addr_0x007bf0fe                           // 0x007bf0eb    7411
                         ...
                         {disp8} jl       .Lbl_addr_0x007bf10d                           // 0x007bf0fc    7c0f
.Lbl_addr_0x007bf0fe:    mov.s            ecx, esi                                       // 0x007bf0fe    8bce
                         call             .Lbl_addr_0x007bf030                           // 0x007bf100    e82bffffff
                         test             eax, eax                                       // 0x007bf105    85c0
                         {disp8} jne      .Lbl_addr_0x007bf10d                           // 0x007bf107    7504
.Lbl_addr_0x007bf109:    xor.s            eax, eax                                       // 0x007bf109    33c0
                         pop              esi                                            // 0x007bf10b    5e
                         ret                                                             // 0x007bf10c    c3
.Lbl_addr_0x007bf10d:    {disp32} mov     edx, dword ptr [esi + 0x000002b0]              // 0x007bf10d    8b96b0020000
                         ...
                         {disp8} jne      .Lbl_addr_0x007bf15c                           // 0x007bf12d    752d
.Lbl_addr_0x007bf12f:    mov.s            ecx, esi                                       // 0x007bf12f    8bce
                         call             .Lbl_addr_0x007bf030                           // 0x007bf131    e8fafeffff
                         test             eax, eax                                       // 0x007bf136    85c0
                         {disp8} je       .Lbl_addr_0x007bf109                           // 0x007bf138    74cf
                         ...
                         {disp8} je       .Lbl_addr_0x007bf12f                           // 0x007bf15a    74d3
.Lbl_addr_0x007bf15c:    push             ebx                                            // 0x007bf15c    53
                         ...
                         {disp8} jbe      .Lbl_addr_0x007bf19e                           // 0x007bf182    761a
...
.Lbl_addr_0x007bf194:    mov              al, byte ptr [edx]                             // 0x007bf194    8a02
                         inc              edx                                            // 0x007bf196    42
                         mov              byte ptr [edi], al                             // 0x007bf197    8807
                         inc              edi                                            // 0x007bf199    47
                         dec              ebp                                            // 0x007bf19a    4d
                         {disp8} jne      .Lbl_addr_0x007bf194                           // 0x007bf19b    75f7
                         pop              ebp                                            // 0x007bf19d    5d
.Lbl_addr_0x007bf19e:    and              ecx, 0x0000ffff                                // 0x007bf19e    81e1ffff0000
                         ...
                         nop                                                             // 0x007bf1be    90
                         nop                                                             // 0x007bf1bf    90
_globl_ct_0x007bf1c0:    call             .Lbl_addr_0x007bf1d0                           // 0x007bf1c0    e80b000000
                         {disp32} jmp     .Lbl_addr_0x007bf1f0                           // 0x007bf1c5    e926000000
                         nop                                                             // 0x007bf1ca    90
                         nop                                                             // 0x007bf1cb    90
                         nop                                                             // 0x007bf1cc    90
                         nop                                                             // 0x007bf1cd    90
                         nop                                                             // 0x007bf1ce    90
                         nop                                                             // 0x007bf1cf    90
.Lbl_addr_0x007bf1d0:    push             0x00c2bdc8                                     // 0x007bf1d0    68c8bdc200
                         ...
                         nop                                                             // 0x007bf1ee    90
                         nop                                                             // 0x007bf1ef    90
.Lbl_addr_0x007bf1f0:    push             0x007bf200                                     // 0x007bf1f0    6800f27b00
