...
_jmp_addr_0x0078cd20:    {disp8} mov      eax, dword ptr [esp + 0x08]             // 0x0078cd20    8b442408
                         ...
                         {disp32} ja      .Lbl_addr_0x0078ce59                    // 0x0078cd28    0f872b010000
                         ...
                         {disp32} jae     .Lbl_addr_0x0078ce59                    // 0x0078cd3e    0f8315010000
                         {disp8} mov      esi, dword ptr [esp + 0x08]             // 0x0078cd44    8b742408
                         xor.s            eax, eax                                // 0x0078cd48    33c0
                         test             ecx, ecx                                // 0x0078cd4a    85c9
                         {disp8} jbe      .Lbl_addr_0x0078cd63                    // 0x0078cd4c    7615
                         mov              edx, 0x00df9d1c                         // 0x0078cd4e    ba1c9ddf00
.Lbl_addr_0x0078cd53:    cmp              dword ptr [edx], esi                    // 0x0078cd53    3932
                         {disp32} je      .Lbl_addr_0x0078ce59                    // 0x0078cd55    0f84fe000000
                         inc              eax                                     // 0x0078cd5b    40
                         add              edx, 0x04                               // 0x0078cd5c    83c204
                         cmp.s            eax, ecx                                // 0x0078cd5f    3bc1
                         .byte            0x72, 0xf0// {disp8} jb .Lbl_addr_0x0078cd53 // 0x0078cd61    72f0
.Lbl_addr_0x0078cd63:    {disp32} mov     dword ptr [ecx * 0x4 + 0x00df9d1c], esi // 0x0078cd63    89348d1c9ddf00
                         ...
                         {disp32} jae     .Lbl_addr_0x0078ce59                    // 0x0078cd7c    0f83d7000000
                         {disp8} mov      esi, dword ptr [esp + 0x08]             // 0x0078cd82    8b742408
                         xor.s            eax, eax                                // 0x0078cd86    33c0
                         test             ecx, ecx                                // 0x0078cd88    85c9
                         {disp8} jbe      .Lbl_addr_0x0078cda1                    // 0x0078cd8a    7615
                         mov              edx, 0x00df5c58                         // 0x0078cd8c    ba585cdf00
.Lbl_addr_0x0078cd91:    cmp              dword ptr [edx], esi                    // 0x0078cd91    3932
                         {disp32} je      .Lbl_addr_0x0078ce59                    // 0x0078cd93    0f84c0000000
                         inc              eax                                     // 0x0078cd99    40
                         add              edx, 0x04                               // 0x0078cd9a    83c204
                         cmp.s            eax, ecx                                // 0x0078cd9d    3bc1
                         .byte            0x72, 0xf0// {disp8} jb .Lbl_addr_0x0078cd91 // 0x0078cd9f    72f0
.Lbl_addr_0x0078cda1:    {disp32} mov     dword ptr [ecx * 0x4 + 0x00df5c58], esi // 0x0078cda1    89348d585cdf00
                         ...
                         {disp32} jae     .Lbl_addr_0x0078ce59                    // 0x0078cdba    0f8399000000
                         {disp8} mov      esi, dword ptr [esp + 0x08]             // 0x0078cdc0    8b742408
                         xor.s            eax, eax                                // 0x0078cdc4    33c0
                         test             ecx, ecx                                // 0x0078cdc6    85c9
                         {disp8} jbe      .Lbl_addr_0x0078cddf                    // 0x0078cdc8    7615
                         mov              edx, 0x00df1b94                         // 0x0078cdca    ba941bdf00
.Lbl_addr_0x0078cdcf:    cmp              dword ptr [edx], esi                    // 0x0078cdcf    3932
                         {disp32} je      .Lbl_addr_0x0078ce59                    // 0x0078cdd1    0f8482000000
                         inc              eax                                     // 0x0078cdd7    40
                         add              edx, 0x04                               // 0x0078cdd8    83c204
                         cmp.s            eax, ecx                                // 0x0078cddb    3bc1
                         .byte            0x72, 0xf0// {disp8} jb .Lbl_addr_0x0078cdcf // 0x0078cddd    72f0
.Lbl_addr_0x0078cddf:    {disp32} mov     dword ptr [ecx * 0x4 + 0x00df1b94], esi // 0x0078cddf    89348d941bdf00
                         ...
                         {disp8} jae      .Lbl_addr_0x0078ce59                    // 0x0078cdf8    735f
                         {disp8} mov      esi, dword ptr [esp + 0x08]             // 0x0078cdfa    8b742408
                         xor.s            eax, eax                                // 0x0078cdfe    33c0
                         test             ecx, ecx                                // 0x0078ce00    85c9
                         {disp8} jbe      .Lbl_addr_0x0078ce15                    // 0x0078ce02    7611
                         mov              edx, 0x00dedad0                         // 0x0078ce04    bad0dade00
.Lbl_addr_0x0078ce09:    cmp              dword ptr [edx], esi                    // 0x0078ce09    3932
                         {disp8} je       .Lbl_addr_0x0078ce59                    // 0x0078ce0b    744c
                         inc              eax                                     // 0x0078ce0d    40
                         add              edx, 0x04                               // 0x0078ce0e    83c204
                         cmp.s            eax, ecx                                // 0x0078ce11    3bc1
                         .byte            0x72, 0xf4// {disp8} jb .Lbl_addr_0x0078ce09 // 0x0078ce13    72f4
.Lbl_addr_0x0078ce15:    {disp32} mov     dword ptr [ecx * 0x4 + 0x00dedad0], esi // 0x0078ce15    89348dd0dade00
                         ...
                         {disp8} jae      .Lbl_addr_0x0078ce59                    // 0x0078ce2e    7329
                         {disp8} mov      esi, dword ptr [esp + 0x08]             // 0x0078ce30    8b742408
                         xor.s            eax, eax                                // 0x0078ce34    33c0
                         test             ecx, ecx                                // 0x0078ce36    85c9
                         {disp8} jbe      .Lbl_addr_0x0078ce4b                    // 0x0078ce38    7611
                         mov              edx, 0x00de9a0c                         // 0x0078ce3a    ba0c9ade00
.Lbl_addr_0x0078ce3f:    cmp              dword ptr [edx], esi                    // 0x0078ce3f    3932
                         {disp8} je       .Lbl_addr_0x0078ce59                    // 0x0078ce41    7416
                         inc              eax                                     // 0x0078ce43    40
                         add              edx, 0x04                               // 0x0078ce44    83c204
                         cmp.s            eax, ecx                                // 0x0078ce47    3bc1
                         .byte            0x72, 0xf4// {disp8} jb .Lbl_addr_0x0078ce3f // 0x0078ce49    72f4
.Lbl_addr_0x0078ce4b:    {disp32} mov     dword ptr [ecx * 0x4 + 0x00de9a0c], esi // 0x0078ce4b    89348d0c9ade00
                         inc              ecx                                     // 0x0078ce52    41
                         {disp32} mov     dword ptr [data_bytes + 0x43be7c], ecx  // 0x0078ce53    890d7c1ee000
.Lbl_addr_0x0078ce59:    pop              esi                                     // 0x0078ce59    5e
                         ret                                                      // 0x0078ce5a    c3
