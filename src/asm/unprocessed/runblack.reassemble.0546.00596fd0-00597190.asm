...
_jmp_addr_0x00596fd0:    sub                esp, 0x08                          // 0x00596fd0    83ec08
                         ...
                         {disp32} fcom      dword ptr [__real@4@00000000000000000000]        // 0x0059700f    d81598a38a00
                         fnstsw             ax                                 // 0x00597015    dfe0
                         test               ah, 0x41                           // 0x00597017    f6c441
                         {disp8} jne        .Lbl_addr_0x0059702c               // 0x0059701a    7510
                         ...
                         {disp8} jmp        .Lbl_addr_0x00597036               // 0x0059702a    eb0a
.Lbl_addr_0x0059702c:    fstp               st(0)                              // 0x0059702c    ddd8
                         {disp8} mov        dword ptr [esp + 0x1c], 0x00000000 // 0x0059702e    c744241c00000000
.Lbl_addr_0x00597036:    mov                ebx, dword ptr [ebx]               // 0x00597036    8b1b
                         {disp8} lea        eax, dword ptr [ebx + -0x01]       // 0x00597038    8d43ff
                         cmp                eax, 0x0b                          // 0x0059703b    83f80b
                         {disp32} ja        .Lbl_addr_0x0059710a               // 0x0059703e    0f87c6000000
                         ...
                         {disp32} jle       .Lbl_addr_0x0059710a               // 0x00597055    0f8eaf000000
                         ...
                         {disp32} jmp       .Lbl_addr_0x0059710a               // 0x00597068    e99d000000
                         cmp.s              edi, ebp                           // 0x0059706d    3bfd
                         {disp32} jle       .Lbl_addr_0x0059710a               // 0x0059706f    0f8e95000000
                         ...
                         {disp8} jne        .Lbl_addr_0x00597099               // 0x00597083    7514
                         test               ah, 0x01                           // 0x00597085    f6c401
                         {disp8} fld        dword ptr [esi + 0x58]             // 0x00597088    d94658
                         {disp8} je         .Lbl_addr_0x005970ad               // 0x0059708b    7420
                         ...
                         {disp8} jmp        .Lbl_addr_0x0059710a               // 0x00597097    eb71
.Lbl_addr_0x00597099:    test               ah, 0x41                           // 0x00597099    f6c441
                         {disp8} fld        dword ptr [esi + 0x58]             // 0x0059709c    d94658
                         {disp8} jne        .Lbl_addr_0x005970ad               // 0x0059709f    750c
                         ...
                         {disp8} jmp        .Lbl_addr_0x0059710a               // 0x005970ab    eb5d
.Lbl_addr_0x005970ad:    {disp32} fsubr     dword ptr [rdata_bytes + 0x28678]  // 0x005970ad    d82d78168d00
                         ...
                         {disp8} jmp        .Lbl_addr_0x0059710a               // 0x005970bd    eb4b
                         cmp.s              edi, ebp                           // 0x005970bf    3bfd
                         {disp8} jle        .Lbl_addr_0x0059710a               // 0x005970c1    7e47
                         ...
                         {disp8} jmp        .Lbl_addr_0x0059710a               // 0x005970d0    eb38
                         cmp.s              edi, ebp                           // 0x005970d2    3bfd
                         {disp8} jle        .Lbl_addr_0x0059710a               // 0x005970d4    7e34
...
.Lbl_addr_0x0059710a:    {disp8} mov        edi, dword ptr [esi + 0x1c]        // 0x0059710a    8b7e1c
                         xor.s              ebx, ebx                           // 0x0059710d    33db
                         cmp.s              edi, ebx                           // 0x0059710f    3bfb
                         {disp8} je         .Lbl_addr_0x00597163               // 0x00597111    7450
.Lbl_addr_0x00597113:    {disp8} mov        esi, dword ptr [edi + 0x04]        // 0x00597113    8b7704
                         ...
                         {disp8} jne        .Lbl_addr_0x0059715d               // 0x0059711f    753c
                         ...
                         {disp8} je         .Lbl_addr_0x0059715d               // 0x0059713a    7421
                         ...
                         {disp8} je         .Lbl_addr_0x0059715d               // 0x00597147    7414
...
.Lbl_addr_0x0059715d:    mov                edi, dword ptr [edi]               // 0x0059715d    8b3f
                         cmp.s              edi, ebx                           // 0x0059715f    3bfb
                         {disp8} jne        .Lbl_addr_0x00597113               // 0x00597161    75b0
.Lbl_addr_0x00597163:    pop                edi                                // 0x00597163    5f
