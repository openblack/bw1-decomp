...
_globl_ct_0x0063eef0:    {disp32} jmp     .Lbl_addr_0x0063ef00                          // 0x0063eef0    e90b000000
                         nop                                                            // 0x0063eef5    90
                         nop                                                            // 0x0063eef6    90
                         nop                                                            // 0x0063eef7    90
                         nop                                                            // 0x0063eef8    90
                         ...
                         nop                                                            // 0x0063eefe    90
                         nop                                                            // 0x0063eeff    90
.Lbl_addr_0x0063ef00:    xor.s            eax, eax                                      // 0x0063ef00    33c0
...
_jmp_addr_0x0063ef20:    sub              esp, 0x08                                     // 0x0063ef20    83ec08
                         ...
                         {disp8} je       .Lbl_addr_0x0063ef51                          // 0x0063ef4a    7405
                         call             ?GetCreature3D@Creature@@QAEPAVLH3DCreature@@XZ                 // 0x0063ef4c    e8ff88e3ff
.Lbl_addr_0x0063ef51:    {disp32} mov     ecx, dword ptr [esi + 0x00205b80]             // 0x0063ef51    8b8e805b2000
                         ...
                         {disp32} jne     .Lbl_addr_0x0063f0f0                          // 0x0063ef7a    0f8570010000
                         ...
                         {disp8} je       .Lbl_addr_0x0063f005                          // 0x0063ef8e    7475
                         ...
                         {disp8} je       .Lbl_addr_0x0063efae                          // 0x0063ef9e    740e
                         {disp32} mov     ecx, dword ptr [eax + 0x000045ec]             // 0x0063efa0    8b88ec450000
                         test             ecx, ecx                                      // 0x0063efa6    85c9
                         {disp32} jne     .Lbl_addr_0x0063f0f0                          // 0x0063efa8    0f8542010000
.Lbl_addr_0x0063efae:    {disp32} mov     eax, dword ptr [data_bytes + 0x30daf0]        // 0x0063efae    a1f03acd00
                         ...
                         {disp8} ja       .Lbl_addr_0x0063efe1                          // 0x0063efd8    7707
                         {disp32} mov     eax, dword ptr [data_bytes + 0x351ca8]        // 0x0063efda    a1a87cd100
                         {disp8} jmp      .Lbl_addr_0x0063efed                          // 0x0063efdf    eb0c
.Lbl_addr_0x0063efe1:    {disp32} mov     edx, dword ptr [data_bytes + 0x351ca8]        // 0x0063efe1    8b15a87cd100
                         {disp32} lea     eax, dword ptr [edx + 0x0000a5cc]             // 0x0063efe7    8d82cca50000
.Lbl_addr_0x0063efed:    {disp8} mov      eax, dword ptr [eax + 0x08]                   // 0x0063efed    8b4008
                         ...
                         {disp32} jmp     .Lbl_addr_0x0063f0f0                          // 0x0063f000    e9eb000000
.Lbl_addr_0x0063f005:    call             ?IsMultiplayerGame@GGame@@QBE_NXZ             // 0x0063f005    e8763ff1ff
                         test             eax, eax                                      // 0x0063f00a    85c0
                         {disp32} jne     .Lbl_addr_0x0063f0f0                          // 0x0063f00c    0f85de000000
                         {disp32} mov     ecx, dword ptr [_game]                        // 0x0063f012    8b0d5c19d000
                         cmp              dword ptr [ecx + 0x00205a08], esi             // 0x0063f018    39b1085a2000
                         {disp32} jne     .Lbl_addr_0x0063f0f0                          // 0x0063f01e    0f85cc000000
                         ...
                         {disp8} je       .Lbl_addr_0x0063f044                          // 0x0063f034    740e
                         {disp32} mov     edx, dword ptr [eax + 0x000045ec]             // 0x0063f036    8b90ec450000
                         test             edx, edx                                      // 0x0063f03c    85d2
                         {disp32} jne     .Lbl_addr_0x0063f0f0                          // 0x0063f03e    0f85ac000000
.Lbl_addr_0x0063f044:    {disp32} mov     ecx, dword ptr [ecx + 0x00250090]             // 0x0063f044    8b8990002500
                         call             _jmp_addr_0x006ebb50                          // 0x0063f04a    e801cb0a00
                         test             eax, eax                                      // 0x0063f04f    85c0
                         {disp32} je      .Lbl_addr_0x0063f0f0                          // 0x0063f051    0f8499000000
                         {disp32} mov     al, byte ptr [data_bytes + 0x5df1db]          // 0x0063f057    a0db51fa00
                         test             al, al                                        // 0x0063f05c    84c0
                         {disp32} jne     .Lbl_addr_0x0063f0f0                          // 0x0063f05e    0f858c000000
                         ...
                         {disp8} je       .Lbl_addr_0x0063f0bf                          // 0x0063f07e    743f
                         ...
                         {disp8} jle      .Lbl_addr_0x0063f0b3                          // 0x0063f090    7e21
                         mov              edx, 0x00d1d28c                               // 0x0063f092    ba8cd2d100
                         mov              edi, 0x0000feff                               // 0x0063f097    bffffe0000
.Lbl_addr_0x0063f09c:    mov              eax, dword ptr [edx]                          // 0x0063f09c    8b02
                         test             eax, eax                                      // 0x0063f09e    85c0
                         {disp8} je       .Lbl_addr_0x0063f0a6                          // 0x0063f0a0    7404
                         and              word ptr [eax + 0x24], di                     // 0x0063f0a2    66217824
.Lbl_addr_0x0063f0a6:    {disp32} mov     eax, dword ptr [data_bytes + 0x35a198]        // 0x0063f0a6    a19801d200
                         inc              ecx                                           // 0x0063f0ab    41
                         add              edx, 0x04                                     // 0x0063f0ac    83c204
                         cmp.s            ecx, eax                                      // 0x0063f0af    3bc8
                         {disp8} jl       .Lbl_addr_0x0063f09c                          // 0x0063f0b1    7ce9
.Lbl_addr_0x0063f0b3:    {disp32} mov     dword ptr [data_bytes + 0x35a198], 0x00000000 // 0x0063f0b3    c7059801d20000000000
                         {disp8} jmp      .Lbl_addr_0x0063f0f0                          // 0x0063f0bd    eb31
.Lbl_addr_0x0063f0bf:    cmp              dword ptr [data_bytes + 0x351cac], 0x00001afb // 0x0063f0bf    813dac7cd100fb1a0000
                         {disp8} ja       .Lbl_addr_0x0063f0d2                          // 0x0063f0c9    7707
                         {disp32} mov     eax, dword ptr [data_bytes + 0x351ca8]        // 0x0063f0cb    a1a87cd100
                         {disp8} jmp      .Lbl_addr_0x0063f0de                          // 0x0063f0d0    eb0c
.Lbl_addr_0x0063f0d2:    {disp32} mov     edx, dword ptr [data_bytes + 0x351ca8]        // 0x0063f0d2    8b15a87cd100
                         {disp32} lea     eax, dword ptr [edx + 0x000143c4]             // 0x0063f0d8    8d82c4430100
.Lbl_addr_0x0063f0de:    {disp8} mov      eax, dword ptr [eax + 0x08]                   // 0x0063f0de    8b4008
...
.Lbl_addr_0x0063f0f0:    call             _jmp_addr_0x00407ef0                          // 0x0063f0f0    e8fb8ddcff
                         ...
                         {disp8} jne      .Lbl_addr_0x0063f146                          // 0x0063f120    7524
...
.Lbl_addr_0x0063f146:    {disp32} mov     ecx, dword ptr [_game]                        // 0x0063f146    8b0d5c19d000
                         ...
                         {disp8} je       .Lbl_addr_0x0063f197                          // 0x0063f18b    740a
                         {disp32} mov     edx, dword ptr [eax + 0x000045ec]             // 0x0063f18d    8b90ec450000
                         test             edx, edx                                      // 0x0063f193    85d2
                         {disp8} jne      .Lbl_addr_0x0063f1db                          // 0x0063f195    7544
.Lbl_addr_0x0063f197:    call             ?IsMultiplayerGame@GGame@@QBE_NXZ             // 0x0063f197    e8e43df1ff
                         test             eax, eax                                      // 0x0063f19c    85c0
                         {disp8} jne      .Lbl_addr_0x0063f1db                          // 0x0063f19e    753b
                         {disp32} mov     ecx, dword ptr [_game]                        // 0x0063f1a0    8b0d5c19d000
                         cmp              dword ptr [ecx + 0x00205a28], ebp             // 0x0063f1a6    39a9285a2000
                         {disp8} jne      .Lbl_addr_0x0063f1b3                          // 0x0063f1ac    7505
                         call             _jmp_addr_0x00553a70                          // 0x0063f1ae    e8bd48f1ff
.Lbl_addr_0x0063f1b3:    cmp              dword ptr [data_bytes + 0x351cac], 0x000019fd // 0x0063f1b3    813dac7cd100fd190000
                         {disp32} mov     eax, dword ptr [data_bytes + 0x351ca8]        // 0x0063f1bd    a1a87cd100
                         {disp8} jbe      .Lbl_addr_0x0063f1c9                          // 0x0063f1c2    7605
                         add              eax, 0x000137dc                               // 0x0063f1c4    05dc370100
.Lbl_addr_0x0063f1c9:    {disp8} mov      ecx, dword ptr [eax + 0x08]                   // 0x0063f1c9    8b4808
...
.Lbl_addr_0x0063f1db:    mov.s            ebx, ebp                                      // 0x0063f1db    8bdd
.Lbl_addr_0x0063f1dd:    {disp32} mov     al, byte ptr [data_bytes + 0x286ced]          // 0x0063f1dd    a0edccc400
                         test             al, al                                        // 0x0063f1e2    84c0
                         {disp8} mov      edi, dword ptr [esp + 0x20]                   // 0x0063f1e4    8b7c2420
                         {disp8} je       .Lbl_addr_0x0063f251                          // 0x0063f1e8    7467
                         {disp8} mov      esi, dword ptr [esp + 0x1c]                   // 0x0063f1ea    8b74241c
                         cmp.s            esi, ebp                                      // 0x0063f1ee    3bf5
                         mov.s            ebx, ebp                                      // 0x0063f1f0    8bdd
                         {disp8} jne      .Lbl_addr_0x0063f211                          // 0x0063f1f2    751d
                         test             di, di                                        // 0x0063f1f4    6685ff
                         {disp8} jne      .Lbl_addr_0x0063f211                          // 0x0063f1f7    7518
                         {disp32} mov     al, byte ptr [data_bytes + 0x286cec]          // 0x0063f1f9    a0ecccc400
                         test             al, al                                        // 0x0063f1fe    84c0
                         {disp8} je       .Lbl_addr_0x0063f211                          // 0x0063f200    740f
...
.Lbl_addr_0x0063f211:    mov.s            edx, edi                                      // 0x0063f211    8bd7
                         ...
                         {disp8} je       .Lbl_addr_0x0063f255                          // 0x0063f22e    7425
                         ...
                         {disp8} jne      .Lbl_addr_0x0063f255                          // 0x0063f23d    7516
                         {disp8} mov      eax, dword ptr [esp + 0x10]                   // 0x0063f23f    8b442410
                         cmp              dword ptr [eax + 0x00205a28], ebp             // 0x0063f243    39a8285a2000
                         {disp32} je      .Lbl_addr_0x0063f695                          // 0x0063f249    0f8446040000
                         {disp8} jmp      .Lbl_addr_0x0063f255                          // 0x0063f24f    eb04
.Lbl_addr_0x0063f251:    {disp8} mov      esi, dword ptr [esp + 0x1c]                   // 0x0063f251    8b74241c
.Lbl_addr_0x0063f255:    {disp8} mov      ecx, dword ptr [esp + 0x10]                   // 0x0063f255    8b4c2410
                         cmp              dword ptr [ecx + 0x00205a28], ebp             // 0x0063f259    39a9285a2000
                         {disp8} jne      .Lbl_addr_0x0063f2a4                          // 0x0063f25f    7543
                         ...
                         {disp8} je       .Lbl_addr_0x0063f285                          // 0x0063f275    740e
                         {disp32} mov     edx, dword ptr [eax + 0x000045ec]             // 0x0063f277    8b90ec450000
                         test             edx, edx                                      // 0x0063f27d    85d2
                         {disp32} jne     .Lbl_addr_0x0063f695                          // 0x0063f27f    0f8510040000
.Lbl_addr_0x0063f285:    test             ebx, ebx                                      // 0x0063f285    85db
                         {disp32} jne     .Lbl_addr_0x0063f695                          // 0x0063f287    0f8508040000
...
.Lbl_addr_0x0063f2a4:    test             ebx, ebx                                      // 0x0063f2a4    85db
                         {disp32} jne     .Lbl_addr_0x0063f695                          // 0x0063f2a6    0f85e9030000
                         {disp8} mov      eax, dword ptr [esp + 0x14]                   // 0x0063f2ac    8b442414
                         test             eax, eax                                      // 0x0063f2b0    85c0
                         {disp8} je       .Lbl_addr_0x0063f2c6                          // 0x0063f2b2    7412
                         ...
                         {disp32} jne     .Lbl_addr_0x0063f695                          // 0x0063f2c0    0f85cf030000
.Lbl_addr_0x0063f2c6:    xor.s            eax, eax                                      // 0x0063f2c6    33c0
                         ...
                         {disp8} je       .Lbl_addr_0x0063f2dc                          // 0x0063f2d3    7407
                         mov              eax, 0x0000002a                               // 0x0063f2d5    b82a000000
                         {disp8} jmp      .Lbl_addr_0x0063f306                          // 0x0063f2da    eb2a
.Lbl_addr_0x0063f2dc:    xor.s            ecx, ecx                                      // 0x0063f2dc    33c9
                         ...
                         {disp8} je       .Lbl_addr_0x0063f2f3                          // 0x0063f2ea    7407
                         mov              eax, 0x0000001d                               // 0x0063f2ec    b81d000000
                         {disp8} jmp      .Lbl_addr_0x0063f306                          // 0x0063f2f1    eb13
.Lbl_addr_0x0063f2f3:    xor.s            eax, eax                                      // 0x0063f2f3    33c0
...
.Lbl_addr_0x0063f306:    {disp8} mov      ecx, dword ptr [esp + 0x10]                   // 0x0063f306    8b4c2410
                         ...
                         {disp32} je      .Lbl_addr_0x0063f695                          // 0x0063f315    0f847a030000
                         {disp8} lea      eax, dword ptr [esi + -0x01]                  // 0x0063f31b    8d46ff
                         cmp              eax, 0x31                                     // 0x0063f31e    83f831
                         {disp32} ja      .Lbl_addr_0x0063f407                          // 0x0063f321    0f87e0000000
                         ...
                         {disp32} je      .Lbl_addr_0x0063f407                          // 0x0063f343    0f84be000000
                         ...
                         {disp32} je      .Lbl_addr_0x0063f407                          // 0x0063f357    0f84aa000000
                         ...
                         {disp32} je      .Lbl_addr_0x0063f695                          // 0x0063f390    0f84ff020000
                         ...
                         {disp8} jne      .Lbl_addr_0x0063f407                          // 0x0063f3c6    753f
                         ...
                         {disp8} jne      .Lbl_addr_0x0063f407                          // 0x0063f3d6    752f
                         ...
                         {disp32} je      .Lbl_addr_0x0063f4d7                          // 0x0063f3e6    0f84eb000000
                         {disp32} mov     al, byte ptr [data_bytes + 0x33b984]          // 0x0063f3ec    a08419d000
                         test             al, al                                        // 0x0063f3f1    84c0
                         {disp8} jne      .Lbl_addr_0x0063f407                          // 0x0063f3f3    7512
...
.Lbl_addr_0x0063f407:    {disp32} mov     eax, dword ptr [_game]                        // 0x0063f407    a15c19d000
                         ...
                         {disp8} je       .Lbl_addr_0x0063f42a                          // 0x0063f41a    740e
                         {disp32} mov     edx, dword ptr [ecx + 0x000045ec]             // 0x0063f41c    8b91ec450000
                         test             edx, edx                                      // 0x0063f422    85d2
                         {disp32} jne     .Lbl_addr_0x0063f695                          // 0x0063f424    0f856b020000
.Lbl_addr_0x0063f42a:    {disp32} mov     eax, dword ptr [eax + 0x00250300]             // 0x0063f42a    8b8000032500
                         {disp32} mov     edx, dword ptr [eax + 0x0000652c]             // 0x0063f430    8b902c650000
                         test             edx, edx                                      // 0x0063f436    85d2
                         {disp32} je      .Lbl_addr_0x0063f695                          // 0x0063f438    0f8457020000
                         {disp32} mov     edx, dword ptr [eax + 0x00006530]             // 0x0063f43e    8b9030650000
                         test             edx, edx                                      // 0x0063f444    85d2
                         {disp32} je      .Lbl_addr_0x0063f695                          // 0x0063f446    0f8449020000
                         ...
                         {disp32} ja      .Lbl_addr_0x0063f695                          // 0x0063f456    0f8739020000
                         ...
                         {disp32} je      .Lbl_addr_0x0063f695                          // 0x0063f472    0f841d020000
                         {disp32} mov     eax, dword ptr [ecx + 0x000045e8]             // 0x0063f478    8b81e8450000
                         test             eax, eax                                      // 0x0063f47e    85c0
                         {disp8} je       .Lbl_addr_0x0063f490                          // 0x0063f480    740e
                         {disp32} mov     eax, dword ptr [ecx + 0x000045ec]             // 0x0063f482    8b81ec450000
                         test             eax, eax                                      // 0x0063f488    85c0
                         {disp32} jne     .Lbl_addr_0x0063f695                          // 0x0063f48a    0f8505020000
.Lbl_addr_0x0063f490:    {disp32} mov     ax, word ptr [rdata_bytes + 0xf861c]          // 0x0063f490    66a11c169a00
                         and.s            ax, di                                        // 0x0063f496    6623c7
                         {disp32} je      .Lbl_addr_0x0063f5b0                          // 0x0063f499    0f8411010000
...
.Lbl_addr_0x0063f4d7:    {disp32} mov     eax, dword ptr [ecx + 0x0025005c]             // 0x0063f4d7    8b815c002500
                         {disp32} mov     ecx, dword ptr [eax + 0x000045e8]             // 0x0063f4dd    8b88e8450000
                         test             ecx, ecx                                      // 0x0063f4e3    85c9
                         {disp8} je       .Lbl_addr_0x0063f4f5                          // 0x0063f4e5    740e
                         {disp32} mov     ecx, dword ptr [eax + 0x000045ec]             // 0x0063f4e7    8b88ec450000
                         test             ecx, ecx                                      // 0x0063f4ed    85c9
                         {disp32} jne     .Lbl_addr_0x0063f407                          // 0x0063f4ef    0f8512ffffff
.Lbl_addr_0x0063f4f5:    call             _jmp_addr_0x006ec670                          // 0x0063f4f5    e876d10a00
                         test             eax, eax                                      // 0x0063f4fa    85c0
                         {disp32} je      .Lbl_addr_0x0063f407                          // 0x0063f4fc    0f8405ffffff
                         call             _jmp_addr_0x00540020                          // 0x0063f502    e8190bf0ff
                         test             al, al                                        // 0x0063f507    84c0
                         {disp32} je      .Lbl_addr_0x0063f407                          // 0x0063f509    0f84f8feffff
                         ...
                         {disp32} jmp     .Lbl_addr_0x0063f407                          // 0x0063f534    e9cefeffff
                         ...
                         {disp32} jne     .Lbl_addr_0x0063f407                          // 0x0063f570    0f8591feffff
...
.Lbl_addr_0x0063f5b0:    xor.s            ecx, ecx                                      // 0x0063f5b0    33c9
                         ...
                         {disp8} je       .Lbl_addr_0x0063f5f6                          // 0x0063f5be    7436
                         ...
                         {disp8} jne      .Lbl_addr_0x0063f5f6                          // 0x0063f5ce    7526
...
.Lbl_addr_0x0063f5f6:    test             ax, ax                                        // 0x0063f5f6    6685c0
                         {disp8} je       .Lbl_addr_0x0063f61f                          // 0x0063f5f9    7424
                         lea              eax, dword ptr [esi + esi * 0x8]              // 0x0063f5fb    8d04f6
                         test             byte ptr [eax * 0x4 + 0x00c58b34], 0x01       // 0x0063f5fe    f60485348bc50001
                         {disp32} je      .Lbl_addr_0x0063f695                          // 0x0063f606    0f8489000000
...
.Lbl_addr_0x0063f61f:    test             di, di                                        // 0x0063f61f    6685ff
                         {disp8} jne      .Lbl_addr_0x0063f695                          // 0x0063f622    7571
                         lea              ecx, dword ptr [esi + esi * 0x8]              // 0x0063f624    8d0cf6
                         test             byte ptr [ecx * 0x4 + 0x00c58b34], 0x01       // 0x0063f627    f6048d348bc50001
                         {disp8} je       .Lbl_addr_0x0063f695                          // 0x0063f62f    7464
                         ...
                         {disp8} je       .Lbl_addr_0x0063f663                          // 0x0063f652    740f
...
.Lbl_addr_0x0063f663:    xor.s            eax, eax                                      // 0x0063f663    33c0
                         ...
                         {disp8} je       .Lbl_addr_0x0063f681                          // 0x0063f670    740f
...
.Lbl_addr_0x0063f681:    call             _jmp_addr_0x0043aa60                          // 0x0063f681    e8dab3dfff
...
.Lbl_addr_0x0063f695:    pop              edi                                           // 0x0063f695    5f
