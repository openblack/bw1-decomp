...
_Draw__11SetupSliderFbb:
                         ...
                         {disp8} je         .Lbl_addr_0x00409b04                     // 0x00409a96    746c
                         ...
                         {disp8} jne        .Lbl_addr_0x00409ae1                     // 0x00409ada    7505
                         mov                edx, 0x00c4ccd8                          // 0x00409adc    bad8ccc400
.Lbl_addr_0x00409ae1:    {disp8} mov        eax, dword ptr [esi + 0x10]              // 0x00409ae1    8b4610
                         ...
                         {disp32} jmp       .Lbl_addr_0x00409bd2                     // 0x00409aff    e9ce000000
.Lbl_addr_0x00409b04:    {disp8} mov        al, byte ptr [esp + 0x18]                // 0x00409b04    8a442418
                         test               al, al                                   // 0x00409b08    84c0
                         {disp8} mov        bl, byte ptr [esp + 0x1c]                // 0x00409b0a    8a5c241c
                         {disp8} jne        .Lbl_addr_0x00409b18                     // 0x00409b0e    7508
                         test               bl, bl                                   // 0x00409b10    84db
                         {disp8} jne        .Lbl_addr_0x00409b18                     // 0x00409b12    7504
                         xor.s              eax, eax                                 // 0x00409b14    33c0
                         {disp8} jmp        .Lbl_addr_0x00409b1d                     // 0x00409b16    eb05
.Lbl_addr_0x00409b18:    mov                eax, 0x00000001                          // 0x00409b18    b801000000
.Lbl_addr_0x00409b1d:    push               0x0000a000                               // 0x00409b1d    6800a00000
                         ...
                         {disp8} jne        .Lbl_addr_0x00409b59                     // 0x00409b4f    7508
                         {disp8} mov        dword ptr [esp + 0x1c], 0x00c4ccd8       // 0x00409b51    c744241cd8ccc400
.Lbl_addr_0x00409b59:    {disp8} mov        eax, dword ptr [esi + 0x20]              // 0x00409b59    8b4620
                         test               eax, eax                                 // 0x00409b5c    85c0
                         {disp8} je         .Lbl_addr_0x00409b64                     // 0x00409b5e    7404
                         mov.s              ebp, eax                                 // 0x00409b60    8be8
                         {disp8} jmp        .Lbl_addr_0x00409b7b                     // 0x00409b62    eb17
.Lbl_addr_0x00409b64:    {disp32} mov       ecx, dword ptr [esi + 0x00000234]        // 0x00409b64    8b8e34020000
                         test               ecx, ecx                                 // 0x00409b6a    85c9
                         {disp8} je         .Lbl_addr_0x00409b76                     // 0x00409b6c    7408
                         {disp32} mov       ebp, dword ptr [ecx + 0x000000ac]        // 0x00409b6e    8ba9ac000000
                         {disp8} jmp        .Lbl_addr_0x00409b7b                     // 0x00409b74    eb05
.Lbl_addr_0x00409b76:    mov                ebp, 0x0000000a                          // 0x00409b76    bd0a000000
.Lbl_addr_0x00409b7b:    test               eax, eax                                 // 0x00409b7b    85c0
                         {disp8} je         .Lbl_addr_0x00409b88                     // 0x00409b7d    7409
                         cdq                                                         // 0x00409b7f    99
                         sub.s              eax, edx                                 // 0x00409b80    2bc2
                         mov.s              ebx, eax                                 // 0x00409b82    8bd8
                         sar                ebx, 1                                   // 0x00409b84    d1fb
                         {disp8} jmp        .Lbl_addr_0x00409ba6                     // 0x00409b86    eb1e
.Lbl_addr_0x00409b88:    {disp32} mov       eax, dword ptr [esi + 0x00000234]        // 0x00409b88    8b8634020000
                         test               eax, eax                                 // 0x00409b8e    85c0
                         {disp8} je         .Lbl_addr_0x00409ba1                     // 0x00409b90    740f
                         ...
                         {disp8} jmp        .Lbl_addr_0x00409ba6                     // 0x00409b9f    eb05
.Lbl_addr_0x00409ba1:    mov                ebx, 0x00000005                          // 0x00409ba1    bb05000000
.Lbl_addr_0x00409ba6:    {disp8} mov        edx, dword ptr [esp + 0x1c]              // 0x00409ba6    8b54241c
...
.Lbl_addr_0x00409bd2:    cdq                                                         // 0x00409bd2    99
...
??_GSetupSlider@@UAEPAXI@Z:
                         ...
                         {disp8} je         .Lbl_addr_0x00409c68                     // 0x00409c5d    7409
                         push               esi                                      // 0x00409c5f    56
                         call               ??3@YAXPAX@Z                             // 0x00409c60    e833523a00
                         add                esp, 0x04                                // 0x00409c65    83c404
.Lbl_addr_0x00409c68:    mov.s              eax, esi                                 // 0x00409c68    8bc6
...
_Drag__11SetupSliderFii:
                         ...
                         {disp8} jl         .Lbl_addr_0x00409cce                     // 0x00409ca7    7c25
                         lea                edx, dword ptr [ebx + eax * 0x1]         // 0x00409ca9    8d1403
                         cmp.s              ecx, edx                                 // 0x00409cac    3bca
                         {disp8} jge        .Lbl_addr_0x00409cca                     // 0x00409cae    7d1a
                         ...
                         {disp8} jmp        .Lbl_addr_0x00409cf2                     // 0x00409cc8    eb28
.Lbl_addr_0x00409cca:    cmp.s              ecx, eax                                 // 0x00409cca    3bc8
                         {disp8} jge        .Lbl_addr_0x00409ce0                     // 0x00409ccc    7d12
.Lbl_addr_0x00409cce:    {disp32} fld       dword ptr [esi + 0x00000240]             // 0x00409cce    d98640020000
...
.Lbl_addr_0x00409ce0:    add.s              ebx, eax                                 // 0x00409ce0    03d8
                         cmp.s              ecx, ebx                                 // 0x00409ce2    3bcb
                         {disp8} jl         .Lbl_addr_0x00409cf8                     // 0x00409ce4    7c12
...
.Lbl_addr_0x00409cf8:    {disp32} fld       dword ptr [esi + 0x0000023c]             // 0x00409cf8    d9863c020000
                         ...
                         {disp8} je         .Lbl_addr_0x00409d31                     // 0x00409d1c    7413
...
.Lbl_addr_0x00409d31:    pop                edi                                      // 0x00409d31    5f
...
.Lbl_addr_0x00409d42:    pop                edi                                      // 0x00409d42    5f
...
_MouseDown__11SetupSliderFiib:
                         ...
                         {disp8} je         .Lbl_addr_0x00409d88                     // 0x00409d66    7420
...
_MouseUp__11SetupSliderFiib:
                         ...
                         {disp8} je         .Lbl_addr_0x00409db5                     // 0x00409dab    7408
...
.Lbl_addr_0x00409db5:    mov                eax, dword ptr [esi]                     // 0x00409db5    8b06
...
@AutoScroll__9SetupListFb@9:    {disp8} mov        al, byte ptr [esp + 0x04]                // 0x00409dd0    8a442404
                         ...
                         {disp32} jne       .Lbl_addr_0x00409e93                     // 0x00409ddb    0f85b2000000
                         ...
                         {disp8} jle        .Lbl_addr_0x00409e4e                     // 0x00409e1e    7e2e
.Lbl_addr_0x00409e20:    cmp.s              ecx, ebx                                 // 0x00409e20    3bcb
                         {disp8} jne        .Lbl_addr_0x00409e44                     // 0x00409e22    7520
                         ...
                         {disp8} jne        .Lbl_addr_0x00409e56                     // 0x00409e33    7521
                         ...
                         {disp8} je         .Lbl_addr_0x00409e5a                     // 0x00409e42    7416
.Lbl_addr_0x00409e44:    fiadd              dword ptr [edi]                          // 0x00409e44    da07
                         inc                ecx                                      // 0x00409e46    41
                         add                edi, 0x04                                // 0x00409e47    83c704
                         cmp.s              ecx, edx                                 // 0x00409e4a    3bca
                         {disp8} jl         .Lbl_addr_0x00409e20                     // 0x00409e4c    7cd2
.Lbl_addr_0x00409e4e:    pop                edi                                      // 0x00409e4e    5f
...
.Lbl_addr_0x00409e5e:    call               _jmp_addr_0x007a1400                     // 0x00409e5e    e89d753900
                         ...
                         {disp8} jl         .Lbl_addr_0x00409e87                     // 0x00409e75    7c10
...
.Lbl_addr_0x00409e85:    xor.s              eax, eax                                 // 0x00409e85    33c0
.Lbl_addr_0x00409e87:    pop                edi                                      // 0x00409e87    5f
...
.Lbl_addr_0x00409e93:    {disp32} mov       ecx, dword ptr [esi + 0x00000278]        // 0x00409e93    8b8e78020000
...
_KeyDown__9SetupListFii:
                         ...
                         {disp32} jne       .Lbl_addr_0x0040a0e8                     // 0x00409ebb    0f8527020000
                         {disp32} mov       al, byte ptr [esi + 0x00000291]          // 0x00409ec1    8a8691020000
                         test               al, al                                   // 0x00409ec7    84c0
                         {disp32} je        .Lbl_addr_0x0040a0e8                     // 0x00409ec9    0f8419020000
                         ...
                         {disp32} ja        .Lbl_addr_0x0040a0cf                     // 0x00409edc    0f87ed010000
                         ...
                         {disp8} jle        .Lbl_addr_0x00409f07                     // 0x00409ef9    7e0c
                         {disp32} mov       dword ptr [esi + 0x00000248], 0x00000000 // 0x00409efb    c7864802000000000000
                         {disp8} jmp        .Lbl_addr_0x00409f11                     // 0x00409f05    eb0a
.Lbl_addr_0x00409f07:    {disp32} mov       dword ptr [esi + 0x00000248], 0xffffffff // 0x00409f07    c78648020000ffffffff
.Lbl_addr_0x00409f11:    {disp8} mov        eax, dword ptr [esi + 0x04]              // 0x00409f11    8b4604
                         test               eax, eax                                 // 0x00409f14    85c0
                         {disp32} je        .Lbl_addr_0x0040a0c6                     // 0x00409f16    0f84aa010000
                         {disp32} mov       eax, dword ptr [data_bytes + 0x286d00]   // 0x00409f1c    a100cdc400
                         test               eax, eax                                 // 0x00409f21    85c0
                         {disp32} je        .Lbl_addr_0x0040a0c6                     // 0x00409f23    0f849d010000
                         ...
                         {disp32} je        .Lbl_addr_0x0040a0c6                     // 0x00409f36    0f848a010000
                         {disp32} jmp       .Lbl_addr_0x0040a0a6                     // 0x00409f3c    e965010000
                         {disp32} mov       eax, dword ptr [esi + 0x00000250]        // 0x00409f41    8b8650020000
                         {disp8} lea        edi, dword ptr [eax + -0x01]             // 0x00409f47    8d78ff
.Lbl_addr_0x00409f4a:    test               edi, edi                                 // 0x00409f4a    85ff
                         {disp8} jl         .Lbl_addr_0x00409f5a                     // 0x00409f4c    7c0c
                         cmp.s              edi, eax                                 // 0x00409f4e    3bf8
                         {disp8} jge        .Lbl_addr_0x00409f5a                     // 0x00409f50    7d08
                         {disp32} mov       dword ptr [esi + 0x00000248], edi        // 0x00409f52    89be48020000
                         {disp8} jmp        .Lbl_addr_0x00409f64                     // 0x00409f58    eb0a
.Lbl_addr_0x00409f5a:    {disp32} mov       dword ptr [esi + 0x00000248], 0xffffffff // 0x00409f5a    c78648020000ffffffff
.Lbl_addr_0x00409f64:    {disp8} mov        eax, dword ptr [esi + 0x04]              // 0x00409f64    8b4604
                         test               eax, eax                                 // 0x00409f67    85c0
                         {disp32} je        .Lbl_addr_0x0040a0c6                     // 0x00409f69    0f8457010000
                         {disp32} mov       eax, dword ptr [data_bytes + 0x286d00]   // 0x00409f6f    a100cdc400
                         test               eax, eax                                 // 0x00409f74    85c0
                         {disp32} je        .Lbl_addr_0x0040a0c6                     // 0x00409f76    0f844a010000
                         test               edi, edi                                 // 0x00409f7c    85ff
                         {disp32} jl        .Lbl_addr_0x0040a0c6                     // 0x00409f7e    0f8c42010000
                         ...
                         {disp32} je        .Lbl_addr_0x0040a0c6                     // 0x00409f91    0f842f010000
                         ...
                         {disp32} jmp       .Lbl_addr_0x0040a0b0                     // 0x00409fa0    e90b010000
                         {disp32} mov       eax, dword ptr [esi + 0x00000248]        // 0x00409fa5    8b8648020000
                         test               eax, eax                                 // 0x00409fab    85c0
                         {disp8} jle        .Lbl_addr_0x0040a011                     // 0x00409fad    7e62
                         {disp8} lea        edi, dword ptr [eax + -0x01]             // 0x00409faf    8d78ff
                         test               edi, edi                                 // 0x00409fb2    85ff
                         {disp8} jl         .Lbl_addr_0x00409fc6                     // 0x00409fb4    7c10
                         cmp                edi, dword ptr [esi + 0x00000250]        // 0x00409fb6    3bbe50020000
                         {disp8} jge        .Lbl_addr_0x00409fc6                     // 0x00409fbc    7d08
                         {disp32} mov       dword ptr [esi + 0x00000248], edi        // 0x00409fbe    89be48020000
                         {disp8} jmp        .Lbl_addr_0x00409fd0                     // 0x00409fc4    eb0a
.Lbl_addr_0x00409fc6:    {disp32} mov       dword ptr [esi + 0x00000248], 0xffffffff // 0x00409fc6    c78648020000ffffffff
.Lbl_addr_0x00409fd0:    {disp8} mov        eax, dword ptr [esi + 0x04]              // 0x00409fd0    8b4604
                         test               eax, eax                                 // 0x00409fd3    85c0
                         {disp32} je        .Lbl_addr_0x0040a0c6                     // 0x00409fd5    0f84eb000000
                         {disp32} mov       eax, dword ptr [data_bytes + 0x286d00]   // 0x00409fdb    a100cdc400
                         test               eax, eax                                 // 0x00409fe0    85c0
                         {disp32} je        .Lbl_addr_0x0040a0c6                     // 0x00409fe2    0f84de000000
                         test               edi, edi                                 // 0x00409fe8    85ff
                         {disp32} jl        .Lbl_addr_0x0040a0c6                     // 0x00409fea    0f8cd6000000
                         ...
                         {disp32} je        .Lbl_addr_0x0040a0c6                     // 0x00409ffd    0f84c3000000
                         ...
                         {disp32} jmp       .Lbl_addr_0x0040a0b0                     // 0x0040a00c    e99f000000
.Lbl_addr_0x0040a011:    {disp32} mov       eax, dword ptr [esi + 0x00000250]        // 0x0040a011    8b8650020000
                         {disp8} lea        edi, dword ptr [eax + -0x01]             // 0x0040a017    8d78ff
                         test               edi, edi                                 // 0x0040a01a    85ff
                         {disp8} jl         .Lbl_addr_0x0040a02a                     // 0x0040a01c    7c0c
                         cmp.s              edi, eax                                 // 0x0040a01e    3bf8
                         {disp8} jge        .Lbl_addr_0x0040a02a                     // 0x0040a020    7d08
                         {disp32} mov       dword ptr [esi + 0x00000248], edi        // 0x0040a022    89be48020000
                         {disp8} jmp        .Lbl_addr_0x0040a034                     // 0x0040a028    eb0a
.Lbl_addr_0x0040a02a:    {disp32} mov       dword ptr [esi + 0x00000248], 0xffffffff // 0x0040a02a    c78648020000ffffffff
.Lbl_addr_0x0040a034:    {disp8} mov        eax, dword ptr [esi + 0x04]              // 0x0040a034    8b4604
                         test               eax, eax                                 // 0x0040a037    85c0
                         {disp32} je        .Lbl_addr_0x0040a0c6                     // 0x0040a039    0f8487000000
                         {disp32} mov       eax, dword ptr [data_bytes + 0x286d00]   // 0x0040a03f    a100cdc400
                         test               eax, eax                                 // 0x0040a044    85c0
                         {disp8} je         .Lbl_addr_0x0040a0c6                     // 0x0040a046    747e
                         test               edi, edi                                 // 0x0040a048    85ff
                         {disp8} jl         .Lbl_addr_0x0040a0c6                     // 0x0040a04a    7c7a
                         ...
                         {disp8} je         .Lbl_addr_0x0040a0c6                     // 0x0040a059    746b
                         push               edi                                      // 0x0040a05b    57
                         {disp8} jmp        .Lbl_addr_0x0040a0a8                     // 0x0040a05c    eb4a
                         ...
                         {disp8} jge        .Lbl_addr_0x0040a079                     // 0x0040a06f    7d08
                         {disp8} lea        edi, dword ptr [ecx + 0x01]              // 0x0040a071    8d7901
                         {disp32} jmp       .Lbl_addr_0x00409f4a                     // 0x0040a074    e9d1feffff
.Lbl_addr_0x0040a079:    xor.s              ecx, ecx                                 // 0x0040a079    33c9
                         ...
                         {disp8} je         .Lbl_addr_0x0040a0c6                     // 0x0040a0a4    7420
.Lbl_addr_0x0040a0a6:    push               0x0                                      // 0x0040a0a6    6a00
.Lbl_addr_0x0040a0a8:    {disp32} mov       edx, dword ptr [esi + 0x00000250]        // 0x0040a0a8    8b9650020000
                         dec                edx                                      // 0x0040a0ae    4a
                         push               edx                                      // 0x0040a0af    52
.Lbl_addr_0x0040a0b0:    {disp32} mov       ecx, dword ptr [data_bytes + 0x4c6104]   // 0x0040a0b0    8b0d04c1e800
...
.Lbl_addr_0x0040a0c6:    push               0x0                                      // 0x0040a0c6    6a00
                         mov.s              ecx, esi                                 // 0x0040a0c8    8bce
                         call               @AutoScroll__9SetupListFb@9              // 0x0040a0ca    e801fdffff
.Lbl_addr_0x0040a0cf:    {disp32} mov       eax, dword ptr [esi + 0x00000248]        // 0x0040a0cf    8b8648020000
...
.Lbl_addr_0x0040a0e8:    pop                esi                                      // 0x0040a0e8    5e
