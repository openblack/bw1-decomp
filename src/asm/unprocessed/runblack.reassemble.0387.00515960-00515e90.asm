...
_globl_ct_0x00515960:    {disp32} mov     cl, byte ptr [_DAT_00fac934]                  // 0x00515960    8a0d34c9fa00
                         ...
                         {disp8} jne      .Lbl_addr_0x00515974                          // 0x0051596a    7508
                         or.s             cl, al                                        // 0x0051596c    0ac8
                         {disp32} mov     byte ptr [_DAT_00fac934], cl                  // 0x0051596e    880d34c9fa00
.Lbl_addr_0x00515974:    {disp32} jmp     .Lbl_addr_0x00515980                          // 0x00515974    e907000000
                         nop                                                            // 0x00515979    90
                         nop                                                            // 0x0051597a    90
                         nop                                                            // 0x0051597b    90
                         nop                                                            // 0x0051597c    90
                         ...
                         nop                                                            // 0x0051597e    90
                         nop                                                            // 0x0051597f    90
.Lbl_addr_0x00515980:    push             0x00407870                                    // 0x00515980    6870784000
...
?Init@DialogBoxSaveMessage@@UAEXIIP6AXHPAVSetupBox@@PAVSetupControl@@HH@Z@Z:
                         ...
                         {disp8} jbe      .Lbl_addr_0x00515a1a                          // 0x00515a13    7605
                         add              eax, 0x0000f12c                               // 0x00515a15    052cf10000
.Lbl_addr_0x00515a1a:    {disp8} mov      ecx, dword ptr [eax + 0x08]                   // 0x00515a1a    8b4808
                         ...
                         {disp8} jmp      .Lbl_addr_0x00515a60                          // 0x00515a5c    eb02
.Lbl_addr_0x00515a5e:    xor.s            esi, esi                                      // 0x00515a5e    33f6
.Lbl_addr_0x00515a60:    push             0x22                                          // 0x00515a60    6a22
                         ...
                         call             ??2@YAPAXIPBDI@Z                              // 0x00515a6f    e81c5d2c00
                         add              esp, 0x0c                                     // 0x00515a74    83c40c
                         test             eax, eax                                      // 0x00515a77    85c0
                         {disp8} je       .Lbl_addr_0x00515abd                          // 0x00515a79    7442
                         cmp              dword ptr [data_bytes + 0x351cac], 0x00000a24 // 0x00515a7b    813dac7cd100240a0000
                         {disp8} ja       .Lbl_addr_0x00515a8f                          // 0x00515a85    7708
                         {disp32} mov     ecx, dword ptr [data_bytes + 0x351ca8]        // 0x00515a87    8b0da87cd100
                         {disp8} jmp      .Lbl_addr_0x00515a9b                          // 0x00515a8d    eb0c
.Lbl_addr_0x00515a8f:    {disp32} mov     edx, dword ptr [data_bytes + 0x351ca8]        // 0x00515a8f    8b15a87cd100
                         {disp32} lea     ecx, dword ptr [edx + 0x000079b0]             // 0x00515a95    8d8ab0790000
.Lbl_addr_0x00515a9b:    {disp8} mov      ecx, dword ptr [ecx + 0x08]                   // 0x00515a9b    8b4908
                         ...
                         {disp8} jmp      .Lbl_addr_0x00515abf                          // 0x00515abb    eb02
.Lbl_addr_0x00515abd:    xor.s            eax, eax                                      // 0x00515abd    33c0
.Lbl_addr_0x00515abf:    push             0x23                                          // 0x00515abf    6a23
                         ...
                         call             ??2@YAPAXIPBDI@Z                              // 0x00515ace    e8bd5c2c00
                         add              esp, 0x0c                                     // 0x00515ad3    83c40c
                         test             eax, eax                                      // 0x00515ad6    85c0
                         {disp8} je       .Lbl_addr_0x00515b14                          // 0x00515ad8    743a
                         ...
                         {disp8} jbe      .Lbl_addr_0x00515af2                          // 0x00515aea    7606
                         add              ecx, 0x000079a4                               // 0x00515aec    81c1a4790000
.Lbl_addr_0x00515af2:    {disp8} mov      ecx, dword ptr [ecx + 0x08]                   // 0x00515af2    8b4908
                         ...
                         {disp8} jmp      .Lbl_addr_0x00515b16                          // 0x00515b12    eb02
.Lbl_addr_0x00515b14:    xor.s            eax, eax                                      // 0x00515b14    33c0
.Lbl_addr_0x00515b16:    push             0x27                                          // 0x00515b16    6a27
                         ...
                         call             ??2@YAPAXIPBDI@Z                              // 0x00515b25    e8665c2c00
                         add              esp, 0x0c                                     // 0x00515b2a    83c40c
                         test             eax, eax                                      // 0x00515b2d    85c0
                         {disp8} je       .Lbl_addr_0x00515b67                          // 0x00515b2f    7436
...
.Lbl_addr_0x00515b67:    xor.s            eax, eax                                      // 0x00515b67    33c0
...
?Destroy@DialogBoxSaveMessage@@UAEXXZ:
                         ...
                         {disp8} je       .Lbl_addr_0x00515bdf                          // 0x00515ba5    7438
                         ...
                         {disp8} jmp      .Lbl_addr_0x00515c05                          // 0x00515bdd    eb26
.Lbl_addr_0x00515bdf:    {disp8} mov      esi, dword ptr [edi + 0x18]                   // 0x00515bdf    8b7718
...
.Lbl_addr_0x00515c05:    {disp32} mov     dword ptr [esi + 0x0000024c], eax             // 0x00515c05    89864c020000
                         ...
                         {disp8} je       .Lbl_addr_0x00515c4f                          // 0x00515c20    742d
                         ...
                         {disp8} jmp      .Lbl_addr_0x00515c97                          // 0x00515c4d    eb48
.Lbl_addr_0x00515c4f:    cmp              dword ptr [data_bytes + 0x351cac], 0x00001419 // 0x00515c4f    813dac7cd10019140000
                         {disp8} ja       .Lbl_addr_0x00515c62                          // 0x00515c59    7707
                         {disp32} mov     eax, dword ptr [data_bytes + 0x351ca8]        // 0x00515c5b    a1a87cd100
                         {disp8} jmp      .Lbl_addr_0x00515c6e                          // 0x00515c60    eb0c
.Lbl_addr_0x00515c62:    {disp32} mov     ecx, dword ptr [data_bytes + 0x351ca8]        // 0x00515c62    8b0da87cd100
                         {disp32} lea     eax, dword ptr [ecx + 0x0000f12c]             // 0x00515c68    8d812cf10000
.Lbl_addr_0x00515c6e:    {disp8} mov      edx, dword ptr [eax + 0x08]                   // 0x00515c6e    8b5008
...
.Lbl_addr_0x00515c97:    {disp8} mov      ecx, dword ptr [edi + 0x18]                   // 0x00515c97    8b4f18
                         ...
                         {disp32} ja      .Lbl_addr_0x00515e54                          // 0x00515cbe    0f8790010000
                         ...
                         {disp8} jne      .Lbl_addr_0x00515d94                          // 0x00515d5a    7538
                         {disp32} mov     eax, dword ptr [esp + 0x00000098]             // 0x00515d5c    8b842498000000
                         test             eax, eax                                      // 0x00515d63    85c0
                         {disp32} jne     .Lbl_addr_0x00515e54                          // 0x00515d65    0f85e9000000
                         ...
                         {disp8} jne      .Lbl_addr_0x00515dc4                          // 0x00515d82    7540
...
.Lbl_addr_0x00515d94:    cmp              eax, 0x1b                                     // 0x00515d94    83f81b
                         {disp32} jne     .Lbl_addr_0x00515e54                          // 0x00515d97    0f85b7000000
                         {disp32} mov     eax, dword ptr [esp + 0x00000098]             // 0x00515d9d    8b842498000000
                         test             eax, eax                                      // 0x00515da4    85c0
                         {disp32} jne     .Lbl_addr_0x00515e54                          // 0x00515da6    0f85a8000000
                         ...
                         {disp8} jmp      .Lbl_addr_0x00515dc4                          // 0x00515dbb    eb07
                         {disp32} mov     eax, dword ptr [esp + 0x00000090]             // 0x00515dbd    8b842490000000
.Lbl_addr_0x00515dc4:    test             eax, eax                                      // 0x00515dc4    85c0
                         {disp32} je      .Lbl_addr_0x00515e54                          // 0x00515dc6    0f8488000000
                         {disp8} mov      eax, dword ptr [eax + 0x18]                   // 0x00515dcc    8b4018
                         sub              eax, 0x000007d0                               // 0x00515dcf    2dd0070000
                         {disp8} je       .Lbl_addr_0x00515de8                          // 0x00515dd4    7412
                         dec              eax                                           // 0x00515dd6    48
                         {disp8} jne      .Lbl_addr_0x00515e54                          // 0x00515dd7    757b
...
.Lbl_addr_0x00515de8:    push             0x000007d2                                    // 0x00515de8    68d2070000
                         ...
                         {disp8} je       .Lbl_addr_0x00515e28                          // 0x00515e05    7421
...
.Lbl_addr_0x00515e28:    call             _jmp_addr_0x00513640                          // 0x00515e28    e813d8ffff
...
.Lbl_addr_0x00515e54:    pop              esi                                           // 0x00515e54    5e
