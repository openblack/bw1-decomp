...
_jmp_addr_0x00666410:    sub              esp, 0x68                         // 0x00666410    83ec68
                         ...
                         {disp32} je      .Lbl_addr_0x006667e1              // 0x006664b4    0f8427030000
                         ...
                         call             ??2Base@@SAPAXIPBDI@Z              // 0x006664d6    e81502ddff
                         mov.s            esi, eax                          // 0x006664db    8bf0
                         add              esp, 0x0c                         // 0x006664dd    83c40c
                         cmp.s            esi, edi                          // 0x006664e0    3bf7
                         {disp8} je       .Lbl_addr_0x006664fc              // 0x006664e2    7418
                         ...
                         call             ?GetLHPoint@MapCoords@@QBE?AULHPoint@@XZ     // 0x006664ed    e84ef7f9ff
                         push             eax                               // 0x006664f2    50
                         mov.s            ecx, esi                          // 0x006664f3    8bce
                         call             _jmp_addr_0x00651120              // 0x006664f5    e826acfeff
                         {disp8} jmp      .Lbl_addr_0x006664fe              // 0x006664fa    eb02
.Lbl_addr_0x006664fc:    xor.s            eax, eax                          // 0x006664fc    33c0
.Lbl_addr_0x006664fe:    push             eax                               // 0x006664fe    50
                         ...
                         call             ??2Base@@SAPAXIPBDI@Z              // 0x0066651e    e8cd01ddff
                         mov.s            esi, eax                          // 0x00666523    8bf0
                         add              esp, 0x0c                         // 0x00666525    83c40c
                         cmp.s            esi, edi                          // 0x00666528    3bf7
                         {disp8} je       .Lbl_addr_0x00666544              // 0x0066652a    7418
                         ...
                         call             ?GetLHPoint@MapCoords@@QBE?AULHPoint@@XZ     // 0x00666535    e806f7f9ff
                         push             eax                               // 0x0066653a    50
                         mov.s            ecx, esi                          // 0x0066653b    8bce
                         call             _jmp_addr_0x00651120              // 0x0066653d    e8deabfeff
                         {disp8} jmp      .Lbl_addr_0x00666546              // 0x00666542    eb02
.Lbl_addr_0x00666544:    xor.s            eax, eax                          // 0x00666544    33c0
.Lbl_addr_0x00666546:    push             eax                               // 0x00666546    50
                         ...
                         call             ??2Base@@SAPAXIPBDI@Z              // 0x00666566    e88501ddff
                         add              esp, 0x0c                         // 0x0066656b    83c40c
                         cmp.s            eax, edi                          // 0x0066656e    3bc7
                         {disp8} je       .Lbl_addr_0x00666585              // 0x00666570    7413
                         ...
                         {disp8} jmp      .Lbl_addr_0x00666587              // 0x00666583    eb02
.Lbl_addr_0x00666585:    xor.s            ebx, ebx                          // 0x00666585    33db
.Lbl_addr_0x00666587:    push             0x00000119                        // 0x00666587    6819010000
                         push             0x00c01cc4                        // 0x0066658c    68c41cc000
                         push             0x74                              // 0x00666591    6a74
                         call             ??2Base@@SAPAXIPBDI@Z              // 0x00666593    e85801ddff
                         add              esp, 0x0c                         // 0x00666598    83c40c
                         cmp.s            eax, edi                          // 0x0066659b    3bc7
                         {disp8} je       .Lbl_addr_0x006665ad              // 0x0066659d    740e
...
.Lbl_addr_0x006665ad:    push             0x00000118                        // 0x006665ad    6818010000
                         ...
                         call             ?GetLHPoint@MapCoords@@QBE?AULHPoint@@XZ     // 0x006665d0    e86bf6f9ff
...
.Lbl_addr_0x006665ff:    push             ebx                               // 0x006665ff    53
                         ...
                         call             ??2Base@@SAPAXIPBDI@Z              // 0x0066662f    e8bc00ddff
                         add              esp, 0x0c                         // 0x00666634    83c40c
                         test             eax, eax                          // 0x00666637    85c0
                         {disp8} je       .Lbl_addr_0x00666647              // 0x00666639    740c
                         ...
                         {disp8} jmp      .Lbl_addr_0x00666649              // 0x00666645    eb02
.Lbl_addr_0x00666647:    xor.s            ebx, ebx                          // 0x00666647    33db
.Lbl_addr_0x00666649:    push             0x0000012e                        // 0x00666649    682e010000
                         push             0x00c01cc4                        // 0x0066664e    68c41cc000
                         push             0x74                              // 0x00666653    6a74
                         call             ??2Base@@SAPAXIPBDI@Z              // 0x00666655    e89600ddff
                         add              esp, 0x0c                         // 0x0066665a    83c40c
                         test             eax, eax                          // 0x0066665d    85c0
                         {disp8} je       .Lbl_addr_0x0066666d              // 0x0066665f    740c
                         ...
                         {disp8} jmp      .Lbl_addr_0x0066666f              // 0x0066666b    eb02
.Lbl_addr_0x0066666d:    xor.s            edi, edi                          // 0x0066666d    33ff
.Lbl_addr_0x0066666f:    push             0x0000012d                        // 0x0066666f    682d010000
                         push             0x00c01cc4                        // 0x00666674    68c41cc000
                         push             0x74                              // 0x00666679    6a74
                         call             ??2Base@@SAPAXIPBDI@Z              // 0x0066667b    e87000ddff
                         mov.s            esi, eax                          // 0x00666680    8bf0
                         add              esp, 0x0c                         // 0x00666682    83c40c
                         test             esi, esi                          // 0x00666685    85f6
                         {disp8} je       .Lbl_addr_0x006666a1              // 0x00666687    7418
                         ...
                         call             ?GetLHPoint@MapCoords@@QBE?AULHPoint@@XZ     // 0x00666692    e8a9f5f9ff
                         push             eax                               // 0x00666697    50
                         mov.s            ecx, esi                          // 0x00666698    8bce
                         call             _jmp_addr_0x00651120              // 0x0066669a    e881aafeff
                         {disp8} jmp      .Lbl_addr_0x006666a3              // 0x0066669f    eb02
.Lbl_addr_0x006666a1:    xor.s            eax, eax                          // 0x006666a1    33c0
.Lbl_addr_0x006666a3:    push             ebx                               // 0x006666a3    53
...
.Lbl_addr_0x006666f1:    push             eax                               // 0x006666f1    50
                         ...
                         call             ??2Base@@SAPAXIPBDI@Z              // 0x00666711    e8daffdcff
                         add              esp, 0x0c                         // 0x00666716    83c40c
                         cmp.s            eax, edi                          // 0x00666719    3bc7
                         {disp8} je       .Lbl_addr_0x00666735              // 0x0066671b    7418
                         ...
                         {disp8} jmp      .Lbl_addr_0x0066673c              // 0x00666733    eb07
.Lbl_addr_0x00666735:    {disp32} mov     dword ptr [esp + 0x00000080], edi // 0x00666735    89bc2480000000
.Lbl_addr_0x0066673c:    push             0x00000140                        // 0x0066673c    6840010000
                         push             0x00c01cc4                        // 0x00666741    68c41cc000
                         push             0x74                              // 0x00666746    6a74
                         call             ??2Base@@SAPAXIPBDI@Z              // 0x00666748    e8a3ffdcff
                         add              esp, 0x0c                         // 0x0066674d    83c40c
                         cmp.s            eax, edi                          // 0x00666750    3bc7
                         {disp8} je       .Lbl_addr_0x00666767              // 0x00666752    7413
                         ...
                         {disp8} jmp      .Lbl_addr_0x00666769              // 0x00666765    eb02
.Lbl_addr_0x00666767:    xor.s            ebx, ebx                          // 0x00666767    33db
.Lbl_addr_0x00666769:    push             0x0000013f                        // 0x00666769    683f010000
                         push             0x00c01cc4                        // 0x0066676e    68c41cc000
                         push             0x74                              // 0x00666773    6a74
                         call             ??2Base@@SAPAXIPBDI@Z              // 0x00666775    e876ffdcff
                         add              esp, 0x0c                         // 0x0066677a    83c40c
                         cmp.s            eax, edi                          // 0x0066677d    3bc7
                         {disp8} je       .Lbl_addr_0x0066678f              // 0x0066677f    740e
...
.Lbl_addr_0x0066678f:    push             0x0000013e                        // 0x0066678f    683e010000
                         ...
                         call             ?GetLHPoint@MapCoords@@QBE?AULHPoint@@XZ     // 0x006667b2    e889f4f9ff
                         push             eax                               // 0x006667b7    50
                         mov.s            ecx, esi                          // 0x006667b8    8bce
                         call             _jmp_addr_0x00651120              // 0x006667ba    e861a9feff
                         {disp8} jmp      .Lbl_addr_0x006667c3              // 0x006667bf    eb02
.Lbl_addr_0x006667c1:    xor.s            eax, eax                          // 0x006667c1    33c0
.Lbl_addr_0x006667c3:    {disp32} mov     ecx, dword ptr [esp + 0x00000080] // 0x006667c3    8b8c2480000000
...
.Lbl_addr_0x006667e1:    pop              edi                               // 0x006667e1    5f
