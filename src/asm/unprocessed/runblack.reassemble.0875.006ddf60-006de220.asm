...
_jmp_addr_0x006ddf60:    {disp8} mov      eax, dword ptr [esp + 0x0c]             // 0x006ddf60    8b44240c
                         ...
                         {disp32} ja      .Lbl_addr_0x006de1a1                    // 0x006ddf72    0f8729020000
                         ...
                         call             ??2Base@@SAPAXIPBDI@Z                    // 0x006ddf8e    e85d87d5ff
                         mov.s            esi, eax                                // 0x006ddf93    8bf0
                         add              esp, 0x0c                               // 0x006ddf95    83c40c
                         test             esi, esi                                // 0x006ddf98    85f6
                         {disp32} je      .Lbl_addr_0x006de19d                    // 0x006ddf9a    0f84fd010000
                         ...
                         {disp8} jmp      .Lbl_addr_0x006de1a5                    // 0x006de19b    eb08
.Lbl_addr_0x006de19d:    xor.s            esi, esi                                // 0x006de19d    33f6
                         {disp8} jmp      .Lbl_addr_0x006de1a5                    // 0x006de19f    eb04
.Lbl_addr_0x006de1a1:    {disp8} mov      esi, dword ptr [esp + 0x10]             // 0x006de1a1    8b742410
.Lbl_addr_0x006de1a5:    mov              eax, dword ptr [esi]                    // 0x006de1a5    8b06
...
.Lbl_addr_0x006de1eb:    xor.s            eax, eax                                // 0x006de1eb    33c0
.Lbl_addr_0x006de1ed:    {disp8} mov      ecx, dword ptr [esi + 0x40]             // 0x006de1ed    8b4e40
