...
_jmp_addr_0x0068e6e0:    {disp8} mov        eax, dword ptr [esp + 0x04]        // 0x0068e6e0    8b442404
                         ...
                         {disp8} ja         .Lbl_addr_0x0068e711               // 0x0068e6f0    771f
                         ...
                         {disp8} jmp        .Lbl_addr_0x0068e711               // 0x0068e703    eb0c
                         mov                esi, 0x00000002                    // 0x0068e705    be02000000
                         {disp8} jmp        .Lbl_addr_0x0068e711               // 0x0068e70a    eb05
                         mov                esi, 0x00000001                    // 0x0068e70c    be01000000
.Lbl_addr_0x0068e711:    cmp                eax, 0x0e                          // 0x0068e711    83f80e
                         {disp8} mov        dword ptr [esp + 0x0c], 0x00000000 // 0x0068e714    c744240c00000000
                         {disp8} ja         .Lbl_addr_0x0068e755               // 0x0068e71c    7737
                         ...
                         {disp8} jmp        .Lbl_addr_0x0068e755               // 0x0068e72d    eb26
                         {disp8} mov        dword ptr [esp + 0x0c], 0x3e800000 // 0x0068e72f    c744240c0000803e
                         {disp8} jmp        .Lbl_addr_0x0068e755               // 0x0068e737    eb1c
                         {disp8} mov        dword ptr [esp + 0x0c], 0x3f000000 // 0x0068e739    c744240c0000003f
                         {disp8} jmp        .Lbl_addr_0x0068e755               // 0x0068e741    eb12
                         {disp8} mov        dword ptr [esp + 0x0c], 0x3f400000 // 0x0068e743    c744240c0000403f
                         {disp8} jmp        .Lbl_addr_0x0068e755               // 0x0068e74b    eb08
                         {disp8} mov        dword ptr [esp + 0x0c], 0x3f800000 // 0x0068e74d    c744240c0000803f
.Lbl_addr_0x0068e755:    {disp32} mov       eax, dword ptr [edi + 0x000057b0]  // 0x0068e755    8b87b0570000
                         test               eax, eax                           // 0x0068e75b    85c0
                         {disp8} jne        .Lbl_addr_0x0068e76a               // 0x0068e75d    750b
