...
_jmp_addr_0x00864420:    {disp32} mov       eax, fs:[0x0]                                 // 0x00864420    64a100000000
                         ...
                         {disp8} je         .Lbl_addr_0x00864478                          // 0x0086445d    7419
.Lbl_addr_0x0086445f:    {disp8} mov        ebx, dword ptr [eax + 0x24]                   // 0x0086445f    8b5824
                         ...
                         {disp8} jne        .Lbl_addr_0x0086445f                          // 0x0086446f    75ee
                         {disp32} mov       ecx, dword ptr [esp + 0x000000b0]             // 0x00864471    8b8c24b0000000
.Lbl_addr_0x00864478:    mov                eax, dword ptr [edi]                          // 0x00864478    8b07
                         ...
                         {disp8} jle        .Lbl_addr_0x00864517                          // 0x008644eb    7e2a
                         {disp32} lea       ebx, dword ptr [esi + 0x00064090]             // 0x008644ed    8d9e90400600
.Lbl_addr_0x008644f3:    mov                ebp, dword ptr [ebx]                          // 0x008644f3    8b2b
                         test               ebp, ebp                                      // 0x008644f5    85ed
                         {disp8} je         .Lbl_addr_0x00864509                          // 0x008644f7    7410
...
.Lbl_addr_0x00864509:    {disp32} mov       eax, dword ptr [esi + 0x000640b8]             // 0x00864509    8b86b8400600
                         inc                edi                                           // 0x0086450f    47
                         add                ebx, 0x04                                     // 0x00864510    83c304
                         cmp.s              edi, eax                                      // 0x00864513    3bf8
                         {disp8} jl         .Lbl_addr_0x008644f3                          // 0x00864515    7cdc
.Lbl_addr_0x00864517:    {disp32} mov       eax, dword ptr [esi + 0x0006406c]             // 0x00864517    8b866c400600
                         ...
                         {disp8} je         .Lbl_addr_0x00864543                          // 0x0086452d    7414
                         ...
                         {disp8} jmp        .Lbl_addr_0x0086454b                          // 0x00864541    eb08
.Lbl_addr_0x00864543:    {disp8} mov        dword ptr [esp + 0x14], 0x00000000            // 0x00864543    c744241400000000
.Lbl_addr_0x0086454b:    {disp32} mov       ecx, dword ptr [esi + 0x00064070]             // 0x0086454b    8b8e70400600
                         ...
                         {disp8} jne        .Lbl_addr_0x008645ba                          // 0x00864592    7526
                         ...
                         {disp8} jmp        .Lbl_addr_0x008645f3                          // 0x008645b8    eb39
.Lbl_addr_0x008645ba:    {disp32} mov       eax, dword ptr [esi + 0x00064070]             // 0x008645ba    8b8670400600
                         ...
                         {disp8} jmp        .Lbl_addr_0x008645f3                          // 0x008645d6    eb1b
.Lbl_addr_0x008645d8:    {disp32} mov       eax, dword ptr [esi + 0x0006402c]             // 0x008645d8    8b862c400600
...
.Lbl_addr_0x008645f3:    {disp32} mov       edx, dword ptr [esi + 0x0006402c]             // 0x008645f3    8b962c400600
                         ...
                         {disp8} je         .Lbl_addr_0x00864642                          // 0x00864623    741d
...
.Lbl_addr_0x00864642:    {disp8} lea        ecx, dword ptr [esp + 0x2c]                   // 0x00864642    8d4c242c
                         ...
                         {disp32} je        .Lbl_addr_0x00864864                          // 0x0086467d    0f84e1010000
.Lbl_addr_0x00864683:    cmp                dword ptr [esp + 0x14], 0x04                  // 0x00864683    837c241404
                         {disp32} jge       .Lbl_addr_0x00864864                          // 0x00864688    0f8dd6010000
...
.Lbl_addr_0x008646ca:    cmp                ebx, 0x20                                     // 0x008646ca    83fb20
                         {disp8} jge        .Lbl_addr_0x008646f6                          // 0x008646cd    7d27
                         ...
                         {disp8} ja         .Lbl_addr_0x008646f1                          // 0x008646d9    7716
                         ...
                         {disp8} jmp        .Lbl_addr_0x008646f1                          // 0x008646ed    eb02
                         xor.s              ebp, ebp                                      // 0x008646ef    33ed
.Lbl_addr_0x008646f1:    inc                ebx                                           // 0x008646f1    43
                         test               ebp, ebp                                      // 0x008646f2    85ed
                         {disp8} jne        .Lbl_addr_0x008646ca                          // 0x008646f4    75d4
.Lbl_addr_0x008646f6:    cmp                dword ptr [esp + 0x7c], 0x05                  // 0x008646f6    837c247c05
                         {disp8} mov        ebx, dword ptr [edi + 0x24]                   // 0x008646fb    8b5f24
                         {disp32} jne       .Lbl_addr_0x0086484f                          // 0x008646fe    0f854b010000
                         ...
                         {disp8} je         .Lbl_addr_0x0086471f                          // 0x00864714    7409
                         cmp                ecx, -0x01                                    // 0x00864716    83f9ff
                         {disp32} jne       .Lbl_addr_0x0086484f                          // 0x00864719    0f8530010000
.Lbl_addr_0x0086471f:    {disp8} mov        ecx, dword ptr [edi + 0x14]                   // 0x0086471f    8b4f14
                         ...
                         {disp8} je         .Lbl_addr_0x0086475a                          // 0x00864746    7412
                         ...
                         {disp8} jmp        .Lbl_addr_0x00864770                          // 0x00864758    eb16
.Lbl_addr_0x0086475a:    {disp32} mov       eax, dword ptr [esi + 0x0006408c]             // 0x0086475a    8b868c400600
...
.Lbl_addr_0x00864770:    {disp32} mov       ecx, dword ptr [esi + 0x0006408c]             // 0x00864770    8b8e8c400600
                         ...
                         {disp8} je         .Lbl_addr_0x0086480f                          // 0x008647ad    7460
                         ...
                         {disp8} je         .Lbl_addr_0x008647e3                          // 0x008647c7    741a
                         ...
                         {disp8} jmp        .Lbl_addr_0x008647e5                          // 0x008647e1    eb02
.Lbl_addr_0x008647e3:    xor.s              eax, eax                                      // 0x008647e3    33c0
.Lbl_addr_0x008647e5:    {disp8} mov        dword ptr [eax + 0x20], ebp                   // 0x008647e5    896820
...
.Lbl_addr_0x0086480f:    cmp.s              edi, ebp                                      // 0x0086480f    3bfd
                         ...
                         {disp8} je         .Lbl_addr_0x00864851                          // 0x0086483b    7414
.Lbl_addr_0x0086483d:    {disp8} mov        ebp, dword ptr [edi + 0x24]                   // 0x0086483d    8b6f24
                         ...
                         {disp8} jne        .Lbl_addr_0x0086483d                          // 0x0086484d    75ee
.Lbl_addr_0x0086484f:    xor.s              ebp, ebp                                      // 0x0086484f    33ed
.Lbl_addr_0x00864851:    {disp8} mov        ecx, dword ptr [esp + 0x14]                   // 0x00864851    8b4c2414
                         ...
                         {disp32} jne       .Lbl_addr_0x00864683                          // 0x0086485e    0f851ffeffff
.Lbl_addr_0x00864864:    {disp8} lea        ecx, dword ptr [esp + 0x2c]                   // 0x00864864    8d4c242c
