...
.Lbl_addr_0x00708fef:    {disp32} mov      ecx, dword ptr [_script_dll]           // 0x00708fef    8b0d105cd900
                         ...
                         {disp8} jne       .Lbl_addr_0x0070905b                   // 0x00709045    7514
                         ...
                         ret                                                      // 0x0070905a    c3
.Lbl_addr_0x0070905b:    {disp32} mov      esi, dword ptr [data_bytes + 0x4f3a08] // 0x0070905b    8b35089aeb00
                         xor.s             ecx, ecx                               // 0x00709061    33c9
                         test              esi, esi                               // 0x00709063    85f6
                         {disp8} je        .Lbl_addr_0x00709082                   // 0x00709065    741b
.Lbl_addr_0x00709067:    test              ecx, ecx                               // 0x00709067    85c9
                         {disp8} jne       .Lbl_addr_0x0070908b                   // 0x00709069    7520
                         cmp               dword ptr [esi + 0x18], edi            // 0x0070906b    397e18
                         {disp8} jne       .Lbl_addr_0x00709077                   // 0x0070906e    7507
                         mov               ecx, 0x00000001                        // 0x00709070    b901000000
                         {disp8} jmp       .Lbl_addr_0x0070907a                   // 0x00709075    eb03
.Lbl_addr_0x00709077:    {disp8} mov       esi, dword ptr [esi + 0x08]            // 0x00709077    8b7608
.Lbl_addr_0x0070907a:    test              esi, esi                               // 0x0070907a    85f6
                         {disp8} jne       .Lbl_addr_0x00709067                   // 0x0070907c    75e9
                         test              ecx, ecx                               // 0x0070907e    85c9
                         {disp8} jne       .Lbl_addr_0x0070908b                   // 0x00709080    7509
.Lbl_addr_0x00709082:    cmp               ebx, 0x13                              // 0x00709082    83fb13
                         {disp32} jne      .Lbl_addr_0x00709127                   // 0x00709085    0f859c000000
.Lbl_addr_0x0070908b:    {disp8} lea       ecx, dword ptr [ebx + -0x07]           // 0x0070908b    8d4bf9
                         cmp               ecx, 0x0c                              // 0x0070908e    83f90c
                         {disp32} ja       .Lbl_addr_0x00709127                   // 0x00709091    0f8790000000
                         ...
                         {disp8} je        .Lbl_addr_0x00709101                   // 0x007090b3    744c
                         ...
                         {disp8} jmp       .Lbl_addr_0x007090f2                   // 0x007090ce    eb22
                         ...
                         {disp8} jmp       .Lbl_addr_0x007090f2                   // 0x007090e0    eb10
...
.Lbl_addr_0x007090f2:    push              ecx                                    // 0x007090f2    51
...
.Lbl_addr_0x00709101:    or                eax, 0x2                               // 0x00709101    83c802
...
.Lbl_addr_0x00709127:    pop               edi                                    // 0x00709127    5f
