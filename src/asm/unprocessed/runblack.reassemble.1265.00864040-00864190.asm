...
_jmp_addr_0x00864040:    {disp8} mov       eax, dword ptr [esp + 0x04]                   // 0x00864040    8b442404
                         ...
                         {disp8} je        .Lbl_addr_0x00864065                          // 0x0086404d    7416
                         ...
                         {disp8} jmp       .Lbl_addr_0x0086406b                          // 0x00864063    eb06
.Lbl_addr_0x00864065:    {disp32} mov      ebp, dword ptr [esi + 0x0006405c]             // 0x00864065    8bae5c400600
.Lbl_addr_0x0086406b:    cmp               dword ptr [esi + 0x000640b8], ecx             // 0x0086406b    398eb8400600
                         {disp32} je       .Lbl_addr_0x0086416b                          // 0x00864071    0f84f4000000
                         xor.s             ebx, ebx                                      // 0x00864077    33db
                         cmp.s             ebp, ecx                                      // 0x00864079    3be9
                         {disp32} jle      .Lbl_addr_0x0086416b                          // 0x0086407b    0f8eea000000
                         push              edi                                           // 0x00864081    57
                         {disp8} jmp       .Lbl_addr_0x00864086                          // 0x00864082    eb02
.Lbl_addr_0x00864084:    xor.s             ecx, ecx                                      // 0x00864084    33c9
.Lbl_addr_0x00864086:    {disp32} mov      edi, dword ptr [esi + 0x000640b8]             // 0x00864086    8bbeb8400600
...
.Lbl_addr_0x008640c3:    inc               ecx                                           // 0x008640c3    41
                         add               edx, 0x04                                     // 0x008640c4    83c204
                         cmp.s             ecx, edi                                      // 0x008640c7    3bcf
                         {disp8} jl        .Lbl_addr_0x008640aa                          // 0x008640c9    7cdf
.Lbl_addr_0x008640cb:    {disp32} mov      ecx, dword ptr [esi + 0x000640bc]             // 0x008640cb    8b8ebc400600
                         ...
                         {disp8} je        .Lbl_addr_0x00864148                          // 0x008640e0    7466
                         cmp               eax, 0x02                                     // 0x008640e2    83f802
                         {disp8} jne       .Lbl_addr_0x008640f0                          // 0x008640e5    7509
                         push              0x0                                           // 0x008640e7    6a00
                         mov.s             ecx, edi                                      // 0x008640e9    8bcf
                         call              @GameTurnUpdate__5RPlanFi@12                  // 0x008640eb    e8b0a80000
.Lbl_addr_0x008640f0:    {disp8} mov       eax, dword ptr [edi + 0x50]                   // 0x008640f0    8b4750
                         cmp               eax, 0x05                                     // 0x008640f3    83f805
                         {disp8} ja        .Lbl_addr_0x00864151                          // 0x008640f6    7759
                         ...
                         {disp8} je        .Lbl_addr_0x00864136                          // 0x00864105    742f
                         ...
                         {disp8} jne       .Lbl_addr_0x00864136                          // 0x00864121    7513
                         ...
                         {disp8} jmp       .Lbl_addr_0x0086414f                          // 0x00864134    eb19
.Lbl_addr_0x00864136:    mov.s             ecx, esi                                      // 0x00864136    8bce
                         call              _jmp_addr_0x008641f0                          // 0x00864138    e8b3000000
                         {disp8} jmp       .Lbl_addr_0x0086414f                          // 0x0086413d    eb10
                         cmp               dword ptr [esi + 0x00064054], 0x04            // 0x0086413f    83be5440060004
                         {disp8} je        .Lbl_addr_0x00864151                          // 0x00864146    7409
.Lbl_addr_0x00864148:    mov.s             ecx, esi                                      // 0x00864148    8bce
                         call              _jmp_addr_0x008642c0                          // 0x0086414a    e871010000
.Lbl_addr_0x0086414f:    mov.s             ebx, ebp                                      // 0x0086414f    8bdd
.Lbl_addr_0x00864151:    inc               ebx                                           // 0x00864151    43
                         cmp.s             ebx, ebp                                      // 0x00864152    3bdd
                         {disp32} jl       .Lbl_addr_0x00864084                          // 0x00864154    0f8c2affffff
...
.Lbl_addr_0x0086416b:    pop               esi                                           // 0x0086416b    5e
