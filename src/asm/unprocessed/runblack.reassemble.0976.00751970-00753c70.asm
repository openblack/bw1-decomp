...
.globl ?IsAvailable@Villager@@QAE_NXZ
.globl ?GetTown@Villager@@QAEPAVTown@@XZ
.globl ?IsFunctional@Villager@@QAE_NXZ
...
?GetTown@Villager@@QAEPAVTown@@XZ:
