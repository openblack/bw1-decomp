...
_jmp_addr_0x0075628e:    {disp32} fcomp     dword ptr [_rdata_float1p0]                   // 0x0075628e    d81d90a38a00
...
_jmp_addr_0x00756429:    mov                edx, dword ptr [esi]                          // 0x00756429    8b16
                         ...
                         nop                                                              // 0x0075644e    90
                         nop                                                              // 0x0075644f    90
?InsertMapObject@Villager@@UAEXXZ:
...
_jmp_addr_0x0075648f:    {disp32} mov       cl, byte ptr [esi + 0x0000008c]               // 0x0075648f    8a8e8c000000
                         ...
                         ret                                                              // 0x0075649e    c3
                         nop                                                              // 0x0075649f    90
?ValidForPlaceInHand@Villager@@UAEIPAVGInterfaceStatus@@@Z:
                         ...
                         nop                                                              // 0x007564be    90
                         nop                                                              // 0x007564bf    90
?CanBecomeAPhysicsObject@Villager@@UAE_NXZ:
                         ...
                         nop                                                              // 0x007564ce    90
                         nop                                                              // 0x007564cf    90
?AddResource@Villager@@UAEIW4RESOURCE_TYPE@@IPAVGInterfaceStatus@@_NPBUMapCoords@@H@Z:
...
?SetTown@Villager@@QAEXPAVTown@@@Z:
                         ...
                         call               ?SetStateAnim@Living@@QAEXXZ                  // 0x00756550    e8bb65e9ff
...
_jmp_addr_0x0075655e:    mov                eax, 0x00000001                               // 0x0075655e    b801000000
                         ...
                         nop                                                              // 0x0075658e    90
                         nop                                                              // 0x0075658f    90
?CallIntoAnimationFunction@Villager@@UAEHW4VILLAGER_STATES@@@Z:
...
_jmp_addr_0x00756612:    pop                edi                                           // 0x00756612    5f
                         ...
                         nop                                                              // 0x0075661e    90
                         nop                                                              // 0x0075661f    90
?CallOutofAnimationFunction@Villager@@UAEHW4VILLAGER_STATES@@@Z:
