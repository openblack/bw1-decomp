...
// Snippet: asm, [0x00504700, 0x00504c73)
                         ...
                         {disp8} ja         .Lbl_addr_0x0050479e                          // 0x0050474e    774e
                         ...
                         {disp8} jmp        .Lbl_addr_0x005047c8                          // 0x00504773    eb53
                         ...
                         {disp8} jmp        .Lbl_addr_0x005047c8                          // 0x00504791    eb35
                         {disp32} mov       edx, dword ptr [esi + 0x00000160]             // 0x00504793    8b9660010000
                         {disp8} mov        ecx, dword ptr [edx + 0x58]                   // 0x00504799    8b4a58
                         {disp8} jmp        .Lbl_addr_0x005047b5                          // 0x0050479c    eb17
.Lbl_addr_0x0050479e:    {disp32} mov       eax, dword ptr [esi + 0x00000160]             // 0x0050479e    8b8660010000
...
.Lbl_addr_0x005047b5:    call               _jmp_addr_0x004848f0                          // 0x005047b5    e83601f8ff
...
.Lbl_addr_0x005047c8:    {disp32} mov       edi, dword ptr [esi + 0x000000d8]             // 0x005047c8    8bbed8000000
                         {disp8} mov        eax, dword ptr [edi + 0x5c]                   // 0x005047ce    8b475c
                         add                eax, -0x1f                                    // 0x005047d1    83c0e1
                         cmp                eax, 0x0b                                     // 0x005047d4    83f80b
                         {disp32} ja        .Lbl_addr_0x00504bd4                          // 0x005047d7    0f87f7030000
                         ...
                         call               __ftol                                        // 0x005047ec    e80fcc2900
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x0050480e    e9c1030000
                         ...
                         call               __ftol                                        // 0x00504821    e8dacb2900
                         ...
                         {disp8} jne        .Lbl_addr_0x00504851                          // 0x00504840    750f
                         {disp32} fsub      dword ptr [rdata_bytes + 0x28678]             // 0x00504842    d82578168d00
                         call               __ftol                                        // 0x00504848    e8b3cb2900
                         mov.s              ecx, eax                                      // 0x0050484d    8bc8
                         {disp8} jmp        .Lbl_addr_0x00504853                          // 0x0050484f    eb02
.Lbl_addr_0x00504851:    fstp               st(0)                                         // 0x00504851    ddd8
.Lbl_addr_0x00504853:    push               ecx                                           // 0x00504853    51
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x00504870    e95f030000
                         ...
                         call               __ftol                                        // 0x00504883    e878cb2900
                         ...
                         {disp32} fcom      dword ptr [__real@4@4001c90fdb0000000000]                   // 0x00504897    d81510b28a00
                         fnstsw             ax                                            // 0x0050489d    dfe0
                         test               ah, 0x41                                      // 0x0050489f    f6c441
                         {disp8} jne        .Lbl_addr_0x005048b3                          // 0x005048a2    750f
                         {disp32} fsub      dword ptr [__real@4@4001c90fdb0000000000]                   // 0x005048a4    d82510b28a00
                         call               __ftol                                        // 0x005048aa    e851cb2900
                         mov.s              ecx, eax                                      // 0x005048af    8bc8
                         {disp8} jmp        .Lbl_addr_0x005048b5                          // 0x005048b1    eb02
.Lbl_addr_0x005048b3:    fstp               st(0)                                         // 0x005048b3    ddd8
.Lbl_addr_0x005048b5:    and                ecx, 0x0000ffff                               // 0x005048b5    81e1ffff0000
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x005048e9    e9e6020000
                         ...
                         call               __ftol                                        // 0x005048fd    e8feca2900
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x00504911    e9be020000
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x00504928    e9a7020000
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x00504940    e98f020000
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x00504958    e977020000
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x0050496f    e960020000
                         ...
                         {disp8} je         .Lbl_addr_0x0050498d                          // 0x00504986    7405
                         {disp8} mov        eax, dword ptr [eax + 0x04]                   // 0x00504988    8b4004
                         {disp8} jmp        .Lbl_addr_0x0050498f                          // 0x0050498b    eb02
.Lbl_addr_0x0050498d:    xor.s              eax, eax                                      // 0x0050498d    33c0
.Lbl_addr_0x0050498f:    {disp8} fild       dword ptr [eax + 0x14]                        // 0x0050498f    db4014
                         ...
                         {disp32} fmul      dword ptr [__real@4@3fef8000000000000000]     // 0x005049a0    d80d1cc48a00
                         fild               dword ptr [ebx]                               // 0x005049a6    db03
                         {disp32} fmul      dword ptr [rdata_bytes + 0x2864c]             // 0x005049a8    d80d4c168d00
                         {disp32} fmul      dword ptr [__real@4@3fef8000000000000000]     // 0x005049ae    d80d1cc48a00
                         ...
                         {disp32} fmul      dword ptr [__real@4@3fef8000000000000000]     // 0x005049c8    d80d1cc48a00
                         {disp8} fild       dword ptr [esi + 0x18]                        // 0x005049ce    db4618
                         {disp32} fmul      dword ptr [rdata_bytes + 0x2864c]             // 0x005049d1    d80d4c168d00
                         {disp32} fmul      dword ptr [__real@4@3fef8000000000000000]     // 0x005049d7    d80d1cc48a00
                         ...
                         {disp8} je         .Lbl_addr_0x00504a04                          // 0x005049f6    740c
                         ...
                         ret                                                              // 0x00504a03    c3
.Lbl_addr_0x00504a04:    {disp8} lea        ecx, dword ptr [esp + 0x2c]                   // 0x00504a04    8d4c242c
                         ...
                         {disp32} jne       .Lbl_addr_0x00504bd4                          // 0x00504a25    0f85a9010000
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x00504a3b    e994010000
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x00504a57    e978010000
                         ...
                         {disp32} ja        .Lbl_addr_0x00504bd4                          // 0x00504a6b    0f8763010000
                         ...
                         {disp32} jne       .Lbl_addr_0x00504bd4                          // 0x00504aae    0f8520010000
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x00504ac4    e90b010000
                         mov.s              ecx, esi                                      // 0x00504ac9    8bce
                         call               _jmp_addr_0x00506e10                          // 0x00504acb    e840230000
                         cmp                eax, 0x02                                     // 0x00504ad0    83f802
                         {disp32} jne       .Lbl_addr_0x00504bd4                          // 0x00504ad3    0f85fb000000
...
.Lbl_addr_0x00504b06:    {disp32} mov       eax, dword ptr [esi + 0x000000d8]             // 0x00504b06    8b86d8000000
                         ...
                         {disp32} jmp       .Lbl_addr_0x00504bd4                          // 0x00504b23    e9ac000000
                         {disp8} fld        dword ptr [edi + 0x64]                        // 0x00504b28    d94764
                         call               __ftol                                        // 0x00504b2b    e8d0c82900
                         ...
                         {disp32} fmul      dword ptr [__real@4@3fef8000000000000000]     // 0x00504b5b    d80d1cc48a00
                         fadd               st, st(1)                                     // 0x00504b61    d8c1
                         {disp32} fmul      dword ptr [__real@4@400f8000000000000000]     // 0x00504b63    d80d08c48a00
                         {disp32} fdiv      dword ptr [rdata_bytes + 0x2864c]             // 0x00504b69    d8354c168d00
                         call               __ftol                                        // 0x00504b6f    e88cc82900
                         ...
                         {disp32} fmul      dword ptr [__real@4@3fef8000000000000000]     // 0x00504b92    d80d1cc48a00
                         fadd               st, st(1)                                     // 0x00504b98    d8c1
                         {disp32} fmul      dword ptr [__real@4@400f8000000000000000]     // 0x00504b9a    d80d08c48a00
                         {disp32} fdiv      dword ptr [rdata_bytes + 0x2864c]             // 0x00504ba0    d8354c168d00
                         call               __ftol                                        // 0x00504ba6    e855c82900
...
.Lbl_addr_0x00504bd4:    {disp8} fld        dword ptr [esp + 0x10]                        // 0x00504bd4    d9442410
                         ...
                         call               ?GetAltitude@LH3DIsland@@SIMABULH3DMapCoords@@@Z// 0x00504bf1    e89ae42f00
...
.Lbl_addr_0x00504c2f:    {disp32} mov       eax, dword ptr [esi + 0x000000d8]             // 0x00504c2f    8b86d8000000
                         ...
                         {disp8} je         .Lbl_addr_0x00504c6a                          // 0x00504c51    7417
                         dec                word ptr [esi + 0x58]                         // 0x00504c53    66ff4e58
                         cmp                word ptr [esi + 0x58], 0x00                   // 0x00504c57    66837e5800
                         {disp8} jne        .Lbl_addr_0x00504c6a                          // 0x00504c5c    750c
                         ...
                         ret                                                              // 0x00504c69    c3
.Lbl_addr_0x00504c6a:    pop                edi                                           // 0x00504c6a    5f
