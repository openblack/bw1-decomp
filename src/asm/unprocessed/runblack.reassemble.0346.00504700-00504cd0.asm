...
// Snippet: asm, [0x00504700, 0x00504c73)
                         ...
                         call               @__ct__9MapCoordsFv@4                         // 0x0050470c    e84fd4f3ff
                         ...
                         call               @GetCreature3D__8CreatureFv@4                 // 0x00504759    e8f230f7ff
...
_jmp_addr_0x005047b5:    call               _jmp_addr_0x004848f0                          // 0x005047b5    e83601f8ff
                         ...
                         call               @GetCreature3D__8CreatureFv@4                 // 0x005047bc    e88f30f7ff
...
_jmp_addr_0x00504853:    push               ecx                                           // 0x00504853    51
                         ...
                         {disp32} fcom      dword ptr [rdata_bytes + 0x2210]              // 0x00504897    d81510b28a00
                         fnstsw             ax                                            // 0x0050489d    dfe0
                         test               ah, 0x41                                      // 0x0050489f    f6c441
                         {disp8} jne        _jmp_addr_0x005048b3                          // 0x005048a2    750f
                         {disp32} fsub      dword ptr [rdata_bytes + 0x2210]              // 0x005048a4    d82510b28a00
...
_jmp_addr_0x005048b5:    and                ecx, 0x0000ffff                               // 0x005048b5    81e1ffff0000
                         ...
                         {disp32} fmul      dword ptr [rdata_bytes + 0x2228]              // 0x005048f7    d80d28b28a00
                         ...
                         call               @GetCreature3D__8CreatureFv@4                 // 0x00504934    e8172ff7ff
...
_jmp_addr_0x0050498f:    {disp8} fild       dword ptr [eax + 0x14]                        // 0x0050498f    db4014
                         ...
                         {disp32} fcomp     dword ptr [rdata_bytes + 0x222c]              // 0x005049e8    d81d2cb28a00
...
_jmp_addr_0x00504b06:    {disp32} mov       eax, dword ptr [esi + 0x000000d8]             // 0x00504b06    8b86d8000000
                         ...
                         call               @GetCreature3D__8CreatureFv@4                 // 0x00504bc8    e8832cf7ff
...
_jmp_addr_0x00504bd4:    {disp8} fld        dword ptr [esp + 0x10]                        // 0x00504bd4    d9442410
                         {disp32} fcomp     dword ptr [rdata_bytes + 0x2244]              // 0x00504bd8    d81d44b28a00
                         ...
                         call               @GetAltitude__10LH3DIslandFRC13LH3DMapCoords@4// 0x00504bf1    e89ae42f00
                         ...
                         {disp32} fmul      dword ptr [rdata_bytes + 0x13a4]              // 0x00504c12    d80da4a38a00
                         {disp8} fstp       dword ptr [esp + 0x48]                        // 0x00504c18    d95c2448
                         {disp8} fild       dword ptr [esp + 0x34]                        // 0x00504c1c    db442434
                         {disp32} fmul      dword ptr [rdata_bytes + 0x13a4]              // 0x00504c20    d80da4a38a00
