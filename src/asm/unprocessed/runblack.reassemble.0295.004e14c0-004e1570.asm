...
_jmp_addr_0x004e14c0:    push             ebx                                           // 0x004e14c0    53
                         ...
                         call             ??2Base@@SAPAXIPBDI@Z                         // 0x004e14d1    e81a52f5ff
                         ...
                         {disp8} je       .Lbl_addr_0x004e14fb                          // 0x004e14e1    7418
...
.Lbl_addr_0x004e14fb:    push             edi                                           // 0x004e14fb    57
                         {disp32} lea     ecx, dword ptr [esi + 0x00002478]             // 0x004e14fc    8d8e78240000
                         call             .Lbl_addr_0x004e1530                          // 0x004e1502    e829000000
...
.Lbl_addr_0x004e1530:    {disp8} mov      edx, dword ptr [esp + 0x04]                   // 0x004e1530    8b542404
                         {disp8} mov      eax, dword ptr [edx + 0x08]                   // 0x004e1534    8b4208
                         cmp              eax, 0x03                                     // 0x004e1537    83f803
                         {disp8} ja       .Lbl_addr_0x004e1559                          // 0x004e153a    771d
...
.Lbl_addr_0x004e1559:    xor.s            eax, eax                                      // 0x004e1559    33c0
