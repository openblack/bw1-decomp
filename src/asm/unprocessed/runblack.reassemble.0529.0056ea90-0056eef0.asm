...
_jmp_addr_0x0056ea90:    push             esi                                           // 0x0056ea90    56
                         ...
                         {disp8} jne      .Lbl_addr_0x0056ead1                          // 0x0056eac5    750a
...
.Lbl_addr_0x0056ead1:    {disp8} mov      ecx, dword ptr [esi + 0x40]                   // 0x0056ead1    8b4e40
...
_jmp_addr_0x0056eaf0:    push             ecx                                           // 0x0056eaf0    51
                         ...
                         {disp8} je       .Lbl_addr_0x0056eb03                          // 0x0056eafc    7405
                         cmp              eax, 0x03                                     // 0x0056eafe    83f803
                         {disp8} jne      .Lbl_addr_0x0056eb0e                          // 0x0056eb01    750b
.Lbl_addr_0x0056eb03:    {disp8} mov      al, byte ptr [esi + 0x5d]                     // 0x0056eb03    8a465d
                         test             al, al                                        // 0x0056eb06    84c0
                         {disp8} je       .Lbl_addr_0x0056eb0e                          // 0x0056eb08    7404
                         xor.s            bl, bl                                        // 0x0056eb0a    32db
                         {disp8} jmp      .Lbl_addr_0x0056eb10                          // 0x0056eb0c    eb02
.Lbl_addr_0x0056eb0e:    mov              bl, 0x01                                      // 0x0056eb0e    b301
.Lbl_addr_0x0056eb10:    {disp8} mov      ecx, dword ptr [esi + 0x44]                   // 0x0056eb10    8b4e44
                         ...
                         {disp8} je       .Lbl_addr_0x0056eb56                          // 0x0056eb3e    7416
                         ...
                         {disp8} jmp      .Lbl_addr_0x0056eb67                          // 0x0056eb54    eb11
.Lbl_addr_0x0056eb56:    {disp8} mov      edx, dword ptr [esi + 0x38]                   // 0x0056eb56    8b5638
...
.Lbl_addr_0x0056eb67:    {disp8} mov      eax, dword ptr [esi + 0x38]                   // 0x0056eb67    8b4638
                         ...
                         .byte            0x72, 0x14// {disp8} jb .Lbl_addr_0x0056ebac  // 0x0056eb96    7214
...
.Lbl_addr_0x0056ebac:    pop              edi                                           // 0x0056ebac    5f
                         ...
                         nop                                                            // 0x0056ebbe    90
                         nop                                                            // 0x0056ebbf    90
.Lbl_addr_0x0056ebc0:    {disp8} mov      al, byte ptr [ecx + 0x61]                     // 0x0056ebc0    8a4161
                         test             al, al                                        // 0x0056ebc3    84c0
                         {disp8} jne      .Lbl_addr_0x0056ebf2                          // 0x0056ebc5    752b
                         ...
                         {disp8} jbe      .Lbl_addr_0x0056ebe1                          // 0x0056ebda    7605
                         add              eax, 0x000141f0                               // 0x0056ebdc    05f0410100
.Lbl_addr_0x0056ebe1:    {disp8} mov      ecx, dword ptr [eax + 0x08]                   // 0x0056ebe1    8b4808
...
.Lbl_addr_0x0056ebf2:    ret              0x0004                                        // 0x0056ebf2    c20400
                         nop                                                            // 0x0056ebf5    90
                         nop                                                            // 0x0056ebf6    90
                         nop                                                            // 0x0056ebf7    90
                         nop                                                            // 0x0056ebf8    90
...
_jmp_addr_0x0056ec00:    {disp8} mov      eax, dword ptr [esp + 0x08]                   // 0x0056ec00    8b442408
                         ...
                         {disp32} ja      .Lbl_addr_0x0056eebf                          // 0x0056ec0a    0f87af020000
                         ...
                         {disp32} jne     .Lbl_addr_0x0056eebf                          // 0x0056ec32    0f8587020000
                         ...
                         {disp32} je      .Lbl_addr_0x0056eebf                          // 0x0056ec41    0f8478020000
                         ...
                         {disp32} jne     .Lbl_addr_0x0056ece8                          // 0x0056ec50    0f8592000000
                         {disp32} mov     eax, dword ptr [data_bytes + 0x381a28]        // 0x0056ec56    a1287ad400
                         test             eax, eax                                      // 0x0056ec5b    85c0
                         {disp32} je      .Lbl_addr_0x0056ece8                          // 0x0056ec5d    0f8485000000
                         ...
                         {disp8} jne      .Lbl_addr_0x0056ec8b                          // 0x0056ec7d    750c
                         {disp32} mov     ecx, dword ptr [data_bytes + 0x30ab0c]        // 0x0056ec7f    8b0d0c0bcd00
                         push             edi                                           // 0x0056ec85    57
                         call             .Lbl_addr_0x0056ebc0                          // 0x0056ec86    e835ffffff
.Lbl_addr_0x0056ec8b:    {disp32} mov     ecx, dword ptr [_game]                        // 0x0056ec8b    8b0d5c19d000
                         ...
                         {disp8} jne      .Lbl_addr_0x0056ed0c                          // 0x0056eca7    7563
                         ...
                         {disp8} je       .Lbl_addr_0x0056ed12                          // 0x0056eccc    7444
                         ...
                         {disp8} jmp      .Lbl_addr_0x0056ed0c                          // 0x0056ece6    eb24
.Lbl_addr_0x0056ece8:    cmp              dword ptr [ecx + 0x00005990], ebx             // 0x0056ece8    399990590000
                         {disp8} jne      .Lbl_addr_0x0056ed12                          // 0x0056ecee    7522
                         add              ecx, 0x0000598c                               // 0x0056ecf0    81c18c590000
                         call             _jmp_addr_0x00633620                          // 0x0056ecf6    e825490c00
                         cmp              eax, 0x03                                     // 0x0056ecfb    83f803
                         {disp8} jne      .Lbl_addr_0x0056ed0c                          // 0x0056ecfe    750c
                         {disp32} mov     ecx, dword ptr [data_bytes + 0x30ab0c]        // 0x0056ed00    8b0d0c0bcd00
                         push             edi                                           // 0x0056ed06    57
                         call             .Lbl_addr_0x0056ebc0                          // 0x0056ed07    e8b4feffff
.Lbl_addr_0x0056ed0c:    {disp32} mov     ecx, dword ptr [_game]                        // 0x0056ed0c    8b0d5c19d000
.Lbl_addr_0x0056ed12:    {disp8} mov      al, byte ptr [esi + 0x60]                     // 0x0056ed12    8a4660
                         test             al, al                                        // 0x0056ed15    84c0
                         {disp8} jne      .Lbl_addr_0x0056ed37                          // 0x0056ed17    751e
                         ...
                         {disp8} jne      .Lbl_addr_0x0056ed5b                          // 0x0056ed33    7526
                         {disp8} jmp      .Lbl_addr_0x0056ed4f                          // 0x0056ed35    eb18
.Lbl_addr_0x0056ed37:    cmp              dword ptr [ecx + 0x00005980], ebx             // 0x0056ed37    399980590000
                         {disp8} jne      .Lbl_addr_0x0056ed61                          // 0x0056ed3d    7522
                         add              ecx, 0x0000597c                               // 0x0056ed3f    81c17c590000
                         call             _jmp_addr_0x00633620                          // 0x0056ed45    e8d6480c00
                         cmp              eax, 0x03                                     // 0x0056ed4a    83f803
                         {disp8} jne      .Lbl_addr_0x0056ed5b                          // 0x0056ed4d    750c
.Lbl_addr_0x0056ed4f:    {disp32} mov     ecx, dword ptr [data_bytes + 0x30ab0c]        // 0x0056ed4f    8b0d0c0bcd00
                         push             edi                                           // 0x0056ed55    57
                         call             .Lbl_addr_0x0056ebc0                          // 0x0056ed56    e865feffff
.Lbl_addr_0x0056ed5b:    {disp32} mov     ecx, dword ptr [_game]                        // 0x0056ed5b    8b0d5c19d000
.Lbl_addr_0x0056ed61:    cmp              dword ptr [ecx + 0x00005990], ebx             // 0x0056ed61    399990590000
                         {disp32} je      .Lbl_addr_0x0056eebf                          // 0x0056ed67    0f8452010000
                         cmp              dword ptr [ecx + 0x00005980], ebx             // 0x0056ed6d    399980590000
                         {disp32} je      .Lbl_addr_0x0056eebf                          // 0x0056ed73    0f8446010000
                         ...
                         {disp32} je      .Lbl_addr_0x0056eebf                          // 0x0056edaa    0f840f010000
                         {disp32} mov     ecx, dword ptr [eax + 0x00000238]             // 0x0056edb0    8b8838020000
                         test             ecx, ecx                                      // 0x0056edb6    85c9
                         {disp8} je       .Lbl_addr_0x0056edcb                          // 0x0056edb8    7411
...
.Lbl_addr_0x0056edcb:    {disp8} mov      eax, dword ptr [eax + 0x18]                   // 0x0056edcb    8b4018
                         sub              eax, 0x000008fc                               // 0x0056edce    2dfc080000
                         {disp8} je       .Lbl_addr_0x0056ee49                          // 0x0056edd3    7474
                         dec              eax                                           // 0x0056edd5    48
                         {disp8} je       .Lbl_addr_0x0056ee12                          // 0x0056edd6    743a
                         dec              eax                                           // 0x0056edd8    48
                         {disp32} jne     .Lbl_addr_0x0056eebf                          // 0x0056edd9    0f85e0000000
...
.Lbl_addr_0x0056ee12:    {disp8} mov      esi, dword ptr [esp + 0x10]                   // 0x0056ee12    8b742410
...
.Lbl_addr_0x0056ee49:    {disp8} mov      ecx, dword ptr [esp + 0x10]                   // 0x0056ee49    8b4c2410
                         ...
                         {disp8} je       .Lbl_addr_0x0056ee6e                          // 0x0056ee69    7403
                         {disp8} mov      esi, dword ptr [ecx + 0x38]                   // 0x0056ee6b    8b7138
.Lbl_addr_0x0056ee6e:    {disp8} mov      eax, dword ptr [ecx + 0x58]                   // 0x0056ee6e    8b4158
...
.Lbl_addr_0x0056eebf:    pop              edi                                           // 0x0056eebf    5f
