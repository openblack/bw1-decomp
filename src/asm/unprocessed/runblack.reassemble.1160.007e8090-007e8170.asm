...
.Lbl_addr_0x007e80c1:    movsx            eax, byte ptr [ebx + edi * 0x1 + 0x04]     // 0x007e80c1    0fbe443b04
                         add              eax, -0x41                                 // 0x007e80c6    83c0bf
                         cmp              eax, 0x0d                                  // 0x007e80c9    83f80d
                         {disp8} ja       .Lbl_addr_0x007e8106                       // 0x007e80cc    7738
                         ...
                         {disp8} jmp      .Lbl_addr_0x007e80f7                       // 0x007e80e2    eb13
                         push             0x00c34ddc                                 // 0x007e80e4    68dc4dc300
                         {disp8} jmp      .Lbl_addr_0x007e80f7                       // 0x007e80e9    eb0c
                         push             0x00be83ac                                 // 0x007e80eb    68ac83be00
                         {disp8} jmp      .Lbl_addr_0x007e80f7                       // 0x007e80f0    eb05
                         push             0x00c34dd4                                 // 0x007e80f2    68d44dc300
.Lbl_addr_0x007e80f7:    call             _jmp_addr_0x007e7200                       // 0x007e80f7    e804f1ffff
...
.Lbl_addr_0x007e8106:    inc              edi                                        // 0x007e8106    47
                         cmp              edi, 0x0c                                  // 0x007e8107    83ff0c
                         .byte            0x72, 0xb5// {disp8} jb .Lbl_addr_0x007e80c1 // 0x007e810a    72b5
                         ...
                         {disp8} je       .Lbl_addr_0x007e8129                       // 0x007e8117    7410
...
.Lbl_addr_0x007e8129:    push             0x00c22098                                 // 0x007e8129    689820c200
