...
// Snippet: asm, [0x008648b0, 0x00864979)
                         ...
                         {disp32} ja        .Lbl_addr_0x00864976              // 0x008648bd    0f87b3000000
                         ...
                         {disp8} jne        .Lbl_addr_0x0086490c              // 0x008648db    752f
...
.Lbl_addr_0x0086490c:    {disp32} fld       dword ptr [esi + 0x00064034]      // 0x0086490c    d98634400600
                         ...
                         {disp8} je         .Lbl_addr_0x0086494a              // 0x00864942    7406
                         fstp               st(0)                             // 0x00864944    ddd8
                         {disp8} fld        dword ptr [esp + 0x04]            // 0x00864946    d9442404
.Lbl_addr_0x0086494a:    {disp32} fstp      dword ptr [esi + 0x00064034]      // 0x0086494a    d99e34400600
.Lbl_addr_0x00864950:    {disp32} fcom      dword ptr [esi + 0x00064034]      // 0x00864950    d89634400600
                         fnstsw             ax                                // 0x00864956    dfe0
                         test               ah, 0x01                          // 0x00864958    f6c401
                         {disp8} je         .Lbl_addr_0x0086496d              // 0x0086495b    7410
                         ...
                         ret                                                  // 0x0086496c    c3
.Lbl_addr_0x0086496d:    mov.s              ecx, esi                          // 0x0086496d    8bce
                         fstp               st(0)                             // 0x0086496f    ddd8
                         call               ?MoveAlongRoute@RPFollow@@QAEXXZ  // 0x00864971    e81a000000
.Lbl_addr_0x00864976:    pop                esi                               // 0x00864976    5e
