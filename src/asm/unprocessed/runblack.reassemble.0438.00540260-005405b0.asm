...
@__vt__8LoginBoxFv@4:    push             esi                                           // 0x00540260    56
                         ...
                         {disp8} ja       .Lbl_addr_0x0054028b                          // 0x00540278    7711
                         ...
                         ret                                                            // 0x0054028a    c3
.Lbl_addr_0x0054028b:    {disp32} mov     ecx, dword ptr [data_bytes + 0x351ca8]        // 0x0054028b    8b0da87cd100
                         ...
                         {disp8} je       .Lbl_addr_0x005402c9                          // 0x005402b7    7410
                         ...
                         call             .Lbl_addr_0x005402d0                          // 0x005402c4    e807000000
.Lbl_addr_0x005402c9:    ret              0x0008                                        // 0x005402c9    c20800
                         nop                                                            // 0x005402cc    90
                         nop                                                            // 0x005402cd    90
                         nop                                                            // 0x005402ce    90
                         nop                                                            // 0x005402cf    90
.Lbl_addr_0x005402d0:    {disp8} mov      eax, dword ptr [esp + 0x08]                   // 0x005402d0    8b442408
                         ...
                         {disp32} ja      .Lbl_addr_0x00540573                          // 0x005402dd    0f8790020000
                         ...
                         {disp32} jmp     .Lbl_addr_0x005403ff                          // 0x00540309    e9f1000000
                         ...
                         {disp32} jmp     .Lbl_addr_0x005403ff                          // 0x0054032d    e9cd000000
                         ...
                         {disp8} jmp      .Lbl_addr_0x005403ff                          // 0x005403b3    eb4a
                         cmp              dword ptr [data_bytes + 0x351cac], 0x00000d9a // 0x005403b5    813dac7cd1009a0d0000
                         {disp8} ja       .Lbl_addr_0x005403cb                          // 0x005403bf    770a
                         {disp32} mov     eax, dword ptr [data_bytes + 0x351ca8]        // 0x005403c1    a1a87cd100
                         {disp32} jmp     .Lbl_addr_0x00540454                          // 0x005403c6    e989000000
.Lbl_addr_0x005403cb:    {disp32} mov     edx, dword ptr [data_bytes + 0x351ca8]        // 0x005403cb    8b15a87cd100
                         {disp32} lea     eax, dword ptr [edx + 0x0000a338]             // 0x005403d1    8d8238a30000
                         {disp8} jmp      .Lbl_addr_0x00540454                          // 0x005403d7    eb7b
                         ...
                         {disp8} jbe      .Lbl_addr_0x005403ef                          // 0x005403e8    7605
                         add              eax, 0x0000a344                               // 0x005403ea    0544a30000
.Lbl_addr_0x005403ef:    {disp8} mov      edi, dword ptr [esp + 0x18]                   // 0x005403ef    8b7c2418
...
.Lbl_addr_0x005403ff:    push             ebx                                           // 0x005403ff    53
                         ...
                         {disp8} ja       .Lbl_addr_0x00540448                          // 0x0054043f    7707
                         {disp32} mov     eax, dword ptr [data_bytes + 0x351ca8]        // 0x00540441    a1a87cd100
                         {disp8} jmp      .Lbl_addr_0x00540454                          // 0x00540446    eb0c
.Lbl_addr_0x00540448:    {disp32} mov     edx, dword ptr [data_bytes + 0x351ca8]        // 0x00540448    8b15a87cd100
                         {disp32} lea     eax, dword ptr [edx + 0x0000a350]             // 0x0054044e    8d8250a30000
.Lbl_addr_0x00540454:    {disp8} mov      eax, dword ptr [eax + 0x08]                   // 0x00540454    8b4008
                         ...
                         {disp8} jbe      .Lbl_addr_0x005404bd                          // 0x005404b6    7605
                         add              eax, 0x0000a35c                               // 0x005404b8    055ca30000
.Lbl_addr_0x005404bd:    {disp8} mov      ecx, dword ptr [eax + 0x08]                   // 0x005404bd    8b4808
...
.Lbl_addr_0x00540573:    pop              edi                                           // 0x00540573    5f
