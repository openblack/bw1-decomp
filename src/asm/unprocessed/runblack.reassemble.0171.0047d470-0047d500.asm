...
_jmp_addr_0x0047d470:    call             ?GetCreature3D@Creature@@QAEPAVLH3DCreature@@XZ     // 0x0047d470    e8dba3ffff
                         ...
                         {disp8} jle      .Lbl_addr_0x0047d4a2              // 0x0047d481    7e1f
                         push             esi                               // 0x0047d483    56
                         {disp32} lea     esi, dword ptr [ecx + 0x00004ac4] // 0x0047d484    8db1c44a0000
.Lbl_addr_0x0047d48a:    mov              ecx, dword ptr [esi]              // 0x0047d48a    8b0e
                         test             ecx, ecx                          // 0x0047d48c    85c9
                         {disp8} je       .Lbl_addr_0x0047d49a              // 0x0047d48e    740a
                         cmp              ecx, 0x01                         // 0x0047d490    83f901
                         {disp8} je       .Lbl_addr_0x0047d49a              // 0x0047d493    7405
                         cmp              ecx, 0x02                         // 0x0047d495    83f902
                         {disp8} jne      .Lbl_addr_0x0047d49b              // 0x0047d498    7501
.Lbl_addr_0x0047d49a:    inc              eax                               // 0x0047d49a    40
.Lbl_addr_0x0047d49b:    add              esi, 0x04                         // 0x0047d49b    83c604
                         dec              edx                               // 0x0047d49e    4a
                         {disp8} jne      .Lbl_addr_0x0047d48a              // 0x0047d49f    75e9
                         pop              esi                               // 0x0047d4a1    5e
.Lbl_addr_0x0047d4a2:    ret                                                // 0x0047d4a2    c3
                         nop                                                // 0x0047d4a3    90
                         nop                                                // 0x0047d4a4    90
                         nop                                                // 0x0047d4a5    90
                         nop                                                // 0x0047d4a6    90
...
?CreatureMustAvoid@Creature@@UAE_NPAVCreature@@@Z:
                         ...
                         {disp8} je       .Lbl_addr_0x0047d4e1              // 0x0047d4b6    7429
                         cmp.s            eax, ecx                          // 0x0047d4b8    3bc1
                         {disp8} je       .Lbl_addr_0x0047d4e1              // 0x0047d4ba    7425
                         ...
                         {disp8} ja       .Lbl_addr_0x0047d4e1              // 0x0047d4d0    770f
...
.Lbl_addr_0x0047d4e1:    xor.s            eax, eax                          // 0x0047d4e1    33c0
