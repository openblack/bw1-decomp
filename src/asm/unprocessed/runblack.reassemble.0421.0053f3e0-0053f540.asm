...
_jmp_addr_0x0053f3e0:    {disp8} mov      eax, dword ptr [esp + 0x04]            // 0x0053f3e0    8b442404
                         ...
                         {disp32} jne     .Lbl_addr_0x0053f4a3                   // 0x0053f3e8    0f85b5000000
                         {disp8} mov      eax, dword ptr [esp + 0x10]            // 0x0053f3ee    8b442410
                         test             eax, eax                               // 0x0053f3f2    85c0
                         {disp32} je      .Lbl_addr_0x0053f521                   // 0x0053f3f4    0f8427010000
                         {disp8} mov      esi, dword ptr [eax + 0x18]            // 0x0053f3fa    8b7018
                         cmp              esi, 0x000008fc                        // 0x0053f3fd    81fefc080000
                         {disp32} jl      .Lbl_addr_0x0053f521                   // 0x0053f403    0f8c18010000
                         cmp              esi, 0x00000902                        // 0x0053f409    81fe02090000
                         {disp32} jge     .Lbl_addr_0x0053f521                   // 0x0053f40f    0f8d0c010000
                         ...
                         {disp8} je       .Lbl_addr_0x0053f438                   // 0x0053f426    7410
...
.Lbl_addr_0x0053f438:    {disp32} lea     ecx, dword ptr [esi + -0x000008fd]     // 0x0053f438    8d8e03f7ffff
                         cmp              ecx, 0x04                              // 0x0053f43e    83f904
                         {disp32} ja      .Lbl_addr_0x0053f521                   // 0x0053f441    0f87da000000
                         ...
                         ret                                                     // 0x0053f4a2    c3
.Lbl_addr_0x0053f4a3:    cmp              eax, 0x06                              // 0x0053f4a3    83f806
                         {disp8} jne      .Lbl_addr_0x0053f521                   // 0x0053f4a6    7579
                         ...
                         {disp8} je       .Lbl_addr_0x0053f521                   // 0x0053f4ba    7465
                         ...
                         {disp8} jne      .Lbl_addr_0x0053f4eb                   // 0x0053f4cd    751c
                         cmp              eax, 0x000004c4                        // 0x0053f4cf    3dc4040000
                         {disp8} ja       .Lbl_addr_0x0053f4dd                   // 0x0053f4d4    7707
                         {disp32} mov     eax, dword ptr [data_bytes + 0x351ca8] // 0x0053f4d6    a1a87cd100
                         {disp8} jmp      .Lbl_addr_0x0053f505                   // 0x0053f4db    eb28
.Lbl_addr_0x0053f4dd:    {disp32} mov     ecx, dword ptr [data_bytes + 0x351ca8] // 0x0053f4dd    8b0da87cd100
                         {disp32} lea     eax, dword ptr [ecx + 0x00003930]      // 0x0053f4e3    8d8130390000
                         {disp8} jmp      .Lbl_addr_0x0053f505                   // 0x0053f4e9    eb1a
.Lbl_addr_0x0053f4eb:    cmp              eax, 0x00001a7a                        // 0x0053f4eb    3d7a1a0000
                         {disp8} ja       .Lbl_addr_0x0053f4f9                   // 0x0053f4f0    7707
                         {disp32} mov     eax, dword ptr [data_bytes + 0x351ca8] // 0x0053f4f2    a1a87cd100
                         {disp8} jmp      .Lbl_addr_0x0053f505                   // 0x0053f4f7    eb0c
.Lbl_addr_0x0053f4f9:    {disp32} mov     edx, dword ptr [data_bytes + 0x351ca8] // 0x0053f4f9    8b15a87cd100
                         {disp32} lea     eax, dword ptr [edx + 0x00013db8]      // 0x0053f4ff    8d82b83d0100
.Lbl_addr_0x0053f505:    {disp8} mov      eax, dword ptr [eax + 0x08]            // 0x0053f505    8b4008
...
.Lbl_addr_0x0053f521:    xor.s            eax, eax                               // 0x0053f521    33c0
