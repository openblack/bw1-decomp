...
_jmp_addr_0x0042acc0:    {disp8} mov       eax, dword ptr [esp + 0x08]                          // 0x0042acc0    8b442408
                         ...
                         {disp8} je        .Lbl_addr_0x0042ad2a                                 // 0x0042ad00    7428
                         {disp32} mov      eax, dword ptr [eax + 0x00003470]                    // 0x0042ad02    8b8070340000
                         {disp8} jmp       .Lbl_addr_0x0042ad2a                                 // 0x0042ad08    eb20
                         ...
                         {disp8} jne       .Lbl_addr_0x0042ad2a                                 // 0x0042ad16    7512
                         {disp32} mov      eax, dword ptr [eax + 0x00003470]                    // 0x0042ad18    8b8070340000
                         {disp8} jmp       .Lbl_addr_0x0042ad2a                                 // 0x0042ad1e    eb0a
                         {disp8} mov       eax, dword ptr [esp + 0x10]                          // 0x0042ad20    8b442410
                         {disp32} mov      ebx, dword ptr [eax + 0x00003470]                    // 0x0042ad24    8b9870340000
.Lbl_addr_0x0042ad2a:    test              eax, eax                                             // 0x0042ad2a    85c0
                         {disp8} je        .Lbl_addr_0x0042ad3a                                 // 0x0042ad2c    740c
...
.Lbl_addr_0x0042ad3a:    test              ebx, ebx                                             // 0x0042ad3a    85db
                         {disp32} je       .Lbl_addr_0x0042ae33                                 // 0x0042ad3c    0f84f1000000
                         mov               edi, 0x00000001                                      // 0x0042ad42    bf01000000
                         mov.s             ecx, ebx                                             // 0x0042ad47    8bcb
                         {disp8} jmp       .Lbl_addr_0x0042ad53                                 // 0x0042ad49    eb08
.Lbl_addr_0x0042ad4b:    {disp8} mov       edi, dword ptr [esp + 0x18]                          // 0x0042ad4b    8b7c2418
                         {disp8} mov       ecx, dword ptr [esp + 0x10]                          // 0x0042ad4f    8b4c2410
.Lbl_addr_0x0042ad53:    {disp8} mov       eax, dword ptr [esi + 0x0c]                          // 0x0042ad53    8b460c
                         cdq                                                                    // 0x0042ad56    99
                         ...
                         {disp32} je       .Lbl_addr_0x0042ae33                                 // 0x0042ad63    0f84ca000000
                         {disp8} mov       eax, dword ptr [esi + 0x08]                          // 0x0042ad69    8b4608
                         dec               eax                                                  // 0x0042ad6c    48
                         cmp               eax, 0x06                                            // 0x0042ad6d    83f806
                         {disp32} ja       .Lbl_addr_0x0042ae33                                 // 0x0042ad70    0f87bd000000
                         ...
                         {disp32} je       .Lbl_addr_0x0042ae33                                 // 0x0042ad98    0f8495000000
                         ...
                         {disp8} je        .Lbl_addr_0x0042ae33                                 // 0x0042adbf    7472
                         ...
                         {disp8} je        .Lbl_addr_0x0042adf1                                 // 0x0042adea    7405
                         cmp               eax, 0x02                                            // 0x0042adec    83f802
                         {disp8} jne       .Lbl_addr_0x0042ae33                                 // 0x0042adef    7542
.Lbl_addr_0x0042adf1:    pop               edi                                                  // 0x0042adf1    5f
...
.Lbl_addr_0x0042ae33:    pop               edi                                                  // 0x0042ae33    5f
