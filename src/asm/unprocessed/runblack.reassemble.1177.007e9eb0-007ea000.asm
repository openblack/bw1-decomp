...
_jmp_addr_0x007e9eb0:    push             ebx                                    // 0x007e9eb0    53
                         ...
                         {disp32} jne     .Lbl_addr_0x007e9fd0                   // 0x007e9ec9    0f8501010000
                         cmp              word ptr [ebp + 0x00], 0x2d            // 0x007e9ecf    66837d002d
                         {disp32} je      .Lbl_addr_0x007e9fd0                   // 0x007e9ed4    0f84f6000000
                         ...
                         {disp8} je       .Lbl_addr_0x007e9f09                   // 0x007e9ee3    7424
                         mov              eax, 0x00c347b8                        // 0x007e9ee5    b8b847c300
                         mov.s            esi, eax                               // 0x007e9eea    8bf0
.Lbl_addr_0x007e9eec:    mov              ecx, dword ptr [eax]                   // 0x007e9eec    8b08
                         ...
                         {disp8} je       .Lbl_addr_0x007e9f43                   // 0x007e9efa    7447
                         ...
                         {disp8} jne      .Lbl_addr_0x007e9eec                   // 0x007e9f07    75e3
.Lbl_addr_0x007e9f09:    {disp8} mov      eax, dword ptr [ebx + 0x28]            // 0x007e9f09    8b4328
                         test             eax, eax                               // 0x007e9f0c    85c0
                         {disp8} je       .Lbl_addr_0x007e9f37                   // 0x007e9f0e    7427
                         mov              ecx, dword ptr [eax]                   // 0x007e9f10    8b08
                         xor.s            esi, esi                               // 0x007e9f12    33f6
                         test             ecx, ecx                               // 0x007e9f14    85c9
                         {disp8} je       .Lbl_addr_0x007e9f37                   // 0x007e9f16    741f
.Lbl_addr_0x007e9f18:    mov              ecx, dword ptr [eax + esi * 0x4]       // 0x007e9f18    8b0cb0
                         ...
                         {disp32} je      .Lbl_addr_0x007e9fbd                   // 0x007e9f27    0f8490000000
                         ...
                         {disp8} jne      .Lbl_addr_0x007e9f18                   // 0x007e9f35    75e1
.Lbl_addr_0x007e9f37:    pop              edi                                    // 0x007e9f37    5f
...
.Lbl_addr_0x007e9f43:    cmp              edi, 0x04                              // 0x007e9f43    83ff04
                         {disp32} ja      .Lbl_addr_0x007e9fdf                   // 0x007e9f46    0f8793000000
...
.Lbl_addr_0x007e9fbd:    {disp8} mov      edx, dword ptr [esp + 0x18]            // 0x007e9fbd    8b542418
...
.Lbl_addr_0x007e9fd0:    push             ebp                                    // 0x007e9fd0    55
...
.Lbl_addr_0x007e9fdf:    pop              edi                                    // 0x007e9fdf    5f
