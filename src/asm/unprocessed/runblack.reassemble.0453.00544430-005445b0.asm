...
?InitControls@SkipBox@@UAEXXZ:
                         ...
                         {disp8} jle      .Lbl_addr_0x00544457                          // 0x00544449    7e0c
                         cmp              eax, 0x03                                     // 0x0054444b    83f803
                         {disp8} jl       .Lbl_addr_0x00544459                          // 0x0054444e    7c09
                         mov              eax, 0x00000003                               // 0x00544450    b803000000
                         {disp8} jmp      .Lbl_addr_0x00544459                          // 0x00544455    eb02
.Lbl_addr_0x00544457:    xor.s            eax, eax                                      // 0x00544457    33c0
.Lbl_addr_0x00544459:    {disp8} mov      dword ptr [esi + 0x20], eax                   // 0x00544459    894620
                         xor.s            eax, eax                                      // 0x0054445c    33c0
                         {disp8} lea      edx, dword ptr [esi + 0x10]                   // 0x0054445e    8d5610
.Lbl_addr_0x00544461:    {disp8} mov      edi, dword ptr [esi + 0x20]                   // 0x00544461    8b7e20
                         ...
                         {disp8} jl       .Lbl_addr_0x00544461                          // 0x0054447a    7ce5
                         ...
                         {disp8} je       .Lbl_addr_0x005444a2                          // 0x0054448d    7413
                         sub              eax, 0x05                                     // 0x0054448f    83e805
                         {disp32} jne     .Lbl_addr_0x00544598                          // 0x00544492    0f8500010000
...
.Lbl_addr_0x005444a2:    {disp8} mov      edi, dword ptr [esp + 0x14]                   // 0x005444a2    8b7c2414
                         test             edi, edi                                      // 0x005444a6    85ff
                         {disp32} je      .Lbl_addr_0x00544598                          // 0x005444a8    0f84ea000000
                         ...
                         {disp8} jne      .Lbl_addr_0x005444e5                          // 0x005444c5    751e
...
.Lbl_addr_0x005444e5:    cmp              dword ptr [edi + 0x18], 0x0b                  // 0x005444e5    837f180b
                         {disp32} jne     .Lbl_addr_0x00544598                          // 0x005444e9    0f85a9000000
                         {disp8} mov      eax, dword ptr [ecx + 0x20]                   // 0x005444ef    8b4120
                         cmp              eax, 0x03                                     // 0x005444f2    83f803
                         {disp32} ja      .Lbl_addr_0x00544589                          // 0x005444f5    0f878e000000
...
.Lbl_addr_0x00544510:    {disp8} mov      dword ptr [eax + 0x14], esi                   // 0x00544510    897014
                         ...
                         {disp8} jmp      .Lbl_addr_0x0054454d                          // 0x00544521    eb2a
                         ...
                         {disp8} jmp      .Lbl_addr_0x00544510                          // 0x00544531    ebdd
...
.Lbl_addr_0x0054454d:    {disp8} mov      dword ptr [eax + 0x14], edx                   // 0x0054454d    895014
                         ...
                         {disp8} jmp      .Lbl_addr_0x00544586                          // 0x0054455e    eb26
...
.Lbl_addr_0x00544586:    {disp8} mov      dword ptr [eax + 0x14], ecx                   // 0x00544586    894814
.Lbl_addr_0x00544589:    push             0x0                                           // 0x00544589    6a00
...
.Lbl_addr_0x00544598:    pop              edi                                           // 0x00544598    5f
