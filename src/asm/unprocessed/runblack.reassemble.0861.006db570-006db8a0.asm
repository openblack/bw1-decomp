...
.Lbl_addr_0x006db59f:    push             0x3f800000                                    // 0x006db59f    680000803f
                         ...
                         {disp8} jl       .Lbl_addr_0x006db59f                          // 0x006db5cf    7cce
                         ...
                         {disp8} ja       .Lbl_addr_0x006db61c                          // 0x006db5f3    7727
                         jmp              dword ptr [eax*4 + 0x6db844]                  // 0x006db5f5    ff248544b86d00
                         {disp32} fld     dword ptr [rdata_bytes + 0x2418]              // 0x006db5fc    d90518b48a00
                         {disp8} jmp      .Lbl_addr_0x006db622                          // 0x006db602    eb1e
                         {disp32} fld     dword ptr [rdata_bytes + 0x19c50]             // 0x006db604    d905502c8c00
                         {disp8} jmp      .Lbl_addr_0x006db622                          // 0x006db60a    eb16
                         {disp32} fld     dword ptr [rdata_bytes + 0x2478]              // 0x006db60c    d90578b48a00
                         {disp8} jmp      .Lbl_addr_0x006db622                          // 0x006db612    eb0e
                         {disp32} fld     dword ptr [__real@4@3fff8000000000000000]                   // 0x006db614    d90590a38a00
                         {disp8} jmp      .Lbl_addr_0x006db622                          // 0x006db61a    eb06
.Lbl_addr_0x006db61c:    {disp32} fld     dword ptr [__real@4@00000000000000000000]                   // 0x006db61c    d90598a38a00
.Lbl_addr_0x006db622:    {disp8} fld      dword ptr [esp + 0x18]                        // 0x006db622    d9442418
                         ...
                         {disp8} ja       .Lbl_addr_0x006db688                          // 0x006db65f    7727
                         jmp              dword ptr [eax*4 + 0x6db858]                  // 0x006db661    ff248558b86d00
                         {disp32} fld     dword ptr [rdata_bytes + 0x2418]              // 0x006db668    d90518b48a00
                         {disp8} jmp      .Lbl_addr_0x006db68e                          // 0x006db66e    eb1e
                         {disp32} fld     dword ptr [rdata_bytes + 0x19c50]             // 0x006db670    d905502c8c00
                         {disp8} jmp      .Lbl_addr_0x006db68e                          // 0x006db676    eb16
                         {disp32} fld     dword ptr [rdata_bytes + 0x2478]              // 0x006db678    d90578b48a00
                         {disp8} jmp      .Lbl_addr_0x006db68e                          // 0x006db67e    eb0e
                         {disp32} fld     dword ptr [__real@4@3fff8000000000000000]                   // 0x006db680    d90590a38a00
                         {disp8} jmp      .Lbl_addr_0x006db68e                          // 0x006db686    eb06
.Lbl_addr_0x006db688:    {disp32} fld     dword ptr [__real@4@00000000000000000000]                   // 0x006db688    d90598a38a00
.Lbl_addr_0x006db68e:    {disp8} fadd     dword ptr [esp + 0x18]                        // 0x006db68e    d8442418
                         ...
                         {disp8} ja       .Lbl_addr_0x006db6f0                          // 0x006db6c7    7727
                         jmp              dword ptr [eax*4 + 0x6db86c]                  // 0x006db6c9    ff24856cb86d00
                         {disp32} fld     dword ptr [rdata_bytes + 0x2418]              // 0x006db6d0    d90518b48a00
                         {disp8} jmp      .Lbl_addr_0x006db6f6                          // 0x006db6d6    eb1e
                         {disp32} fld     dword ptr [rdata_bytes + 0x19c50]             // 0x006db6d8    d905502c8c00
                         {disp8} jmp      .Lbl_addr_0x006db6f6                          // 0x006db6de    eb16
                         {disp32} fld     dword ptr [rdata_bytes + 0x2478]              // 0x006db6e0    d90578b48a00
                         {disp8} jmp      .Lbl_addr_0x006db6f6                          // 0x006db6e6    eb0e
                         {disp32} fld     dword ptr [__real@4@3fff8000000000000000]                   // 0x006db6e8    d90590a38a00
                         {disp8} jmp      .Lbl_addr_0x006db6f6                          // 0x006db6ee    eb06
.Lbl_addr_0x006db6f0:    {disp32} fld     dword ptr [__real@4@00000000000000000000]                   // 0x006db6f0    d90598a38a00
.Lbl_addr_0x006db6f6:    {disp8} fadd     dword ptr [esp + 0x18]                        // 0x006db6f6    d8442418
                         ...
                         {disp8} ja       .Lbl_addr_0x006db758                          // 0x006db72f    7727
                         jmp              dword ptr [eax*4 + 0x6db880]                  // 0x006db731    ff248580b86d00
                         {disp32} fld     dword ptr [rdata_bytes + 0x2418]              // 0x006db738    d90518b48a00
                         {disp8} jmp      .Lbl_addr_0x006db75e                          // 0x006db73e    eb1e
                         {disp32} fld     dword ptr [rdata_bytes + 0x19c50]             // 0x006db740    d905502c8c00
                         {disp8} jmp      .Lbl_addr_0x006db75e                          // 0x006db746    eb16
                         {disp32} fld     dword ptr [rdata_bytes + 0x2478]              // 0x006db748    d90578b48a00
                         {disp8} jmp      .Lbl_addr_0x006db75e                          // 0x006db74e    eb0e
                         {disp32} fld     dword ptr [__real@4@3fff8000000000000000]                   // 0x006db750    d90590a38a00
                         {disp8} jmp      .Lbl_addr_0x006db75e                          // 0x006db756    eb06
.Lbl_addr_0x006db758:    {disp32} fld     dword ptr [__real@4@00000000000000000000]                   // 0x006db758    d90598a38a00
.Lbl_addr_0x006db75e:    {disp8} fadd     dword ptr [esp + 0x18]                        // 0x006db75e    d8442418
...
.Lbl_addr_0x006db78f:    test             edi, edi                                      // 0x006db78f    85ff
                         {disp8} je       .Lbl_addr_0x006db7a9                          // 0x006db791    7416
                         ...
                         {disp8} jmp      .Lbl_addr_0x006db7b5                          // 0x006db7a7    eb0c
.Lbl_addr_0x006db7a9:    {disp32} mov     ecx, dword ptr [esi + 0x000003bc]             // 0x006db7a9    8b8ebc030000
                         {disp8} mov      eax, dword ptr [ecx + 0x40]                   // 0x006db7af    8b4140
                         or               dword ptr [eax + 8], ebx                      // 0x006db7b2    095808
.Lbl_addr_0x006db7b5:    inc              edi                                           // 0x006db7b5    47
                         cmp              edi, 0x04                                     // 0x006db7b6    83ff04
                         {disp8} jl       .Lbl_addr_0x006db78f                          // 0x006db7b9    7cd4
