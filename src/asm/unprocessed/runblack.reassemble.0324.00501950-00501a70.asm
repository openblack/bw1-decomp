...
// Snippet: asm, [0x00501950, 0x00501a4d)
                         ...
                         call              ?GetAltitude@LH3DIsland@@SIMABULH3DMapCoords@@@Z                  // 0x0050199e    e8ed163000
                         ...
                         {disp8} je        .Lbl_addr_0x00501a45                    // 0x005019e5    745e
                         ...
                         {disp8} ja        .Lbl_addr_0x00501a3a                    // 0x00501a26    7712
