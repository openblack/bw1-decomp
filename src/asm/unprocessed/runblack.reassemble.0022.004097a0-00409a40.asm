...
.Lbl_addr_0x004097f4:    {disp8} fild       dword ptr [esp + 0x14]                   // 0x004097f4    db442414
                         ...
                         {disp8} jne        .Lbl_addr_0x00409831                     // 0x00409825    750a
                         dec                ebp                                      // 0x00409827    4d
                         cmp                ebp, 0x0a                                // 0x00409828    83fd0a
                         {disp8} mov        dword ptr [esp + 0x14], ebp              // 0x0040982b    896c2414
                         {disp8} jg         .Lbl_addr_0x004097f4                     // 0x0040982f    7fc3
.Lbl_addr_0x00409831:    test               bl, bl                                   // 0x00409831    84db
                         {disp8} je         .Lbl_addr_0x00409843                     // 0x00409833    740e
                         mov                eax, 0x00c4cce4                          // 0x00409835    b8e4ccc400
                         {disp8} jmp        .Lbl_addr_0x00409855                     // 0x0040983a    eb19
.Lbl_addr_0x0040983c:    mov                ebp, 0x0000000a                          // 0x0040983c    bd0a000000
                         {disp8} jmp        .Lbl_addr_0x00409831                     // 0x00409841    ebee
.Lbl_addr_0x00409843:    {disp8} mov        al, byte ptr [esp + 0x18]                // 0x00409843    8a442418
                         test               al, al                                   // 0x00409847    84c0
                         mov                eax, 0x00c4ccf8                          // 0x00409849    b8f8ccc400
                         {disp8} jne        .Lbl_addr_0x00409855                     // 0x0040984e    7505
                         mov                eax, 0x00c4ccd8                          // 0x00409850    b8d8ccc400
.Lbl_addr_0x00409855:    {disp8} mov        edi, dword ptr [esi + 0x10]              // 0x00409855    8b7e10
...
_KeyDown__11SetupButtonFii:
                         ...
                         {disp8} je         .Lbl_addr_0x00409938                     // 0x00409928    740e
...
??_GSetupButton@@UAEPAXI@Z:
                         ...
                         {disp8} je         .Lbl_addr_0x00409958                     // 0x0040994d    7409
                         push               esi                                      // 0x0040994f    56
                         call               ??3@YAXPAX@Z                             // 0x00409950    e843553a00
                         add                esp, 0x04                                // 0x00409955    83c404
.Lbl_addr_0x00409958:    mov.s              eax, esi                                 // 0x00409958    8bc6
...
_KeyDown__11SetupSliderFii:
                         ...
                         {disp8} ja         .Lbl_addr_0x004099b1                     // 0x0040996e    7741
                         ...
                         {disp8} jmp        .Lbl_addr_0x004099af                     // 0x00409981    eb2c
                         {disp32} mov       dword ptr [ecx + 0x0000023c], 0x3f800000 // 0x00409983    c7813c0200000000803f
                         {disp8} jmp        .Lbl_addr_0x004099af                     // 0x0040998d    eb20
                         {disp32} fld       dword ptr [ecx + 0x0000023c]             // 0x0040998f    d9813c020000
                         {disp32} fsub      dword ptr [__real@3dcccccd]              // 0x00409995    d8252cb28a00
                         {disp8} jmp        .Lbl_addr_0x004099a9                     // 0x0040999b    eb0c
                         {disp32} fld       dword ptr [ecx + 0x0000023c]             // 0x0040999d    d9813c020000
                         {disp32} fadd      dword ptr [__real@3dcccccd]              // 0x004099a3    d8052cb28a00
.Lbl_addr_0x004099a9:    {disp32} fstp      dword ptr [ecx + 0x0000023c]             // 0x004099a9    d9993c020000
.Lbl_addr_0x004099af:    mov                dl, 0x01                                 // 0x004099af    b201
.Lbl_addr_0x004099b1:    {disp32} fld       dword ptr [ecx + 0x0000023c]             // 0x004099b1    d9813c020000
                         {disp32} fcomp     dword ptr [__real@4@00000000000000000000]              // 0x004099b7    d81d98a38a00
                         fnstsw             ax                                       // 0x004099bd    dfe0
                         test               ah, 0x41                                 // 0x004099bf    f6c441
                         {disp8} jne        .Lbl_addr_0x004099e7                     // 0x004099c2    7523
                         ...
                         {disp8} je         .Lbl_addr_0x004099df                     // 0x004099d5    7408
                         {disp32} fld       dword ptr [ecx + 0x0000023c]             // 0x004099d7    d9813c020000
                         {disp8} jmp        .Lbl_addr_0x004099ed                     // 0x004099dd    eb0e
.Lbl_addr_0x004099df:    {disp32} fld       dword ptr [rdata_bytes + 0x1390]         // 0x004099df    d90590a38a00
                         {disp8} jmp        .Lbl_addr_0x004099ed                     // 0x004099e5    eb06
.Lbl_addr_0x004099e7:    {disp32} fld       dword ptr [__real@4@00000000000000000000]              // 0x004099e7    d90598a38a00
.Lbl_addr_0x004099ed:    test               dl, dl                                   // 0x004099ed    84d2
                         {disp32} fst       dword ptr [ecx + 0x0000023c]             // 0x004099ef    d9913c020000
                         {disp32} fstp      dword ptr [ecx + 0x00000240]             // 0x004099f5    d99940020000
                         {disp8} je         .Lbl_addr_0x00409a17                     // 0x004099fb    741a
                         ...
                         {disp8} je         .Lbl_addr_0x00409a17                     // 0x00409a0b    740a
...
.Lbl_addr_0x00409a17:    ret                0x0008                                   // 0x00409a17    c20800
