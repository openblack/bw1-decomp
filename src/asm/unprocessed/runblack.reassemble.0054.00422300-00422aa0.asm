...
// Snippet: asm, [0x00422300, 0x00422a7e)
                         ...
                         {disp32} mov      edx, dword ptr [data_bytes + 0x4d9e34]        // 0x0042231c    8b1534fee900
...
_jmp_addr_0x0042232a:    {disp8} mov       ecx, dword ptr [esi + 0x40]                   // 0x0042232a    8b4e40
                         ...
                         {disp32} fmul     dword ptr [rdata_bytes + 0x13a4]              // 0x00422366    d80da4a38a00
                         ...
                         {disp32} fmul     dword ptr [rdata_bytes + 0x13a4]              // 0x00422376    d80da4a38a00
                         ...
                         call              _jmp_addr_0x00803340                          // 0x00422387    e8b40f3e00
                         ...
                         call              _jmp_addr_0x00423140                          // 0x004223a4    e8970d0000
                         ...
                         call              _jmp_addr_0x0052ea50                          // 0x004223df    e86cc61000
...
_jmp_addr_0x00422486:    test              edi, edi                                      // 0x00422486    85ff
                         {disp32} fld      dword ptr [rdata_bytes + 0x1398]              // 0x00422488    d90598a38a00
...
_jmp_addr_0x004224a0:    {disp8} mov       eax, dword ptr [esi + 0x40]                   // 0x004224a0    8b4640
                         ...
                         call              _jmp_addr_0x0063abb0                          // 0x004224fc    e8af862100
                         {disp32} mov      dword ptr [esi + edi * 0x4 + 0x00000080], eax // 0x00422501    8984be80000000
                         {disp32} mov      edx, dword ptr [data_bytes + 0x4d9e34]        // 0x00422508    8b1534fee900
...
_jmp_addr_0x004225ca:    {disp8} mov       edx, dword ptr [edi + 0x04]                   // 0x004225ca    8b5704
                         ...
                         call              _jmp_addr_0x007aee98                          // 0x004225d2    e8c1c83800
...
_jmp_addr_0x00422687:    mov               ecx, dword ptr [eax]                          // 0x00422687    8b08
                         ...
                         {disp32} fmul     dword ptr [rdata_bytes + 0x2228]              // 0x004226b8    d80d28b28a00
                         call              _jmp_addr_0x007a1400                          // 0x004226be    e83ded3700
                         {disp32} fmul     dword ptr [rdata_bytes + 0x2228]              // 0x004226c3    d80d28b28a00
                         ...
                         call              _jmp_addr_0x00719610                          // 0x00422724    e8e76e2f00
...
_jmp_addr_0x0042289f:    cmp               dword ptr [ebp + 0x00], 0x00                  // 0x0042289f    837d0000
                         ...
                         {disp32} fsub     dword ptr [rdata_bytes + 0x2244]              // 0x0042293c    d82544b28a00
...
_jmp_addr_0x0042297e:    {disp8} mov       ecx, dword ptr [ebp + 0x00]                   // 0x0042297e    8b4d00
                         ...
                         {disp32} fsub     dword ptr [rdata_bytes + 0x2244]              // 0x004229c8    d82544b28a00
                         ...
                         call              _jmp_addr_0x00555850                          // 0x00422a3a    e8112e1300
