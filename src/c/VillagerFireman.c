...
bool32_t __fastcall DecideHowToPutOutFire__8VillagerFP10FireEffect(struct Villager* this, const void* edx, struct FireEffect* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x0075a433");                          // 0x0075a403    742e
    ...
    asm("{disp8} je         LAB__addr_0x0075a433");                          // 0x0075a414    741d
...
float __stdcall GetViaPoint__FRC9MapCoordsRC9MapCoordsRC9MapCoordsfR9MapCoordsfPbPbf(const struct MapCoords* param_1, const struct MapCoords* param_2, const struct MapCoords* param_3, float param_4, struct MapCoords* param_5, float param_6, bool* param_7, bool* param_8, float param_9)
{
    ...
    asm("{disp8} je         LAB__addr_0x0075a46a");                          // 0x0075a465    7403
    asm("mov                byte ptr [eax], 0x00");                          // 0x0075a467    c60000
    asm("LAB__addr_0x0075a46a:");
    ...
    asm("{disp8} je         LAB__addr_0x0075a47a");                          // 0x0075a474    7404
    asm("{disp8} mov        byte ptr [ebp + 0x00], 0x00");                   // 0x0075a476    c6450000
    asm("LAB__addr_0x0075a47a:");
    ...
    asm("{disp8} je         LAB__addr_0x0075a4e0");                          // 0x0075a4bf    741f
    ...
    asm("{disp32} jne       LAB__addr_0x0075a74d");                          // 0x0075a558    0f85ef010000
    ...
    asm("{disp8} je         LAB__addr_0x0075a599");                          // 0x0075a585    7412
    ...
    asm("{disp8} je         LAB__addr_0x0075a6c6");                          // 0x0075a64d    7477
    asm("{disp8} jmp        LAB__addr_0x0075a6c2");                          // 0x0075a64f    eb71
    asm("LAB__addr_0x0075a651:");
    ...
    asm("{disp8} je         LAB__addr_0x0075a6c6");                          // 0x0075a6c0    7404
    asm("LAB__addr_0x0075a6c2:");
    asm("{disp8} mov        byte ptr [ebp + 0x00], 0x01");                   // 0x0075a6c2    c6450001
    asm("LAB__addr_0x0075a6c6:");
    ...
    asm("{disp8} je         LAB__addr_0x0075a714");                          // 0x0075a6ff    7413
    asm("{disp8} mov        eax, dword ptr [esp + 0x44]");                   // 0x0075a701    8b442444
    asm("test               eax, eax");                                      // 0x0075a705    85c0
    asm("{disp8} je         LAB__addr_0x0075a755");                          // 0x0075a707    744c
    ...
    asm("{disp8} jne        LAB__addr_0x0075a755");                          // 0x0075a74b    7508
...
bool32_t __fastcall SetupMoveAroundFire__8VillagerFRC9MapCoords15VILLAGER_STATES(struct Villager* this, const void* edx, const struct MapCoords* param_1, enum VILLAGER_STATES param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0075a7d7");                          // 0x0075a783    7552
    ...
    asm("{disp8} jne        LAB__addr_0x0075a7ce");                          // 0x0075a7ab    7521
    ...
    asm("{disp8} je         LAB__addr_0x0075a7ce");                          // 0x0075a7b6    7416
...
uint32_t __fastcall MoveAroundFire__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0075a839");                          // 0x0075a811    7426
    ...
    asm("{disp32} je        LAB__addr_0x0075aa79");                          // 0x0075a845    0f842e020000
    asm("mov.s              ecx, ebp");                                      // 0x0075a84b    8bcd
    asm("call               _jmp_addr_0x007305f0");                          // 0x0075a84d    e89e5dfdff
    asm("test               eax, eax");                                      // 0x0075a852    85c0
    asm("{disp32} je        LAB__addr_0x0075aa79");                          // 0x0075a854    0f841f020000
    ...
    asm("{disp8} jne        LAB__addr_0x0075a918");                          // 0x0075a8f3    7523
    ...
    asm("{disp8} jmp        LAB__addr_0x0075a91a");                          // 0x0075a916    eb02
    asm("LAB__addr_0x0075a918:");
    asm("fstp               st(0)");                                         // 0x0075a918    ddd8
    asm("LAB__addr_0x0075a91a:");
    asm("cmp                byte ptr [esp + 0x11], bl");                     // 0x0075a91a    385c2411
    asm("{disp8} je         LAB__addr_0x0075a966");                          // 0x0075a91e    7446
    asm("cmp                byte ptr [esp + 0x12], bl");                     // 0x0075a920    385c2412
    asm("{disp8} je         LAB__addr_0x0075a966");                          // 0x0075a924    7440
    ...
    asm("{disp32} je        LAB__addr_0x0075aa33");                          // 0x0075a971    0f84bc000000
    asm("LAB__addr_0x0075a977:");
    ...
    asm("{disp8} je         LAB__addr_0x0075a9f1");                          // 0x0075a9d6    7419
    asm("cmp                byte ptr [esp + 0x11], bl");                     // 0x0075a9d8    385c2411
    asm("{disp8} je         LAB__addr_0x0075a9e4");                          // 0x0075a9dc    7406
    asm("cmp                byte ptr [esp + 0x12], bl");                     // 0x0075a9de    385c2412
    asm("{disp8} jne        LAB__addr_0x0075a9f1");                          // 0x0075a9e2    750d
    asm("LAB__addr_0x0075a9e4:");
    ...
    asm("{disp8} jmp        LAB__addr_0x0075aa2b");                          // 0x0075a9ef    eb3a
    asm("LAB__addr_0x0075a9f1:");
    ...
    asm("{disp8} jae        LAB__addr_0x0075aa79");                          // 0x0075aa29    734e
    asm("LAB__addr_0x0075aa2b:");
    asm("cmp.s              edi, ebx");                                      // 0x0075aa2b    3bfb
    asm("{disp32} jne       LAB__addr_0x0075a977");                          // 0x0075aa2d    0f8544ffffff
    asm("LAB__addr_0x0075aa33:");
    asm("cmp                byte ptr [esp + 0x13], bl");                     // 0x0075aa33    385c2413
    asm("{disp8} jne        LAB__addr_0x0075aa47");                          // 0x0075aa37    750e
    ...
    asm("{disp8} je         LAB__addr_0x0075aa79");                          // 0x0075aa5a    741d
...
bool32_t __fastcall GetFireFightingPos__8VillagerFP10FireEffectP9MapCoords(struct Villager* this, const void* edx, struct FireEffect* param_1, struct MapCoords* param_2)
{
    ...
    asm("call               ??HMapCoords@@QBE?AU0@ABU0@@Z");            // 0x0075ab6a    e8b1a9eaff
...
bool32_t __fastcall EnterPutOutFire__8VillagerFUcUc(struct Villager* this, const void* edx, unsigned char param_1, unsigned char param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0075ae41");                          // 0x0075ade0    755f
    asm("{disp32} mov       eax, dword ptr [esi + 0x00000114]");             // 0x0075ade2    8b8614010000
    asm("test               eax, eax");                                      // 0x0075ade8    85c0
    asm("{disp8} je         LAB__addr_0x0075ae55");                          // 0x0075adea    7469
    ...
    asm("{disp8} je         LAB__addr_0x0075ae4b");                          // 0x0075adf6    7453
    ...
    asm("{disp8} je         LAB__addr_0x0075ae35");                          // 0x0075ae28    740b
    asm("LAB__addr_0x0075ae2a:");
    asm("cmp                dword ptr [eax + 0x04], esi");                   // 0x0075ae2a    397004
    asm("{disp8} je         LAB__addr_0x0075ae75");                          // 0x0075ae2d    7446
    asm("mov                eax, dword ptr [eax]");                          // 0x0075ae2f    8b00
    asm("test               eax, eax");                                      // 0x0075ae31    85c0
    asm("{disp8} jne        LAB__addr_0x0075ae2a");                          // 0x0075ae33    75f5
    asm("LAB__addr_0x0075ae35:");
    ...
    asm("{disp8} je         LAB__addr_0x0075ae75");                          // 0x0075ae69    740a
...
bool32_t __fastcall ExitPutOutFire__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0075af14");                          // 0x0075ae9d    7575
    asm("{disp32} mov       ecx, dword ptr [esi + 0x00000114]");             // 0x0075ae9f    8b8e14010000
    asm("test               ecx, ecx");                                      // 0x0075aea5    85c9
    asm("{disp8} je         LAB__addr_0x0075aee0");                          // 0x0075aea7    7437
    ...
    asm("{disp8} je         LAB__addr_0x0075aec0");                          // 0x0075aeb3    740b
    asm("LAB__addr_0x0075aeb5:");
    asm("cmp                dword ptr [eax + 0x04], esi");                   // 0x0075aeb5    397004
    asm("{disp8} je         LAB__addr_0x0075aed4");                          // 0x0075aeb8    741a
    asm("mov                eax, dword ptr [eax]");                          // 0x0075aeba    8b00
    asm("test               eax, eax");                                      // 0x0075aebc    85c0
    asm("{disp8} jne        LAB__addr_0x0075aeb5");                          // 0x0075aebe    75f5
    asm("LAB__addr_0x0075aec0:");
    ...
    asm("{disp8} je         LAB__addr_0x0075af14");                          // 0x0075aef3    741f
    asm("{disp32} mov       edx, dword ptr [eax + 0x00000df4]");             // 0x0075aef5    8b90f40d0000
    asm("test               edx, edx");                                      // 0x0075aefb    85d2
    asm("{disp8} je         LAB__addr_0x0075af14");                          // 0x0075aefd    7415
    asm("LAB__addr_0x0075aeff:");
    asm("cmp                dword ptr [edx + 0x04], esi");                   // 0x0075aeff    397204
    asm("{disp8} je         LAB__addr_0x0075af0c");                          // 0x0075af02    7408
    asm("mov                edx, dword ptr [edx]");                          // 0x0075af04    8b12
    asm("test               edx, edx");                                      // 0x0075af06    85d2
    asm("{disp8} jne        LAB__addr_0x0075aeff");                          // 0x0075af08    75f5
    asm("{disp8} jmp        LAB__addr_0x0075af14");                          // 0x0075af0a    eb08
    asm("LAB__addr_0x0075af0c:");
...
bool32_t __fastcall EnterOnFire__8VillagerFUcUc(struct Villager* this, const void* edx, unsigned char param_1, unsigned char param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x0075af63");                          // 0x0075af56    740b
    asm("LAB__addr_0x0075af58:");
    asm("cmp                dword ptr [eax + 0x04], esi");                   // 0x0075af58    397004
    asm("{disp8} je         LAB__addr_0x0075af78");                          // 0x0075af5b    741b
    asm("mov                eax, dword ptr [eax]");                          // 0x0075af5d    8b00
    asm("test               eax, eax");                                      // 0x0075af5f    85c0
    asm("{disp8} jne        LAB__addr_0x0075af58");                          // 0x0075af61    75f5
    asm("LAB__addr_0x0075af63:");
...
bool32_t __fastcall ExitOnFire__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x0075afc9");                          // 0x0075af8b    743c
    ...
    asm("{disp8} je         LAB__addr_0x0075afbf");                          // 0x0075af97    7426
    asm("LAB__addr_0x0075af99:");
    asm("cmp                dword ptr [eax + 0x04], esi");                   // 0x0075af99    397004
    asm("{disp8} je         LAB__addr_0x0075afb3");                          // 0x0075af9c    7415
    asm("mov                eax, dword ptr [eax]");                          // 0x0075af9e    8b00
    asm("test               eax, eax");                                      // 0x0075afa0    85c0
    asm("{disp8} jne        LAB__addr_0x0075af99");                          // 0x0075afa2    75f5
...
bool32_t __fastcall StopFireFighting__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0075b168");                          // 0x0075b02c    0f8436010000
    ...
    asm("{disp32} jne       LAB__addr_0x0075b143");                          // 0x0075b03c    0f8501010000
    ...
    asm("{disp8} jne        LAB__addr_0x0075b0cf");                          // 0x0075b0c0    750d
    ...
    asm("{disp8} jmp        LAB__addr_0x0075b0ef");                          // 0x0075b0cd    eb20
    asm("LAB__addr_0x0075b0cf:");
    ...
    asm("{disp8} jne        LAB__addr_0x0075b168");                          // 0x0075b113    7553
    asm("test               eax, eax");                                      // 0x0075b115    85c0
    asm("{disp8} je         LAB__addr_0x0075b125");                          // 0x0075b117    740c
    asm("test               ecx, ecx");                                      // 0x0075b119    85c9
    asm("{disp8} jne        LAB__addr_0x0075b168");                          // 0x0075b11b    754b
    asm("test               edx, edx");                                      // 0x0075b11d    85d2
    asm("{disp8} jne        LAB__addr_0x0075b168");                          // 0x0075b11f    7547
    asm("test               edi, edi");                                      // 0x0075b121    85ff
    asm("{disp8} jne        LAB__addr_0x0075b168");                          // 0x0075b123    7543
    asm("LAB__addr_0x0075b125:");
    asm("{disp32} mov       al, byte ptr [esi + 0x0000008e]");               // 0x0075b125    8a868e000000
    asm("test               al, al");                                        // 0x0075b12b    84c0
    asm("{disp8} jne        LAB__addr_0x0075b168");                          // 0x0075b12d    7539
...
bool32_t __fastcall SetupOnFire__8VillagerFP10FireEffect(struct Villager* this, const void* edx, struct FireEffect* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x0075b1d8");                          // 0x0075b18e    7448
...
bool32_t __fastcall OnFire__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0075b1fb");                          // 0x0075b1ec    750d
    ...
    asm("{disp8} je         LAB__addr_0x0075b26c");                          // 0x0075b242    7428
    ...
    asm("{disp8} jmp        LAB__addr_0x0075b2e4");                          // 0x0075b26a    eb78
    asm("LAB__addr_0x0075b26c:");
    ...
    asm("{disp8} je         LAB__addr_0x0075b2a6");                          // 0x0075b297    740d
    ...
    asm("{disp32} jmp       LAB__addr_0x0075b392");                          // 0x0075b308    e985000000
    asm("LAB__addr_0x0075b30d:");
    asm("call               _jmp_addr_0x00730360");                          // 0x0075b30d    e84e50fdff
    asm("test               eax, eax");                                      // 0x0075b312    85c0
    asm("{disp8} jne        LAB__addr_0x0075b323");                          // 0x0075b314    750d
    ...
    asm("call               ??HMapCoords@@QBE?AU0@ABU0@@Z");            // 0x0075b379    e8a2a1eaff
    ...
    asm("{disp8} jne        LAB__addr_0x0075b3be");                          // 0x0075b3ab    7511
