...
bool32_t __fastcall VillagerBecomesFarmer__8VillagerFP5Field(struct Villager* this, const void* edx, struct Field* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x00759c33");                          // 0x00759c23    740e
    asm("LAB__addr_0x00759c25:");
...
bool32_t __fastcall SetFarmerGotoField__8VillagerFP5Fieldi(struct Villager* this, const void* edx, struct Field* param_1, int param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x00759cc8");                          // 0x00759c89    743d
    asm("dec                eax");                                           // 0x00759c8b    48
    asm("{disp8} je         LAB__addr_0x00759c98");                          // 0x00759c8c    740a
    ...
    asm("{disp8} jmp        LAB__addr_0x00759cf6");                          // 0x00759cc6    eb2e
    asm("LAB__addr_0x00759cc8:");
...
bool32_t __fastcall FarmerArrivesAtFarm__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x00759dd6");                          // 0x00759d4d    0f8483000000
    asm("dec                eax");                                           // 0x00759d53    48
    asm("{disp8} jne        LAB__addr_0x00759dbc");                          // 0x00759d54    7566
    ...
    asm("{disp8} je         LAB__addr_0x00759dbc");                          // 0x00759d69    7451
    ...
    asm("{disp32} je        LAB__addr_0x00759e2a");                          // 0x00759d80    0f84a4000000
    ...
    asm("{disp8} je         LAB__addr_0x00759e2a");                          // 0x00759df2    7436
...
bool32_t __fastcall FarmerDigsUpCrop__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jbe        LAB__addr_0x00759ea8");                          // 0x00759e6a    763c
    ...
    asm("{disp8} je         LAB__addr_0x00759ea8");                          // 0x00759e99    740d
...
bool32_t __fastcall FarmerPlantsCrop__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00759f0e");                          // 0x00759ed4    7438
    ...
    asm("{disp8} je         LAB__addr_0x00759ef8");                          // 0x00759ee3    7413
...
bool32_t __fastcall CheckSatisfyFoodDesire__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jmp        LAB__addr_0x00759f54");                          // 0x00759f4e    eb04
    asm("LAB__addr_0x00759f50:");
    asm("{disp8} mov        ecx, dword ptr [esp + 0x10]");                   // 0x00759f50    8b4c2410
    asm("LAB__addr_0x00759f54:");
    ...
    asm("{disp8} je         LAB__addr_0x00759f8e");                          // 0x00759f64    7428
    asm("dec                eax");                                           // 0x00759f66    48
    asm("{disp8} je         LAB__addr_0x00759f7d");                          // 0x00759f67    7414
    asm("dec                eax");                                           // 0x00759f69    48
    asm("{disp8} jne        LAB__addr_0x00759f9d");                          // 0x00759f6a    7531
    ...
    asm("{disp8} jmp        LAB__addr_0x00759f9d");                          // 0x00759f7b    eb20
    asm("LAB__addr_0x00759f7d:");
    ...
    asm("{disp8} jmp        LAB__addr_0x00759f9d");                          // 0x00759f8c    eb0f
    asm("LAB__addr_0x00759f8e:");
    ...
    asm("{disp8} je         LAB__addr_0x00759fba");                          // 0x00759faf    7409
    ...
    asm("{disp8} jmp        LAB__addr_0x00759fbc");                          // 0x00759fb8    eb02
    asm("LAB__addr_0x00759fba:");
    asm("xor.s              esi, esi");                                      // 0x00759fba    33f6
    asm("LAB__addr_0x00759fbc:");
    asm("{disp8} mov        ecx, dword ptr [esp + 0x18]");                   // 0x00759fbc    8b4c2418
    asm("test               ecx, ecx");                                      // 0x00759fc0    85c9
    asm("{disp8} je         LAB__addr_0x00759ff4");                          // 0x00759fc2    7430
    asm("LAB__addr_0x00759fc4:");
    ...
    asm("{disp8} je         LAB__addr_0x00759fdc");                          // 0x00759fcf    740b
    asm("mov.s              edx, ecx");                                      // 0x00759fd1    8bd1
    asm("{disp8} mov        ecx, dword ptr [ecx + 0x04]");                   // 0x00759fd3    8b4904
    asm("test               ecx, ecx");                                      // 0x00759fd6    85c9
    asm("{disp8} je         LAB__addr_0x00759ff0");                          // 0x00759fd8    7416
    asm("{disp8} jmp        LAB__addr_0x00759fc4");                          // 0x00759fda    ebe8
    asm("LAB__addr_0x00759fdc:");
    asm("test               edx, edx");                                      // 0x00759fdc    85d2
    asm("{disp8} mov        dword ptr [esi + 0x04], ecx");                   // 0x00759fde    894e04
    asm("{disp8} jne        LAB__addr_0x00759fe9");                          // 0x00759fe1    7506
    asm("{disp8} mov        dword ptr [esp + 0x18], esi");                   // 0x00759fe3    89742418
    asm("{disp8} jmp        LAB__addr_0x00759fec");                          // 0x00759fe7    eb03
    asm("LAB__addr_0x00759fe9:");
    asm("{disp8} mov        dword ptr [edx + 0x04], esi");                   // 0x00759fe9    897204
    asm("LAB__addr_0x00759fec:");
    asm("test               ecx, ecx");                                      // 0x00759fec    85c9
    asm("{disp8} jne        LAB__addr_0x00759ffd");                          // 0x00759fee    750d
    asm("LAB__addr_0x00759ff0:");
    asm("test               edx, edx");                                      // 0x00759ff0    85d2
    asm("{disp8} jne        LAB__addr_0x00759ffa");                          // 0x00759ff2    7506
    asm("LAB__addr_0x00759ff4:");
    asm("{disp8} mov        dword ptr [esp + 0x18], esi");                   // 0x00759ff4    89742418
    asm("{disp8} jmp        LAB__addr_0x00759ffd");                          // 0x00759ff8    eb03
    asm("LAB__addr_0x00759ffa:");
    asm("{disp8} mov        dword ptr [edx + 0x04], esi");                   // 0x00759ffa    897204
    asm("LAB__addr_0x00759ffd:");
    ...
    asm("{disp32} jb        LAB__addr_0x00759f50");                          // 0x0075a00a    0f8240ffffff
    ...
    asm("{disp8} jne        LAB__addr_0x0075a0c1");                          // 0x0075a090    752f
    ...
    asm("{disp8} je         LAB__addr_0x0075a0b7");                          // 0x0075a0a1    7414
    asm("LAB__addr_0x0075a0a3:");
    ...
    asm("{disp8} jne        LAB__addr_0x0075a0a3");                          // 0x0075a0b5    75ec
    asm("LAB__addr_0x0075a0b7:");
    ...
    asm("LAB__addr_0x0075a0c1:");
    asm("{disp8} mov        eax, dword ptr [edx + 0x04]");                   // 0x0075a0c1    8b4204
    asm("test               eax, eax");                                      // 0x0075a0c4    85c0
    asm("{disp32} je        LAB__addr_0x0075a1f4");                          // 0x0075a0c6    0f8428010000
    asm("{disp8} mov        edx, dword ptr [edx + 0x08]");                   // 0x0075a0cc    8b5208
    asm("sub                edx, 0x00");                                     // 0x0075a0cf    83ea00
    asm("{disp32} je        LAB__addr_0x0075a188");                          // 0x0075a0d2    0f84b0000000
    asm("dec                edx");                                           // 0x0075a0d8    4a
    asm("{disp8} je         LAB__addr_0x0075a14e");                          // 0x0075a0d9    7473
    asm("dec                edx");                                           // 0x0075a0db    4a
    asm("{disp32} jne       LAB__addr_0x0075a1f4");                          // 0x0075a0dc    0f8512010000
    ...
    asm("{disp32} jne       LAB__addr_0x0075a1f0");                          // 0x0075a0ed    0f85fd000000
    asm("{disp8} mov        ecx, dword ptr [esp + 0x18]");                   // 0x0075a0f3    8b4c2418
    asm("test               ecx, ecx");                                      // 0x0075a0f7    85c9
    asm("{disp8} je         LAB__addr_0x0075a141");                          // 0x0075a0f9    7446
    asm("LAB__addr_0x0075a0fb:");
    ...
    asm("LAB__addr_0x0075a13d:");
    asm("test               ecx, ecx");                                      // 0x0075a13d    85c9
    asm("{disp8} jne        LAB__addr_0x0075a0fb");                          // 0x0075a13f    75ba
    asm("LAB__addr_0x0075a141:");
    ...
    asm("{disp32} jne       LAB__addr_0x0075a1f0");                          // 0x0075a159    0f8591000000
    asm("{disp8} mov        eax, dword ptr [esp + 0x18]");                   // 0x0075a15f    8b442418
    asm("test               eax, eax");                                      // 0x0075a163    85c0
    asm("{disp8} je         LAB__addr_0x0075a17b");                          // 0x0075a165    7414
    asm("LAB__addr_0x0075a167:");
    ...
    asm("{disp8} jne        LAB__addr_0x0075a167");                          // 0x0075a179    75ec
    asm("LAB__addr_0x0075a17b:");
    ...
    asm("{disp8} jne        LAB__addr_0x0075a1f0");                          // 0x0075a193    755b
    asm("{disp8} mov        ecx, dword ptr [esp + 0x18]");                   // 0x0075a195    8b4c2418
    asm("test               ecx, ecx");                                      // 0x0075a199    85c9
    asm("{disp8} je         LAB__addr_0x0075a1e3");                          // 0x0075a19b    7446
    asm("LAB__addr_0x0075a19d:");
    ...
    asm("LAB__addr_0x0075a1df:");
    asm("test               ecx, ecx");                                      // 0x0075a1df    85c9
    asm("{disp8} jne        LAB__addr_0x0075a19d");                          // 0x0075a1e1    75ba
    asm("LAB__addr_0x0075a1e3:");
    ...
    asm("LAB__addr_0x0075a1f0:");
    asm("{disp8} mov        ecx, dword ptr [esp + 0x18]");                   // 0x0075a1f0    8b4c2418
    asm("LAB__addr_0x0075a1f4:");
    asm("test               ecx, ecx");                                      // 0x0075a1f4    85c9
    asm("{disp8} je         LAB__addr_0x0075a23e");                          // 0x0075a1f6    7446
    asm("LAB__addr_0x0075a1f8:");
    ...
    asm("LAB__addr_0x0075a23a:");
    asm("test               ecx, ecx");                                      // 0x0075a23a    85c9
    asm("{disp8} jne        LAB__addr_0x0075a1f8");                          // 0x0075a23c    75ba
    asm("LAB__addr_0x0075a23e:");
...
bool32_t __fastcall EnterFarming__8VillagerFUcUc(struct Villager* this, const void* edx, unsigned char param_1, unsigned char param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0075a296");                          // 0x0075a281    7513
...
bool32_t __fastcall ExitFarming__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0075a303");                          // 0x0075a2ba    7547
    asm("{disp32} mov       eax, dword ptr [esi + 0x00000118]");             // 0x0075a2bc    8b8618010000
    asm("test               eax, eax");                                      // 0x0075a2c2    85c0
    asm("{disp8} je         LAB__addr_0x0075a303");                          // 0x0075a2c4    743d
