...
void __fastcall DeleteAbodeSurroundingObjects__5AbodeFv(struct Abode* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00403d90");                          // 0x00403d32    745c
    ...
    asm("{disp8} je         LAB__addr_0x00403d7e");                          // 0x00403d73    7409
    ...
    asm("{disp8} je         LAB__addr_0x00403dda");                          // 0x00403dcf    7409
...
void __fastcall CreateAbodeSurroundingObjects__5AbodeFv(struct Abode* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00403e79");                          // 0x00403e12    7465
    ...
    asm("{disp8} je         LAB__addr_0x00403e79");                          // 0x00403e4f    7428
    ...
    asm("{disp8} jne        LAB__addr_0x00403ed9");                          // 0x00403ec1    7516
...
uint16_t __fastcall GetNumberOfInstanceForGlobalList__5AbodeFv(struct GameThing* this)
{
    ...
    asm("LAB__addr_0x00403f20:");
    asm("{disp32} mov       eax, dword ptr [ecx + 0x00000090]");             // 0x00403f20    8b8190000000
    asm("test               eax, eax");                                      // 0x00403f26    85c0
    asm("{disp8} jne        LAB__addr_0x00403f31");                          // 0x00403f28    7507
    asm("{disp32} fld       dword ptr [__real@4@3fff8000000000000000]");                   // 0x00403f2a    d90590a38a00
    asm("ret");                                                              // 0x00403f30    c3
    asm("LAB__addr_0x00403f31:");
...
uint32_t __fastcall DestroyedByEffect__5AbodeFP7GPlayerf(struct Object* this, const void* edx, struct GPlayer* player, float param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x00404001");                          // 0x00403f9d    7462
    asm("test               edi, edi");                                      // 0x00403f9f    85ff
    asm("{disp8} jne        LAB__addr_0x00403fc3");                          // 0x00403fa1    7520
    ...
    asm("{disp8} je         LAB__addr_0x00403fe1");                          // 0x00403fd0    740f
    ...
    asm("{disp8} je         LAB__addr_0x00404041");                          // 0x00404025    741a
    ...
    asm("{disp8} je         LAB__addr_0x0040404a");                          // 0x0040403f    7409
    asm("LAB__addr_0x00404041:");
...
void __fastcall AddVillagerToAbode__5AbodeFP8Villager(struct Abode* this, const void* edx, struct Villager* villager)
{
    ...
    asm("{disp8} je         LAB__addr_0x004040de");                          // 0x00404077    7465
    ...
    asm("{disp32} jmp       LAB__addr_0x00404154");                          // 0x004040a8    e9a7000000
    asm("LAB__addr_0x004040ad:");
    asm("cmp.s              eax, ebp");                                      // 0x004040ad    3bc5
    asm("{disp32} je        LAB__addr_0x0040415a");                          // 0x004040af    0f84a5000000
    asm("LAB__addr_0x004040b5:");
    asm("{disp32} mov       ecx, dword ptr [eax + 0x000000e4]");             // 0x004040b5    8b88e4000000
    asm("cmp.s              ecx, esi");                                      // 0x004040bb    3bce
    asm("{disp8} je         LAB__addr_0x004040ca");                          // 0x004040bd    740b
    asm("mov.s              eax, ecx");                                      // 0x004040bf    8bc1
    asm("cmp.s              eax, ebp");                                      // 0x004040c1    3bc5
    asm("{disp8} jne        LAB__addr_0x004040b5");                          // 0x004040c3    75f0
    asm("{disp32} jmp       LAB__addr_0x0040415a");                          // 0x004040c5    e990000000
    asm("LAB__addr_0x004040ca:");
    ...
    asm("{disp8} jmp        LAB__addr_0x00404154");                          // 0x004040dc    eb76
    asm("LAB__addr_0x004040de:");
    ...
    asm("{disp8} je         LAB__addr_0x004040fa");                          // 0x004040e7    7411
    ...
    asm("{disp8} jmp        LAB__addr_0x0040415a");                          // 0x004040f8    eb60
    asm("LAB__addr_0x004040fa:");
    ...
    asm("{disp8} je         LAB__addr_0x0040415a");                          // 0x00404109    744f
    asm("LAB__addr_0x0040410b:");
    asm("cmp.s              eax, esi");                                      // 0x0040410b    3bc6
    asm("{disp8} je         LAB__addr_0x0040411b");                          // 0x0040410d    740c
    asm("{disp32} mov       eax, dword ptr [eax + 0x000000e4]");             // 0x0040410f    8b80e4000000
    asm("cmp.s              eax, ebp");                                      // 0x00404115    3bc5
    asm("{disp8} jne        LAB__addr_0x0040410b");                          // 0x00404117    75f2
    asm("{disp8} jmp        LAB__addr_0x0040415a");                          // 0x00404119    eb3f
    asm("LAB__addr_0x0040411b:");
    asm("cmp.s              eax, ebp");                                      // 0x0040411b    3bc5
    asm("{disp8} je         LAB__addr_0x0040415a");                          // 0x0040411d    743b
    asm("mov                eax, dword ptr [edx]");                          // 0x0040411f    8b02
    asm("cmp.s              eax, esi");                                      // 0x00404121    3bc6
    asm("{disp8} jne        LAB__addr_0x0040412f");                          // 0x00404123    750a
    asm("{disp32} mov       ecx, dword ptr [esi + 0x000000e4]");             // 0x00404125    8b8ee4000000
    asm("mov                dword ptr [edx], ecx");                          // 0x0040412b    890a
    asm("{disp8} jmp        LAB__addr_0x00404151");                          // 0x0040412d    eb22
    asm("LAB__addr_0x0040412f:");
    asm("cmp.s              eax, ebp");                                      // 0x0040412f    3bc5
    asm("{disp8} je         LAB__addr_0x0040415a");                          // 0x00404131    7427
    asm("LAB__addr_0x00404133:");
    asm("{disp32} mov       ecx, dword ptr [eax + 0x000000e4]");             // 0x00404133    8b88e4000000
    asm("cmp.s              ecx, esi");                                      // 0x00404139    3bce
    asm("{disp8} je         LAB__addr_0x00404145");                          // 0x0040413b    7408
    asm("mov.s              eax, ecx");                                      // 0x0040413d    8bc1
    asm("cmp.s              eax, ebp");                                      // 0x0040413f    3bc5
    asm("{disp8} jne        LAB__addr_0x00404133");                          // 0x00404141    75f0
    asm("{disp8} jmp        LAB__addr_0x0040415a");                          // 0x00404143    eb15
    asm("LAB__addr_0x00404145:");
    ...
    asm("{disp8} je         LAB__addr_0x004041bb");                          // 0x0040418a    742f
    ...
    asm("{disp8} je         LAB__addr_0x004041a6");                          // 0x00404195    740f
    ...
    asm("{disp8} jne        LAB__addr_0x00404210");                          // 0x004041c7    7547
    ...
    asm("{disp8} jne        LAB__addr_0x004041e6");                          // 0x004041e2    7502
    asm("mov                dword ptr [eax], esi");                          // 0x004041e4    8930
    asm("LAB__addr_0x004041e6:");
...
void __fastcall RemoveDeletedVillagerFromAbode__5AbodeFP8Villager(struct Abode* this, const void* edx, struct Villager* villager)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00404254");                          // 0x0040423d    7515
    ...
    asm("{disp8} jmp        LAB__addr_0x004042e8");                          // 0x004042c4    eb22
    asm("LAB__addr_0x004042c6:");
    asm("cmp.s              eax, ebx");                                      // 0x004042c6    3bc3
    asm("{disp8} je         LAB__addr_0x004042f4");                          // 0x004042c8    742a
    asm("LAB__addr_0x004042ca:");
    asm("{disp32} mov       ecx, dword ptr [eax + 0x000000e4]");             // 0x004042ca    8b88e4000000
    asm("cmp.s              ecx, edi");                                      // 0x004042d0    3bcf
    asm("{disp8} je         LAB__addr_0x004042dc");                          // 0x004042d2    7408
    asm("mov.s              eax, ecx");                                      // 0x004042d4    8bc1
    asm("cmp.s              eax, ebx");                                      // 0x004042d6    3bc3
    asm("{disp8} jne        LAB__addr_0x004042ca");                          // 0x004042d8    75f0
    asm("{disp8} jmp        LAB__addr_0x004042f4");                          // 0x004042da    eb18
    asm("LAB__addr_0x004042dc:");
    ...
    asm("{disp8} je         LAB__addr_0x0040432b");                          // 0x00404305    7424
...
void __fastcall RemoveAliveVillagerFromAbode__5AbodeFP8Villager(struct Abode* this, const void* edx, struct Villager* villager)
{
    ...
    asm("{disp8} je         LAB__addr_0x00404360");                          // 0x0040434f    740f
    ...
    asm("{disp8} jmp        LAB__addr_0x004043f6");                          // 0x004043d2    eb22
    asm("LAB__addr_0x004043d4:");
    asm("test               eax, eax");                                      // 0x004043d4    85c0
    asm("{disp8} je         LAB__addr_0x00404406");                          // 0x004043d6    742e
    asm("LAB__addr_0x004043d8:");
    asm("{disp32} mov       ecx, dword ptr [eax + 0x000000e4]");             // 0x004043d8    8b88e4000000
    asm("cmp.s              ecx, edi");                                      // 0x004043de    3bcf
    asm("{disp8} je         LAB__addr_0x004043ea");                          // 0x004043e0    7408
    asm("mov.s              eax, ecx");                                      // 0x004043e2    8bc1
    asm("test               eax, eax");                                      // 0x004043e4    85c0
    asm("{disp8} jne        LAB__addr_0x004043d8");                          // 0x004043e6    75f0
    asm("{disp8} jmp        LAB__addr_0x00404406");                          // 0x004043e8    eb1c
    asm("LAB__addr_0x004043ea:");
    ...
    asm("{disp8} je         LAB__addr_0x0040442f");                          // 0x00404418    7415
...
uint32_t __fastcall Process__5AbodeFv(struct Object* this)
{
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00404452    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00404458    dfe0
    asm("test               ah, 0x40");                                      // 0x0040445a    f6c440
    asm("{disp32} je        LAB__addr_0x00404503");                          // 0x0040445d    0f84a0000000
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x0040446d    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00404473    dfe0
    asm("test               ah, 0x40");                                      // 0x00404475    f6c440
    asm("{disp32} je        LAB__addr_0x00404503");                          // 0x00404478    0f8485000000
    ...
    asm("{disp8} je         LAB__addr_0x00404503");                          // 0x0040448a    7477
    ...
    asm("{disp8} jne        LAB__addr_0x00404503");                          // 0x00404498    7569
    ...
    asm("{disp8} je         LAB__addr_0x004044b6");                          // 0x004044a3    7411
    ...
    asm("{disp8} jne        LAB__addr_0x00404503");                          // 0x004044b4    754d
    asm("LAB__addr_0x004044b6:");
    asm("{disp32} fld       dword ptr [esi + 0x000000b0]");                  // 0x004044b6    d986b0000000
    asm("{disp32} fadd      dword ptr [__real@4@3ff583126f0000000000]");                 // 0x004044bc    d805b0a38a00
    asm("{disp32} fst       dword ptr [esi + 0x000000b0]");                  // 0x004044c2    d996b0000000
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                   // 0x004044c8    d81d90a38a00
    asm("fnstsw             ax");                                            // 0x004044ce    dfe0
    asm("test               ah, 0x01");                                      // 0x004044d0    f6c401
    asm("{disp8} jne        LAB__addr_0x00404503");                          // 0x004044d3    752e
...
void __fastcall MoveAbodeToPlannedAbodes__5AbodeFv(struct Abode* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0040455a");                          // 0x0040452d    742b
    ...
    asm("{disp8} jne        LAB__addr_0x00404552");                          // 0x0040453b    7515
...
void __fastcall RemoveAllVillagersFromAbode__5AbodeFv(struct Abode* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0040457d");                          // 0x00404568    7413
    asm("push               esi");                                           // 0x0040456a    56
    asm("LAB__addr_0x0040456b:");
    ...
    asm("{disp8} jne        LAB__addr_0x0040456b");                          // 0x0040457a    75ef
    asm("pop                esi");                                           // 0x0040457c    5e
    asm("LAB__addr_0x0040457d:");
...
int __fastcall CalculateFoodNeededForDinner__5AbodeFv(struct Abode* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x004045f3");                          // 0x004045da    7417
    asm("push               esi");                                           // 0x004045dc    56
    asm("LAB__addr_0x004045dd:");
    ...
    asm("{disp8} jne        LAB__addr_0x004045dd");                          // 0x004045f0    75eb
    asm("pop                esi");                                           // 0x004045f2    5e
    asm("LAB__addr_0x004045f3:");
...
struct Villager* __fastcall GetSpouse__5AbodeFP8Villager(struct Abode* this, const void* edx, struct Villager* villager)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00404657");                          // 0x00404644    7511
...
bool32_t __fastcall IsTooCrowded__5AbodeFv(struct Abode* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x004046db");                          // 0x004046cf    750a
    ...
    asm("{disp8} jne        LAB__addr_0x00404712");                          // 0x00404706    750a
...
bool __fastcall Built__5AbodeFv(struct MultiMapFixed* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0040478a");                          // 0x00404731    7457
    ...
    asm("{disp8} je         LAB__addr_0x0040478a");                          // 0x00404743    7445
    ...
    asm("{disp8} je         LAB__addr_0x0040477a");                          // 0x0040476d    740b
    ...
    asm("{disp8} jmp        LAB__addr_0x00404783");                          // 0x00404778    eb09
    asm("LAB__addr_0x0040477a:");
    ...
    asm("LAB__addr_0x00404783:");
    asm("mov.s              ecx, eax");                                      // 0x00404783    8bc8
    asm("call               ?FUN_0064da80@GPlayer@@QAEXHH@Z");               // 0x00404785    e8f6922400
    asm("LAB__addr_0x0040478a:");
    ...
    asm("{disp8} je         LAB__addr_0x0040479f");                          // 0x00404793    740a
...
bool __fastcall Repaired__5AbodeFv(struct MultiMapFixed* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x004047cd");                          // 0x004047c1    740a
...
void __fastcall MakeFunctional__5AbodeFv(struct Abode* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x00404955");                          // 0x004047f0    0f845f010000
    ...
    asm("{disp8} jne        LAB__addr_0x00404829");                          // 0x0040481a    750d
    ...
    asm("{disp8} je         LAB__addr_0x0040485f");                          // 0x00404847    7416
    ...
    asm("{disp8} je         LAB__addr_0x0040485f");                          // 0x00404855    7408
    ...
    asm("{disp32} je        LAB__addr_0x0040494d");                          // 0x00404869    0f84de000000
    ...
    asm("{disp32} je        LAB__addr_0x0040494d");                          // 0x00404878    0f84cf000000
    ...
    asm("{disp32} jbe       LAB__addr_0x0040494d");                          // 0x0040488c    0f86bb000000
    ...
    asm("{disp8} jmp        LAB__addr_0x004048bb");                          // 0x004048b7    eb02
    asm("LAB__addr_0x004048b9:");
    asm("xor.s              edi, edi");                                      // 0x004048b9    33ff
    asm("LAB__addr_0x004048bb:");
    ...
    asm("{disp8} je         LAB__addr_0x00404910");                          // 0x00404901    740d
    asm("LAB__addr_0x00404903:");
    asm("{disp8} mov        ecx, dword ptr [eax + 0x24]");                   // 0x00404903    8b4824
    asm("test               ecx, ecx");                                      // 0x00404906    85c9
    asm("{disp8} je         LAB__addr_0x00404910");                          // 0x00404908    7406
    asm("mov.s              eax, ecx");                                      // 0x0040490a    8bc1
    asm("test               eax, eax");                                      // 0x0040490c    85c0
    asm("{disp8} jne        LAB__addr_0x00404903");                          // 0x0040490e    75f3
    asm("LAB__addr_0x00404910:");
    ...
    asm("{disp8} jne        LAB__addr_0x00404937");                          // 0x0040491e    7517
    ...
    asm("call               LAB__addr_0x00404960");                          // 0x0040492b    e830000000
    ...
    asm("LAB__addr_0x0040494d:");
    asm("mov.s              ecx, esi");                                      // 0x0040494d    8bce
    asm("call               LAB__addr_0x00404960");                          // 0x0040494f    e80c000000
    asm("pop                edi");                                           // 0x00404954    5f
    asm("LAB__addr_0x00404955:");
    ...
    asm("{disp32} je        LAB__addr_0x00404a8d");                          // 0x0040497a    0f840d010000
    ...
    asm("{disp32} jne       LAB__addr_0x00404a8d");                          // 0x0040498d    0f85fa000000
    ...
    asm("{disp8} je         LAB__addr_0x00404a24");                          // 0x004049a4    747e
    asm("LAB__addr_0x004049a6:");
    asm("cmp.s              esi, edi");                                      // 0x004049a6    3bf7
    asm("{disp8} je         LAB__addr_0x004049fa");                          // 0x004049a8    7450
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                   // 0x004049b4    d81d90a38a00
    asm("fnstsw             ax");                                            // 0x004049ba    dfe0
    asm("test               ah, 0x01");                                      // 0x004049bc    f6c401
    asm("{disp8} jne        LAB__addr_0x004049fa");                          // 0x004049bf    7539
    ...
    asm("{disp8} jne        LAB__addr_0x004049d6");                          // 0x004049ce    7506
    asm("{disp8} inc        dword ptr [esp + 0x10]");                        // 0x004049d0    ff442410
    asm("{disp8} jmp        LAB__addr_0x004049fa");                          // 0x004049d4    eb24
    asm("LAB__addr_0x004049d6:");
    ...
    asm("{disp8} je         LAB__addr_0x004049e7");                          // 0x004049e2    7403
    asm("inc                ebp");                                           // 0x004049e4    45
    asm("{disp8} jmp        LAB__addr_0x004049fa");                          // 0x004049e5    eb13
    asm("LAB__addr_0x004049e7:");
    ...
    asm("{disp8} jne        LAB__addr_0x00404a39");                          // 0x00404a31    7506
    asm("{disp8} inc        dword ptr [esp + 0x10]");                        // 0x00404a33    ff442410
    asm("{disp8} jmp        LAB__addr_0x00404a5d");                          // 0x00404a37    eb24
    asm("LAB__addr_0x00404a39:");
    ...
    asm("{disp8} je         LAB__addr_0x00404a4a");                          // 0x00404a45    7403
    asm("inc                ebp");                                           // 0x00404a47    45
    asm("{disp8} jmp        LAB__addr_0x00404a5d");                          // 0x00404a48    eb13
    asm("LAB__addr_0x00404a4a:");
    ...
    asm("call               ?FUN_0064da80@GPlayer@@QAEXHH@Z");               // 0x00404a88    e8f38f2400
    asm("LAB__addr_0x00404a8d:");
...
int __fastcall GetMesh__5AbodeCFv(const struct Object* this)
{
    ...
    asm(".byte              0x72, 0xe1");// {disp8} jb LAB__addr_0x00404ad1  // 0x00404aee    72e1
