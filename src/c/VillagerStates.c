...
uint32_t __fastcall GotoStoragePitForDropOff__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076967a");                            // 0x0076962d    744b
    ...
    asm("{disp8} je         LAB__addr_0x0076967a");                            // 0x00769642    7436
    ...
    asm("{disp8} je         LAB__addr_0x007696a9");                            // 0x0076968c    741b
    asm("cmp                eax, 0x01");                                       // 0x0076968e    83f801
    asm("{disp8} je         LAB__addr_0x007696a9");                            // 0x00769691    7416
...
uint32_t __fastcall ArrivesAtStoragePitForDropOff__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x007697d7");                            // 0x007696e7    0f84ea000000
    ...
    asm("{disp8} je         LAB__addr_0x0076974d");                            // 0x007696f8    7453
    ...
    asm("{disp8} je         LAB__addr_0x0076974d");                            // 0x00769706    7445
    ...
    asm("{disp32} je        LAB__addr_0x007697e6");                            // 0x0076971f    0f84c1000000
    ...
    asm("{disp8} je         LAB__addr_0x007697d7");                            // 0x00769756    747f
    ...
    asm("{disp8} je         LAB__addr_0x007697d7");                            // 0x00769790    7445
    ...
    asm("{disp8} je         LAB__addr_0x007697ff");                            // 0x007697a5    7458
    ...
    asm("{disp8} jne        LAB__addr_0x007697f1");                            // 0x007697c9    7526
    ...
    asm("{disp8} jmp        LAB__addr_0x007697d7");                            // 0x007697fd    ebd8
    asm("LAB__addr_0x007697ff:");
...
bool32_t __fastcall GotoStoragePitForFood__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076988a");                            // 0x0076983d    744b
    ...
    asm("{disp8} je         LAB__addr_0x0076988a");                            // 0x00769852    7436
...
bool32_t __fastcall ArrivesAtStoragePitForResource__8VillagerF13RESOURCE_TYPEUl15VILLAGER_STATES15VILLAGER_STATES(struct Villager* this, const void* edx, enum RESOURCE_TYPE param_1, unsigned long param_2, enum VILLAGER_STATES param_3, enum VILLAGER_STATES param_4)
{
    ...
    asm("{disp32} jbe       LAB__addr_0x00769b0a");                            // 0x007698e1    0f8623020000
    asm("call               ?GetStoragePit@Villager@@QAEPAVStoragePit@@XZ");   // 0x007698e7    e82486feff
    asm("test               eax, eax");                                        // 0x007698ec    85c0
    asm("{disp32} je        LAB__addr_0x007699be");                            // 0x007698ee    0f84ca000000
    ...
    asm("{disp32} je        LAB__addr_0x007699be");                            // 0x00769907    0f84b1000000
    ...
    asm(".byte              0x72, 0x14");// {disp8} jb LAB__addr_0x0076993b    // 0x00769925    7214
    ...
    asm("LAB__addr_0x0076993b:");
    asm("cmp.s              ebx, ebp");                                        // 0x0076993b    3bdd
    asm("{disp8} jbe        LAB__addr_0x007699a3");                            // 0x0076993d    7664
    ...
    asm("{disp8} jne        LAB__addr_0x00769960");                            // 0x00769954    750a
    ...
    asm("LAB__addr_0x00769960:");
    asm("cmp                eax, 0x01");                                       // 0x00769960    83f801
    asm("{disp8} jne        LAB__addr_0x007699a3");                            // 0x00769963    753e
    asm("{disp8} mov        edi, dword ptr [esp + 0x40]");                     // 0x00769965    8b7c2440
    asm("cmp.s              edi, ebp");                                        // 0x00769969    3bfd
    asm("{disp8} je         LAB__addr_0x007699a3");                            // 0x0076996b    7436
    ...
    asm("{disp32} je        LAB__addr_0x00769b0a");                            // 0x007699c7    0f843d010000
    ...
    asm("{disp32} je        LAB__addr_0x00769b0a");                            // 0x007699fd    0f8407010000
    ...
    asm("call               __ftol");                                          // 0x00769a1d    e8de790300
    ...
    asm("call               __ftol");                                          // 0x00769a30    e8cb790300
    ...
    asm("call               __ftol");                                          // 0x00769a49    e8b2790300
    ...
    asm("call               __ftol");                                          // 0x00769a62    e899790300
    ...
    asm("call               ?GetAltitude@LH3DIsland@@SIMABULH3DMapCoords@@@Z");// 0x00769a77    e814960900
    ...
    asm("{disp8} je         LAB__addr_0x00769ae4");                            // 0x00769a97    744b
    ...
    asm("{disp8} je         LAB__addr_0x00769ac9");                            // 0x00769ac3    7404
    asm("mov                edx, dword ptr [esi]");                            // 0x00769ac5    8b16
    asm("{disp8} jmp        LAB__addr_0x00769b10");                            // 0x00769ac7    eb47
    asm("LAB__addr_0x00769ac9:");
...
bool32_t __fastcall ArrivesAtHomeWithFood__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00769b6a");                            // 0x00769b3a    742e
...
bool32_t __fastcall CheckTrader__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00769b8f");                            // 0x00769b8b    7502
    asm("pop                esi");                                             // 0x00769b8d    5e
    asm("ret");                                                                // 0x00769b8e    c3
    asm("LAB__addr_0x00769b8f:");
    ...
    asm("{disp8} jne        LAB__addr_0x00769bcc");                            // 0x00769bba    7510
    ...
    asm("{disp8} jmp        LAB__addr_0x00769be5");                            // 0x00769bca    eb19
    asm("LAB__addr_0x00769bcc:");
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                     // 0x00769bcc    d81d98a38a00
    asm("fnstsw             ax");                                              // 0x00769bd2    dfe0
    asm("test               ah, 0x40");                                        // 0x00769bd4    f6c440
    asm("{disp8} jne        LAB__addr_0x00769bfe");                            // 0x00769bd7    7525
    asm("{disp32} mov       dword ptr [esi + 0x00000118], 0x00000001");        // 0x00769bd9    c7861801000001000000
    asm("push               0x1");                                             // 0x00769be3    6a01
    asm("LAB__addr_0x00769be5:");
...
bool32_t __fastcall CheckTraderPickUpOrDropOff__8VillagerF13RESOURCE_TYPE(struct Villager* this, const void* edx, enum RESOURCE_TYPE param_1)
{
    ...
    asm("{disp32} fld       dword ptr [__real@4@3fff8000000000000000]");                     // 0x00769ca9    d90590a38a00
    ...
    asm("{disp8} je         LAB__addr_0x00769d0c");                            // 0x00769d05    7405
    asm("mov                eax, 0x000000e0");                                 // 0x00769d07    b8e0000000
    asm("LAB__addr_0x00769d0c:");
...
bool32_t __fastcall ArrivesAtStoragePitForTraderPickUp__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jmp        LAB__addr_0x00769d54");                            // 0x00769d49    eb09
    asm("LAB__addr_0x00769d4b:");
    ...
    asm("call               __ftol");                                          // 0x00769d92    e869760300
...
bool32_t __fastcall ArrivesAtStoragePitForTraderDropOff__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00769e57");                            // 0x00769e25    7430
    ...
    asm("LAB__addr_0x00769e57:");
    asm("test               ebx, ebx");                                        // 0x00769e57    85db
    asm("{disp8} je         LAB__addr_0x00769e8b");                            // 0x00769e59    7430
...
bool32_t __fastcall SetTraderNothingToDo__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00769ed1");                            // 0x00769ec5    750a
...
bool32_t __fastcall SetupBreederDisciple__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00769f09");                            // 0x00769eef    7418
    ...
    asm("{disp32} je        LAB__addr_0x0076a19d");                            // 0x00769f16    0f8481020000
    ...
    asm("{disp32} je        LAB__addr_0x0076a19d");                            // 0x00769f40    0f8457020000
    ...
    asm("{disp32} jne       LAB__addr_0x0076a19d");                            // 0x00769f6d    0f852a020000
    ...
    asm("{disp8} je         LAB__addr_0x00769fb9");                            // 0x00769f86    7431
    asm("{disp8} lea        ebp, dword ptr [ebx + 0x14]");                     // 0x00769f88    8d6b14
    asm("LAB__addr_0x00769f8b:");
    ...
    asm("{disp32} jne       LAB__addr_0x0076a073");                            // 0x00769fcc    0f85a1000000
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076a002    e82945f7ff
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076a022    e80945f7ff
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z");   // 0x0076a032    e84935feff
    ...
    asm("{disp32} jmp       LAB__addr_0x0076a17b");                            // 0x0076a06e    e908010000
    asm("LAB__addr_0x0076a073:");
    ...
    asm("{disp8} jne        LAB__addr_0x0076a0d0");                            // 0x0076a0c6    7508
    asm("{disp8} mov        dword ptr [esp + 0x10], 0xbf800000");              // 0x0076a0c8    c7442410000080bf
    asm("LAB__addr_0x0076a0d0:");
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076a0df    e84c44f7ff
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076a10e    e81d44f7ff
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z");   // 0x0076a13e    e83d34feff
...
bool32_t __fastcall BreederDisciple__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076a200");                            // 0x0076a1ba    7544
    ...
    asm("{disp8} je         LAB__addr_0x0076a200");                            // 0x0076a1d2    742c
    ...
    asm("{disp8} jg         LAB__addr_0x0076a20c");                            // 0x0076a1e4    7f26
...
bool32_t __fastcall MissionaryDisciple__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076a27b");                            // 0x0076a23c    743d
...
bool32_t __fastcall EnterBreeder__8VillagerFUcUc(struct Villager* this, const void* edx, unsigned char param_1, unsigned char param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076a2c5");                            // 0x0076a2ae    7515
...
uint32_t __fastcall AtStructureRemoveResource__8VillagerFP13MultiMapFixed13RESOURCE_TYPEUlPb(struct Villager* this, const void* edx, struct MultiMapFixed* param_1, enum RESOURCE_TYPE param_2, unsigned long param_3, bool* param_4)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076a372");                            // 0x0076a366    750a
...
uint32_t __fastcall AtStructureAddResource__8VillagerFP13MultiMapFixed13RESOURCE_TYPERUlb(struct Villager* this, const void* edx, struct MultiMapFixed* param_1, enum RESOURCE_TYPE param_2, unsigned long* param_3, bool param_4)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076a478");                            // 0x0076a45b    741b
...
bool __fastcall SetDying__8VillagerFv(struct Object* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076a506");                            // 0x0076a4d7    742d
    ...
    asm("{disp8} je         LAB__addr_0x0076a530");                            // 0x0076a51e    7410
    ...
    asm("{disp8} jmp        LAB__addr_0x0076a53e");                            // 0x0076a52e    eb0e
    asm("LAB__addr_0x0076a530:");
    ...
    asm("{disp8} jne        LAB__addr_0x0076a55f");                            // 0x0076a54b    7512
...
bool __fastcall Dying__8VillagerFv(struct Living* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076a58d");                            // 0x0076a57e    740d
    ...
    asm("{disp8} jmp        LAB__addr_0x0076a599");                            // 0x0076a58b    eb0c
    asm("LAB__addr_0x0076a58d:");
    ...
    asm("LAB__addr_0x0076a599:");
    asm("test               byte ptr [esi + 0x000000e0], 0x04");               // 0x0076a599    f686e000000004
    asm("{disp8} jne        LAB__addr_0x0076a5cd");                            // 0x0076a5a0    752b
    ...
    asm("{disp8} je         LAB__addr_0x0076a5be");                            // 0x0076a5ab    7411
    ...
    asm("{disp8} jne        LAB__addr_0x0076a5cd");                            // 0x0076a5bc    750f
    asm("LAB__addr_0x0076a5be:");
...
bool __fastcall Dead__8VillagerFv(struct Living* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076a5f9");                            // 0x0076a5e9    740e
    ...
    asm("{disp8} jg         LAB__addr_0x0076a61c");                            // 0x0076a618    7f02
    asm("xor.s              eax, eax");                                        // 0x0076a61a    33c0
    asm("LAB__addr_0x0076a61c:");
    ...
    asm("LAB__addr_0x0076a626:");
    asm("test               byte ptr [esi + 0x25], 0x04");                     // 0x0076a626    f6462504
    asm("{disp32} jne       LAB__addr_0x0076a770");                            // 0x0076a62a    0f8540010000
    ...
    asm("{disp32} je        LAB__addr_0x0076a750");                            // 0x0076a641    0f8409010000
    ...
    asm("{disp32} jne       LAB__addr_0x0076a750");                            // 0x0076a668    0f85e2000000
    asm("{disp32} mov       eax, dword ptr [data_bytes + 0x4f3a80]");          // 0x0076a66e    a1809aeb00
    asm("test               eax, eax");                                        // 0x0076a673    85c0
    asm("{disp8} jne        LAB__addr_0x0076a6df");                            // 0x0076a675    7568
    ...
    asm("{disp8} jle        LAB__addr_0x0076a68c");                            // 0x0076a682    7e08
    asm("{disp32} mov       ecx, dword ptr [eax + 0x000003d4]");               // 0x0076a684    8b88d4030000
    asm("{disp8} jmp        LAB__addr_0x0076a68f");                            // 0x0076a68a    eb03
    asm("LAB__addr_0x0076a68c:");
    asm("{disp8} mov        ecx, dword ptr [eax + 0x04]");                     // 0x0076a68c    8b4804
    asm("LAB__addr_0x0076a68f:");
    ...
    asm("{disp8} jle        LAB__addr_0x0076a6a5");                            // 0x0076a69b    7e08
    asm("{disp32} mov       ecx, dword ptr [eax + 0x000003e0]");               // 0x0076a69d    8b88e0030000
    asm("{disp8} jmp        LAB__addr_0x0076a6a8");                            // 0x0076a6a3    eb03
    asm("LAB__addr_0x0076a6a5:");
    asm("{disp8} mov        ecx, dword ptr [eax + 0x04]");                     // 0x0076a6a5    8b4804
    asm("LAB__addr_0x0076a6a8:");
    ...
    asm("{disp8} jle        LAB__addr_0x0076a6be");                            // 0x0076a6b4    7e08
    asm("{disp32} mov       ecx, dword ptr [eax + 0x000003d8]");               // 0x0076a6b6    8b88d8030000
    asm("{disp8} jmp        LAB__addr_0x0076a6c1");                            // 0x0076a6bc    eb03
    asm("LAB__addr_0x0076a6be:");
    asm("{disp8} mov        ecx, dword ptr [eax + 0x04]");                     // 0x0076a6be    8b4804
    asm("LAB__addr_0x0076a6c1:");
    ...
    asm("{disp8} jae        LAB__addr_0x0076a720");                            // 0x0076a6f2    732c
    ...
    asm("{disp8} jmp        LAB__addr_0x0076a74b");                            // 0x0076a71e    eb2b
    asm("LAB__addr_0x0076a720:");
    ...
    asm("{disp8} je         LAB__addr_0x0076a750");                            // 0x0076a738    7416
...
bool32_t __fastcall Drowning__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076a78f");                            // 0x0076a787    7406
    asm("{disp8} mov        word ptr [esi + 0x58], 0x000a");                   // 0x0076a789    66c746580a00
    asm("LAB__addr_0x0076a78f:");
    ...
    asm("{disp8} jne        LAB__addr_0x0076a7d0");                            // 0x0076a79a    7534
    ...
    asm("{disp8} je         LAB__addr_0x0076a7b9");                            // 0x0076a7a5    7412
    ...
    asm("{disp8} jne        LAB__addr_0x0076a7bf");                            // 0x0076a7b7    7506
    asm("LAB__addr_0x0076a7b9:");
    asm("{disp32} mov       eax, dword ptr [esi + 0x00000104]");               // 0x0076a7b9    8b8604010000
    asm("LAB__addr_0x0076a7bf:");
...
bool32_t __fastcall MakeScaredStiff__8VillagerFv(struct Villager* this)
{
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076a822    e8093df7ff
    ...
    asm("{disp8} je         LAB__addr_0x0076a869");                            // 0x0076a839    742e
    ...
    asm("{disp8} jmp        LAB__addr_0x0076a886");                            // 0x0076a867    eb1d
    asm("LAB__addr_0x0076a869:");
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076a878    e8b33cf7ff
    asm("{disp32} fadd      dword ptr [rdata_bytes + 0x2414]");                // 0x0076a87d    d80514b48a00
    asm("add                esp, 0x0c");                                       // 0x0076a883    83c40c
    asm("LAB__addr_0x0076a886:");
    asm("call               __ftol");                                          // 0x0076a886    e8756b0300
...
bool32_t __fastcall ScaredStiff__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076a8c0");                            // 0x0076a8b9    7505
    asm("call               ?GoHome@Villager@@QAE_NXZ");                       // 0x0076a8bb    e8b059ffff
    asm("LAB__addr_0x0076a8c0:");
...
bool32_t __fastcall VagrantStart__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076a92a");                            // 0x0076a901    7527
    ...
    asm("{disp8} je         LAB__addr_0x0076a92a");                            // 0x0076a90d    741b
    ...
    asm("{disp8} je         LAB__addr_0x0076a9c3");                            // 0x0076a942    747f
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076a953    e8d83bf7ff
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076a96d    e8be3bf7ff
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z");   // 0x0076a97d    e8fe2bfeff
    ...
    asm("{disp32} je        LAB__addr_0x0076aa53");                            // 0x0076a9a0    0f84ad000000
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076a9d2    e8593bf7ff
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076aa05    e8263bf7ff
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z");   // 0x0076aa20    e85b2bfeff
    ...
    asm("{disp8} je         LAB__addr_0x0076aa53");                            // 0x0076aa40    7411
...
bool32_t __fastcall SetupInspectObject__8VillagerFP6Object(struct Villager* this, const void* edx, struct Object* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076aafc");                            // 0x0076aae3    7417
    ...
    asm("{disp32} jne       LAB__addr_0x0076ac1f");                            // 0x0076ab27    0f85f2000000
    ...
    asm("call               __ftol");                                          // 0x0076aba2    e859680300
    ...
    asm("call               __ftol");                                          // 0x0076abb5    e846680300
    ...
    asm("call               __ftol");                                          // 0x0076abca    e831680300
    ...
    asm("call               __ftol");                                          // 0x0076abe3    e818680300
    ...
    asm("call               ?GetAltitude@LH3DIsland@@SIMABULH3DMapCoords@@@Z");// 0x0076abf8    e893840900
...
bool32_t __fastcall InspectObject__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076ac5a");                            // 0x0076ac4c    740c
    ...
    asm("{disp8} je         LAB__addr_0x0076aca3");                            // 0x0076ac58    7449
    asm("LAB__addr_0x0076ac5a:");
    ...
    asm("{disp8} je         LAB__addr_0x0076aca3");                            // 0x0076ac92    740f
    asm("LAB__addr_0x0076ac94:");
...
int __fastcall ExitInFlying__8VillagerF15VILLAGER_STATES(struct Living* this, const void* edx, enum VILLAGER_STATES param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076accd");                            // 0x0076acb6    7415
    asm("cmp                al, 0x0b");                                        // 0x0076acb8    3c0b
    asm("{disp8} je         LAB__addr_0x0076accd");                            // 0x0076acba    7411
    asm("cmp                al, 0x0e");                                        // 0x0076acbc    3c0e
    asm("{disp8} je         LAB__addr_0x0076accd");                            // 0x0076acbe    740d
    asm("cmp                al, 0x0f");                                        // 0x0076acc0    3c0f
    asm("{disp8} je         LAB__addr_0x0076accd");                            // 0x0076acc2    7409
    asm("cmp                al, 0x10");                                        // 0x0076acc4    3c10
    asm("{disp8} je         LAB__addr_0x0076accd");                            // 0x0076acc6    7405
    asm("xor.s              eax, eax");                                        // 0x0076acc8    33c0
    asm("ret                0x0004");                                          // 0x0076acca    c20400
    asm("LAB__addr_0x0076accd:");
...
bool32_t __fastcall SetupWander__8VillagerFR14JustWholeMapXZ15VILLAGER_STATES(struct Villager* this, const void* edx, struct JustWholeMapXZ* param_1, enum VILLAGER_STATES param_2)
{
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076ad13    e81838f7ff
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076ad2b    e80038f7ff
...
bool32_t __fastcall ExitSex__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076add2");                            // 0x0076ad9a    7536
    ...
    asm("{disp8} je         LAB__addr_0x0076add2");                            // 0x0076adaa    7426
    asm("cmp                ecx, dword ptr [data_bytes + 0x30db1c]");          // 0x0076adac    3b0d1c3bcd00
    asm("{disp8} jbe        LAB__addr_0x0076add2");                            // 0x0076adb2    761e
    ...
    asm("{disp8} jne        LAB__addr_0x0076add2");                            // 0x0076adc0    7510
...
bool __fastcall InHand__8VillagerFv(struct Living* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076adfd");                            // 0x0076adf0    740b
    ...
    asm("{disp32} jne       LAB__addr_0x0076af79");                            // 0x0076ae16    0f855d010000
    ...
    asm("{disp32} je        LAB__addr_0x0076af67");                            // 0x0076ae2e    0f8433010000
    ...
    asm("{disp32} je        LAB__addr_0x0076af67");                            // 0x0076ae3c    0f8425010000
    asm("LAB__addr_0x0076ae42:");
    ...
    asm("{disp32} je        LAB__addr_0x0076aedc");                            // 0x0076ae4f    0f8487000000
    ...
    asm("{disp8} je         LAB__addr_0x0076aebe");                            // 0x0076ae7e    743e
    ...
    asm("{disp8} je         LAB__addr_0x0076aebe");                            // 0x0076ae89    7433
    ...
    asm("{disp8} jne        LAB__addr_0x0076aebe");                            // 0x0076ae97    7525
    ...
    asm("{disp8} jne        LAB__addr_0x0076aebe");                            // 0x0076aea5    7517
    ...
    asm("{disp8} jne        LAB__addr_0x0076aebe");                            // 0x0076aeb3    7509
    asm("test               byte ptr [esi + 0x000000e0], -0x80");              // 0x0076aeb5    f686e000000080
    asm("{disp8} je         LAB__addr_0x0076aed3");                            // 0x0076aebc    7415
    asm("LAB__addr_0x0076aebe:");
    asm("cmp                ebp, 0x0b");                                       // 0x0076aebe    83fd0b
    asm("{disp8} jne        LAB__addr_0x0076aedc");                            // 0x0076aec1    7519
    ...
    asm("{disp8} jne        LAB__addr_0x0076aef9");                            // 0x0076aecf    7528
    asm("{disp8} jmp        LAB__addr_0x0076aedc");                            // 0x0076aed1    eb09
    asm("LAB__addr_0x0076aed3:");
    asm("cmp                ebp, 0x09");                                       // 0x0076aed3    83fd09
    asm("{disp8} je         LAB__addr_0x0076aeec");                            // 0x0076aed6    7414
    asm("test               ebp, ebp");                                        // 0x0076aed8    85ed
    asm("{disp8} jne        LAB__addr_0x0076aef9");                            // 0x0076aeda    751d
    asm("LAB__addr_0x0076aedc:");
    asm("{disp8} mov        ebx, dword ptr [ebx + 0x04]");                     // 0x0076aedc    8b5b04
    asm("test               ebx, ebx");                                        // 0x0076aedf    85db
    asm("{disp32} je        LAB__addr_0x0076af67");                            // 0x0076aee1    0f8480000000
    asm("{disp32} jmp       LAB__addr_0x0076ae42");                            // 0x0076aee7    e956ffffff
    asm("LAB__addr_0x0076aeec:");
    ...
    asm("{disp32} je        LAB__addr_0x0076afc7");                            // 0x0076af0a    0f84b7000000
    asm("LAB__addr_0x0076af10:");
    ...
    asm("LAB__addr_0x0076af56:");
    asm("test               ecx, ecx");                                        // 0x0076af56    85c9
    asm("{disp8} jne        LAB__addr_0x0076af10");                            // 0x0076af58    75b6
    ...
    asm("LAB__addr_0x0076af79:");
    asm("{disp8} mov        ecx, dword ptr [esp + 0x10]");                     // 0x0076af79    8b4c2410
    asm("test               ecx, ecx");                                        // 0x0076af7d    85c9
    asm("{disp8} je         LAB__addr_0x0076afc7");                            // 0x0076af7f    7446
    asm("LAB__addr_0x0076af81:");
    ...
    asm("LAB__addr_0x0076afc3:");
    asm("test               ecx, ecx");                                        // 0x0076afc3    85c9
    asm("{disp8} jne        LAB__addr_0x0076af81");                            // 0x0076afc5    75ba
    asm("LAB__addr_0x0076afc7:");
...
uint32_t __fastcall EnterInHand__8VillagerF15VILLAGER_STATES15VILLAGER_STATES(struct Living* this, const void* edx, enum VILLAGER_STATES param_1, enum VILLAGER_STATES param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076afef");                            // 0x0076afeb    7502
    asm("xor.s              eax, eax");                                        // 0x0076afed    33c0
    asm("LAB__addr_0x0076afef:");
...
int __fastcall ExitInHand__8VillagerF15VILLAGER_STATES(struct Living* this, const void* edx, enum VILLAGER_STATES param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076b024");                            // 0x0076b013    750f
    ...
    asm("{disp8} je         LAB__addr_0x0076b024");                            // 0x0076b01e    7404
    asm("and                byte ptr [eax + 0x7c], -0x11");                    // 0x0076b020    80607cef
    asm("LAB__addr_0x0076b024:");
...
bool32_t __fastcall IsInACreaturesHand__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076b04d");                            // 0x0076b037    7414
    asm("LAB__addr_0x0076b039:");
    ...
    asm("{disp8} je         LAB__addr_0x0076b050");                            // 0x0076b045    7409
    asm("mov                eax, dword ptr [eax]");                            // 0x0076b047    8b00
    asm("test               eax, eax");                                        // 0x0076b049    85c0
    asm("{disp8} jne        LAB__addr_0x0076b039");                            // 0x0076b04b    75ec
    asm("LAB__addr_0x0076b04d:");
    asm("xor.s              eax, eax");                                        // 0x0076b04d    33c0
    asm("ret");                                                                // 0x0076b04f    c3
    asm("LAB__addr_0x0076b050:");
...
bool32_t __fastcall SetupWaitForCounter__8VillagerFUs15VILLAGER_STATES(struct Villager* this, const void* edx, unsigned short param_1, enum VILLAGER_STATES param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076b086");                            // 0x0076b077    750d
...
bool32_t __fastcall SetupPanicReaction__8VillagerFP8ReactionR9MapCoords(struct Villager* this, const void* edx, struct Reaction* param_1, struct MapCoords* param_2)
{
    ...
    asm("{disp32} je        LAB__addr_0x0076b1ad");                            // 0x0076b0e0    0f84c7000000
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076b116    e81534f7ff
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076b154    e8d733f7ff
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z");   // 0x0076b181    e8fa23feff
...
bool32_t __fastcall PanicReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076b1f2");                            // 0x0076b1e2    740e
...
bool32_t __fastcall GotoCongregateInTownAfterEmergency__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                     // 0x0076b257    d81d90a38a00
    asm("fnstsw             ax");                                              // 0x0076b25d    dfe0
    asm("test               ah, 0x01");                                        // 0x0076b25f    f6c401
    asm("{disp8} je         LAB__addr_0x0076b296");                            // 0x0076b262    7432
    ...
    asm("{disp8} jmp        LAB__addr_0x0076b29c");                            // 0x0076b294    eb06
    asm("LAB__addr_0x0076b296:");
    asm("{disp32} fld       dword ptr [__real@4@3fff8000000000000000]");                     // 0x0076b296    d90590a38a00
    asm("LAB__addr_0x0076b29c:");
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                    // 0x0076b2bb    e87032f7ff
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z");   // 0x0076b2cb    e8b022feff
    asm("add                esp, 0x0c");                                       // 0x0076b2d0    83c40c
    asm("push               eax");                                             // 0x0076b2d3    50
    asm("{disp8} lea        ecx, dword ptr [esp + 0x14]");                     // 0x0076b2d4    8d4c2414
    asm("call               ??YMapCoords@@QAEXABU0@@Z");              // 0x0076b2d8    e833a1e9ff
...
bool32_t __fastcall CongregateInTownAfterEmergency__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076b34f");                            // 0x0076b30a    7443
    ...
    asm("{disp8} je         LAB__addr_0x0076b34f");                            // 0x0076b31c    7431
...
bool32_t __fastcall GoAndChilloutOutsideHome__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0076b4c1");                            // 0x0076b401    0f84ba000000
    ...
    asm("{disp32} je        LAB__addr_0x0076b4c1");                            // 0x0076b410    0f84ab000000
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z");   // 0x0076b472    e80921feff
    asm("add                esp, 0x0c");                                       // 0x0076b477    83c40c
    asm("push               eax");                                             // 0x0076b47a    50
    asm("{disp8} lea        ecx, dword ptr [esp + 0x20]");                     // 0x0076b47b    8d4c2420
    asm("call               ??YMapCoords@@QAEXABU0@@Z");              // 0x0076b47f    e88c9fe9ff
...
bool32_t __fastcall SitAndChillout__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jg         LAB__addr_0x0076b566");                            // 0x0076b4f3    7f71
    ...
    asm("{disp8} je         LAB__addr_0x0076b527");                            // 0x0076b504    7421
    ...
    asm("{disp8} je         LAB__addr_0x0076b527");                            // 0x0076b50f    7416
    ...
    asm("{disp8} jne        LAB__addr_0x0076b566");                            // 0x0076b530    7534
    ...
    asm("{disp8} jne        LAB__addr_0x0076b558");                            // 0x0076b548    750e
...
bool32_t __fastcall GoAndChilloutInTown__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076b5f3");                            // 0x0076b5a2    744f
...
void __fastcall GetMeToMyChillOutPos__8VillagerFM8VillagerFPCvPvR9MapCoords_iR9MapCoordsfRC9MapCoords(struct Villager* this, const void* edx, int (__fastcall* callback)(const struct Villager * param_1, const void * param_2, struct MapCoords * param_3), const void* unused_1, const void* unused_2, const void* unused_3, struct MapCoords* param_5, float param_6, struct MapCoords* param_7)
{
    ...
    asm("call               ?GetMetresDistance@MapCoords@@QBEMABU1@@Z");                            // 0x0076b621    e8aaa6e9ff
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z");   // 0x0076b734    e8471efeff
    asm("add                esp, 0x14");                                       // 0x0076b739    83c414
    asm("push               eax");                                             // 0x0076b73c    50
    asm("{disp8} lea        ecx, dword ptr [esp + 0x1c]");                     // 0x0076b73d    8d4c241c
    asm("call               ??YMapCoords@@QAEXABU0@@Z");              // 0x0076b741    e8ca9ce9ff
...
bool32_t __fastcall BreederJustLanded__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076b8ba");                            // 0x0076b882    7436
    ...
    asm("call               ??YMapCoords@@QAEXABUJustMapXZ@@@Z");              // 0x0076b8d1    e89a9be9ff
    ...
    asm("{disp8} je         LAB__addr_0x0076b8fd");                            // 0x0076b8e6    7415
