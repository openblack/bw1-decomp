...
struct RTTICompleteObjectLocator* const p__RTTICompleObjectLocator__12PlannedAbode = &__RTTICompleObjectLocator__12PlannedAbode;

const struct PlannedMultiMapFixedVftable __vt__12PlannedAbode = {
    Serialise__4BaseFR7Archive,
    __dt__12PlannedAbodeFv,
    Delete__4BaseFi,
    ...
    IsCreature2__9GameThingFP8Creature,
