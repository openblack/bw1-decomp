...
void __cdecl jmp_addr_0x004010a0(void)
{
    __asm__(
        "push              ebx\n"                                           // 0x004010a0    53
        "{disp8} mov       bl, byte ptr [esp + 0x08]\n"                     // 0x004010a1    8a5c2408
        "test              bl, 0x02\n"                                      // 0x004010a5    f6c302
        "push              esi\n"                                           // 0x004010a8    56
        "mov.s             esi, ecx\n"                                      // 0x004010a9    8bf1
        "{disp8} je        _jmp_addr_0x004010f1\n"                          // 0x004010ab    7444
        ...
        "{disp8} js        _jmp_addr_0x004010db\n"                          // 0x004010bb    781e
        "push              ebp\n"                                           // 0x004010bd    55
        "{disp8} lea       esi, dword ptr [ecx + 0x08]\n"                   // 0x004010be    8d7108
        "{disp8} lea       ebp, dword ptr [eax + 0x01]\n"                   // 0x004010c1    8d6801
        "_jmp_addr_0x004010c4:\n"
        "{disp8} mov       eax, dword ptr [esi + -0x0c]\n"                  // 0x004010c4    8b46f4
        "sub               esi, 0x0c\n"                                     // 0x004010c7    83ee0c
        "test              eax, eax\n"                                      // 0x004010ca    85c0
        "{disp8} je        _jmp_addr_0x004010d7\n"                          // 0x004010cc    7409
        "push              eax\n"                                           // 0x004010ce    50
        "call               ___dl__FPv\n"                                   // 0x004010cf    e8c4dd3a00
        "add               esp, 0x04\n"                                     // 0x004010d4    83c404
        "_jmp_addr_0x004010d7:\n"
        "dec               ebp\n"                                           // 0x004010d7    4d
        "{disp8} jne       _jmp_addr_0x004010c4\n"                          // 0x004010d8    75ea
        "pop               ebp\n"                                           // 0x004010da    5d
        "_jmp_addr_0x004010db:\n"
        "test              bl, 0x01\n"                                      // 0x004010db    f6c301
        "{disp8} je        _jmp_addr_0x004010e9\n"                          // 0x004010de    7409
        "push              edi\n"                                           // 0x004010e0    57
        "call               ___dl__FPv\n"                                   // 0x004010e1    e8b2dd3a00
        "add               esp, 0x04\n"                                     // 0x004010e6    83c404
        "_jmp_addr_0x004010e9:\n"
        "mov.s             eax, edi\n"                                      // 0x004010e9    8bc7
        "pop               edi\n"                                           // 0x004010eb    5f
        "pop               esi\n"                                           // 0x004010ec    5e
        "pop               ebx\n"                                           // 0x004010ed    5b
        "ret               0x0004\n"                                        // 0x004010ee    c20400
        "_jmp_addr_0x004010f1:\n"
        "{disp8} mov       eax, dword ptr [esi + 0x08]\n"                   // 0x004010f1    8b4608
        "test              eax, eax\n"                                      // 0x004010f4    85c0
        "{disp8} je        _jmp_addr_0x00401101\n"                          // 0x004010f6    7409
        "push              eax\n"                                           // 0x004010f8    50
        "call               ___dl__FPv\n"                                   // 0x004010f9    e89add3a00
        "add               esp, 0x04\n"                                     // 0x004010fe    83c404
        "_jmp_addr_0x00401101:\n"
        "test              bl, 0x01\n"                                      // 0x00401101    f6c301
        "{disp8} je        _jmp_addr_0x0040110f\n"                          // 0x00401104    7409
        "push              esi\n"                                           // 0x00401106    56
        "call               ___dl__FPv\n"                                   // 0x00401107    e88cdd3a00
        "add               esp, 0x04\n"                                     // 0x0040110c    83c404
        "_jmp_addr_0x0040110f:\n"
        "mov.s             eax, esi\n"                                      // 0x0040110f    8bc6
        "pop               esi\n"                                           // 0x00401111    5e
        "pop               ebx\n"                                           // 0x00401112    5b
        "ret               0x0004\n"                                        // 0x00401113    c20400
