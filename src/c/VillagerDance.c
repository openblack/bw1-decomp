...
struct Villager* __fastcall FindImmediateNeighbour__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007598f7");                          // 0x007598d5    7520
    ...
    asm("{disp8} je         LAB__addr_0x007598f7");                          // 0x007598e2    7413
    asm("LAB__addr_0x007598e4:");
    asm("{disp8} mov        ecx, dword ptr [eax + 0x28]");                   // 0x007598e4    8b4828
    asm("cmp                dword ptr [ecx + 0x10], ebx");                   // 0x007598e7    395910
    asm("{disp8} jne        LAB__addr_0x007598f0");                          // 0x007598ea    7504
    asm("cmp.s              eax, esi");                                      // 0x007598ec    3bc6
    asm("{disp8} jne        LAB__addr_0x0075991a");                          // 0x007598ee    752a
    asm("LAB__addr_0x007598f0:");
    asm("{disp8} mov        eax, dword ptr [eax + 0x20]");                   // 0x007598f0    8b4020
    asm("test               eax, eax");                                      // 0x007598f3    85c0
    asm("{disp8} jne        LAB__addr_0x007598e4");                          // 0x007598f5    75ed
    asm("LAB__addr_0x007598f7:");
...
bool32_t __fastcall ControlledByCreature__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00759a7c");                          // 0x00759a11    7469
    asm("{disp8} mov        edx, dword ptr [eax + 0x14]");                   // 0x00759a13    8b5014
    asm("cmp.s              edx, ecx");                                      // 0x00759a16    3bd1
    asm("{disp8} je         LAB__addr_0x00759a7c");                          // 0x00759a18    7462
...
bool32_t __fastcall ExitControlledByCreature__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x00759ada");                          // 0x00759a9b    743d
    asm("cmp                bl, 0x0a");                                      // 0x00759a9d    80fb0a
    asm("{disp8} je         LAB__addr_0x00759ada");                          // 0x00759aa0    7438
    ...
    asm("{disp8} jne        LAB__addr_0x00759ada");                          // 0x00759ab8    7520
    asm("cmp                bl, -0x34");                                     // 0x00759aba    80fbcc
    asm("{disp32} je        LAB__addr_0x00759b71");                          // 0x00759abd    0f84ae000000
    asm("cmp                bl, 0x5a");                                      // 0x00759ac3    80fb5a
    asm("{disp32} je        LAB__addr_0x00759b71");                          // 0x00759ac6    0f84a5000000
    asm("cmp                bl, -0x5d");                                     // 0x00759acc    80fba3
    asm("{disp32} je        LAB__addr_0x00759b71");                          // 0x00759acf    0f849c000000
    asm("pop                ebp");                                           // 0x00759ad5    5d
    asm("pop                ebx");                                           // 0x00759ad6    5b
    asm("ret                0x0004");                                        // 0x00759ad7    c20400
    asm("LAB__addr_0x00759ada:");
    asm("{disp32} mov       ecx, dword ptr [_CreatureList]");                // 0x00759ada    8b0df8fcc500
    asm("test               ecx, ecx");                                      // 0x00759ae0    85c9
    asm("{disp32} je        LAB__addr_0x00759b68");                          // 0x00759ae2    0f8480000000
    asm("LAB__addr_0x00759ae8:");
    ...
    asm("{disp8} je         LAB__addr_0x00759b00");                          // 0x00759af3    740b
    asm("LAB__addr_0x00759af5:");
    asm("cmp                dword ptr [eax + 0x04], ebp");                   // 0x00759af5    396804
    asm("{disp8} je         LAB__addr_0x00759b08");                          // 0x00759af8    740e
    asm("mov                eax, dword ptr [eax]");                          // 0x00759afa    8b00
    asm("test               eax, eax");                                      // 0x00759afc    85c0
    asm("{disp8} jne        LAB__addr_0x00759af5");                          // 0x00759afe    75f5
    asm("LAB__addr_0x00759b00:");
    asm("mov                ecx, dword ptr [ecx]");                          // 0x00759b00    8b09
    asm("test               ecx, ecx");                                      // 0x00759b02    85c9
    asm("{disp8} je         LAB__addr_0x00759b68");                          // 0x00759b04    7462
    asm("{disp8} jmp        LAB__addr_0x00759ae8");                          // 0x00759b06    ebe0
    asm("LAB__addr_0x00759b08:");
    ...
    asm("{disp8} je         LAB__addr_0x00759b4b");                          // 0x00759b1c    742d
    asm("push               edi");                                           // 0x00759b1e    57
    asm("LAB__addr_0x00759b1f:");
    asm("cmp                dword ptr [eax + 0x04], ebp");                   // 0x00759b1f    396804
    asm("mov                edi, dword ptr [eax]");                          // 0x00759b22    8b38
    asm("{disp8} jne        LAB__addr_0x00759b42");                          // 0x00759b24    751c
    asm("cmp                eax, dword ptr [esi]");                          // 0x00759b26    3b06
    asm("{disp8} jne        LAB__addr_0x00759b2e");                          // 0x00759b28    7504
    asm("mov                dword ptr [esi], edi");                          // 0x00759b2a    893e
    asm("{disp8} jmp        LAB__addr_0x00759b30");                          // 0x00759b2c    eb02
    asm("LAB__addr_0x00759b2e:");
    asm("mov                dword ptr [ebx], edi");                          // 0x00759b2e    893b
    asm("LAB__addr_0x00759b30:");
    ...
    asm("{disp8} jmp        LAB__addr_0x00759b44");                          // 0x00759b40    eb02
    asm("LAB__addr_0x00759b42:");
    asm("mov.s              ebx, eax");                                      // 0x00759b42    8bd8
    asm("LAB__addr_0x00759b44:");
    asm("test               edi, edi");                                      // 0x00759b44    85ff
    asm("mov.s              eax, edi");                                      // 0x00759b46    8bc7
    asm("{disp8} jne        LAB__addr_0x00759b1f");                          // 0x00759b48    75d5
    asm("pop                edi");                                           // 0x00759b4a    5f
    asm("LAB__addr_0x00759b4b:");
    ...
    asm("{disp8} je         LAB__addr_0x00759b68");                          // 0x00759b59    740d
