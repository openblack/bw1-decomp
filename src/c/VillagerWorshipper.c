...
float __fastcall CheckNeededForWorship__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076ba8e");                            // 0x0076ba70    741c
    ...
    asm("{disp8} jle        LAB__addr_0x0076bad7");                            // 0x0076bac6    7e0f
...
float __fastcall CheckWorshipActivity__8VillagerFi(struct Villager* this, const void* edx, int param_1)
{
    ...
    asm("{disp32} jne       LAB__addr_0x0076bc0d");                            // 0x0076bb3b    0f85cc000000
    ...
    asm("{disp32} jne       LAB__addr_0x0076bc0d");                            // 0x0076bb5f    0f85a8000000
    ...
    asm("{disp8} jne        LAB__addr_0x0076bb81");                            // 0x0076bb73    750c
    asm("{disp8} mov        eax, dword ptr [esp + 0x18]");                     // 0x0076bb75    8b442418
    asm("test               eax, eax");                                        // 0x0076bb79    85c0
    asm("{disp32} jne       LAB__addr_0x0076bc0d");                            // 0x0076bb7b    0f858c000000
    asm("LAB__addr_0x0076bb81:");
    ...
    asm("{disp8} je         LAB__addr_0x0076bb99");                            // 0x0076bb8b    740c
    ...
    asm("{disp8} jne        LAB__addr_0x0076bc0d");                            // 0x0076bb97    7574
    asm("LAB__addr_0x0076bb99:");
    ...
    asm("{disp8} je         LAB__addr_0x0076bc0d");                            // 0x0076bba4    7467
    ...
    asm("{disp8} je         LAB__addr_0x0076bbf5");                            // 0x0076bbb7    743c
...
bool32_t __fastcall CanIGetToTheWorshipSite__8VillagerFRP13MagicTeleport(struct Villager* this, const void* edx, struct MagicTeleport* * param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076bcaa");                            // 0x0076bc35    7473
    ...
    asm("{disp8} je         LAB__addr_0x0076bcaa");                            // 0x0076bc43    7465
    ...
    asm("{disp8} jne        LAB__addr_0x0076bc93");                            // 0x0076bc69    7528
    ...
    asm("{disp8} je         LAB__addr_0x0076bc93");                            // 0x0076bc74    741d
...
bool32_t __fastcall GotoWorshipSiteForWorship__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0076bd67");                            // 0x0076bce0    0f8481000000
    ...
    asm("{disp8} je         LAB__addr_0x0076bd67");                            // 0x0076bcf2    7473
    ...
    asm("{disp8} jmp        LAB__addr_0x0076bd56");                            // 0x0076bd48    eb0c
    asm("LAB__addr_0x0076bd4a:");
    ...
    asm("{disp8} je         LAB__addr_0x0076bd8d");                            // 0x0076bd7f    740c
    asm("cmp                ebx, 0x01");                                       // 0x0076bd81    83fb01
    asm("{disp8} jne        LAB__addr_0x0076bd8d");                            // 0x0076bd84    7507
    asm("mov.s              ecx, ebp");                                        // 0x0076bd86    8bcd
    asm("call               _jmp_addr_0x0073c650");                            // 0x0076bd88    e8c308fdff
    asm("LAB__addr_0x0076bd8d:");
...
bool32_t __fastcall SetGotoWorshipSpeed__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076bdea");                            // 0x0076bdbb    742d
...
bool32_t __fastcall ArrivesAtWorshipSiteForWorship__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076be27");                            // 0x0076be15    7510
    ...
    asm("{disp8} je         LAB__addr_0x0076be9a");                            // 0x0076be5f    7439
    ...
    asm("{disp8} jae        LAB__addr_0x0076be8a");                            // 0x0076be78    7310
...
bool32_t __fastcall CheckVillagerGoBackToTownFromWorship__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0076bf85");                            // 0x0076becd    0f84b2000000
    ...
    asm("{disp8} jne        LAB__addr_0x0076bf6e");                            // 0x0076bf0a    7562
    ...
    asm("{disp8} jne        LAB__addr_0x0076bf6e");                            // 0x0076bf2e    753e
    ...
    asm("{disp8} jge        LAB__addr_0x0076bf85");                            // 0x0076bf3f    7d44
    ...
    asm("{disp8} je         LAB__addr_0x0076bf85");                            // 0x0076bf55    742e
    ...
    asm("{disp8} jne        LAB__addr_0x0076bf85");                            // 0x0076bf69    751a
    asm("pop                edi");                                             // 0x0076bf6b    5f
    asm("pop                esi");                                             // 0x0076bf6c    5e
    asm("ret");                                                                // 0x0076bf6d    c3
    asm("LAB__addr_0x0076bf6e:");
...
bool32_t __fastcall GotoStoragePitForWorshipSupplies__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0076c068");                            // 0x0076bfaf    0f84b3000000
    ...
    asm("{disp32} je        LAB__addr_0x0076c068");                            // 0x0076bfc8    0f849a000000
    ...
    asm("{disp32} je        LAB__addr_0x0076c068");                            // 0x0076bfda    0f8488000000
    ...
    asm("{disp8} je         LAB__addr_0x0076c068");                            // 0x0076c00c    745a
    asm("cmp.s              ebx, edi");                                        // 0x0076c00e    3bdf
    asm("{disp8} ja         LAB__addr_0x0076c05a");                            // 0x0076c010    7748
    asm("{disp8} mov        ecx, dword ptr [esi + 0x28]");                     // 0x0076c012    8b4e28
    asm("cmp                ebx, dword ptr [ecx + 0x00000264]");               // 0x0076c015    3b9964020000
    asm("{disp8} je         LAB__addr_0x0076c05a");                            // 0x0076c01b    743d
    asm("test               eax, eax");                                        // 0x0076c01d    85c0
    asm("{disp8} je         LAB__addr_0x0076c068");                            // 0x0076c01f    7447
...
bool32_t __fastcall ArrivesAtStoragePitForWorshipSupplies__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c0e7");                            // 0x0076c08e    7457
    ...
    asm("{disp8} je         LAB__addr_0x0076c0e7");                            // 0x0076c0a2    7443
    ...
    asm("{disp8} jl         LAB__addr_0x0076c0b9");                            // 0x0076c0af    7c08
    ...
    asm("{disp8} jge        LAB__addr_0x0076c0cf");                            // 0x0076c0c3    7d0a
    ...
    asm("LAB__addr_0x0076c0cf:");
    asm("test               edi, edi");                                        // 0x0076c0cf    85ff
    asm("{disp8} jle        LAB__addr_0x0076c0e7");                            // 0x0076c0d1    7e14
...
bool32_t __fastcall ExitMoveToWorshipSiteWithSupplies__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076c163");                            // 0x0076c13a    7527
    ...
    asm("{disp8} je         LAB__addr_0x0076c163");                            // 0x0076c148    7419
...
bool32_t __fastcall ExitMoveToWorshipSite__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076c1e4");                            // 0x0076c189    7559
    ...
    asm("{disp8} je         LAB__addr_0x0076c1db");                            // 0x0076c1ca    740f
...
bool32_t __fastcall ExitAtWorshipSite__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076c272");                            // 0x0076c20d    7563
    ...
    asm("{disp8} je         LAB__addr_0x0076c227");                            // 0x0076c21d    7408
    ...
    asm("{disp8} jne        LAB__addr_0x0076c24c");                            // 0x0076c232    7518
    asm("cmp                bl, -0x0f");                                       // 0x0076c234    80fbf1
    asm("{disp8} je         LAB__addr_0x0076c24c");                            // 0x0076c237    7413
    ...
    asm("LAB__addr_0x0076c24c:");
    asm("test               edi, edi");                                        // 0x0076c24c    85ff
    asm("{disp8} je         LAB__addr_0x0076c258");                            // 0x0076c24e    7408
    ...
    asm("{disp8} je         LAB__addr_0x0076c272");                            // 0x0076c264    740c
...
bool32_t __fastcall ExitGetFoodAtWorship__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076c2b8");                            // 0x0076c299    751d
...
bool32_t __fastcall ArrivesAtWorshipSiteWithSupplies__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c329");                            // 0x0076c2de    7449
    ...
    asm("{disp8} je         LAB__addr_0x0076c329");                            // 0x0076c2ed    743a
    ...
    asm("{disp8} je         LAB__addr_0x0076c338");                            // 0x0076c327    740f
    asm("LAB__addr_0x0076c329:");
...
struct WorshipSite* __fastcall GetWorshipSite__8VillagerFv(struct GameThingWithPos* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c35f");                            // 0x0076c34a    7413
    ...
    asm("{disp8} je         LAB__addr_0x0076c388");                            // 0x0076c36b    741b
...
bool32_t __fastcall RestartWorshippingAtWorshipSite__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c3ac");                            // 0x0076c39b    740f
...
bool32_t __fastcall RestartWorshippingCreature__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c3e0");                            // 0x0076c3c8    7416
...
bool32_t __fastcall AddVillagerToWorshipSite__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076c419");                            // 0x0076c3fa    751d
...
bool32_t __fastcall RemoveVillagerFromWorshipSite__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c4a3");                            // 0x0076c44a    7457
    asm("test               byte ptr [esi + 0x000000e0], 0x02");               // 0x0076c44c    f686e000000002
    asm("{disp8} je         LAB__addr_0x0076c463");                            // 0x0076c453    740e
    ...
    asm("{disp8} je         LAB__addr_0x0076c488");                            // 0x0076c472    7414
    ...
    asm("{disp8} je         LAB__addr_0x0076c488");                            // 0x0076c47e    7408
    ...
    asm("{disp8} je         LAB__addr_0x0076c4a3");                            // 0x0076c495    740c
...
bool32_t __fastcall StartWorshippingAtWorshipSite__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c547");                            // 0x0076c4d3    7472
    ...
    asm("{disp8} jne        LAB__addr_0x0076c547");                            // 0x0076c4f3    7552
    ...
    asm("{disp8} je         LAB__addr_0x0076c547");                            // 0x0076c533    7412
...
bool32_t __fastcall StartHidingAtWorshipSite__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076c577");                            // 0x0076c565    7510
    ...
    asm("{disp8} je         LAB__addr_0x0076c5d2");                            // 0x0076c5be    7412
...
bool32_t __fastcall HidingAtWorshipSite__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c662");                            // 0x0076c5f2    746e
    ...
    asm("{disp8} je         LAB__addr_0x0076c647");                            // 0x0076c639    740c
...
bool32_t __fastcall WorshippingAtWorshipSite__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c6ab");                            // 0x0076c68e    741b
    ...
    asm("{disp8} jne        LAB__addr_0x0076c6d1");                            // 0x0076c6b5    751a
...
bool32_t __fastcall StartWorshippingCreature__8VillagerFP8Creature(struct Villager* this, const void* edx, struct Creature* param_1)
{
    ...
    asm("{disp32} je        LAB__addr_0x0076c7b6");                            // 0x0076c711    0f849f000000
    asm("{disp32} mov       eax, dword ptr [esi + 0x000000d8]");               // 0x0076c717    8b86d8000000
    asm("test               eax, eax");                                        // 0x0076c71d    85c0
    asm("{disp32} je        LAB__addr_0x0076c7b6");                            // 0x0076c71f    0f8491000000
    ...
    asm("{disp8} jne        LAB__addr_0x0076c76c");                            // 0x0076c753    7517
    asm("test               eax, eax");                                        // 0x0076c755    85c0
    asm("{disp8} je         LAB__addr_0x0076c765");                            // 0x0076c757    740c
    asm("test               ecx, ecx");                                        // 0x0076c759    85c9
    asm("{disp8} jne        LAB__addr_0x0076c76c");                            // 0x0076c75b    750f
    asm("test               edx, edx");                                        // 0x0076c75d    85d2
    asm("{disp8} jne        LAB__addr_0x0076c76c");                            // 0x0076c75f    750b
    asm("test               edi, edi");                                        // 0x0076c761    85ff
    asm("{disp8} jne        LAB__addr_0x0076c76c");                            // 0x0076c763    7507
    asm("LAB__addr_0x0076c765:");
    asm("{disp32} mov       byte ptr [esi + 0x0000008c], -0x34");              // 0x0076c765    c6868c000000cc
    asm("LAB__addr_0x0076c76c:");
    ...
    asm("{disp8} je         LAB__addr_0x0076c7b6");                            // 0x0076c784    7430
...
bool32_t __fastcall WorshippingCreature__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c7f3");                            // 0x0076c7c8    7429
    ...
    asm("{disp8} jne        LAB__addr_0x0076c7ee");                            // 0x0076c7d7    7515
...
bool32_t __fastcall ReduceVillagerLifeByChant__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c881");                            // 0x0076c80f    7470
    ...
    asm("{disp8} je         LAB__addr_0x0076c869");                            // 0x0076c857    7410
    ...
    asm("{disp8} jmp        LAB__addr_0x0076c86b");                            // 0x0076c867    eb02
    asm("LAB__addr_0x0076c869:");
    asm("xor.s              eax, eax");                                        // 0x0076c869    33c0
    asm("LAB__addr_0x0076c86b:");
...
bool32_t __fastcall CheckRequestGoHome__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076c920");                            // 0x0076c8e0    743e
    ...
    asm("{disp8} je         LAB__addr_0x0076c913");                            // 0x0076c902    740f
    asm("test               eax, eax");                                        // 0x0076c904    85c0
    asm("{disp8} jne        LAB__addr_0x0076c920");                            // 0x0076c906    7518
    ...
    asm("LAB__addr_0x0076c913:");
    asm("cmp                eax, 0x01");                                       // 0x0076c913    83f801
    asm("{disp8} jne        LAB__addr_0x0076c920");                            // 0x0076c916    7508
...
bool32_t __fastcall CheckNeededForWorshipSiteBuilding__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076c963");                            // 0x0076c93e    7523
    ...
    asm("{disp8} je         LAB__addr_0x0076c997");                            // 0x0076c94e    7447
    ...
    asm("{disp8} je         LAB__addr_0x0076c997");                            // 0x0076c961    7434
    asm("LAB__addr_0x0076c963:");
    ...
    asm("{disp8} je         LAB__addr_0x0076c997");                            // 0x0076c976    741f
    ...
    asm("{disp8} jne        LAB__addr_0x0076c997");                            // 0x0076c992    7503
    asm("pop                edi");                                             // 0x0076c994    5f
    asm("pop                esi");                                             // 0x0076c995    5e
    asm("ret");                                                                // 0x0076c996    c3
    asm("LAB__addr_0x0076c997:");
...
bool32_t __fastcall CheckAllowedToRestAtWorshipSite__8VillagerFi(struct Villager* this, const void* edx, int param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076ca19");                            // 0x0076c9c5    7452
...
bool32_t __fastcall GetFoodAtWorshipSite__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0076cad1");                            // 0x0076ca43    0f8488000000
    ...
    asm("{disp8} je         LAB__addr_0x0076caa5");                            // 0x0076ca6e    7435
    ...
    asm("{disp8} je         LAB__addr_0x0076ca86");                            // 0x0076ca79    740b
...
bool32_t __fastcall GotoAltarForRest__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076cb59");                            // 0x0076cb10    7447
...
bool32_t __fastcall ArrivesAtAltarForRest__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076cb98");                            // 0x0076cb8d    7409
...
bool32_t __fastcall AtAltarRest__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076cbc8");                            // 0x0076cbbd    7409
...
bool32_t __fastcall AtAltarFinishedRest__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076cbef");                            // 0x0076cbeb    7502
    asm("pop                esi");                                             // 0x0076cbed    5e
    asm("ret");                                                                // 0x0076cbee    c3
    asm("LAB__addr_0x0076cbef:");
