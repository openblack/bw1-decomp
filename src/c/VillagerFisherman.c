...
bool32_t __fastcall FishermanLookForWater__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0075b4fd");                          // 0x0075b4cb    7430
    ...
    asm("{disp8} je         LAB__addr_0x0075b4fd");                          // 0x0075b4eb    7410
...
bool32_t __fastcall VillagerBecomesFisherman__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0075b550");                          // 0x0075b51e    7530
...
bool32_t __fastcall FishermanArrivesAtFishing__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0075b60f");                          // 0x0075b5e6    7527
...
bool32_t __fastcall Fishing__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0075b80d");                          // 0x0075b6b0    0f8457010000
    ...
    asm("{disp8} jne        LAB__addr_0x0075b77e");                          // 0x0075b768    7514
    ...
    asm("{disp8} jmp        LAB__addr_0x0075b790");                          // 0x0075b77c    eb12
    asm("LAB__addr_0x0075b77e:");
    ...
    asm("{disp8} jne        LAB__addr_0x0075b800");                          // 0x0075b7f2    750c
    ...
    asm("{disp8} jne        LAB__addr_0x0075b80d");                          // 0x0075b7fe    750d
    asm("LAB__addr_0x0075b800:");
...
bool32_t __fastcall EnterFishing__8VillagerFUcUc(struct Villager* this, const void* edx, unsigned char param_1, unsigned char param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0075b86f");                          // 0x0075b841    752c
    ...
    asm("{disp8} je         LAB__addr_0x0075b86f");                          // 0x0075b84c    7421
    ...
    asm("{disp8} je         LAB__addr_0x0075b869");                          // 0x0075b85c    740b
    asm("LAB__addr_0x0075b85e:");
    asm("cmp                dword ptr [eax + 0x04], esi");                   // 0x0075b85e    397004
    asm("{disp8} je         LAB__addr_0x0075b86f");                          // 0x0075b861    740c
    asm("mov                eax, dword ptr [eax]");                          // 0x0075b863    8b00
    asm("test               eax, eax");                                      // 0x0075b865    85c0
    asm("{disp8} jne        LAB__addr_0x0075b85e");                          // 0x0075b867    75f5
    asm("LAB__addr_0x0075b869:");
    asm("push               esi");                                           // 0x0075b869    56
    asm("call               _jmp_addr_0x0052d250");                          // 0x0075b86a    e8e119ddff
    asm("LAB__addr_0x0075b86f:");
