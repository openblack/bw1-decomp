...
struct Villager* __fastcall __ct__8VillagerFv(struct Villager* this)
{
    ...
    asm("call               @__ct__13MobileWallHugFv@4");                     // 0x0055c8a4    e8e77ff1ff
    asm("{disp32} lea       ecx, dword ptr [esi + 0x0000008c]");              // 0x0055c8a9    8d8e8c000000
    asm("call               @__ct__12LivingActionFv@4");                      // 0x0055c8af    e8bc030900
    ...
    asm("call               @SetToZero__6LivingFv@4");                        // 0x0055c8e2    e849f70800
...
char* __fastcall GetDebugText__8VillagerFv(struct GameThing* this)
{
    ...
    asm("mov  eax, 0xbed194");  // 0x0055cb30    b894d1be00
    asm("ret");                 // 0x0055cb35    c3
    __builtin_unreachable();
}

void __fastcall __dt__8VillagerFv(struct Base* this, const void* edx, uint32_t param_1)
{
    asm("push               esi");                                            // 0x0055cb40    56
    asm("mov.s              esi, ecx");                                       // 0x0055cb41    8bf1
    asm("call               _jmp_addr_0x0074fbc0");                           // 0x0055cb43    e878301f00
