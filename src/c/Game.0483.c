...
bool __stdcall MouseHandler__5GGameFPv19LH_MOUSE_EVENT_TYPEUlUl(struct GGame* this, void* param_1, enum LH_MOUSE_EVENT_TYPE param_2, unsigned long param_3, unsigned long param_4)
{
    ...
    asm("{disp8} je         LAB__addr_0x0055007b");                           // 0x0055002a    744f
...
void __fastcall UnfinishInitialisation__5GGameFv(struct GGame* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00550109");                           // 0x005500b7    7450
    ...
    asm("{disp8} je         LAB__addr_0x00550105");                           // 0x005500d1    7432
    ...
    asm("{disp8} js         LAB__addr_0x005500fb");                           // 0x005500e4    7815
...
void __fastcall FinishInitialisation__5GGameFv(struct GGame* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00550130");                           // 0x0055011a    7414
...
void __cdecl LoadAllAnimations__Fv(void)
{
    ...
    asm("{disp8} jl         LAB__addr_0x005501a9");                           // 0x005501cc    7cdb
    ...
    asm("{disp32} je        LAB__addr_0x00550381");                           // 0x005501e8    0f8493010000
    ...
    asm("{disp8} jne        LAB__addr_0x00550246");                           // 0x00550226    751e
    asm("test               cl, cl");                                         // 0x00550228    84c9
    asm("{disp8} je         LAB__addr_0x00550242");                           // 0x0055022a    7416
    ...
    asm("{disp8} jne        LAB__addr_0x00550246");                           // 0x00550236    750e
    asm("add                eax, 0x02");                                      // 0x00550238    83c002
    asm("add                esi, 0x02");                                      // 0x0055023b    83c602
    asm("test               cl, cl");                                         // 0x0055023e    84c9
    asm("{disp8} jne        LAB__addr_0x0055021e");                           // 0x00550240    75dc
    asm("LAB__addr_0x00550242:");
    asm("xor.s              eax, eax");                                       // 0x00550242    33c0
    asm("{disp8} jmp        LAB__addr_0x0055024b");                           // 0x00550244    eb05
    asm("LAB__addr_0x00550246:");
    asm("sbb.s              eax, eax");                                       // 0x00550246    1bc0
    asm("sbb                eax, -0x01");                                     // 0x00550248    83d8ff
    asm("LAB__addr_0x0055024b:");
    asm("cmp.s              eax, ebp");                                       // 0x0055024b    3bc5
    asm("{disp32} je        LAB__addr_0x00550377");                           // 0x0055024d    0f8424010000
    ...
    asm("{disp8} jne        LAB__addr_0x00550267");                           // 0x0055025f    7506
    asm("{disp8} mov        dword ptr [esp + 0x18], ebp");                    // 0x00550261    896c2418
    asm("{disp8} jmp        LAB__addr_0x0055027a");                           // 0x00550265    eb13
    asm("LAB__addr_0x00550267:");
    ...
    asm("{disp8} jne        LAB__addr_0x005502c7");                           // 0x005502b7    750e
    asm("add                eax, 0x02");                                      // 0x005502b9    83c002
    asm("add                esi, 0x02");                                      // 0x005502bc    83c602
    asm("test               cl, cl");                                         // 0x005502bf    84c9
    asm("{disp8} jne        LAB__addr_0x005502a3");                           // 0x005502c1    75e0
    asm("LAB__addr_0x005502c3:");
    asm("xor.s              eax, eax");                                       // 0x005502c3    33c0
    asm("{disp8} jmp        LAB__addr_0x005502cc");                           // 0x005502c5    eb05
    asm("LAB__addr_0x005502c7:");
    asm("sbb.s              eax, eax");                                       // 0x005502c7    1bc0
    asm("sbb                eax, -0x01");                                     // 0x005502c9    83d8ff
    asm("LAB__addr_0x005502cc:");
    asm("test               eax, eax");                                       // 0x005502cc    85c0
    asm("{disp8} jne        LAB__addr_0x005502d9");                           // 0x005502ce    7509
    ...
    asm("{disp8} jl         LAB__addr_0x00550284");                           // 0x005502f4    7c8e
    asm("LAB__addr_0x005502f6:");
    asm("{disp8} mov        dword ptr [esp + 0x1c], 0x00000001");             // 0x005502f6    c744241c01000000
    asm("LAB__addr_0x005502fe:");
    ...
    asm("{disp8} je         LAB__addr_0x00550368");                           // 0x00550322    7444
    ...
    asm("{disp8} jmp        LAB__addr_0x00550365");                           // 0x00550361    eb02
    asm("LAB__addr_0x00550363:");
    asm("xor.s              eax, eax");                                       // 0x00550363    33c0
    asm("LAB__addr_0x00550365:");
    asm("{disp8} mov        dword ptr [ebx + 0x48], eax");                    // 0x00550365    894348
    asm("LAB__addr_0x00550368:");
    asm("{disp8} mov        eax, dword ptr [esp + 0x1c]");                    // 0x00550368    8b44241c
    asm("test               eax, eax");                                       // 0x0055036c    85c0
    asm("{disp8} jne        LAB__addr_0x005502fe");                           // 0x0055036e    758e
    asm("xor.s              ebp, ebp");                                       // 0x00550370    33ed
    asm("{disp32} jmp       LAB__addr_0x00550202");                           // 0x00550372    e98bfeffff
    asm("LAB__addr_0x00550377:");
...
bool __fastcall LoadFiles__5GGameFv(struct GGame* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x005503ca");                           // 0x005503c6    7502
    asm("pop                esi");                                            // 0x005503c8    5e
    asm("ret");                                                               // 0x005503c9    c3
    asm("LAB__addr_0x005503ca:");
...
void __fastcall SetupPlayers__5GGameFv(struct GGame* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0055076b");                           // 0x00550452    0f8413030000
    ...
    asm("{disp8} ja         LAB__addr_0x00550472");                           // 0x00550469    7707
    asm("{disp32} mov       eax, dword ptr [data_bytes + 0x351ca8]");         // 0x0055046b    a1a87cd100
    asm("{disp8} jmp        LAB__addr_0x0055047e");                           // 0x00550470    eb0c
    asm("LAB__addr_0x00550472:");
    ...
    asm("{disp32} je        LAB__addr_0x0055056f");                           // 0x005504b7    0f84b2000000
    asm("mov                edi, 0x00000001");                                // 0x005504bd    bf01000000
    asm("LAB__addr_0x005504c2:");
    ...
    asm("{disp8} jne        LAB__addr_0x005504f2");                           // 0x005504d5    751b
    ...
    asm("{disp8} jne        LAB__addr_0x0055054d");                           // 0x0055050a    7541
    ...
    asm("{disp8} jne        LAB__addr_0x00550539");                           // 0x00550528    750f
    ...
    asm("{disp8} jmp        LAB__addr_0x0055054d");                           // 0x00550537    eb14
    asm("LAB__addr_0x00550539:");
    ...
    asm("{disp32} jne       LAB__addr_0x005504c2");                           // 0x00550569    0f8553ffffff
    asm("LAB__addr_0x0055056f:");
    ...
    asm("{disp8} je         LAB__addr_0x005505df");                           // 0x005505ac    7431
    asm("LAB__addr_0x005505ae:");
    ...
    asm("{disp8} jne        LAB__addr_0x005505ae");                           // 0x005505dd    75cf
    asm("LAB__addr_0x005505df:");
    ...
    asm("{disp8} je         LAB__addr_0x00550665");                           // 0x005505eb    7478
    asm("LAB__addr_0x005505ed:");
    ...
    asm("{disp8} jne        LAB__addr_0x00550614");                           // 0x005505fa    7518
    ...
    asm("{disp8} jmp        LAB__addr_0x0055064d");                           // 0x00550612    eb39
    asm("LAB__addr_0x00550614:");
    ...
    asm("{disp8} jne        LAB__addr_0x005505ed");                           // 0x00550663    7588
    asm("LAB__addr_0x00550665:");
    asm("xor.s              edi, edi");                                       // 0x00550665    33ff
    asm("add                esi, 0x18");                                      // 0x00550667    83c618
    asm("LAB__addr_0x0055066a:");
    ...
    asm("{disp8} jne        LAB__addr_0x005506a4");                           // 0x0055068a    7518
    ...
    asm("{disp8} je         LAB__addr_0x005506f4");                           // 0x005506bf    7433
    asm("mov.s              ecx, eax");                                       // 0x005506c1    8bc8
    asm("cmp.s              eax, ecx");                                       // 0x005506c3    3bc1
    asm("{disp8} jne        LAB__addr_0x005506f4");                           // 0x005506c5    752d
    ...
    asm("{disp8} jmp        LAB__addr_0x0055071a");                           // 0x005506f2    eb26
    asm("LAB__addr_0x005506f4:");
    asm("cmp.s              eax, esi");                                       // 0x005506f4    3bc6
    asm("{disp8} je         LAB__addr_0x0055071a");                           // 0x005506f6    7422
    asm("LAB__addr_0x005506f8:");
    ...
    asm("{disp8} jne        LAB__addr_0x005506f8");                           // 0x00550718    75de
    asm("LAB__addr_0x0055071a:");
    ...
    asm("{disp8} jne        LAB__addr_0x00550755");                           // 0x00550747    750c
...
void __fastcall Dump__5GGameFv(struct Base* this)
{
    ...
    asm(".byte              0x72, 0xeb");// {disp8} jb LAB__addr_0x00550786   // 0x00550799    72eb
...
void __fastcall LoopThroughPlayers__5GGameFv(struct GGame* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x005507ea");                           // 0x005507dc    740c
    asm("LAB__addr_0x005507de:");
    ...
    asm("{disp8} jne        LAB__addr_0x005507de");                           // 0x005507e8    75f4
    asm("LAB__addr_0x005507ea:");
...
void __fastcall Birthday__5GGameFv(struct GGame* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00550816");                           // 0x005507ff    7415
    asm("LAB__addr_0x00550801:");
    ...
    asm("{disp8} jne        LAB__addr_0x00550801");                           // 0x00550814    75eb
    asm("LAB__addr_0x00550816:");
...
int __fastcall MyPlayerID__5GGameFUl(struct GGame* this, const void* edx, unsigned long param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x00550870");                           // 0x0055083a    7434
    asm("LAB__addr_0x0055083c:");
    ...
    asm("{disp8} je         LAB__addr_0x00550862");                           // 0x0055084b    7415
    ...
    asm("{disp8} je         LAB__addr_0x00550886");                           // 0x00550860    7424
    asm("LAB__addr_0x00550862:");
    ...
    asm("{disp8} jne        LAB__addr_0x0055083c");                           // 0x0055086e    75cc
    asm("LAB__addr_0x00550870:");
    asm("inc                ebp");                                            // 0x00550870    45
    asm("add                edi, 0x00000a60");                                // 0x00550871    81c7600a0000
    asm("cmp                ebp, 0x08");                                      // 0x00550877    83fd08
    asm(".byte              0x72, 0xb1");// {disp8} jb LAB__addr_0x0055082d   // 0x0055087a    72b1
...
struct GPlayer* __fastcall GetNextPlayer__5GGameFP7GPlayer(struct GGame* this, const void* edx, struct GPlayer* param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x005508ba");                           // 0x005508a6    7512
    asm("{disp8} lea        edx, dword ptr [ecx + 0x18]");                    // 0x005508a8    8d5118
    asm("LAB__addr_0x005508ab:");
    ...
    asm("{disp8} jne        LAB__addr_0x005508ab");                           // 0x005508c9    75e0
...
struct GPlayer* __fastcall GetNextActivePlayer__5GGameFP7GPlayer(struct GGame* this, const void* edx, struct GPlayer* param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00550910");                           // 0x005508d6    7538
    asm("{disp8} lea        edx, dword ptr [ecx + 0x18]");                    // 0x005508d8    8d5118
    asm("LAB__addr_0x005508db:");
    ...
    asm("{disp8} jne        LAB__addr_0x00550900");                           // 0x005508e4    751a
    asm("{disp32} lea       eax, dword ptr [ecx + 0x000048b8]");              // 0x005508e6    8d81b8480000
    asm("LAB__addr_0x005508ec:");
    asm("cmp.s              edx, eax");                                       // 0x005508ec    3bd0
    asm("{disp8} jae        LAB__addr_0x00550900");                           // 0x005508ee    7310
    ...
    asm("{disp8} je         LAB__addr_0x005508ec");                           // 0x005508fe    74ec
    asm("LAB__addr_0x00550900:");
    ...
    asm("{disp8} jne        LAB__addr_0x005508db");                           // 0x0055091f    75ba
...
struct GPlayer* __fastcall GetNextActivePlayerAndNeutral__5GGameFP7GPlayer(struct GGame* this, const void* edx, struct GPlayer* player)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0055093d");                           // 0x00550936    7505
    asm("{disp8} lea        edx, dword ptr [ecx + 0x18]");                    // 0x00550938    8d5118
    asm("{disp8} jmp        LAB__addr_0x00550943");                           // 0x0055093b    eb06
    asm("LAB__addr_0x0055093d:");
    asm("add                edx, 0x00000a60");                                // 0x0055093d    81c2600a0000
    asm("LAB__addr_0x00550943:");
    ...
    asm("{disp8} jne        LAB__addr_0x00550968");                           // 0x0055094c    751a
    asm("{disp32} lea       eax, dword ptr [ecx + 0x000048b8]");              // 0x0055094e    8d81b8480000
    asm("LAB__addr_0x00550954:");
    asm("cmp.s              edx, eax");                                       // 0x00550954    3bd0
    asm("{disp8} jae        LAB__addr_0x00550968");                           // 0x00550956    7310
    ...
    asm("{disp8} je         LAB__addr_0x00550954");                           // 0x00550966    74ec
    asm("LAB__addr_0x00550968:");
...
struct GPlayer* __fastcall GetNextPlayerAndNeutral__5GGameFP7GPlayer(struct GGame* this, const void* edx, struct GPlayer* player)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0055099a");                           // 0x00550986    7512
...
struct GPlayer* __fastcall GetPlayer__5GGameFUl(struct GGame* this, const void* edx, uint32_t param_1)
{
    ...
    asm(".byte              0x72, 0x5");// {disp8} jb LAB__addr_0x005509be    // 0x005509b7    7205
    asm("xor.s              eax, eax");                                       // 0x005509b9    33c0
    asm("ret                0x0004");                                         // 0x005509bb    c20400
    asm("LAB__addr_0x005509be:");
...
struct GPlayer* __fastcall GetPlayerFromReal__5GGameFUl(struct GGame* this, const void* edx, unsigned long param_1)
{
    ...
    asm(".byte              0x72, 0x5");// {disp8} jb LAB__addr_0x005509ee    // 0x005509e7    7205
    asm("xor.s              eax, eax");                                       // 0x005509e9    33c0
    asm("ret                0x0004");                                         // 0x005509eb    c20400
    asm("LAB__addr_0x005509ee:");
...
struct GInterface* __fastcall GetPlayerInterfaceFromReal__5GGameFUl(struct GGame* this, const void* edx, unsigned long param_1)
{
    ...
    asm(".byte              0x72, 0x5");// {disp8} jb LAB__addr_0x00550a1e    // 0x00550a17    7205
    asm("xor.s              eax, eax");                                       // 0x00550a19    33c0
    asm("ret                0x0004");                                         // 0x00550a1b    c20400
    asm("LAB__addr_0x00550a1e:");
...
struct GPlayer* __fastcall GetNextPlayerWithNoCreature__5GGameFP7GPlayer(struct GGame* this, const void* edx, struct GPlayer* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x00550a54");                           // 0x00550a3c    7416
    asm("LAB__addr_0x00550a3e:");
    asm("{disp32} mov       ecx, dword ptr [eax + 0x00000a4c]");              // 0x00550a3e    8b884c0a0000
    asm("test               ecx, ecx");                                       // 0x00550a44    85c9
    asm("{disp8} je         LAB__addr_0x00550a56");                           // 0x00550a46    740e
    ...
    asm("{disp8} jne        LAB__addr_0x00550a3e");                           // 0x00550a52    75ea
    asm("LAB__addr_0x00550a54:");
    asm("xor.s              eax, eax");                                       // 0x00550a54    33c0
    asm("LAB__addr_0x00550a56:");
