...
bool __fastcall IsAvailableForReaction__8VillagerF8REACTION(struct Living* this, const void* edx, enum REACTION param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00763409");                          // 0x007633ad    755a
    ...
    asm("{disp8} je         LAB__addr_0x00763409");                          // 0x007633c3    7444
    asm("test               dl, -0x80");                                     // 0x007633c5    f6c280
    asm("{disp8} jne        LAB__addr_0x00763409");                          // 0x007633c8    753f
    ...
    asm("{disp8} jne        LAB__addr_0x00763409");                          // 0x007633d7    7530
    ...
    asm("{disp8} je         LAB__addr_0x007633fc");                          // 0x007633f5    7405
    asm("cmp                eax, 0x07");                                     // 0x007633f7    83f807
    asm("{disp8} jne        LAB__addr_0x00763409");                          // 0x007633fa    750d
    asm("LAB__addr_0x007633fc:");
...
bool __fastcall IsAvailableForBeliefButNotReaction__8VillagerF8REACTION(struct Living* this, const void* edx, enum REACTION param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00763435");                          // 0x00763422    7511
    ...
    asm("{disp8} je         LAB__addr_0x00763435");                          // 0x0076342e    7405
    asm("xor.s              eax, eax");                                      // 0x00763430    33c0
    asm("ret                0x0004");                                        // 0x00763432    c20400
    asm("LAB__addr_0x00763435:");
...
void __fastcall UpdateHowImpressed__8VillagerFP8Reactioni(struct Living* this, const void* edx, struct Reaction* param_1, int param_2)
{
    ...
    asm("{disp32} je        LAB__addr_0x007635bf");                          // 0x007634d9    0f84e0000000
    ...
    asm("{disp32} je        LAB__addr_0x007635bf");                          // 0x007634ea    0f84cf000000
    ...
    asm("{disp32} fadd      dword ptr [__real@4@3ff583126f0000000000]");                 // 0x00763513    d805b0a38a00
    ...
    asm("{disp32} fadd      dword ptr [__real@4@3ff583126f0000000000]");                 // 0x00763533    d805b0a38a00
...
bool32_t __fastcall DisplayHowImpressed__4TownFv(struct Town* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x007637bd");                          // 0x007635dd    0f84da010000
    ...
    asm("call               __ftol");                                        // 0x0076360c    e8efdd0300
    ...
    asm("call               __ftol");                                        // 0x0076361f    e8dcdd0300
    ...
    asm("call               ?GetNearestTown@MapCoords@@QBEPAVTown@@M@Z");             // 0x0076363b    e8a0eae9ff
    asm("test               eax, eax");                                      // 0x00763640    85c0
    asm("{disp32} je        LAB__addr_0x007637bd");                          // 0x00763642    0f8475010000
    ...
    asm("{disp8} jne        LAB__addr_0x0076368b");                          // 0x00763679    7510
    ...
    asm("LAB__addr_0x0076368b:");
    asm("inc                esi");                                           // 0x0076368b    46
    asm("cmp                esi, 0x08");                                     // 0x0076368c    83fe08
    asm(".byte              0x72, 0xd7");// {disp8} jb LAB__addr_0x00763668  // 0x0076368f    72d7
    ...
    asm("{disp8} jne        LAB__addr_0x00763742");                          // 0x00763737    7509
    asm("push               0x0");                                           // 0x00763739    6a00
    asm("push               0x000000ff");                                    // 0x0076373b    68ff000000
    asm("{disp8} jmp        LAB__addr_0x00763749");                          // 0x00763740    eb07
    asm("LAB__addr_0x00763742:");
    asm("push               0x000000ff");                                    // 0x00763742    68ff000000
    asm("push               0x0");                                           // 0x00763747    6a00
    asm("LAB__addr_0x00763749:");
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00763756    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x0076375c    dfe0
    asm("test               ah, 0x40");                                      // 0x0076375e    f6c440
    asm("{disp8} je         LAB__addr_0x0076376b");                          // 0x00763761    7408
    asm("{disp32} fld       dword ptr [__real@4@00000000000000000000]");                   // 0x00763763    d90598a38a00
    asm("{disp8} jmp        LAB__addr_0x00763773");                          // 0x00763769    eb08
    asm("LAB__addr_0x0076376b:");
    asm("{disp8} fld        dword ptr [esp + 0x14]");                        // 0x0076376b    d9442414
    asm("{disp8} fdiv       dword ptr [esp + 0x10]");                        // 0x0076376f    d8742410
    asm("LAB__addr_0x00763773:");
    ...
    asm("call               __ftol");                                        // 0x0076377f    e87cdc0300
...
void __fastcall StopReacting__8VillagerFv(struct Living* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007637f6");                          // 0x007637da    751a
    ...
    asm("{disp8} je         LAB__addr_0x007637f6");                          // 0x007637e8    740c
...
uint8_t __fastcall FleeFromPredatorPriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp32} je        LAB__addr_0x00763969");                          // 0x0076387a    0f84e9000000
    ...
    asm("{disp8} jne        LAB__addr_0x007638b0");                          // 0x007638a7    7507
    asm("mov                ebx, 0x00000001");                               // 0x007638a9    bb01000000
    asm("{disp8} jmp        LAB__addr_0x007638b2");                          // 0x007638ae    eb02
    asm("LAB__addr_0x007638b0:");
    asm("xor.s              ebx, ebx");                                      // 0x007638b0    33db
    asm("LAB__addr_0x007638b2:");
    asm("test               byte ptr [edi + 0x000000e0], 0x04");             // 0x007638b2    f687e000000004
    asm("{disp32} jne       LAB__addr_0x00763969");                          // 0x007638b9    0f85aa000000
    ...
    asm("{disp32} je        LAB__addr_0x00763969");                          // 0x007638c9    0f849a000000
    asm("cmp                byte ptr [edi + 0x0000008d], al");               // 0x007638cf    38878d000000
    asm("{disp8} jne        LAB__addr_0x007638df");                          // 0x007638d5    7508
    asm("test               ebx, ebx");                                      // 0x007638d7    85db
    asm("{disp32} jne       LAB__addr_0x00763969");                          // 0x007638d9    0f858a000000
    asm("LAB__addr_0x007638df:");
    ...
    asm("{disp8} jne        LAB__addr_0x007638f7");                          // 0x007638eb    750a
    asm("cmp                word ptr [edi + 0x00000090], 0x14");             // 0x007638ed    6683bf9000000014
    asm("{disp8} jae        LAB__addr_0x00763922");                          // 0x007638f5    732b
    asm("LAB__addr_0x007638f7:");
    asm("{disp32} mov       al, byte ptr [esi + 0x0000008c]");               // 0x007638f7    8a868c000000
    asm("cmp                al, 0x23");                                      // 0x007638fd    3c23
    asm("{disp8} je         LAB__addr_0x00763969");                          // 0x007638ff    7468
    asm("cmp                al, 0x33");                                      // 0x00763901    3c33
    asm("{disp8} je         LAB__addr_0x00763969");                          // 0x00763903    7464
    asm("test               ebx, ebx");                                      // 0x00763905    85db
    asm("{disp8} je         LAB__addr_0x00763922");                          // 0x00763907    7419
    ...
    asm("{disp8} jbe        LAB__addr_0x00763922");                          // 0x00763914    760c
    ...
    asm("{disp8} je         LAB__addr_0x00763969");                          // 0x00763920    7447
    asm("LAB__addr_0x00763922:");
    ...
    asm("call               __ftol");                                        // 0x00763959    e8a2da0300
...
void __fastcall SetupFleeFromPredator__8VillagerFP16GameThingWithPosP8Reaction(struct Living* this, const void* edx, struct GameThingWithPos* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007639ad");                          // 0x0076399d    750e
...
void __fastcall SetupReactToFlyingObject__8VillagerFP16GameThingWithPosP8Reaction(struct Living* this, const void* edx, struct GameThingWithPos* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00763a7a");                          // 0x00763a59    751f
...
bool32_t __fastcall FleeingFromPredatorReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00763b8d");                          // 0x00763b84    7507
    ...
    asm("{disp8} jne        LAB__addr_0x00763bd9");                          // 0x00763bc1    7516
    ...
    asm("{disp8} jne        LAB__addr_0x00763c2e");                          // 0x00763be5    7547
    ...
    asm("{disp8} je         LAB__addr_0x00763c2e");                          // 0x00763c03    7429
    ...
    asm("{disp8} jne        LAB__addr_0x00763c51");                          // 0x00763c43    750c
    ...
    asm("{disp8} jne        LAB__addr_0x00763c69");                          // 0x00763c4f    7518
    asm("LAB__addr_0x00763c51:");
    ...
    asm("{disp8} jne        LAB__addr_0x00763c75");                          // 0x00763c67    750c
    asm("LAB__addr_0x00763c69:");
    ...
    asm("{disp8} jne        LAB__addr_0x00763c98");                          // 0x00763c73    7523
    asm("LAB__addr_0x00763c75:");
...
bool32_t __fastcall SetupGoAndHideInNearbyBuilding__8VillagerFP16GameThingWithPos(struct Villager* this, const void* edx, struct GameThingWithPos* param_1)
{
    ...
    asm("{disp32} je        LAB__addr_0x00763d80");                          // 0x00763cbf    0f84bb000000
    ...
    asm("{disp32} je        LAB__addr_0x00763d80");                          // 0x00763ce3    0f8497000000
    asm("push               ebp");                                           // 0x00763ce9    55
    asm("{disp8} lea        ebp, dword ptr [ebx + 0x14]");                   // 0x00763cea    8d6b14
    asm("LAB__addr_0x00763ced:");
    ...
    asm("{disp8} je         LAB__addr_0x00763d31");                          // 0x00763d16    7419
    ...
    asm("{disp8} je         LAB__addr_0x00763d31");                          // 0x00763d25    740a
...
bool32_t __fastcall GoAndHideInNearbyBuilding__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x00763edc");                          // 0x00763de8    0f84ee000000
    ...
    asm("{disp32} je        LAB__addr_0x00763eb3");                          // 0x00763e0c    0f84a1000000
    asm("{disp32} mov       eax, dword ptr [esi + 0x000000bc]");             // 0x00763e12    8b86bc000000
    asm("test               eax, eax");                                      // 0x00763e18    85c0
    asm("{disp8} je         LAB__addr_0x00763e50");                          // 0x00763e1a    7434
    ...
    asm("{disp32} jne       LAB__addr_0x00763ee6");                          // 0x00763e4a    0f8596000000
    asm("LAB__addr_0x00763e50:");
    ...
    asm("{disp8} jbe        LAB__addr_0x00763ee6");                          // 0x00763e7d    7667
...
struct Abode* __fastcall GetAbodeToHideInAtPos__8VillagerFRC9MapCoords(struct Villager* this, const void* edx, const struct MapCoords* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x00763f67");                          // 0x00763f1a    744b
    asm("LAB__addr_0x00763f1c:");
    ...
    asm("{disp8} je         LAB__addr_0x00763f52");                          // 0x00763f42    740e
    ...
    asm("{disp8} jne        LAB__addr_0x00763f6e");                          // 0x00763f50    751c
    asm("LAB__addr_0x00763f52:");
...
bool32_t __fastcall LookToSeeIfItIsSafe__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x00764057");                          // 0x00763f8f    0f84c2000000
    ...
    asm("{disp32} je        LAB__addr_0x00764057");                          // 0x00763fc3    0f848e000000
    ...
    asm("{disp8} je         LAB__addr_0x00764057");                          // 0x00763fd9    747c
    ...
    asm("{disp8} je         LAB__addr_0x00764057");                          // 0x00763fe9    746c
    asm("cmp                al, 0x33");                                      // 0x00763feb    3c33
    asm("{disp8} je         LAB__addr_0x00764057");                          // 0x00763fed    7468
    ...
    asm("{disp8} je         LAB__addr_0x0076403f");                          // 0x0076400b    7432
    ...
    asm("{disp8} jbe        LAB__addr_0x0076408b");                          // 0x0076407f    760a
...
uint32_t __fastcall NumGameTurnsToReactToPredatorFunction__8VillagerFP16GameThingWithPosUlf(struct Living* this, const void* edx, struct GameThingWithPos* param_1, uint32_t param_2, float param_3)
{
    ...
    asm("{disp8} je         LAB__addr_0x007640cd");                          // 0x007640ad    741e
    asm("cmp                al, -0x13");                                     // 0x007640af    3ced
    asm("{disp8} je         LAB__addr_0x007640cd");                          // 0x007640b1    741a
...
uint32_t __fastcall NumGameTurnsBeforeReactingAgainToBurningObjectFunction__8VillagerFP16GameThingWithPosUlf(struct Living* this, const void* edx, struct GameThingWithPos* param_1, uint32_t param_2, float param_3)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076418f");                          // 0x0076415f    752e
    ...
    asm("{disp8} je         LAB__addr_0x0076418f");                          // 0x00764176    7417
...
uint32_t __fastcall NumGameTurnsToReactToShieldFunction__8VillagerFP16GameThingWithPosUlf(struct Living* this, const void* edx, struct GameThingWithPos* param_1, uint32_t param_2, float param_3)
{
    ...
    asm("{disp8} je         LAB__addr_0x00764211");                          // 0x007641aa    7465
    ...
    asm("{disp8} je         LAB__addr_0x00764211");                          // 0x007641c2    744d
...
uint32_t __fastcall NumGameTurnsBeforeReactingToShieldAgainFunction__8VillagerFP16GameThingWithPosUlf(struct Living* this, const void* edx, struct GameThingWithPos* param_1, uint32_t param_2, float param_3)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076426f");                          // 0x0076423b    7432
    ...
    asm("{disp8} jbe        LAB__addr_0x0076426f");                          // 0x00764263    760a
    ...
    asm("{disp8} je         LAB__addr_0x0076429a");                          // 0x0076427f    7419
...
bool __fastcall LookingAtObjectReaction__8VillagerFv(struct Living* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007642d6");                          // 0x007642cb    7409
    asm("call               ?GetReaction@Living@@QAEXXZ");                   // 0x007642cd    e88e87e8ff
    asm("test               eax, eax");                                      // 0x007642d2    85c0
    asm("{disp8} jne        LAB__addr_0x007642e7");                          // 0x007642d4    7511
    asm("LAB__addr_0x007642d6:");
    ...
    asm("{disp8} jne        LAB__addr_0x00764307");                          // 0x007642f4    7511
...
bool __fastcall FollowingObjectReaction__8VillagerFv(struct Living* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00764343");                          // 0x00764330    7511
...
bool __fastcall InspectObjectReaction__8VillagerFv(struct Living* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00764379");                          // 0x00764363    7514
    ...
    asm("{disp32} fmul      dword ptr [__real@4@3fffc000000000000000]");                   // 0x007643a4    d80d4cb28a00
    asm("call               __ftol");                                        // 0x007643aa    e851d00300
    ...
    asm("call               __ftol");                                        // 0x007643da    e821d00300
...
bool32_t __fastcall PerformInspectionReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00764433");                          // 0x00764420    7511
    ...
    asm("LAB__addr_0x00764433:");
    asm("{disp32} fld       dword ptr [esi + 0x0000010c]");                  // 0x00764433    d9860c010000
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                   // 0x00764439    d81d90a38a00
    asm("fnstsw             ax");                                            // 0x0076443f    dfe0
    asm("test               ah, 0x01");                                      // 0x00764441    f6c401
    asm("{disp8} je         LAB__addr_0x00764457");                          // 0x00764444    7411
    ...
    asm("LAB__addr_0x00764457:");
    asm("dec                dword ptr [esi + 0x00000110]");                  // 0x00764457    ff8e10010000
    asm("{disp8} jne        LAB__addr_0x00764475");                          // 0x0076445d    7516
...
bool32_t __fastcall ApproachObjectReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007644b9");                          // 0x007644a3    7514
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                   // 0x007644dc    d81d90a38a00
    asm("fnstsw             ax");                                            // 0x007644e2    dfe0
    asm("test               ah, 0x41");                                      // 0x007644e4    f6c441
    asm("{disp32} jne       LAB__addr_0x0076457a");                          // 0x007644e7    0f858d000000
    ...
    asm("{disp32} fmul      dword ptr [__real@4@3fffc000000000000000]");                   // 0x00764597    d80d4cb28a00
    asm("call               __ftol");                                        // 0x0076459d    e85ece0300
    ...
    asm("call               __ftol");                                        // 0x007645c9    e832ce0300
...
bool32_t __fastcall InitialiseTellOthersAboutObject__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00764633");                          // 0x00764620    7511
...
bool __fastcall GotoFoodReaction__8VillagerFv(struct Living* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007646bf");                          // 0x007646ab    7412
...
bool __fastcall ArrivesAtWoodReaction__8VillagerFv(struct Living* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x007648ab");                          // 0x00764749    0f845c010000
    ...
    asm("{disp32} je        LAB__addr_0x007648ab");                          // 0x00764758    0f844d010000
    asm("test               byte ptr [edi + 0x24], 0x04");                   // 0x0076475e    f6472404
    asm("{disp32} jne       LAB__addr_0x007648ab");                          // 0x00764762    0f8543010000
    asm("mov.s              ecx, edi");                                      // 0x00764768    8bcf
    asm("call               _jmp_addr_0x00637cc0");                          // 0x0076476a    e85135edff
    asm("test               eax, eax");                                      // 0x0076476f    85c0
    asm("{disp32} jne       LAB__addr_0x007648ab");                          // 0x00764771    0f8534010000
    asm("test               byte ptr [edi + 0x24], 0x40");                   // 0x00764777    f6472440
    asm("{disp32} je        LAB__addr_0x00764856");                          // 0x0076477b    0f84d5000000
    ...
    asm("call               __ftol");                                        // 0x007647ae    e84dcc0300
    ...
    asm("{disp32} ja        LAB__addr_0x007648ab");                          // 0x007647ce    0f87d7000000
    ...
    asm("{disp8} je         LAB__addr_0x00764833");                          // 0x007647fa    7437
    ...
    asm("{disp32} je        LAB__addr_0x007648ba");                          // 0x00764808    0f84ac000000
    ...
    asm("{disp8} jne        LAB__addr_0x0076489d");                          // 0x00764863    7538
    ...
    asm("{disp8} jle        LAB__addr_0x0076489d");                          // 0x00764871    7e2a
    ...
    asm("{disp8} jle        LAB__addr_0x0076489d");                          // 0x00764888    7e13
...
uint32_t __fastcall StandardNumGameTurnsBeforeReactingToWoodAgainFunction__8VillagerFP16GameThingWithPosUlf(struct Living* this, const void* edx, struct GameThingWithPos* param_1, uint32_t param_2, float param_3)
{
    ...
    asm("{disp8} jl         LAB__addr_0x007648f5");                          // 0x007648e3    7c10
    asm("cmp                eax, 0x32");                                     // 0x007648e5    83f832
    asm("{disp8} jle        LAB__addr_0x007648ef");                          // 0x007648e8    7e05
    asm("cmp                eax, 0x34");                                     // 0x007648ea    83f834
    asm("{disp8} jne        LAB__addr_0x007648f5");                          // 0x007648ed    7506
    asm("LAB__addr_0x007648ef:");
    asm("xor.s              eax, eax");                                      // 0x007648ef    33c0
    asm("pop                esi");                                           // 0x007648f1    5e
    asm("ret                0x000c");                                        // 0x007648f2    c20c00
    asm("LAB__addr_0x007648f5:");
...
bool __fastcall ArrivesAtFoodReaction__8VillagerFv(struct Living* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076497c");                          // 0x0076496b    740f
    asm("test               edi, edi");                                      // 0x0076496d    85ff
    asm("{disp8} jle        LAB__addr_0x0076497c");                          // 0x0076496f    7e0b
    ...
    asm("{disp8} je         LAB__addr_0x007649ac");                          // 0x00764994    7416
    ...
    asm("{disp8} je         LAB__addr_0x007649db");                          // 0x007649ba    741f
    ...
    asm("{disp32} je        LAB__addr_0x00764a6c");                          // 0x007649d5    0f8491000000
    asm("LAB__addr_0x007649db:");
    ...
    asm("{disp8} je         LAB__addr_0x00764a6c");                          // 0x00764a38    7432
    ...
    asm("{disp8} jne        LAB__addr_0x00764a6c");                          // 0x00764a5e    750c
...
bool32_t __fastcall InitialiseBewilderedByMagicTreeReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00764aec");                          // 0x00764ad9    7511
...
bool32_t __fastcall PerformBewilderedByMagicTreeReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x00764cf5");                          // 0x00764b95    0f845a010000
    ...
    asm("{disp32} jae       LAB__addr_0x00764cf5");                          // 0x00764be6    0f8309010000
    ...
    asm("call               __ftol");                                        // 0x00764c4c    e8afc70300
    ...
    asm("call               __ftol");                                        // 0x00764c5f    e89cc70300
    ...
    asm("call               __ftol");                                        // 0x00764cac    e84fc70300
    ...
    asm("call               __ftol");                                        // 0x00764cdb    e820c70300
...
bool32_t __fastcall TurnToFaceMagicTree__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00764d5b");                          // 0x00764d39    7520
...
bool32_t __fastcall LookAtMagicTree__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00764dbb");                          // 0x00764dad    750c
    ...
    asm("LAB__addr_0x00764dbb:");
    asm("dec                byte ptr [esi + 0x58]");                         // 0x00764dbb    fe4e58
    asm("{disp8} jne        LAB__addr_0x00764de0");                          // 0x00764dbe    7520
...
bool __fastcall IsInterestedInFoodObject__8VillagerFP6Object(struct Living* this, const void* edx, struct Object* param_1)
{
    ...
    asm("{disp32} je        LAB__addr_0x00764f4e");                          // 0x00764e04    0f8444010000
    ...
    asm("{disp32} je        LAB__addr_0x00764f4e");                          // 0x00764e18    0f8430010000
    asm("test               al, 0x04");                                      // 0x00764e1e    a804
    asm("{disp32} jne       LAB__addr_0x00764f4e");                          // 0x00764e20    0f8528010000
    ...
    asm("{disp8} je         LAB__addr_0x00764eb8");                          // 0x00764eae    7408
    asm("{disp32} fld       dword ptr [rdata_bytes + 0x2478]");              // 0x00764eb0    d90578b48a00
    asm("{disp8} jmp        LAB__addr_0x00764ebe");                          // 0x00764eb6    eb06
    asm("LAB__addr_0x00764eb8:");
    asm("{disp32} fld       dword ptr [__real@4@3fff8000000000000000]");                   // 0x00764eb8    d90590a38a00
    asm("LAB__addr_0x00764ebe:");
    ...
    asm("{disp8} jne        LAB__addr_0x00764ef4");                          // 0x00764ee5    750d
    ...
    asm("{disp8} je         LAB__addr_0x00764f4e");                          // 0x00764eff    744d
    ...
    asm("{disp8} jne        LAB__addr_0x00764f4e");                          // 0x00764f3f    750d
...
bool __fastcall IsInterestedInWoodObject__8VillagerFP6Object(struct Living* this, const void* edx, struct Object* param_1)
{
    ...
    asm("{disp32} je        LAB__addr_0x00765132");                          // 0x00764f7d    0f84af010000
    ...
    asm("{disp32} je        LAB__addr_0x00765132");                          // 0x00764f8d    0f849f010000
    ...
    asm("{disp32} je        LAB__addr_0x00765132");                          // 0x00764f9d    0f848f010000
    asm("test               ebx, ebx");                                      // 0x00764fa3    85db
    asm("{disp32} je        LAB__addr_0x00765132");                          // 0x00764fa5    0f8487010000
    ...
    asm("{disp32} jne       LAB__addr_0x00765132");                          // 0x00764fc3    0f8569010000
    ...
    asm("{disp8} je         LAB__addr_0x00765004");                          // 0x00764fd5    742d
    ...
    asm("{disp8} jge        LAB__addr_0x00765004");                          // 0x00764fe8    7d1a
    ...
    asm("{disp8} je         LAB__addr_0x00765004");                          // 0x00764ff3    740f
    ...
    asm("{disp8} je         LAB__addr_0x00765032");                          // 0x00765018    7418
    asm("mov.s              ecx, ebp");                                      // 0x0076501a    8bcd
    asm("call               ?GetWoodNeededToBuild@BuildingSite@@QAEMXZ");    // 0x0076501c    e8cf75cdff
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00765021    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00765027    dfe0
    asm("test               ah, 0x41");                                      // 0x00765029    f6c441
    asm("{disp32} jne       LAB__addr_0x00765132");                          // 0x0076502c    0f8500010000
    asm("LAB__addr_0x00765032:");
    ...
    asm("{disp8} jne        LAB__addr_0x0076505a");                          // 0x0076503e    751a
    ...
    asm("{disp8} je         LAB__addr_0x00765074");                          // 0x00765058    741a
    asm("LAB__addr_0x0076505a:");
    ...
    asm("{disp8} je         LAB__addr_0x00765074");                          // 0x00765063    740f
    ...
    asm("{disp8} jne        LAB__addr_0x00765132");                          // 0x00765121    750f
...
bool32_t __fastcall ApproachHandReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00765163");                          // 0x00765150    7511
...
bool32_t __fastcall FindNearbyVillagerWhoIsntReacting__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076522e");                          // 0x007651de    754e
    ...
    asm("{disp8} je         LAB__addr_0x0076522e");                          // 0x007651ed    743f
    asm("LAB__addr_0x007651ef:");
    ...
    asm("{disp8} je         LAB__addr_0x00765214");                          // 0x00765208    740a
    asm("{disp32} mov       ecx, dword ptr [eax + 0x00000094]");             // 0x0076520a    8b8894000000
    asm("test               ecx, ecx");                                      // 0x00765210    85c9
    asm("{disp8} je         LAB__addr_0x00765251");                          // 0x00765212    743d
    asm("LAB__addr_0x00765214:");
    ...
    asm("{disp8} jne        LAB__addr_0x007651ef");                          // 0x0076522c    75c1
    asm("LAB__addr_0x0076522e:");
...
uint8_t __fastcall ReactToFlyingObjectPriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x00765292");                          // 0x00765276    741a
    ...
    asm("{disp8} jne        LAB__addr_0x00765292");                          // 0x00765285    750b
    ...
    asm("{disp8} jne        LAB__addr_0x00765308");                          // 0x007652a7    755f
    asm("{disp32} mov       edi, dword ptr [esi + 0x000000bc]");             // 0x007652a9    8bbebc000000
    asm("test               edi, edi");                                      // 0x007652af    85ff
    asm("{disp8} jne        LAB__addr_0x007652be");                          // 0x007652b1    750b
    ...
    asm("{disp8} je         LAB__addr_0x00765308");                          // 0x007652fb    740b
...
bool32_t __fastcall ArrivesAtPickupBallReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x007653d1");                          // 0x00765345    0f8486000000
    ...
    asm("{disp8} jne        LAB__addr_0x007653d1");                          // 0x00765355    757a
    ...
    asm("{disp8} je         LAB__addr_0x007653b6");                          // 0x00765369    744b
    ...
    asm("{disp8} je         LAB__addr_0x00765388");                          // 0x0076537c    740a
    ...
    asm("{disp8} je         LAB__addr_0x007653db");                          // 0x00765391    7448
    ...
    asm("{disp8} jne        LAB__addr_0x007653db");                          // 0x007653a5    7534
...
bool32_t __fastcall WatchFlyingObjectReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076543f");                          // 0x00765433    750a
...
bool32_t __fastcall PointAtFlyingObjectReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007654e7");                          // 0x007654cf    7516
    ...
    asm("{disp8} jne        LAB__addr_0x00765529");                          // 0x0076551d    750a
...
void __fastcall SetupReactToFire__8VillagerFP16GameThingWithPosP8Reaction(struct Living* this, const void* edx, struct GameThingWithPos* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp32} je        LAB__addr_0x0076560a");                          // 0x0076556a    0f849a000000
    asm("test               byte ptr [esi + 0x000000e0], 0x10");             // 0x00765570    f686e000000010
    asm("{disp8} je         LAB__addr_0x007655f6");                          // 0x00765577    747d
    ...
    asm("{disp8} je         LAB__addr_0x007655b6");                          // 0x007655a6    740e
    ...
    asm("{disp8} je         LAB__addr_0x0076560a");                          // 0x007655cf    7439
...
uint8_t __fastcall ReactToFirePriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00765649");                          // 0x0076563b    750c
    ...
    asm("{disp8} jne        LAB__addr_0x00765676");                          // 0x00765668    750c
    ...
    asm("{disp32} fadd      dword ptr [__real@4@3fff8000000000000000]");                   // 0x007656b6    d80590a38a00
    ...
    asm("{disp8} je         LAB__addr_0x00765702");                          // 0x007656cb    7435
    ...
    asm("{disp32} fadd      dword ptr [__real@4@3fff8000000000000000]");                   // 0x007656f6    d80590a38a00
    asm("{disp8} fimul      dword ptr [esp + 0x14]");                        // 0x007656fc    da4c2414
    asm("{disp8} jmp        LAB__addr_0x00765708");                          // 0x00765700    eb06
    asm("LAB__addr_0x00765702:");
    asm("{disp32} fld       dword ptr [__real@437f0000]");                   // 0x00765702    d90570b28a00
    asm("LAB__addr_0x00765708:");
    asm("call               __ftol");                                        // 0x00765708    e8f3bc0300
    ...
    asm("{disp8} jae        LAB__addr_0x0076573e");                          // 0x00765723    7319
    ...
    asm("{disp32} jne       LAB__addr_0x0076585a");                          // 0x00765738    0f851c010000
    asm("LAB__addr_0x0076573e:");
    ...
    asm("{disp32} je        LAB__addr_0x0076585a");                          // 0x0076574e    0f8406010000
    ...
    asm("{disp8} je         LAB__addr_0x00765775");                          // 0x00765769    740a
    asm("cmp                dword ptr [ecx + 0x24], 0x0a");                  // 0x0076576b    8379240a
    asm("{disp32} jne       LAB__addr_0x0076585a");                          // 0x0076576f    0f85e5000000
    asm("LAB__addr_0x00765775:");
    ...
    asm("{disp8} jne        LAB__addr_0x007657a5");                          // 0x00765787    751c
    asm("cmp.s              ecx, edi");                                      // 0x00765789    3bcf
    asm("{disp8} je         LAB__addr_0x007657b7");                          // 0x0076578b    742a
    asm("cmp                dword ptr [eax + 0x00d091bc], edi");             // 0x0076578d    39b8bc91d000
    asm("{disp8} jne        LAB__addr_0x007657a5");                          // 0x00765793    7510
    asm("cmp                dword ptr [eax + 0x00d091c0], edi");             // 0x00765795    39b8c091d000
    asm("{disp8} jne        LAB__addr_0x007657a5");                          // 0x0076579b    7508
    asm("cmp                dword ptr [eax + 0x00d091c4], edi");             // 0x0076579d    39b8c491d000
    asm("{disp8} je         LAB__addr_0x007657b7");                          // 0x007657a3    7412
    asm("LAB__addr_0x007657a5:");
    ...
    asm("{disp32} jne       LAB__addr_0x0076585a");                          // 0x007657b1    0f85a3000000
    asm("LAB__addr_0x007657b7:");
    asm("{disp32} mov       ecx, dword ptr [esi + 0x00000114]");             // 0x007657b7    8b8e14010000
    asm("cmp.s              ecx, edi");                                      // 0x007657bd    3bcf
    asm("{disp32} je        LAB__addr_0x0076585a");                          // 0x007657bf    0f8495000000
    asm("call               _jmp_addr_0x007305f0");                          // 0x007657c5    e826aefcff
    asm("test               eax, eax");                                      // 0x007657ca    85c0
    asm("{disp32} je        LAB__addr_0x0076585a");                          // 0x007657cc    0f8488000000
    ...
    asm("{disp8} je         LAB__addr_0x007657f0");                          // 0x007657e2    740c
    ...
    asm("{disp8} je         LAB__addr_0x0076585a");                          // 0x0076580d    744b
    ...
    asm("{disp8} jne        LAB__addr_0x0076585a");                          // 0x00765840    7518
...
bool32_t __fastcall ReactToFire__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007658a2");                          // 0x00765898    7508
    ...
    asm("{disp32} je        LAB__addr_0x00765b5a");                          // 0x007658c5    0f848f020000
    ...
    asm("{disp8} je         LAB__addr_0x00765921");                          // 0x00765903    741c
    ...
    asm("{disp8} jne        LAB__addr_0x00765937");                          // 0x0076591f    7516
    asm("LAB__addr_0x00765921:");
    ...
    asm("{disp32} jne       LAB__addr_0x00765a05");                          // 0x00765931    0f85ce000000
    asm("LAB__addr_0x00765937:");
    asm("xor.s              ebp, ebp");                                      // 0x00765937    33ed
    asm("cmp.s              edi, ebp");                                      // 0x00765939    3bfd
    asm("{disp8} je         LAB__addr_0x00765992");                          // 0x0076593b    7455
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x0076596f    e8bc8bf7ff
    ...
    asm("{disp8} jmp        LAB__addr_0x007659b8");                          // 0x00765990    eb26
    asm("LAB__addr_0x00765992:");
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x007659a1    e88a8bf7ff
    ...
    asm("{disp8} jne        LAB__addr_0x00765a5b");                          // 0x00765a32    7527
    asm("test               eax, eax");                                      // 0x00765a34    85c0
    asm("{disp8} je         LAB__addr_0x00765a44");                          // 0x00765a36    740c
    asm("test               ecx, ecx");                                      // 0x00765a38    85c9
    asm("{disp8} jne        LAB__addr_0x00765a5b");                          // 0x00765a3a    751f
    asm("test               edx, edx");                                      // 0x00765a3c    85d2
    asm("{disp8} jne        LAB__addr_0x00765a5b");                          // 0x00765a3e    751b
    asm("test               edi, edi");                                      // 0x00765a40    85ff
    asm("{disp8} jne        LAB__addr_0x00765a5b");                          // 0x00765a42    7517
    asm("LAB__addr_0x00765a44:");
    ...
    asm("{disp32} je        LAB__addr_0x00765b33");                          // 0x00765a64    0f84c9000000
    asm("test               byte ptr [esi + 0x000000e0], 0x10");             // 0x00765a6a    f686e000000010
    asm("{disp32} jne       LAB__addr_0x00765b33");                          // 0x00765a71    0f85bc000000
    ...
    asm("{disp32} fmul      dword ptr [__real@4@4001c90fdb0000000000]");                   // 0x00765aa0    d80d10b28a00
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00765abf    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00765ac5    dfe0
    asm("test               ah, 0x40");                                      // 0x00765ac7    f6c440
    asm("{disp8} jne        LAB__addr_0x00765af4");                          // 0x00765aca    7528
    ...
    asm("{disp8} jmp        LAB__addr_0x00765afc");                          // 0x00765af2    eb08
    asm("LAB__addr_0x00765af4:");
    asm("{disp8} mov        dword ptr [esp + 0x10], 0x00000000");            // 0x00765af4    c744241000000000
    asm("LAB__addr_0x00765afc:");
    ...
    asm("{disp8} jne        LAB__addr_0x00765b33");                          // 0x00765b25    750c
    ...
    asm("{disp8} jne        LAB__addr_0x00765b5a");                          // 0x00765b31    7527
    asm("LAB__addr_0x00765b33:");
...
uint8_t __fastcall ReactToMagicShieldPriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x00765c55");                          // 0x00765bd7    747c
    ...
    asm("{disp8} je         LAB__addr_0x00765c55");                          // 0x00765be2    7471
    ...
    asm("{disp8} je         LAB__addr_0x00765c48");                          // 0x00765c08    743e
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00765c14    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00765c1a    dfe0
    asm("test               ah, 0x40");                                      // 0x00765c1c    f6c440
    asm("{disp8} jne        LAB__addr_0x00765c55");                          // 0x00765c1f    7534
    ...
    asm("{disp8} ja         LAB__addr_0x00765c55");                          // 0x00765c46    770d
    asm("LAB__addr_0x00765c48:");
...
void __fastcall SetupReactToMagicShield__8VillagerFP16GameThingWithPosP8Reaction(struct Living* this, const void* edx, struct GameThingWithPos* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp32} je        LAB__addr_0x00765df6");                          // 0x00765c86    0f846a010000
    ...
    asm("{disp32} jne       LAB__addr_0x00765d8b");                          // 0x00765ccb    0f85ba000000
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x00765cf7    e83488f7ff
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x00765d2b    e80088f7ff
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z"); // 0x00765d59    e82278feff
    ...
    asm("call               ??HMapCoords@@QBE?AU0@ABU0@@Z");            // 0x00765d75    e8a6f7e9ff
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x00765db1    e87a87f7ff
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z"); // 0x00765dd3    e8a877feff
    ...
    asm("call               ??HMapCoords@@QBE?AU0@ABU0@@Z");            // 0x00765de3    e838f7e9ff
...
bool32_t __fastcall AmazedByMagicShieldReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x00765fc0");                          // 0x00765e10    0f84aa010000
    ...
    asm("{disp32} je        LAB__addr_0x00765fc0");                          // 0x00765e35    0f8485010000
    ...
    asm("{disp32} je        LAB__addr_0x00765fc0");                          // 0x00765e44    0f8476010000
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00765e54    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00765e5a    dfe0
    asm("test               ah, 0x41");                                      // 0x00765e5c    f6c441
    asm("{disp32} jne       LAB__addr_0x00765fc0");                          // 0x00765e5f    0f855b010000
    ...
    asm("{disp32} je        LAB__addr_0x00765f0c");                          // 0x00765e82    0f8484000000
    ...
    asm("{disp8} jne        LAB__addr_0x00765f0c");                          // 0x00765e9e    756c
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x00765ecd    e85e86f7ff
    ...
    asm("call               ?GetPosFromAngle@GUtils@@SA?AUMapCoords@@MM@Z"); // 0x00765eef    e88c76feff
    ...
    asm("call               ??HMapCoords@@QBE?AU0@ABU0@@Z");            // 0x00765eff    e81cf6e9ff
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x00765f1b    e81086f7ff
    ...
    asm("{disp8} jle        LAB__addr_0x00765f6a");                          // 0x00765f60    7e08
    asm("{disp32} mov       edi, dword ptr [eax + 0x0000047c]");             // 0x00765f62    8bb87c040000
    asm("{disp8} jmp        LAB__addr_0x00765f6d");                          // 0x00765f68    eb03
    asm("LAB__addr_0x00765f6a:");
    asm("{disp8} mov        edi, dword ptr [eax + 0x04]");                   // 0x00765f6a    8b7804
    asm("LAB__addr_0x00765f6d:");
    ...
    asm("{disp8} jne        LAB__addr_0x00765f89");                          // 0x00765f7a    750d
    asm("{disp32} fld       dword ptr [__real@4@3fff8000000000000000]");                   // 0x00765f7c    d90590a38a00
    asm("mov                ebx, 0x0000018b");                               // 0x00765f82    bb8b010000
    asm("{disp8} jmp        LAB__addr_0x00765f8d");                          // 0x00765f87    eb04
    asm("LAB__addr_0x00765f89:");
    asm("{disp8} fld        dword ptr [esp + 0x0c]");                        // 0x00765f89    d944240c
    asm("LAB__addr_0x00765f8d:");
    asm("call               __ftol");                                        // 0x00765f8d    e86eb40300
    ...
    asm("{disp8} je         LAB__addr_0x00765fb4");                          // 0x00765f9c    7416
    ...
    asm("call               __ftol");                                        // 0x00765fef    e80cb40300
...
void __fastcall SetupReactToNewBuilding__8VillagerFP16GameThingWithPosP8Reaction(struct Living* this, const void* edx, struct GameThingWithPos* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007660b9");                          // 0x00766046    7571
    ...
    asm("{disp8} jne        LAB__addr_0x0076605f");                          // 0x00766058    7505
    asm("mov                esi, 0x00000005");                               // 0x0076605a    be05000000
    asm("LAB__addr_0x0076605f:");
    ...
    asm("{disp8} je         LAB__addr_0x0076611e");                          // 0x007660ae    746e
    asm("{disp8} mov        edx, dword ptr [esp + 0x24]");                   // 0x007660b0    8b542424
    asm("{disp8} mov        dword ptr [edx + 0x28], esi");                   // 0x007660b4    897228
    asm("{disp8} jmp        LAB__addr_0x007660bb");                          // 0x007660b7    eb02
    asm("LAB__addr_0x007660b9:");
    asm("fstp               st(0)");                                         // 0x007660b9    ddd8
    asm("LAB__addr_0x007660bb:");
    ...
    asm("{disp8} jne        LAB__addr_0x0076610d");                          // 0x007660cc    753f
...
bool32_t __fastcall DanceWhileReacting__8VillagerFv(struct Villager* this)
{
    ...
    asm("call               ??9MapCoords@@QBEIABU0@@Z");                 // 0x00766168    e843f5e9ff
    asm("test               eax, eax");                                      // 0x0076616d    85c0
    asm("{disp8} je         LAB__addr_0x007661af");                          // 0x0076616f    743e
    ...
    asm("call               ??8MapCoords@@QBEIABU0@@Z");            // 0x0076618a    e8d1f4e9ff
    asm("test               eax, eax");                                      // 0x0076618f    85c0
    asm("{disp8} je         LAB__addr_0x007661af");                          // 0x00766191    741c
    ...
    asm("{disp8} jne        LAB__addr_0x007661cd");                          // 0x007661bb    7510
...
void __fastcall SetupReactToTeleport__8VillagerFP16GameThingWithPosP8Reaction(struct Living* this, const void* edx, struct GameThingWithPos* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x007662de");                          // 0x00766274    7468
...
bool32_t __fastcall GoToTeleportReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00766351");                          // 0x00766336    7419
...
bool32_t __fastcall ExitReactToTeleport__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007663d2");                          // 0x007663ad    7523
    ...
    asm("{disp8} je         LAB__addr_0x007663c9");                          // 0x007663b8    740f
...
bool32_t __fastcall TeleportReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00766400");                          // 0x007663fb    7503
    asm("pop                edi");                                           // 0x007663fd    5f
    asm("pop                esi");                                           // 0x007663fe    5e
    asm("ret");                                                              // 0x007663ff    c3
    asm("LAB__addr_0x00766400:");
    ...
    asm("{disp8} jne        LAB__addr_0x00766421");                          // 0x0076641c    7503
    asm("pop                edi");                                           // 0x0076641e    5f
    asm("pop                esi");                                           // 0x0076641f    5e
    asm("ret");                                                              // 0x00766420    c3
    asm("LAB__addr_0x00766421:");
...
uint8_t __fastcall ReactToDeathPriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x00766462");                          // 0x00766455    740b
    ...
    asm("{disp8} je         LAB__addr_0x0076648a");                          // 0x0076646b    741d
    ...
    asm("{disp8} je         LAB__addr_0x0076648a");                          // 0x0076647c    740c
    ...
    asm("{disp8} jne        LAB__addr_0x0076649f");                          // 0x00766488    7515
    asm("LAB__addr_0x0076648a:");
    asm("cmp.s              esi, edi");                                      // 0x0076648a    3bf7
    asm("{disp8} je         LAB__addr_0x0076649f");                          // 0x0076648c    7411
    asm("cmp                dword ptr [ebx + 0x1c], 0x0a");                  // 0x0076648e    837b1c0a
    asm("{disp8} jae        LAB__addr_0x0076649f");                          // 0x00766492    730b
...
uint8_t __fastcall ReactToDroppedByHandPriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp32} je        LAB__addr_0x0076659f");                          // 0x007664db    0f84be000000
    ...
    asm("{disp32} je        LAB__addr_0x0076659f");                          // 0x007664ea    0f84af000000
    ...
    asm("{disp32} jne       LAB__addr_0x0076659f");                          // 0x007664fe    0f859b000000
    ...
    asm("{disp32} jne       LAB__addr_0x0076659f");                          // 0x00766518    0f8581000000
    ...
    asm("{disp8} je         LAB__addr_0x0076659f");                          // 0x00766539    7464
    ...
    asm("{disp8} je         LAB__addr_0x0076659f");                          // 0x00766544    7459
    ...
    asm("{disp8} je         LAB__addr_0x0076659f");                          // 0x00766555    7448
    ...
    asm("{disp8} je         LAB__addr_0x0076659f");                          // 0x00766560    743d
    ...
    asm("{disp8} jne        LAB__addr_0x0076659f");                          // 0x0076656e    752f
    ...
    asm("{disp8} jne        LAB__addr_0x0076659f");                          // 0x0076657c    7521
    ...
    asm("{disp8} jne        LAB__addr_0x0076659f");                          // 0x0076658a    7513
    asm("test               byte ptr [esi + 0x000000e0], -0x80");            // 0x0076658c    f686e000000080
    asm("{disp8} jne        LAB__addr_0x0076659f");                          // 0x00766593    750a
...
void __fastcall SetupReactToDeath__8VillagerFP16GameThingWithPosP8Reaction(struct Living* this, const void* edx, struct GameThingWithPos* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007665f3");                          // 0x007665e4    750d
    ...
    asm("{disp8} jmp        LAB__addr_0x007665fa");                          // 0x007665f1    eb07
    asm("LAB__addr_0x007665f3:");
    asm("mov                edx, dword ptr [esi]");                          // 0x007665f3    8b16
    asm("push               0x000000ce");                                    // 0x007665f5    68ce000000
    asm("LAB__addr_0x007665fa:");
...
void __fastcall SetupReactToDroppedByHand__8VillagerFP16GameThingWithPosP8Reaction(struct Living* this, const void* edx, struct GameThingWithPos* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076666c");                          // 0x00766646    7424
    ...
    asm("{disp8} je         LAB__addr_0x0076666c");                          // 0x00766651    7419
    asm("test               byte ptr [edi + 0x000000e1], 0x04");             // 0x00766653    f687e100000004
    asm("{disp8} jne        LAB__addr_0x0076666c");                          // 0x0076665a    7510
...
bool32_t __fastcall PointAtDeadPerson__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007666f2");                          // 0x00766696    745a
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x007666ab    e8807ef7ff
    ...
    asm("call               __ftol");                                        // 0x007666d6    e825ad0300
    asm("movsx              ecx, word ptr [esi + 0x58]");                    // 0x007666db    0fbf4e58
    asm("cmp.s              ecx, eax");                                      // 0x007666df    3bc8
    asm("{disp8} jle        LAB__addr_0x007666f2");                          // 0x007666e1    7e0f
...
bool32_t __fastcall GoTowardsDeadPerson__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076671b");                          // 0x00766710    7509
    ...
    asm("{disp32} je        LAB__addr_0x007667ef");                          // 0x0076675b    0f848e000000
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                   // 0x00766782    d81d90a38a00
    asm("fnstsw             ax");                                            // 0x00766788    dfe0
    asm("test               ah, 0x41");                                      // 0x0076678a    f6c441
    asm("{disp8} jne        LAB__addr_0x007667ef");                          // 0x0076678d    7560
...
bool32_t __fastcall LookAtDeadPerson__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076683b");                          // 0x00766824    7515
...
bool32_t __fastcall MournDeadPerson__8VillagerFv(struct Villager* this)
{
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x00766869    e8c27cf7ff
    ...
    asm("call               __ftol");                                        // 0x00766894    e867ab0300
    asm("movsx              ecx, word ptr [esi + 0x58]");                    // 0x00766899    0fbf4e58
    asm("cmp.s              ecx, eax");                                      // 0x0076689d    3bc8
    asm("{disp8} jle        LAB__addr_0x007668ab");                          // 0x0076689f    7e0a
...
bool32_t __fastcall ConfusedReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} jbe       LAB__addr_0x00766a00");                          // 0x00766945    0f86b5000000
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x00766971    e8ba7bf7ff
    ...
    asm("call               __ftol");                                        // 0x0076699a    e861aa0300
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x007669ba    e8717bf7ff
    ...
    asm("call               __ftol");                                        // 0x007669e6    e815aa0300
...
bool32_t __fastcall CrowdReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00766b4f    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00766b55    dfe0
    asm("test               ah, 0x40");                                      // 0x00766b57    f6c440
    asm("{disp8} je         LAB__addr_0x00766b7c");                          // 0x00766b5a    7420
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00766b5c    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00766b62    dfe0
    asm("test               ah, 0x40");                                      // 0x00766b64    f6c440
    asm("{disp8} je         LAB__addr_0x00766b7e");                          // 0x00766b67    7415
    asm("{disp8} fld        dword ptr [esp + 0x28]");                        // 0x00766b69    d9442428
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00766b6d    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00766b73    dfe0
    asm("test               ah, 0x40");                                      // 0x00766b75    f6c440
    asm("{disp8} jne        LAB__addr_0x00766ba2");                          // 0x00766b78    7528
    asm("{disp8} jmp        LAB__addr_0x00766b7e");                          // 0x00766b7a    eb02
    asm("LAB__addr_0x00766b7c:");
    asm("fstp               st(0)");                                         // 0x00766b7c    ddd8
    asm("LAB__addr_0x00766b7e:");
    ...
    asm("{disp32} fdivr     dword ptr [__real@4@3fff8000000000000000]");                   // 0x00766b8c    d83d90a38a00
    ...
    asm("{disp32} jne       LAB__addr_0x00766c39");                          // 0x00766bb1    0f8582000000
    ...
    asm("call               __ftol");                                        // 0x00766beb    e810a80300
    ...
    asm("call               __ftol");                                        // 0x00766bfe    e8fda70300
...
bool32_t __fastcall MoveTowardsObjectToLookAt__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00766c89");                          // 0x00766c73    7514
    ...
    asm("{disp8} jne        LAB__addr_0x00766cf2");                          // 0x00766cd7    7519
...
bool32_t __fastcall InitialiseImpressedReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00766d51");                          // 0x00766d29    7526
...
bool32_t __fastcall PerformImpressedReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} fmul      dword ptr [__real@4@3fffc000000000000000]");                   // 0x00766d9f    d80d4cb28a00
    asm("call               __ftol");                                        // 0x00766da5    e856a60300
    asm("movsx              ecx, di");                                       // 0x00766daa    0fbfcf
    asm("cmp.s              ecx, eax");                                      // 0x00766dad    3bc8
    asm("pop                edi");                                           // 0x00766daf    5f
    asm("{disp8} jle        LAB__addr_0x00766ddc");                          // 0x00766db0    7e2a
    ...
    asm("{disp8} jne        LAB__addr_0x00766ddc");                          // 0x00766dc5    7515
...
uint8_t __fastcall ReactToFightPriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00766e17");                          // 0x00766e10    7505
    asm("xor.s              al, al");                                        // 0x00766e12    32c0
    asm("ret                0x0008");                                        // 0x00766e14    c20800
    asm("LAB__addr_0x00766e17:");
...
bool32_t __fastcall InitialiseFightReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x00766f9a");                          // 0x00766e77    0f841d010000
    ...
    asm("LAB__addr_0x00766ee3:");
    asm("mov                eax, dword ptr [eax]");                          // 0x00766ee3    8b00
    asm("{disp8} jmp        LAB__addr_0x00766ed1");                          // 0x00766ee5    ebea
    asm("LAB__addr_0x00766ee7:");
    asm("cmp                esi, -0x01");                                    // 0x00766ee7    83feff
    asm("{disp32} je        LAB__addr_0x00766fa4");                          // 0x00766eea    0f84b4000000
    ...
    asm("call               __ftol");                                        // 0x00766f3d    e8bea40300
    ...
    asm("call               __ftol");                                        // 0x00766f74    e887a40300
...
void __fastcall SetupReactToTownCelebration__8VillagerFP16GameThingWithPosP8Reaction(struct Living* this, const void* edx, struct GameThingWithPos* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x00767059");                          // 0x00766fe9    746e
    ...
    asm("{disp8} jne        LAB__addr_0x0076703c");                          // 0x00766ff4    7546
    ...
    asm("{disp32} je        LAB__addr_0x00767173");                          // 0x00767033    0f843a010000
    asm("{disp8} mov        dword ptr [esi + 0x28], eax");                   // 0x00767039    894628
    asm("LAB__addr_0x0076703c:");
    ...
    asm("{disp8} jne        LAB__addr_0x007670fa");                          // 0x00767085    7573
    ...
    asm("{disp8} je         LAB__addr_0x00767114");                          // 0x00767106    740c
    ...
    asm("{disp8} jne        LAB__addr_0x00767162");                          // 0x00767125    753b
...
uint8_t __fastcall ReactToBreederPriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076726c");                          // 0x00767228    7442
    asm("{disp8} mov        esi, dword ptr [ebx + 0x14]");                   // 0x0076722a    8b7314
    asm("test               esi, esi");                                      // 0x0076722d    85f6
    asm("{disp8} je         LAB__addr_0x0076726c");                          // 0x0076722f    743b
    asm("cmp.s              edi, esi");                                      // 0x00767231    3bfe
    asm("{disp8} je         LAB__addr_0x0076726c");                          // 0x00767233    7437
    ...
    asm("{disp8} je         LAB__addr_0x0076726c");                          // 0x0076723e    742c
    ...
    asm("{disp8} je         LAB__addr_0x0076726c");                          // 0x00767252    7418
    asm("{disp8} mov        eax, dword ptr [ebx + 0x1c]");                   // 0x00767254    8b431c
    asm("test               eax, eax");                                      // 0x00767257    85c0
    asm("{disp8} jne        LAB__addr_0x0076726c");                          // 0x00767259    7511
    asm("test               byte ptr [edi + 0x25], 0x04");                   // 0x0076725b    f6472504
    asm("{disp8} jne        LAB__addr_0x0076726c");                          // 0x0076725f    750b
...
bool32_t __fastcall ReactToBreeder__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007672b0");                          // 0x0076728b    7423
    ...
    asm("{disp8} je         LAB__addr_0x007672b0");                          // 0x00767299    7415
...
uint8_t __fastcall ReactToVillagerInHandPriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x00767391");                          // 0x00767337    7458
    asm("{disp8} mov        esi, dword ptr [esi + 0x14]");                   // 0x00767339    8b7614
    asm("test               esi, esi");                                      // 0x0076733c    85f6
    asm("{disp8} je         LAB__addr_0x00767391");                          // 0x0076733e    7451
    ...
    asm("{disp8} jne        LAB__addr_0x00767391");                          // 0x0076734c    7543
    ...
    asm("{disp8} je         LAB__addr_0x00767391");                          // 0x00767357    7438
    ...
    asm("{disp8} je         LAB__addr_0x00767391");                          // 0x0076736b    7424
    ...
    asm("{disp8} jne        LAB__addr_0x00767391");                          // 0x0076737f    7510
    asm("test               byte ptr [edi + 0x25], 0x04");                   // 0x00767381    f6472504
    asm("{disp8} jne        LAB__addr_0x00767391");                          // 0x00767385    750a
...
bool32_t __fastcall WaitForMate__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007673f5");                          // 0x007673c4    742f
    ...
    asm("{disp8} je         LAB__addr_0x007673ff");                          // 0x007673d8    7425
    ...
    asm("{disp8} je         LAB__addr_0x007673ff");                          // 0x007673e5    7418
...
uint8_t __fastcall ReactToBurningObjectInHandPriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076747e");                          // 0x0076745e    751e
...
void __fastcall SetupReactToMagicShieldStruck__8VillagerFP16GameThingWithPosP8Reaction(struct Living* this, const void* edx, struct GameThingWithPos* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076750f");                          // 0x007674d3    743a
...
uint8_t __fastcall ReactToMagicShieldStruckPriority__8VillagerFP8ReactionP8Reaction(struct Living* this, const void* edx, struct Reaction* param_1, struct Reaction* param_2)
{
    ...
    asm("{disp8} je         LAB__addr_0x00767596");                          // 0x00767566    742e
