...
uint32_t __fastcall GetSizeUV2Data__8LH3DMeshFv(struct LH3DMesh* param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0040374d");                          // 0x00403748    7503
    asm("xor.s              eax, eax");                                      // 0x0040374a    33c0
    asm("ret");                                                              // 0x0040374c    c3
    asm("LAB__addr_0x0040374d:");
    asm("test               ah, -0x80");                                     // 0x0040374d    f6c480
    asm("{disp8} je         LAB__addr_0x0040375b");                          // 0x00403750    7409
...
uint32_t __fastcall GetSizeNameData__8LH3DMeshFv(struct LH3DMesh* param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0040377e");                          // 0x00403779    7503
    asm("xor.s              eax, eax");                                      // 0x0040377b    33c0
    asm("ret");                                                              // 0x0040377d    c3
    asm("LAB__addr_0x0040377e:");
    ...
    asm("{disp8} je         LAB__addr_0x00403792");                          // 0x00403788    7408
    asm("{disp8} mov        eax, dword ptr [ecx + 0x48]");                   // 0x0040378a    8b4148
    asm("{disp8} mov        edi, dword ptr [eax + 0x08]");                   // 0x0040378d    8b7808
    asm("{disp8} jmp        LAB__addr_0x00403794");                          // 0x00403790    eb02
    asm("LAB__addr_0x00403792:");
    asm("xor.s              edi, edi");                                      // 0x00403792    33ff
    asm("LAB__addr_0x00403794:");
    asm("test               edx, 0x00040000");                               // 0x00403794    f7c200000400
    asm("{disp8} je         LAB__addr_0x004037c7");                          // 0x0040379a    742b
    asm("test               esi, esi");                                      // 0x0040379c    85f6
    asm("{disp8} je         LAB__addr_0x004037b4");                          // 0x0040379e    7414
...
uint32_t __fastcall GetSizeEMetricsData__8LH3DMeshFv(struct LH3DMesh* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x0040380b");                          // 0x004037fd    740c
    ...
    asm("{disp8} jmp        LAB__addr_0x00403813");                          // 0x00403809    eb08
    asm("LAB__addr_0x0040380b:");
    asm("{disp8} mov        dword ptr [esp + 0x10], 0x00000000");            // 0x0040380b    c744241000000000
    asm("LAB__addr_0x00403813:");
    asm("mov.s              ebx, esi");                                      // 0x00403813    8bde
    asm("and                ebx, 0x00040000");                               // 0x00403815    81e300000400
    asm("{disp8} je         LAB__addr_0x0040383a");                          // 0x0040381b    741d
    asm("test               edi, edi");                                      // 0x0040381d    85ff
    asm("{disp8} je         LAB__addr_0x0040382e");                          // 0x0040381f    740d
    ...
    asm("{disp8} jmp        LAB__addr_0x0040383c");                          // 0x0040382c    eb0e
    asm("LAB__addr_0x0040382e:");
    ...
    asm("{disp8} jmp        LAB__addr_0x0040383c");                          // 0x00403838    eb02
    asm("LAB__addr_0x0040383a:");
    asm("xor.s              ebp, ebp");                                      // 0x0040383a    33ed
    asm("LAB__addr_0x0040383c:");
    asm("test               esi, 0x00080000");                               // 0x0040383c    f7c600000800
    asm("{disp32} je        LAB__addr_0x004038ca");                          // 0x00403842    0f8482000000
    asm("test               edi, edi");                                      // 0x00403848    85ff
    asm("{disp8} je         LAB__addr_0x00403854");                          // 0x0040384a    7408
    asm("{disp8} mov        eax, dword ptr [ecx + 0x48]");                   // 0x0040384c    8b4148
    asm("{disp8} mov        esi, dword ptr [eax + 0x08]");                   // 0x0040384f    8b7008
    asm("{disp8} jmp        LAB__addr_0x00403856");                          // 0x00403852    eb02
    asm("LAB__addr_0x00403854:");
    asm("xor.s              esi, esi");                                      // 0x00403854    33f6
    asm("LAB__addr_0x00403856:");
    asm("test               ebx, ebx");                                      // 0x00403856    85db
    asm("{disp8} je         LAB__addr_0x004038ab");                          // 0x00403858    7451
    asm("test               edi, edi");                                      // 0x0040385a    85ff
    asm("{disp8} je         LAB__addr_0x00403885");                          // 0x0040385c    7427
...
uint32_t __fastcall GetSizeEBone__8LH3DMeshFv(struct LH3DMesh* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x00403911");                          // 0x00403903    740c
    ...
    asm("{disp8} jmp        LAB__addr_0x00403919");                          // 0x0040390f    eb08
    asm("LAB__addr_0x00403911:");
    asm("{disp8} mov        dword ptr [esp + 0x14], 0x00000000");            // 0x00403911    c744241400000000
    asm("LAB__addr_0x00403919:");
    asm("mov.s              ebp, edx");                                      // 0x00403919    8bea
    asm("and                ebp, 0x00040000");                               // 0x0040391b    81e500000400
    asm("{disp8} je         LAB__addr_0x00403946");                          // 0x00403921    7423
    asm("test               ebx, ebx");                                      // 0x00403923    85db
    asm("{disp8} je         LAB__addr_0x00403937");                          // 0x00403925    7410
    ...
    asm("{disp8} jmp        LAB__addr_0x0040394e");                          // 0x00403935    eb17
    asm("LAB__addr_0x00403937:");
    ...
    asm("{disp8} jmp        LAB__addr_0x0040394e");                          // 0x00403944    eb08
    asm("LAB__addr_0x00403946:");
    asm("{disp8} mov        dword ptr [esp + 0x10], 0x00000000");            // 0x00403946    c744241000000000
    asm("LAB__addr_0x0040394e:");
    asm("test               edx, 0x00080000");                               // 0x0040394e    f7c200000800
    asm("{disp8} je         LAB__addr_0x004039ac");                          // 0x00403954    7456
    asm("test               ebx, ebx");                                      // 0x00403956    85db
    asm("{disp8} je         LAB__addr_0x00403962");                          // 0x00403958    7408
    asm("{disp8} mov        eax, dword ptr [esi + 0x48]");                   // 0x0040395a    8b4648
    asm("{disp8} mov        edi, dword ptr [eax + 0x08]");                   // 0x0040395d    8b7808
    asm("{disp8} jmp        LAB__addr_0x00403964");                          // 0x00403960    eb02
    asm("LAB__addr_0x00403962:");
    asm("xor.s              edi, edi");                                      // 0x00403962    33ff
    asm("LAB__addr_0x00403964:");
    asm("test               ebp, ebp");                                      // 0x00403964    85ed
    asm("{disp8} je         LAB__addr_0x0040399e");                          // 0x00403966    7436
    asm("test               ebx, ebx");                                      // 0x00403968    85db
    asm("{disp8} je         LAB__addr_0x00403989");                          // 0x0040396a    741d
    ...
    asm("{disp8} jmp        LAB__addr_0x004039ae");                          // 0x00403987    eb25
    asm("LAB__addr_0x00403989:");
    ...
    asm("{disp8} jmp        LAB__addr_0x004039ae");                          // 0x0040399c    eb10
    asm("LAB__addr_0x0040399e:");
    ...
    asm("{disp8} jmp        LAB__addr_0x004039dd");                          // 0x004039d9    eb02
    asm("LAB__addr_0x004039db:");
    asm("xor.s              edi, edi");                                      // 0x004039db    33ff
    asm("LAB__addr_0x004039dd:");
    asm("test               dword ptr [esi + 0x04], 0x00080000");            // 0x004039dd    f7460400000800
    asm("{disp8} je         LAB__addr_0x004039fc");                          // 0x004039e4    7416
    ...
    asm("{disp8} jmp        LAB__addr_0x00403a0d");                          // 0x004039fa    eb11
    asm("LAB__addr_0x004039fc:");
    ...
    asm("{disp8} jmp        LAB__addr_0x00403a0d");                          // 0x00403a09    eb02
    asm("LAB__addr_0x00403a0b:");
    asm("xor.s              ecx, ecx");                                      // 0x00403a0b    33c9
    asm("LAB__addr_0x00403a0d:");
...
uint32_t __fastcall GetSizeTnLData__8LH3DMeshFv(struct LH3DMesh* param_1)
{
    ...
    asm("{disp32} je        LAB__addr_0x00403b7d");                          // 0x00403a40    0f8437010000
    asm("mov.s              edx, edi");                                      // 0x00403a46    8bd7
    asm("and                edx, 0x00008000");                               // 0x00403a48    81e200800000
    asm("{disp8} je         LAB__addr_0x00403a5c");                          // 0x00403a4e    740c
    ...
    asm("{disp8} jmp        LAB__addr_0x00403a64");                          // 0x00403a5a    eb08
    asm("LAB__addr_0x00403a5c:");
    asm("{disp8} mov        dword ptr [esp + 0x0c], 0x00000000");            // 0x00403a5c    c744240c00000000
    asm("LAB__addr_0x00403a64:");
    asm("test               edi, 0x00040000");                               // 0x00403a64    f7c700000400
    asm("{disp8} je         LAB__addr_0x00403a8f");                          // 0x00403a6a    7423
    asm("test               edx, edx");                                      // 0x00403a6c    85d2
    asm("{disp8} je         LAB__addr_0x00403a80");                          // 0x00403a6e    7410
    ...
    asm("{disp8} jmp        LAB__addr_0x00403a97");                          // 0x00403a7e    eb17
    asm("LAB__addr_0x00403a80:");
    ...
    asm("{disp8} jmp        LAB__addr_0x00403ab3");                          // 0x00403aaf    eb02
    asm("LAB__addr_0x00403ab1:");
    asm("xor.s              edi, edi");                                      // 0x00403ab1    33ff
    asm("LAB__addr_0x00403ab3:");
    asm("test               dword ptr [esi + 0x04], 0x00040000");            // 0x00403ab3    f7460400000400
    asm("{disp8} je         LAB__addr_0x00403ad1");                          // 0x00403aba    7415
    ...
    asm("{disp8} jmp        LAB__addr_0x00403ae1");                          // 0x00403acf    eb10
    asm("LAB__addr_0x00403ad1:");
    ...
    asm("{disp8} jmp        LAB__addr_0x00403ae1");                          // 0x00403add    eb02
    asm("LAB__addr_0x00403adf:");
    asm("xor.s              ebp, ebp");                                      // 0x00403adf    33ed
    asm("LAB__addr_0x00403ae1:");
    asm("{disp8} mov        eax, dword ptr [esi + 0x04]");                   // 0x00403ae1    8b4604
    asm("test               eax, 0x00100000");                               // 0x00403ae4    a900001000
    asm("{disp8} je         LAB__addr_0x00403b26");                          // 0x00403ae9    743b
    asm("test               ah, -0x80");                                     // 0x00403aeb    f6c480
    asm("{disp8} je         LAB__addr_0x00403afc");                          // 0x00403aee    740c
    ...
    asm("{disp8} jmp        LAB__addr_0x00403afe");                          // 0x00403afa    eb02
    asm("LAB__addr_0x00403afc:");
    asm("xor.s              ebx, ebx");                                      // 0x00403afc    33db
    asm("LAB__addr_0x00403afe:");
    asm("test               dword ptr [esi + 0x04], 0x00040000");            // 0x00403afe    f7460400000400
    asm("{disp8} je         LAB__addr_0x00403b12");                          // 0x00403b05    740b
    ...
    asm("{disp8} jmp        LAB__addr_0x00403b14");                          // 0x00403b10    eb02
    asm("LAB__addr_0x00403b12:");
    asm("xor.s              edi, edi");                                      // 0x00403b12    33ff
    asm("LAB__addr_0x00403b14:");
    ...
    asm("{disp8} jmp        LAB__addr_0x00403b28");                          // 0x00403b24    eb02
    asm("LAB__addr_0x00403b26:");
    asm("xor.s              ebx, ebx");                                      // 0x00403b26    33db
    asm("LAB__addr_0x00403b28:");
    asm("test               dword ptr [esi + 0x04], 0x00200000");            // 0x00403b28    f7460400002000
    asm("{disp8} je         LAB__addr_0x00403b5c");                          // 0x00403b2f    742b
    ...
    asm("{disp8} jmp        LAB__addr_0x00403b5e");                          // 0x00403b5a    eb02
    asm("LAB__addr_0x00403b5c:");
    asm("xor.s              edi, edi");                                      // 0x00403b5c    33ff
    asm("LAB__addr_0x00403b5e:");
...
uint32_t __fastcall GetSizeFootprintData_dup1__8LH3DMeshFv(struct LH3DMesh* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x00403b9f");                          // 0x00403b96    7407
...
uint32_t __fastcall GetSizeUV2Data_dup1__8LH3DMeshFv(struct LH3DMesh* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x00403bd4");                          // 0x00403bb8    741a
    asm("test               ah, -0x80");                                     // 0x00403bba    f6c480
    asm("{disp8} je         LAB__addr_0x00403bca");                          // 0x00403bbd    740b
...
uint32_t __fastcall GetSizeNameData_dup1__8LH3DMeshFv(struct LH3DMesh* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x00403c46");                          // 0x00403be9    745b
    ...
    asm("{disp8} je         LAB__addr_0x00403bff");                          // 0x00403bf5    7408
    asm("{disp8} mov        eax, dword ptr [ecx + 0x48]");                   // 0x00403bf7    8b4148
    asm("{disp8} mov        edi, dword ptr [eax + 0x08]");                   // 0x00403bfa    8b7808
    asm("{disp8} jmp        LAB__addr_0x00403c01");                          // 0x00403bfd    eb02
    asm("LAB__addr_0x00403bff:");
    asm("xor.s              edi, edi");                                      // 0x00403bff    33ff
    asm("LAB__addr_0x00403c01:");
    asm("test               edx, 0x00040000");                               // 0x00403c01    f7c200000400
    asm("{disp8} je         LAB__addr_0x00403c38");                          // 0x00403c07    742f
    asm("test               esi, esi");                                      // 0x00403c09    85f6
    asm("{disp8} je         LAB__addr_0x00403c23");                          // 0x00403c0b    7416
...
uint32_t __fastcall GetSizeEMetricsData_dup1__8LH3DMeshFv(struct LH3DMesh* param_1)
{
    ...
    asm("{disp32} je        LAB__addr_0x00403d19");                          // 0x00403c5b    0f84b8000000
    ...
    asm("{disp8} je         LAB__addr_0x00403c7a");                          // 0x00403c6c    740c
    ...
    asm("{disp8} jmp        LAB__addr_0x00403c82");                          // 0x00403c78    eb08
    asm("LAB__addr_0x00403c7a:");
    asm("{disp8} mov        dword ptr [esp + 0x10], 0x00000000");            // 0x00403c7a    c744241000000000
    asm("LAB__addr_0x00403c82:");
    asm("mov.s              ebp, esi");                                      // 0x00403c82    8bee
    asm("and                ebp, 0x00040000");                               // 0x00403c84    81e500000400
    asm("{disp8} je         LAB__addr_0x00403ca9");                          // 0x00403c8a    741d
    asm("test               edi, edi");                                      // 0x00403c8c    85ff
    asm("{disp8} je         LAB__addr_0x00403c9d");                          // 0x00403c8e    740d
    ...
    asm("{disp8} jmp        LAB__addr_0x00403cab");                          // 0x00403c9b    eb0e
    asm("LAB__addr_0x00403c9d:");
    ...
    asm("{disp8} jmp        LAB__addr_0x00403cab");                          // 0x00403ca7    eb02
    asm("LAB__addr_0x00403ca9:");
    asm("xor.s              ebx, ebx");                                      // 0x00403ca9    33db
    asm("LAB__addr_0x00403cab:");
    asm("test               esi, 0x00080000");                               // 0x00403cab    f7c600000800
    asm("{disp8} je         LAB__addr_0x00403d02");                          // 0x00403cb1    744f
    asm("test               edi, edi");                                      // 0x00403cb3    85ff
    asm("{disp8} je         LAB__addr_0x00403cbf");                          // 0x00403cb5    7408
    asm("{disp8} mov        eax, dword ptr [ecx + 0x48]");                   // 0x00403cb7    8b4148
    asm("{disp8} mov        esi, dword ptr [eax + 0x08]");                   // 0x00403cba    8b7008
    asm("{disp8} jmp        LAB__addr_0x00403cc1");                          // 0x00403cbd    eb02
    asm("LAB__addr_0x00403cbf:");
    asm("xor.s              esi, esi");                                      // 0x00403cbf    33f6
    asm("LAB__addr_0x00403cc1:");
    asm("test               ebp, ebp");                                      // 0x00403cc1    85ed
    asm("{disp8} je         LAB__addr_0x00403cf4");                          // 0x00403cc3    742f
    asm("test               edi, edi");                                      // 0x00403cc5    85ff
    asm("{disp8} je         LAB__addr_0x00403cdf");                          // 0x00403cc7    7416
    ...
    asm("{disp8} jmp        LAB__addr_0x00403d04");                          // 0x00403cdd    eb25
    asm("LAB__addr_0x00403cdf:");
    ...
    asm("{disp8} jmp        LAB__addr_0x00403d04");                          // 0x00403cf2    eb10
    asm("LAB__addr_0x00403cf4:");
    ...
    asm("{disp8} jmp        LAB__addr_0x00403d04");                          // 0x00403d00    eb02
    asm("LAB__addr_0x00403d02:");
    asm("xor.s              edx, edx");                                      // 0x00403d02    33d2
    asm("LAB__addr_0x00403d04:");
