...
bool32_t __fastcall WaitForKickOff__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076315d");                          // 0x0076314f    750c
...
bool32_t __fastcall FootballMatchPaused__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007631a6");                          // 0x0076317a    742a
    ...
    asm("{disp8} je         LAB__addr_0x007631a6");                          // 0x0076318c    7418
...
bool32_t __fastcall FootballMexicanWave__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007631c8");                          // 0x007631ba    750c
...
bool32_t __fastcall FootballWatchMatch__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0076320a");                          // 0x007631fb    750d
    ...
    asm("{disp8} jne        LAB__addr_0x0076322b");                          // 0x0076321c    750d
    ...
    asm("LAB__addr_0x00763242:");
    asm("cmp                ecx, 0x01");                                     // 0x00763242    83f901
    asm("{disp8} jne        LAB__addr_0x00763253");                          // 0x00763245    750c
    ...
    asm("LAB__addr_0x00763253:");
    asm("cmp                ecx, 0x04");                                     // 0x00763253    83f904
    asm("{disp8} jne        LAB__addr_0x00763277");                          // 0x00763256    751f
...
bool32_t __fastcall ExitFootball__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007632f7");                          // 0x007632a6    754f
    asm("cmp                bl, 0x01");                                      // 0x007632a8    80fb01
    asm("{disp8} je         LAB__addr_0x007632f7");                          // 0x007632ab    744a
    asm("cmp                bl, 0x02");                                      // 0x007632ad    80fb02
    asm("{disp8} je         LAB__addr_0x007632f7");                          // 0x007632b0    7445
