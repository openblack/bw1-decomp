...
int __cdecl GetInfoFromText__10GAbodeInfoFPc(const char* text)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00405ae8");                          // 0x00405ab5    7531
    asm("cmp                byte ptr [edi + ebx * 0x1], 0x5f");              // 0x00405ab7    803c1f5f
    asm("{disp8} jne        LAB__addr_0x00405ae8");                          // 0x00405abb    752b
    ...
    asm("{disp8} je         LAB__addr_0x00405b15");                          // 0x00405ada    7439
    asm("inc                esi");                                           // 0x00405adc    46
    asm("add                edi, 0x000001c8");                               // 0x00405add    81c7c8010000
    asm("cmp                esi, 0x10");                                     // 0x00405ae3    83fe10
    asm(".byte              0x72, 0xdf");// {disp8} jb LAB__addr_0x00405ac7  // 0x00405ae6    72df
    asm("LAB__addr_0x00405ae8:");
    ...
    asm(".byte              0x72, 0x82");// {disp8} jb LAB__addr_0x00405a8c  // 0x00405b08    7282
...
struct GAbodeInfo* __cdecl Find__10GAbodeInfoF10TRIBE_TYPE12ABODE_NUMBER(enum TRIBE_TYPE tribe_type, enum ABODE_NUMBER abode_number)
{
    ...
    asm("LAB__addr_0x00405b44:");
    asm("mov                edx, dword ptr [ecx]");                          // 0x00405b44    8b11
    asm("cmp.s              edx, esi");                                      // 0x00405b46    3bd6
    asm("{disp8} je         LAB__addr_0x00405b4f");                          // 0x00405b48    7405
    asm("cmp                edx, -0x01");                                    // 0x00405b4a    83faff
    asm("{disp8} jne        LAB__addr_0x00405b54");                          // 0x00405b4d    7505
    asm("LAB__addr_0x00405b4f:");
    asm("cmp                dword ptr [ecx + -0x34], edi");                  // 0x00405b4f    3979cc
    asm("{disp8} je         LAB__addr_0x00405b69");                          // 0x00405b52    7415
    asm("LAB__addr_0x00405b54:");
    ...
    asm(".byte              0x72, 0xdd");// {disp8} jb LAB__addr_0x00405b44  // 0x00405b65    72dd
    asm("xor.s              eax, eax");                                      // 0x00405b67    33c0
    asm("LAB__addr_0x00405b69:");
