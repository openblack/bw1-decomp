...
float __fastcall CheckNeededForCivic__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0075819a");                          // 0x0075818a    740e
    ...
    asm("{disp8} jne        LAB__addr_0x0075819a");                          // 0x00758196    7502
    asm("pop                esi");                                           // 0x00758198    5e
    asm("ret");                                                              // 0x00758199    c3
    asm("LAB__addr_0x0075819a:");
...
uint32_t __fastcall CheckNeededForTownDesire__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007581db");                          // 0x007581ab    742e
...
float __fastcall GetOwnDesiresTrigger__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007581fa");                          // 0x007581ed    740b
    asm("{disp32} fld       dword ptr [__real@4@00000000000000000000]");                   // 0x007581ef    d90598a38a00
    asm("pop                esi");                                           // 0x007581f5    5e
    asm("add                esp, 0x08");                                     // 0x007581f6    83c408
    asm("ret");                                                              // 0x007581f9    c3
    asm("LAB__addr_0x007581fa:");
    ...
    asm("{disp8} je         LAB__addr_0x00758212");                          // 0x00758203    740d
    ...
    asm("{disp8} jmp        LAB__addr_0x0075821a");                          // 0x00758210    eb08
    asm("LAB__addr_0x00758212:");
    asm("{disp8} mov        dword ptr [esp + 0x04], 0x00000000");            // 0x00758212    c744240400000000
    asm("LAB__addr_0x0075821a:");
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x0075822b    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00758231    dfe0
    asm("test               ah, 0x41");                                      // 0x00758233    f6c441
    asm("{disp8} jne        LAB__addr_0x0075824e");                          // 0x00758236    7516
    ...
    asm("{disp8} jmp        LAB__addr_0x00758256");                          // 0x0075824c    eb08
    asm("LAB__addr_0x0075824e:");
    asm("{disp8} mov        dword ptr [esp + 0x0c], 0x00000000");            // 0x0075824e    c744240c00000000
    asm("LAB__addr_0x00758256:");
    ...
    asm("{disp8} jne        LAB__addr_0x0075826c");                          // 0x00758264    7506
    asm("{disp8} fld        dword ptr [esp + 0x04]");                        // 0x00758266    d9442404
    asm("{disp8} jmp        LAB__addr_0x00758270");                          // 0x0075826a    eb04
    asm("LAB__addr_0x0075826c:");
    asm("{disp8} fld        dword ptr [esp + 0x08]");                        // 0x0075826c    d9442408
    asm("LAB__addr_0x00758270:");
    ...
    asm("{disp8} je         LAB__addr_0x00758285");                          // 0x0075827d    7406
    asm("{disp8} fld        dword ptr [esp + 0x04]");                        // 0x0075827f    d9442404
    asm("{disp8} jmp        LAB__addr_0x00758289");                          // 0x00758283    eb04
    asm("LAB__addr_0x00758285:");
    asm("{disp8} fld        dword ptr [esp + 0x08]");                        // 0x00758285    d9442408
    asm("LAB__addr_0x00758289:");
    ...
    asm("{disp8} je         LAB__addr_0x007582c7");                          // 0x007582a3    7422
    ...
    asm("{disp8} je         LAB__addr_0x007582c7");                          // 0x007582b4    7411
    ...
    asm("LAB__addr_0x007582c7:");
    asm("{disp8} fld        dword ptr [esp + 0x08]");                        // 0x007582c7    d9442408
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                   // 0x007582cb    d81d90a38a00
    asm("fnstsw             ax");                                            // 0x007582d1    dfe0
    asm("test               ah, 0x01");                                      // 0x007582d3    f6c401
    asm("{disp8} je         LAB__addr_0x007582e1");                          // 0x007582d6    7409
    ...
    asm("LAB__addr_0x007582e1:");
    asm("{disp32} fld       dword ptr [__real@4@3fff8000000000000000]");                   // 0x007582e1    d90590a38a00
...
bool32_t __fastcall CheckNeededForHarvest__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0075832e");                          // 0x00758301    742b
    ...
    asm("{disp8} je         LAB__addr_0x0075832e");                          // 0x00758317    7415
...
bool32_t __fastcall CheckNeededForBuilding__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00758387");                          // 0x00758351    7434
    ...
    asm("{disp8} je         LAB__addr_0x00758387");                          // 0x00758376    740f
    ...
    asm("{disp8} jne        LAB__addr_0x00758387");                          // 0x00758383    7502
    asm("pop                esi");                                           // 0x00758385    5e
    asm("ret");                                                              // 0x00758386    c3
    asm("LAB__addr_0x00758387:");
...
bool32_t __fastcall RunAwayFromObjectReaction__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0075848e");                          // 0x007583a1    0f84e7000000
    ...
    asm("{disp32} je        LAB__addr_0x0075848e");                          // 0x007583b1    0f84d7000000
    ...
    asm("{disp8} je         LAB__addr_0x0075848e");                          // 0x0075846e    741e
...
bool32_t __fastcall SetupBuildingObject__8VillagerFP12BuildingSite(struct Villager* this, const void* edx, struct BuildingSite* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x00758520");                          // 0x007584bc    7462
    ...
    asm("{disp8} je         LAB__addr_0x00758520");                          // 0x007584cd    7451
    ...
    asm("{disp8} jne        LAB__addr_0x007584ec");                          // 0x007584dc    750e
    ...
    asm("{disp8} jne        LAB__addr_0x00758520");                          // 0x007584ea    7534
    asm("LAB__addr_0x007584ec:");
...
bool32_t __fastcall SetupBuildingObject__8VillagerFP13MultiMapFixed(struct Villager* this, const void* edx, struct MultiMapFixed* param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00758581");                          // 0x00758559    7526
    asm("LAB__addr_0x0075855b:");
    ...
    asm("{disp8} je         LAB__addr_0x0075853d");                          // 0x0075856c    74cf
    ...
    asm("{disp8} je         LAB__addr_0x0075855b");                          // 0x0075857f    74da
    asm("LAB__addr_0x00758581:");
...
bool32_t __fastcall SetupWaitForWood__8VillagerFP12BuildingSite(struct Villager* this, const void* edx, struct BuildingSite* param_1)
{
    ...
    asm("call               ?GameFloatRand@GRand@@SAMMPBDI@Z");                  // 0x007585fc    e82f5ff8ff
...
bool32_t __fastcall WaitForWood__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007586d7");                          // 0x007586bc    7419
    asm("cmp                word ptr [esi + 0x000000f6], 0x00");             // 0x007586be    6683bef600000000
    asm("{disp8} je         LAB__addr_0x007586d7");                          // 0x007586c6    740f
...
bool32_t __fastcall SetupGetBuildingSupplies__8VillagerFP12BuildingSite(struct Villager* this, const void* edx, struct BuildingSite* param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00758733");                          // 0x00758721    7510
    ...
    asm("{disp8} je         LAB__addr_0x007587bc");                          // 0x0075875d    745d
    asm("dec                eax");                                           // 0x0075875f    48
    asm("{disp8} je         LAB__addr_0x0075878b");                          // 0x00758760    7429
    asm("dec                eax");                                           // 0x00758762    48
    asm("{disp8} je         LAB__addr_0x0075876f");                          // 0x00758763    740a
...
bool32_t __fastcall GotoStoragePitForBuildingMaterials__8VillagerFP12BuildingSite(struct Villager* this, const void* edx, struct BuildingSite* param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x007587ea");                          // 0x007587df    7509
    ...
    asm("{disp8} jne        LAB__addr_0x0075880a");                          // 0x007587ff    7509
    ...
    asm("{disp8} jg         LAB__addr_0x0075883f");                          // 0x0075882c    7f11
    ...
    asm("{disp8} je         LAB__addr_0x00758884");                          // 0x0075884a    7438
    ...
    asm("{disp8} je         LAB__addr_0x00758884");                          // 0x00758858    742a
    ...
    asm("{disp8} jmp        LAB__addr_0x007588a6");                          // 0x00758882    eb22
    asm("LAB__addr_0x00758884:");
    ...
    asm("{disp8} jne        LAB__addr_0x0075890e");                          // 0x007588fc    7510
    asm("test               eax, eax");                                      // 0x007588fe    85c0
    asm("{disp8} je         LAB__addr_0x00758918");                          // 0x00758900    7416
    asm("test               ecx, ecx");                                      // 0x00758902    85c9
    asm("{disp8} jne        LAB__addr_0x0075890e");                          // 0x00758904    7508
    asm("test               edx, edx");                                      // 0x00758906    85d2
    asm("{disp8} jne        LAB__addr_0x0075890e");                          // 0x00758908    7504
    asm("test               edi, edi");                                      // 0x0075890a    85ff
    asm("{disp8} je         LAB__addr_0x00758918");                          // 0x0075890c    740a
    asm("LAB__addr_0x0075890e:");
    ...
    asm("LAB__addr_0x00758918:");
    asm("test               ebx, ebx");                                      // 0x00758918    85db
    asm("push               0x27");                                          // 0x0075891a    6a27
    asm("{disp8} je         LAB__addr_0x00758939");                          // 0x0075891c    741b
...
bool32_t __fastcall GotoWorkshopForBuildingMaterials__8VillagerFP12BuildingSite(struct Villager* this, const void* edx, struct BuildingSite* param_1)
{
    ...
    asm("{disp8} je         LAB__addr_0x0075897f");                          // 0x0075896a    7413
    ...
    asm("{disp8} je         LAB__addr_0x007589e4");                          // 0x0075899c    7446
    ...
    asm("{disp8} je         LAB__addr_0x007589e4");                          // 0x007589ad    7435
    ...
    asm("{disp8} jne        LAB__addr_0x007589cd");                          // 0x007589bb    7510
    ...
    asm("{disp8} jne        LAB__addr_0x007589e4");                          // 0x007589c8    751a
    asm("pop                edi");                                           // 0x007589ca    5f
    asm("pop                esi");                                           // 0x007589cb    5e
    asm("ret");                                                              // 0x007589cc    c3
    asm("LAB__addr_0x007589cd:");
...
bool32_t __fastcall GotoBuildingSite__8VillagerFP12BuildingSite(struct Villager* this, const void* edx, struct BuildingSite* param_1)
{
    ...
    asm("{disp32} je        LAB__addr_0x00758adf");                          // 0x00758a0e    0f84cb000000
    ...
    asm("{disp32} je        LAB__addr_0x00758adf");                          // 0x00758a29    0f84b0000000
    asm("{disp8} mov        eax, dword ptr [edi + 0x18]");                   // 0x00758a2f    8b4718
    asm("test               eax, eax");                                      // 0x00758a32    85c0
    asm("{disp8} je         LAB__addr_0x00758a41");                          // 0x00758a34    740b
    asm("LAB__addr_0x00758a36:");
    asm("cmp                dword ptr [eax + 0x04], esi");                   // 0x00758a36    397004
    asm("{disp8} je         LAB__addr_0x00758a59");                          // 0x00758a39    741e
    asm("mov                eax, dword ptr [eax]");                          // 0x00758a3b    8b00
    asm("test               eax, eax");                                      // 0x00758a3d    85c0
    asm("{disp8} jne        LAB__addr_0x00758a36");                          // 0x00758a3f    75f5
    asm("LAB__addr_0x00758a41:");
    asm("mov.s              ecx, edi");                                      // 0x00758a41    8bcf
    asm("call               _jmp_addr_0x0043bc60");                          // 0x00758a43    e81832ceff
    asm("test               eax, eax");                                      // 0x00758a48    85c0
    asm("{disp8} jne        LAB__addr_0x00758a59");                          // 0x00758a4a    750d
    asm("cmp                byte ptr [esi + 0x000000f2], 0x04");             // 0x00758a4c    80bef200000004
    asm("{disp32} jne       LAB__addr_0x00758adf");                          // 0x00758a53    0f8586000000
    asm("LAB__addr_0x00758a59:");
    ...
    asm("{disp8} jne        LAB__addr_0x00758ac6");                          // 0x00758aa3    7521
    ...
    asm("{disp32} je        LAB__addr_0x00758c25");                          // 0x00758b0c    0f8413010000
    asm("{disp32} mov       eax, dword ptr [esi + 0x00000118]");             // 0x00758b12    8b8618010000
    asm("test               eax, eax");                                      // 0x00758b18    85c0
    asm("{disp32} jl        LAB__addr_0x00758c25");                          // 0x00758b1a    0f8c05010000
    asm("cmp                eax, 0x00000080");                               // 0x00758b20    3d80000000
    asm("{disp32} jge       LAB__addr_0x00758c25");                          // 0x00758b25    0f8dfa000000
    ...
    asm("call               __ftol");                                        // 0x00758b58    e8a3880400
    ...
    asm("call               __ftol");                                        // 0x00758b6a    e891880400
    ...
    asm("call               ?GetMetresDistance@MapCoords@@QBEMABU1@@Z");                          // 0x00758b85    e846d1eaff
    ...
    asm("{disp8} jne        LAB__addr_0x00758bb0");                          // 0x00758b95    7519
    ...
    asm("{disp8} jne        LAB__addr_0x00758c34");                          // 0x00758bc8    756a
    asm("{disp32} mov       ax, word ptr [esi + 0x000000f6]");               // 0x00758bca    668b86f6000000
    asm("test               ax, ax");                                        // 0x00758bd1    6685c0
    asm("{disp8} je         LAB__addr_0x00758c01");                          // 0x00758bd4    742b
...
bool32_t __fastcall Building__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00758c5e");                          // 0x00758c55    7507
    ...
    asm("{disp32} je        LAB__addr_0x00758e08");                          // 0x00758c69    0f8499010000
    ...
    asm("{disp32} je        LAB__addr_0x00758def");                          // 0x00758c89    0f8460010000
    ...
    asm("{disp32} fsubr     dword ptr [__real@4@3fff8000000000000000]");                   // 0x00758c9d    d82d90a38a00
    asm("{disp8} fst        dword ptr [esp + 0x0c]");                        // 0x00758ca3    d954240c
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                   // 0x00758ca7    d81d90a38a00
    asm("fnstsw             ax");                                            // 0x00758cad    dfe0
    asm("test               ah, 0x01");                                      // 0x00758caf    f6c401
    asm("{disp8} je         LAB__addr_0x00758cbe");                          // 0x00758cb2    740a
    asm("{disp8} mov        dword ptr [esp + 0x0c], 0x3f800000");            // 0x00758cb4    c744240c0000803f
    asm("{disp8} jmp        LAB__addr_0x00758cd7");                          // 0x00758cbc    eb19
    asm("LAB__addr_0x00758cbe:");
    ...
    asm("{disp8} jne        LAB__addr_0x00758cd7");                          // 0x00758ccd    7508
    asm("{disp8} mov        dword ptr [esp + 0x0c], 0x3f99999a");            // 0x00758ccf    c744240c9a99993f
    asm("LAB__addr_0x00758cd7:");
    ...
    asm("call               __ftol");                                        // 0x00758ce3    e818870400
    ...
    asm("{disp8} jae        LAB__addr_0x00758d08");                          // 0x00758cf8    730e
    ...
    asm("{disp8} jmp        LAB__addr_0x00758d18");                          // 0x00758d06    eb10
    asm("LAB__addr_0x00758d08:");
    ...
    asm("call               __ftol");                                        // 0x00758d13    e8e8860400
    asm("LAB__addr_0x00758d18:");
    ...
    asm("{disp8} je         LAB__addr_0x00758d76");                          // 0x00758d25    744f
    ...
    asm("{disp8} je         LAB__addr_0x00758def");                          // 0x00758d80    746d
    ...
    asm("{disp8} je         LAB__addr_0x00758da0");                          // 0x00758d8f    740f
    ...
    asm("{disp8} jne        LAB__addr_0x00758def");                          // 0x00758d9e    754f
    asm("LAB__addr_0x00758da0:");
    ...
    asm("{disp8} je         LAB__addr_0x00758de0");                          // 0x00758dae    7430
...
bool32_t __fastcall CheckSatisfyAbodesDesire__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00758e3f");                          // 0x00758e3b    7502
    asm("pop                esi");                                           // 0x00758e3d    5e
    asm("ret");                                                              // 0x00758e3e    c3
    asm("LAB__addr_0x00758e3f:");
    ...
    asm("{disp8} jne        LAB__addr_0x00758e84");                          // 0x00758e4e    7534
    ...
    asm("{disp8} jne        LAB__addr_0x00758e84");                          // 0x00758e74    750e
    ...
    asm("{disp8} jne        LAB__addr_0x00758e84");                          // 0x00758e80    7502
    asm("pop                esi");                                           // 0x00758e82    5e
    asm("ret");                                                              // 0x00758e83    c3
    asm("LAB__addr_0x00758e84:");
...
bool32_t __fastcall CheckSatisfyCivicBuildings__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00758e9f");                          // 0x00758e9b    7502
    asm("pop                esi");                                           // 0x00758e9d    5e
    asm("ret");                                                              // 0x00758e9e    c3
    asm("LAB__addr_0x00758e9f:");
    ...
    asm("{disp8} jne        LAB__addr_0x00758ee2");                          // 0x00758eae    7532
    ...
    asm("{disp8} jne        LAB__addr_0x00758ee2");                          // 0x00758ed2    750e
    ...
    asm("{disp8} jne        LAB__addr_0x00758ee2");                          // 0x00758ede    7502
    asm("pop                esi");                                           // 0x00758ee0    5e
    asm("ret");                                                              // 0x00758ee1    c3
    asm("LAB__addr_0x00758ee2:");
...
bool32_t __fastcall GotWoodFromRock__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00758f4c");                          // 0x00758f1c    742e
    ...
    asm("{disp8} je         LAB__addr_0x00758f4c");                          // 0x00758f3f    740b
...
bool32_t __fastcall ReenterBuildingState__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0075904f");                          // 0x00758f74    0f84d5000000
    ...
    asm("{disp32} je        LAB__addr_0x0075904f");                          // 0x00758f8b    0f84be000000
    ...
    asm("{disp32} jne       LAB__addr_0x00759042");                          // 0x00758f9b    0f85a1000000
    ...
    asm("{disp8} je         LAB__addr_0x00758fec");                          // 0x00758fd3    7417
    ...
    asm("{disp8} jne        LAB__addr_0x0075902b");                          // 0x0075900a    751f
    ...
    asm("{disp8} je         LAB__addr_0x0075905e");                          // 0x0075904d    740f
    asm("LAB__addr_0x0075904f:");
...
bool32_t __fastcall CheckForClearArea__8VillagerFRC9MapCoordsf(struct Villager* this, const void* edx, const struct MapCoords* param_1, float param_2)
{
    ...
    asm("{disp32} je        LAB__addr_0x007591c7");                          // 0x0075911c    0f84a5000000
    ...
    asm("{disp8} je         LAB__addr_0x00759193");                          // 0x00759133    745e
...
bool32_t __fastcall ProcessPoint__14ClearAreaPointFRC7LHPoint(struct ClearAreaPoint* this, const void* edx, const struct LHPoint* param_1)
{
    ...
    asm("call               __ftol");                                        // 0x007591f0    e80b820400
    ...
    asm("call               __ftol");                                        // 0x00759202    e8f9810400
    ...
    asm("{disp32} je        LAB__addr_0x007592bd");                          // 0x00759236    0f8481000000
    ...
    asm("{disp8} jne        LAB__addr_0x007592bd");                          // 0x00759257    7564
    ...
    asm("{disp8} je         LAB__addr_0x007592bb");                          // 0x0075928e    742b
    ...
    asm("{disp8} jmp        LAB__addr_0x007592bd");                          // 0x007592b9    eb02
    asm("LAB__addr_0x007592bb:");
    asm("fstp               st(0)");                                         // 0x007592bb    ddd8
    asm("LAB__addr_0x007592bd:");
...
bool32_t __fastcall CheckSatisfyToBuild__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00759369");                          // 0x0075933a    742d
    ...
    asm("{disp8} je         LAB__addr_0x00759369");                          // 0x00759358    740f
    ...
    asm("{disp8} jne        LAB__addr_0x00759369");                          // 0x00759365    7502
    asm("pop                esi");                                           // 0x00759367    5e
    asm("ret");                                                              // 0x00759368    c3
    asm("LAB__addr_0x00759369:");
...
bool32_t __fastcall CheckSatisfyToRepair__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00759396");                          // 0x0075937a    741a
    ...
    asm("{disp8} je         LAB__addr_0x00759396");                          // 0x00759385    740f
    ...
    asm("{disp8} jne        LAB__addr_0x00759396");                          // 0x00759392    7502
    asm("pop                esi");                                           // 0x00759394    5e
    asm("ret");                                                              // 0x00759395    c3
    asm("LAB__addr_0x00759396:");
...
bool32_t __fastcall CheckSatisfySupplyWorkshop__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x00759440");                          // 0x007593ae    0f848c000000
    ...
    asm("{disp8} je         LAB__addr_0x00759440");                          // 0x007593c7    7477
    asm("cmp                word ptr [esi + 0x000000f6], 0x00");             // 0x007593c9    6683bef600000000
    asm("{disp8} je         LAB__addr_0x007593fb");                          // 0x007593d1    7428
    ...
    asm("{disp8} je         LAB__addr_0x00759440");                          // 0x00759406    7438
    ...
    asm("{disp8} jle        LAB__addr_0x00759440");                          // 0x00759416    7e28
...
bool32_t __fastcall ArrivesAtStoragePitForWorkshopMaterials__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x0075946a");                          // 0x00759461    7507
    ...
    asm("{disp32} je        LAB__addr_0x00759500");                          // 0x00759475    0f8485000000
    ...
    asm("{disp8} je         LAB__addr_0x00759500");                          // 0x00759487    7477
    ...
    asm("{disp8} je         LAB__addr_0x007594d7");                          // 0x00759494    7441
    ...
    asm("{disp8} je         LAB__addr_0x00759500");                          // 0x007594a7    7457
    ...
    asm("{disp8} je         LAB__addr_0x00759500");                          // 0x007594b5    7449
...
bool32_t __fastcall ArrivesAtWorkshopForDropOff__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00759538");                          // 0x0075952f    7507
    ...
    asm("{disp8} je         LAB__addr_0x00759591");                          // 0x0075954b    7444
    ...
    asm("{disp8} je         LAB__addr_0x007595ac");                          // 0x0075956b    743f
...
struct MapCoords* __fastcall GetPosForPushObject__8VillagerFP6ObjectR9MapCoords(struct Villager* this, const void* edx, struct Object* param_1, struct MapCoords* param_2)
{
    ...
    asm("{disp32} fcom      dword ptr [__real@4@00000000000000000000]");                   // 0x00759697    d81598a38a00
    asm("fnstsw             ax");                                            // 0x0075969d    dfe0
    asm("test               ah, 0x40");                                      // 0x0075969f    f6c440
    asm("{disp8} je         LAB__addr_0x007596c6");                          // 0x007596a2    7422
    asm("{disp8} fld        dword ptr [esp + 0x10]");                        // 0x007596a4    d9442410
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x007596a8    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x007596ae    dfe0
    asm("test               ah, 0x40");                                      // 0x007596b0    f6c440
    asm("{disp8} je         LAB__addr_0x007596c6");                          // 0x007596b3    7411
    asm("{disp8} fld        dword ptr [esp + 0x14]");                        // 0x007596b5    d9442414
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x007596b9    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x007596bf    dfe0
    asm("test               ah, 0x40");                                      // 0x007596c1    f6c440
    asm("{disp8} jne        LAB__addr_0x007596f4");                          // 0x007596c4    752e
    asm("LAB__addr_0x007596c6:");
    ...
    asm("call               __ftol");                                        // 0x0075970a    e8f17c0400
    ...
    asm("call               __ftol");                                        // 0x0075971b    e8e07c0400
...
bool32_t __fastcall ExitBuilding__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00759806");                          // 0x007597ca    753a
    ...
    asm("{disp8} je         LAB__addr_0x007597fc");                          // 0x007597d5    7425
    ...
    asm("{disp8} je         LAB__addr_0x007597fc");                          // 0x007597ee    740c
