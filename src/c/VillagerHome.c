...
{
    asm("{disp32} mov       cl, byte ptr [data_bytes + 0x5e6934]");          // 0x0075fe40    8a0d34c9fa00
    ...
    asm("{disp32} mov       byte ptr [data_bytes + 0x5e6934], cl");          // 0x0075fe4e    880d34c9fa00
...
{
    asm("{disp32} fld       dword ptr [rdata_bytes + 0xf1998]");             // 0x0075fe80    d90598a99900
    asm("{disp32} fmul      dword ptr [rdata_bytes + 0xf1994]");             // 0x0075fe86    d80d94a99900
    asm("{disp32} fstp      dword ptr [data_bytes + 0x3f3e18]");             // 0x0075fe8c    d91d189edb00
    asm("ret");                                                              // 0x0075fe92    c3
    __builtin_unreachable();
}
