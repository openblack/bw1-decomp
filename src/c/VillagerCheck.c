...
void __fastcall InteractDecideWhatToDoForOtherVillager__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00756dc6");                          // 0x00756d71    7453
    asm("LAB__addr_0x00756d73:");
    asm("cmp.s              esi, edi");                                      // 0x00756d73    3bf7
    asm("{disp8} je         LAB__addr_0x00756db4");                          // 0x00756d75    743d
    ...
    asm("{disp8} je         LAB__addr_0x00756db4");                          // 0x00756d80    7432
    ...
    asm("{disp8} je         LAB__addr_0x00756db4");                          // 0x00756d8e    7424
    ...
    asm("{disp8} je         LAB__addr_0x00756dfc");                          // 0x00756db2    7448
    asm("LAB__addr_0x00756db4:");
    ...
    asm("{disp8} jne        LAB__addr_0x00756d73");                          // 0x00756dc4    75ad
    asm("LAB__addr_0x00756dc6:");
...
bool32_t __fastcall FindCloseObjectsForInteract__8VillagerFP35LHOrderedLinkedList_12SortedObject_RC9MapCoords(struct Villager* this, const void* edx, struct LHOrderedLinkedList__SortedObject* param_1, const struct MapCoords* param_2)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00756eb5");                          // 0x00756ea9    750a
    ...
    asm("{disp32} je        LAB__addr_0x00757148");                          // 0x00756edf    0f8463020000
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00756f29    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00756f2f    dfe0
    asm("test               ah, 0x41");                                      // 0x00756f31    f6c441
    asm("{disp8} jne        LAB__addr_0x00756f4d");                          // 0x00756f34    7517
    ...
    asm("{disp8} jmp        LAB__addr_0x00756f55");                          // 0x00756f4b    eb08
    asm("LAB__addr_0x00756f4d:");
    asm("{disp8} mov        dword ptr [esp + 0x14], 0x00000000");            // 0x00756f4d    c744241400000000
    asm("LAB__addr_0x00756f55:");
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@3ff583126f0000000000]");                 // 0x00756f7f    d81db0a38a00
    asm("fnstsw             ax");                                            // 0x00756f85    dfe0
    asm("test               ah, 0x41");                                      // 0x00756f87    f6c441
    asm("{disp32} jne       LAB__addr_0x00757107");                          // 0x00756f8a    0f8577010000
    ...
    asm("{disp8} je         LAB__addr_0x00756fc5");                          // 0x00756fb8    740b
    ...
    asm("{disp8} jmp        LAB__addr_0x00756fc9");                          // 0x00756fc3    eb04
    asm("LAB__addr_0x00756fc5:");
    asm("{disp8} mov        dword ptr [esp + 0x10], ebp");                   // 0x00756fc5    896c2410
    asm("LAB__addr_0x00756fc9:");
    asm("mov                esi, dword ptr [ebx]");                          // 0x00756fc9    8b33
    asm("cmp.s              esi, ebp");                                      // 0x00756fcb    3bf5
    asm("{disp32} je        LAB__addr_0x007570de");                          // 0x00756fcd    0f840b010000
    asm("LAB__addr_0x00756fd3:");
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00756fe5    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00756feb    dfe0
    asm("test               ah, 0x41");                                      // 0x00756fed    f6c441
    asm("{disp8} jne        LAB__addr_0x00757008");                          // 0x00756ff0    7516
    ...
    asm("{disp8} jmp        LAB__addr_0x00757010");                          // 0x00757006    eb08
    asm("LAB__addr_0x00757008:");
    asm("{disp8} mov        dword ptr [esp + 0x18], 0x00000000");            // 0x00757008    c744241800000000
    asm("LAB__addr_0x00757010:");
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00757046    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x0075704c    dfe0
    asm("test               ah, 0x41");                                      // 0x0075704e    f6c441
    asm("{disp8} jne        LAB__addr_0x00757069");                          // 0x00757051    7516
    ...
    asm("{disp8} jmp        LAB__addr_0x00757071");                          // 0x00757067    eb08
    asm("LAB__addr_0x00757069:");
    asm("{disp8} mov        dword ptr [esp + 0x1c], 0x00000000");            // 0x00757069    c744241c00000000
    asm("LAB__addr_0x00757071:");
    ...
    asm("{disp8} jne        LAB__addr_0x007570bc");                          // 0x007570ac    750e
    asm("mov.s              ebp, esi");                                      // 0x007570ae    8bee
    asm("{disp8} mov        esi, dword ptr [esi + 0x04]");                   // 0x007570b0    8b7604
    asm("test               esi, esi");                                      // 0x007570b3    85f6
    asm("{disp8} je         LAB__addr_0x007570d6");                          // 0x007570b5    741f
    asm("{disp32} jmp       LAB__addr_0x00756fd3");                          // 0x007570b7    e917ffffff
    asm("LAB__addr_0x007570bc:");
    ...
    asm("{disp8} jmp        LAB__addr_0x0075710b");                          // 0x00757105    eb04
    asm("LAB__addr_0x00757107:");
    asm("{disp8} mov        ecx, dword ptr [esp + 0x40]");                   // 0x00757107    8b4c2440
    asm("LAB__addr_0x0075710b:");
    ...
    asm("{disp32} jne       LAB__addr_0x00756eff");                          // 0x00757120    0f85d9fdffff
    asm("{disp8} mov        eax, dword ptr [esp + 0x44]");                   // 0x00757126    8b442444
    asm("test               eax, eax");                                      // 0x0075712a    85c0
    asm("{disp8} je         LAB__addr_0x00757148");                          // 0x0075712c    741a
    ...
    asm("{disp32} jne       LAB__addr_0x00756eff");                          // 0x00757142    0f85b7fdffff
    asm("LAB__addr_0x00757148:");
...
bool32_t __fastcall CheckMoveHouse__8VillagerFP6Object(struct Villager* this, const void* edx, struct Object* object)
{
    ...
    asm("{disp8} je         LAB__addr_0x00757200");                          // 0x007571a3    745b
    ...
    asm("{disp8} je         LAB__addr_0x007571bf");                          // 0x007571b1    740c
    ...
    asm("{disp8} jmp        LAB__addr_0x007571c9");                          // 0x007571bd    eb0a
    asm("LAB__addr_0x007571bf:");
    ...
    asm("LAB__addr_0x007571c9:");
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                   // 0x007571c9    d81d90a38a00
    asm("fnstsw             ax");                                            // 0x007571cf    dfe0
    asm("test               ah, 0x01");                                      // 0x007571d1    f6c401
    asm("{disp8} je         LAB__addr_0x007571e8");                          // 0x007571d4    7412
    ...
    asm("{disp8} je         LAB__addr_0x00757200");                          // 0x007571f1    740d
...
bool32_t __fastcall CheckMoveIntoTown__8VillagerFR4Town(struct Villager* this, const void* edx, struct Town* param_1)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00757245");                          // 0x00757224    751f
...
bool32_t __fastcall CheckInteractWithWorshipSite__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007572bd");                          // 0x007572a4    7417
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x007572b0    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x007572b6    dfe0
    asm("test               ah, 0x41");                                      // 0x007572b8    f6c441
    asm("{disp8} jne        LAB__addr_0x0075730f");                          // 0x007572bb    7552
    asm("LAB__addr_0x007572bd:");
    ...
    asm("{disp8} jne        LAB__addr_0x0075730f");                          // 0x007572cf    753e
    ...
    asm("{disp8} jne        LAB__addr_0x0075730f");                          // 0x007572dc    7531
    ...
    asm("{disp8} je         LAB__addr_0x00757302");                          // 0x007572e7    7419
    ...
    asm("{disp32} je        LAB__addr_0x0075740f");                          // 0x0075731a    0f84ef000000
    ...
    asm("{disp32} je        LAB__addr_0x0075740f");                          // 0x0075732e    0f84db000000
    ...
    asm("{disp32} jne       LAB__addr_0x0075740f");                          // 0x00757354    0f85b5000000
    ...
    asm("{disp32} je        LAB__addr_0x0075740f");                          // 0x00757366    0f84a3000000
    ...
    asm("{disp8} je         LAB__addr_0x00757390");                          // 0x00757375    7419
    ...
    asm("{disp8} jne        LAB__addr_0x007573a4");                          // 0x0075739a    7508
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                   // 0x007573d0    d81d90a38a00
    asm("fnstsw             ax");                                            // 0x007573d6    dfe0
    asm("test               ah, 0x41");                                      // 0x007573d8    f6c441
    asm("{disp8} je         LAB__addr_0x007573fb");                          // 0x007573db    741e
    ...
    asm("{disp8} je         LAB__addr_0x007573fb");                          // 0x007573e6    7413
    ...
    asm("{disp8} jne        LAB__addr_0x0075740f");                          // 0x00757405    7508
...
bool32_t __fastcall CheckInteractWithAbode__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x0075757d");                          // 0x00757446    0f8431010000
    ...
    asm("{disp32} je        LAB__addr_0x0075757d");                          // 0x00757455    0f8422010000
    ...
    asm("{disp8} je         LAB__addr_0x00757480");                          // 0x00757467    7417
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00757473    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00757479    dfe0
    asm("test               ah, 0x41");                                      // 0x0075747b    f6c441
    asm("{disp8} jne        LAB__addr_0x007574fb");                          // 0x0075747e    757b
    asm("LAB__addr_0x00757480:");
    ...
    asm("{disp8} jne        LAB__addr_0x007574fb");                          // 0x00757492    7567
    ...
    asm("{disp8} je         LAB__addr_0x007574be");                          // 0x007574a6    7416
    ...
    asm("{disp8} je         LAB__addr_0x007574fb");                          // 0x007574b4    7445
    ...
    asm("{disp8} jne        LAB__addr_0x007574ed");                          // 0x007574c9    7522
    ...
    asm("{disp8} je         LAB__addr_0x00757545");                          // 0x00757522    7421
    ...
    asm("{disp8} jne        LAB__addr_0x0075757d");                          // 0x00757570    750b
...
bool32_t __fastcall CheckInteractWithField__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00757604");                          // 0x007575c6    753c
    ...
    asm("{disp8} jne        LAB__addr_0x00757604");                          // 0x007575d5    752d
    ...
    asm("{disp8} je         LAB__addr_0x007575fb");                          // 0x007575e0    7419
...
bool32_t __fastcall CheckInteractWithFishFarm__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00757682");                          // 0x00757646    753a
    ...
    asm("{disp8} jne        LAB__addr_0x00757682");                          // 0x00757653    752d
    ...
    asm("{disp8} je         LAB__addr_0x00757679");                          // 0x0075765e    7419
...
bool32_t __fastcall CheckInteractWithTree__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00757703");                          // 0x007576b7    744a
    ...
    asm("{disp8} je         LAB__addr_0x00757703");                          // 0x007576c7    743a
    ...
    asm("{disp8} je         LAB__addr_0x007576ed");                          // 0x007576d2    7419
...
bool32_t __fastcall CheckInteractWithVillager__8VillagerFv(struct Villager* this)
{
    ...
    asm("{disp32} je        LAB__addr_0x00757816");                          // 0x00757785    0f848b000000
    ...
    asm("{disp8} je         LAB__addr_0x00757816");                          // 0x00757797    747d
    ...
    asm("{disp8} jne        LAB__addr_0x007577fc");                          // 0x007577ad    754d
    ...
    asm("{disp8} je         LAB__addr_0x007577fc");                          // 0x007577b8    7442
    ...
    asm("{disp8} je         LAB__addr_0x007577fc");                          // 0x007577c3    7437
    ...
    asm("{disp8} je         LAB__addr_0x007577fc");                          // 0x007577d7    7423
