...
struct VillagerName* __cdecl Alloc__17VillagerNameBlockFv(void)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076273a");                          // 0x00762729    740f
    asm("LAB__addr_0x0076272b:");
    asm("{disp8} mov        eax, dword ptr [ecx + 0x0c]");                   // 0x0076272b    8b410c
    asm("cmp                eax, dword ptr [ecx + 0x04]");                   // 0x0076272e    3b4104
    asm("{disp8} jl         LAB__addr_0x0076275c");                          // 0x00762731    7c29
    asm("{disp8} mov        ecx, dword ptr [ecx + 0x10]");                   // 0x00762733    8b4910
    asm("test               ecx, ecx");                                      // 0x00762736    85c9
    asm("{disp8} jne        LAB__addr_0x0076272b");                          // 0x00762738    75f1
    asm("LAB__addr_0x0076273a:");
    ...
    asm("{disp8} jmp        LAB__addr_0x0076275c");                          // 0x00762758    eb02
    asm("LAB__addr_0x0076275a:");
    asm("xor.s              ecx, ecx");                                      // 0x0076275a    33c9
    asm("LAB__addr_0x0076275c:");
...
void __cdecl Delete__17VillagerNameBlockFP12VillagerName(struct VillagerName* name)
{
    ...
    asm("{disp8} je         LAB__addr_0x007627da");                          // 0x0076278a    744e
    asm("{disp8} mov        edi, dword ptr [esp + 0x0c]");                   // 0x0076278c    8b7c240c
    asm("LAB__addr_0x00762790:");
    asm("mov                edx, dword ptr [esi]");                          // 0x00762790    8b16
    asm("cmp.s              edi, edx");                                      // 0x00762792    3bfa
    asm(".byte              0x72, 0x19");// {disp8} jb LAB__addr_0x007627af  // 0x00762794    7219
    ...
    asm(".byte              0x72, 0xa");// {disp8} jb LAB__addr_0x007627b9   // 0x007627ad    720a
    asm("LAB__addr_0x007627af:");
    asm("{disp8} mov        esi, dword ptr [esi + 0x10]");                   // 0x007627af    8b7610
    asm("test               esi, esi");                                      // 0x007627b2    85f6
    asm("{disp8} jne        LAB__addr_0x00762790");                          // 0x007627b4    75da
    asm("pop                edi");                                           // 0x007627b6    5f
    asm("pop                esi");                                           // 0x007627b7    5e
    asm("ret");                                                              // 0x007627b8    c3
    asm("LAB__addr_0x007627b9:");
    ...
    asm("{disp8} jg         LAB__addr_0x007627da");                          // 0x007627c4    7f14
    asm("test               esi, esi");                                      // 0x007627c6    85f6
    asm("{disp8} je         LAB__addr_0x007627da");                          // 0x007627c8    7410
...
bool32_t __fastcall DeleteAll__17VillagerNameBlockFv(struct VillagerNameBlock* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x00762805");                          // 0x007627e9    741a
    asm("LAB__addr_0x007627eb:");
    ...
    asm("{disp8} jne        LAB__addr_0x007627eb");                          // 0x00762803    75e6
    asm("LAB__addr_0x00762805:");
...
struct VillagerNameBlock* __fastcall __ct__17VillagerNameBlockFv(struct VillagerNameBlock* this)
{
    ...
    asm("{disp8} jne        LAB__addr_0x00762860");                          // 0x0076286c    75f2
...
void __fastcall __dt__17VillagerNameBlockFv(struct VillagerNameBlock* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x0076294d");                          // 0x0076290a    7441
    ...
    asm("{disp8} js         LAB__addr_0x00762938");                          // 0x00762926    7810
    asm("inc                eax");                                           // 0x00762928    40
    asm("LAB__addr_0x00762929:");
...
void __fastcall FreeAll__17VillagerNameBlockFv(struct VillagerNameBlock* this)
{
    ...
    asm("{disp8} je         LAB__addr_0x007629af");                          // 0x00762977    7436
    ...
    asm("{disp8} js         LAB__addr_0x007629a5");                          // 0x00762993    7810
    asm("inc                eax");                                           // 0x00762995    40
    asm("LAB__addr_0x00762996:");
    ...
    asm("{disp8} jne        LAB__addr_0x00762996");                          // 0x007629a3    75f1
    asm("LAB__addr_0x007629a5:");
...
struct VillagerName* __cdecl Add__12VillagerNameFf7LHPointPwR9LH3DColor(float text_size, struct LHPoint point, const char16_t* text, const struct LH3DColor* p_color)
{
    ...
    asm("{disp8} je         LAB__addr_0x00762a06");                          // 0x007629f4    7410
    asm("cmp                dword ptr [eax + 0x000045e8], ebx");             // 0x007629f6    3998e8450000
    asm("{disp8} je         LAB__addr_0x00762a06");                          // 0x007629fc    7408
    ...
    asm("{disp8} je         LAB__addr_0x00762a1f");                          // 0x00762a15    7408
    ...
    asm("{disp32} jne       LAB__addr_0x00762db1");                          // 0x00762a54    0f8557030000
    ...
    asm("{disp8} jae        LAB__addr_0x00762aa4");                          // 0x00762a91    7311
    asm("cmp                byte ptr [edx + 0x01], 0x0a");                   // 0x00762a93    807a010a
    asm("{disp8} jae        LAB__addr_0x00762aa4");                          // 0x00762a97    730b
    asm("cmp                byte ptr [edx], 0x0a");                          // 0x00762a99    803a0a
    asm("{disp8} jae        LAB__addr_0x00762aa4");                          // 0x00762a9c    7306
    asm("mov                dword ptr [edx], 0x00ffffff");                   // 0x00762a9e    c702ffffff00
    asm("LAB__addr_0x00762aa4:");
    ...
    asm("LAB__addr_0x00762b4a:");
    asm("{disp8} mov        dx, word ptr [ebp + 0x00]");                     // 0x00762b4a    668b5500
    asm("cmp.s              dx, bx");                                        // 0x00762b4e    663bd3
    asm("{disp8} je         LAB__addr_0x00762b82");                          // 0x00762b51    742f
    asm("cmp                dx, 0x0a");                                      // 0x00762b53    6683fa0a
    asm("{disp8} jne        LAB__addr_0x00762b73");                          // 0x00762b57    751a
    ...
    asm("{disp8} je         LAB__addr_0x00762b82");                          // 0x00762b71    740f
    asm("LAB__addr_0x00762b73:");
    ...
    asm("{disp8} jl         LAB__addr_0x00762b4a");                          // 0x00762b80    7cc8
    asm("LAB__addr_0x00762b82:");
    ...
    asm("{disp8} jle        LAB__addr_0x00762c0d");                          // 0x00762bb9    7e52
    ...
    asm("{disp8} jne        LAB__addr_0x00762c00");                          // 0x00762bf8    7506
    asm("{disp8} fstp       dword ptr [esp + 0x38]");                        // 0x00762bfa    d95c2438
    asm("{disp8} jmp        LAB__addr_0x00762c02");                          // 0x00762bfe    eb02
    asm("LAB__addr_0x00762c00:");
    asm("fstp               st(0)");                                         // 0x00762c00    ddd8
    asm("LAB__addr_0x00762c02:");
    ...
    asm("{disp8} jl         LAB__addr_0x00762bc9");                          // 0x00762c0b    7cbc
    asm("LAB__addr_0x00762c0d:");
    ...
    asm("{disp8} je         LAB__addr_0x00762c44");                          // 0x00762c2d    7415
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00762c57    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00762c5d    dfe0
    asm("test               ah, 0x01");                                      // 0x00762c5f    f6c401
    asm("{disp8} je         LAB__addr_0x00762c6b");                          // 0x00762c62    7407
    asm("{disp8} mov        dword ptr [esi + 0x04], 0x00000000");            // 0x00762c64    c7460400000000
    asm("LAB__addr_0x00762c6b:");
    ...
    asm("{disp8} jne        LAB__addr_0x00762caa");                          // 0x00762c96    7512
    ...
    asm("{disp8} je         LAB__addr_0x00762d5e");                          // 0x00762ce0    747c
    asm("LAB__addr_0x00762ce2:");
    ...
    asm("{disp8} je         LAB__addr_0x00762d5e");                          // 0x00762ced    746f
    asm("LAB__addr_0x00762cef:");
    ...
    asm("{disp8} jne        LAB__addr_0x00762d54");                          // 0x00762cfa    7558
    ...
    asm("{disp8} je         LAB__addr_0x00762d54");                          // 0x00762d07    744b
    ...
    asm("{disp8} jne        LAB__addr_0x00762d54");                          // 0x00762d14    753e
    ...
    asm("{disp32} fsub      dword ptr [__real@4@3fff8000000000000000]");                   // 0x00762d22    d82590a38a00
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00762d34    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00762d3a    dfe0
    asm("test               ah, 0x01");                                      // 0x00762d3c    f6c401
    asm("{disp8} jne        LAB__addr_0x00762d5e");                          // 0x00762d3f    751d
    ...
    asm("{disp8} jne        LAB__addr_0x00762cef");                          // 0x00762d52    759b
    asm("LAB__addr_0x00762d54:");
    asm("{disp32} mov       ecx, dword ptr [ecx + 0x00000460]");             // 0x00762d54    8b8960040000
    asm("test               ecx, ecx");                                      // 0x00762d5a    85c9
    asm("{disp8} jne        LAB__addr_0x00762ce2");                          // 0x00762d5c    7584
    asm("LAB__addr_0x00762d5e:");
    asm("{disp8} fld        dword ptr [esi + 0x08]");                        // 0x00762d5e    d94608
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00762d61    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00762d67    dfe0
    asm("test               ah, 0x01");                                      // 0x00762d69    f6c401
    asm("{disp8} je         LAB__addr_0x00762d7f");                          // 0x00762d6c    7411
    ...
    asm("{disp8} je         LAB__addr_0x00762da7");                          // 0x00762d8c    7419
    asm("LAB__addr_0x00762d8e:");
    ...
    asm("{disp8} je         LAB__addr_0x00762da7");                          // 0x00762d99    740c
    ...
    asm("{disp8} jne        LAB__addr_0x00762d8e");                          // 0x00762da5    75e7
    asm("LAB__addr_0x00762da7:");
...
void __fastcall Draw__12VillagerNameFv(struct VillagerName* this)
{
    ...
    asm("{disp32} fcomp     dword ptr [__real@4@00000000000000000000]");                   // 0x00762dc9    d81d98a38a00
    asm("fnstsw             ax");                                            // 0x00762dcf    dfe0
    asm("test               ah, 0x41");                                      // 0x00762dd1    f6c441
    asm("{disp8} jne        LAB__addr_0x00762df3");                          // 0x00762dd4    751d
    asm("{disp8} fld        dword ptr [esi + 0x24]");                        // 0x00762dd6    d94624
    asm("{disp32} fcomp     dword ptr [__real@4@3fff8000000000000000]");                   // 0x00762dd9    d81d90a38a00
    asm("fnstsw             ax");                                            // 0x00762ddf    dfe0
    asm("test               ah, 0x01");                                      // 0x00762de1    f6c401
    asm("{disp8} je         LAB__addr_0x00762deb");                          // 0x00762de4    7405
    asm("{disp8} fld        dword ptr [esi + 0x24]");                        // 0x00762de6    d94624
    asm("{disp8} jmp        LAB__addr_0x00762df9");                          // 0x00762de9    eb0e
    asm("LAB__addr_0x00762deb:");
    asm("{disp32} fld       dword ptr [__real@4@3fff8000000000000000]");                   // 0x00762deb    d90590a38a00
    asm("{disp8} jmp        LAB__addr_0x00762df9");                          // 0x00762df1    eb06
    asm("LAB__addr_0x00762df3:");
    asm("{disp32} fld       dword ptr [__real@4@00000000000000000000]");                   // 0x00762df3    d90598a38a00
    asm("LAB__addr_0x00762df9:");
    ...
    asm("call               __ftol");                                        // 0x00762e05    e8f6e50300
    ...
    asm("{disp32} je        LAB__addr_0x00762f71");                          // 0x00762e6f    0f84fc000000
    ...
    asm("call               __ftol");                                        // 0x00762ebd    e83ee50300
    ...
    asm("call               __ftol");                                        // 0x00762ee4    e817e50300
    ...
    asm("call               __ftol");                                        // 0x00762f36    e8c5e40300
    ...
    asm("call               __ftol");                                        // 0x00762f45    e8b6e40300
    ...
    asm("call               __ftol");                                        // 0x00762f54    e8a7e40300
    ...
    asm("call               __ftol");                                        // 0x00762f63    e898e40300
    ...
    asm("call               __ftol");                                        // 0x00762f83    e878e40300
    ...
    asm("{disp8} jle        LAB__addr_0x00763017");                          // 0x00762f99    7e7c
    asm("{disp32} lea       edi, dword ptr [esi + 0x00000430]");             // 0x00762f9b    8dbe30040000
    asm("LAB__addr_0x00762fa1:");
    ...
    asm("{disp8} jl         LAB__addr_0x00762fa1");                          // 0x00763015    7c8a
    asm("LAB__addr_0x00763017:");
    ...
    asm("{disp8} jne        LAB__addr_0x0076303c");                          // 0x00763021    7519
    ...
    asm("LAB__addr_0x0076303c:");
    asm("test               eax, eax");                                      // 0x0076303c    85c0
    asm("{disp8} je         LAB__addr_0x0076306e");                          // 0x0076303e    742e
    asm("LAB__addr_0x00763040:");
    asm("{disp32} mov       ecx, dword ptr [eax + 0x00000460]");             // 0x00763040    8b8860040000
    asm("test               ecx, ecx");                                      // 0x00763046    85c9
    asm("{disp8} je         LAB__addr_0x0076306e");                          // 0x00763048    7424
    asm("cmp.s              ecx, esi");                                      // 0x0076304a    3bce
    asm("{disp8} je         LAB__addr_0x00763062");                          // 0x0076304c    7414
    asm("mov.s              eax, ecx");                                      // 0x0076304e    8bc1
    asm("test               eax, eax");                                      // 0x00763050    85c0
    asm("{disp8} jne        LAB__addr_0x00763040");                          // 0x00763052    75ec
