...
- `BW1E100` — Windows v1.00 (PE/COFF, MSVC 6.0 SP5 with `/OPT:ICF`)
- `BW1E110` — Windows v1.10 (PE/COFF, MSVC 6.0 SP5)
- `BW1E120` — Windows v1.20 (PE/COFF, MSVC 6.0 SP5)

Work in progress:

- `BW1E130` — Windows v1.30 (PE/COFF, MSVC 6.0 SP5)
- `BW1EMAC` — Classic Mac OS PowerPC (PEF, CodeWarrior Mac)
...
- `config/[VERSION]` - Configuration files for each game version (`BW1E100`, `BW1E110`, `BW1E120`, `BW1EMAC`).
