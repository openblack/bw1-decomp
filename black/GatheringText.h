...
float __fastcall GetStringWidth__13GatheringTextFPwif(struct GatheringText* this, const void* edx, const char16_t* str, int len, float text_size);
...
float __fastcall DrawText__13GatheringTextFPwfffffffffP9LH3DColoriii(struct GatheringText* this, const void* edx, const char16_t* text, float param_2, float param_3, float param_4, float param_5, float param_6, float param_7, float param_8, float param_9, float param_10, const struct LH3DColor* p_color, int param_12, int param_13, int param_14);
...
void __fastcall DrawTextRaw__13GatheringTextFPwiffffP9LH3DColoriP9LH3DColorff(struct GatheringText* this, const void* edx, const char16_t* text, int param_2, float x, float y, float param_5, float param_6, struct LH3DColor* param_7, int param_8, struct LH3DColor* param_9, float param_10, float param_11);
