...
struct ControlMap
{
  struct BindableAction bindable_actions[0x21];  /* 0x0 */
  bool32_t bindable_action_states[0x21];  /* 0x648c */
...
struct ControlMap* __fastcall __ct__10ControlMapFv(struct ControlMap* this);

// Non-virtual methods

// win1.41 00470910 mac 101caba0 ControlMap::GetText(ulong, wchar_t*)
void __fastcall GetText__10ControlMapFUlPw(struct ControlMap* this, const void* edx, enum LH_KEY key, char16_t* out_text);
// win1.41 00470ab0 mac 10090ab0 ControlMap::ProcessActionsPerformed(void)
void __fastcall ProcessActionsPerformed__10ControlMapFv(struct ControlMap* this);
