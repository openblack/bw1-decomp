...
void __cdecl ConvertLandscapePointToMapCoord__10GLandscapeFRC7LHPointR9MapCoords(const struct LHPoint* point, struct MapCoords* coords);
// win1.41 inlined mac 106f5c34 GLandscape::ConvertAbsoluteMapCoordToLandscapePoint(MapCoords const &, LHPoint &)
void __cdecl ConvertAbsoluteMapCoordToLandscapePoint__10GLandscapeFRC9MapCoordsR7LHPoint(const struct MapCoords* coords, struct LHPoint* point);
// win1.41 005e3f60 mac 1001d960 GLandscape::PreDraw(void)
uint32_t __cdecl PreDraw__10GLandscapeFv(void);
// win1.41 00613750 mac 10048570 GLandscape::ConvertMapCoordToLandscapePoint(MapCoords const &)
struct LHPoint* __cdecl ConvertMapCoordToLandscapePoint__10GLandscapeFRC9MapCoordsR7LHPoint(const struct MapCoords* param_2, struct LHPoint* param_1);
