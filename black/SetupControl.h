...
struct SetupControl* __fastcall __ct__12SetupControlFiiiiiPw(struct SetupControl* this, const void* edx, int id, int x, int y, int width, int height, const char16_t* label) asm("??0SetupControl@@QAE@HHHHHPB_S@Z");
...
int __fastcall GetTextSize__12SetupControlFv(const struct SetupControl* this) asm("?GetTextSize@SetupControl@@QBEHXZ");
// win1.41 00409210 mac 1057a320 SetupControl::SetToolTip(unsigned long)
void __fastcall SetToolTip__12SetupControlFUl(struct SetupControl* this, const void* edx, uint32_t tooltip_id) asm("?SetToolTip@SetupControl@@QAEXI@Z");
// win1.41 004092f0 mac 100c4fd0 SetupControl::SetToolTip(wchar_t *)
void __fastcall SetToolTip__12SetupControlFPw(struct SetupControl* this, const void* edx, const char16_t* tooltip) asm("?SetToolTip@SetupControl@@QAEXPB_S@Z");
