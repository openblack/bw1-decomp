...
// win1.41 0x0052dda0 mac 100e1f20 FixedObject::_dt(void)
struct Base * __fastcall __dt__11FixedObjectFv(struct Base* this, const void* edx, uint8_t param_1) asm("??1Fixed@@UAE@XZ");
// win1.41 0x0052df20 mac 100e1bd0 FixedObject::GetTownArtifactValue(void)
...
// win1.41 0x0052e140 mac 100e17b0 FixedObject::Save(GameOSFile &)
...
// win1.41 0x00401410 mac 10570f10 FixedObject::CanBeSleptNextToByCreature(Creature *)
...
// win1.41 0x00401440 mac 1056c2a0 FixedObject::CanBePickedUpByCreature(Creature *)
...
// win1.41 0x00401430 mac 100b19c0 FixedObject::CanBeSetOnFire(Creature *)
...
// win1.41 0x00401420 mac 105e81f0 FixedObject::CanBeDestroyedByStoning(Creature *)
...
// win1.41 0x004d1b80 mac 10242ed0 FixedObject::GetHowMuchCreatureWantsToLookAtMe(void)
...
// win1.41 0x0052e530 mac 100e0b90 FixedObject::InsertMapObject(void)
void __fastcall InsertMapObject__11FixedObjectFv(struct Object* this) asm("?InsertMapObject@Fixed@@UAEXXZ");
// win1.41 0x0052e5c0 mac 100e0af0 FixedObject::RemoveMapObject(void)
...
// win1.41 0x00401450 mac 1057a200 FixedObject::CanBeCrushed(void)
bool __fastcall CanBeCrushed__11FixedObjectFv(struct Object* this) asm("?CanBeCrushed@Fixed@@UAE_NXZ");
// win1.41 0x0052eb90 mac 100dff80 FixedObject::ValidForLockedSelectProcess(GInterfaceStatus *)
...
// win1.41 0x0052eba0 mac 100dff20 FixedObject::NetworkFriendlyStartLockedSelect(GInterfaceStatus *)
...
// win1.41 0x0052e0e0 mac 100e1840 FixedObject::InterfaceSetInMagicHand(GInterfaceStatus *)
...
// win1.41 0x0052df50 mac 100e1950 FixedObject::EndPhysics(PhysicsObject *, bool)
...
// win1.41 0x00401460 mac 10554e40 FixedObject::VillagerMustAvoid(Villager *)
...
// win1.41 0x0052de50 mac 100e1df0 FixedObject::GetSpecialPos(unsigned long, MapCoords *)
...
// win1.41 0x00401470 mac 1057ad40 FixedObject::GetTownArtifact(void)
...
// win1.41 0x00401480 mac 10588280 FixedObject::IsTownArtifact(void)
