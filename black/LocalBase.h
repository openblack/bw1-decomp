...
extern const struct RTTITypeDescriptor __RTTITypeDescriptor__9LocalBase asm("??_R0?AVLocalBase@@@8");
...
extern const struct RTTICompleteObjectLocator __RTTICompleObjectLocator__9LocalBase asm("??_R4LocalBase@@6B@");
