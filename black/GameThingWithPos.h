...
public:
    ...
    virtual bool IsCannotBePickedUp() const; /* 0x180 */
    ...
    virtual bool32_tcorrect IsInteractable(); /* 0x190 */
    ...
    virtual bool32_tcorrect IsFemaleVillager(); /* 0x450 */
    ...
    virtual bool32_tcorrect IsWonder(); /* 0x490 */
