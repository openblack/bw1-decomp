...
uint32_t __fastcall GetMesh__10GAbodeInfoCFv(const struct GObjectInfo* this) asm("?GetMesh@AbodeInfo@@UBE?AW4MeshId@@XZ");
// win1.41 00401250 mac 106fde70 GAbodeInfo::GetAbodeNumber() const
