...
uint32_t __fastcall AddFootpath__13MultiMapFixedFP9GFootpath(struct GameThing* this, const void* edx, struct GFootpath* footpath) asm("?AddFootpath@MultiMapFixed@@UAEIPAVGFootpath@@@Z");
