...
public:
    ...
    virtual uint32_t JustRemoveResource(RESOURCE_TYPE param_1, uint32_t param_2, bool* param_3); /* 0x90 */
    ...
    virtual uint32_t GetGuidanceResourceType(); /* 0xe0 */
...
// win1.41 004017f0 mac 1010bb00 GameThing::CalculateInfluence(MapCoords const &)
float __fastcall CalculateInfluence__9GameThingFRC9MapCoords(struct GameThing* this, const void* edx, const struct MapCoords* param_1) asm("?CalculateInfluence@GameThing@@UAEMABUMapCoords@@@Z");
// win1.41 00401800 mac 10494700 GameThing::RemoveDance(void)
void __fastcall RemoveDance__9GameThingFv(struct GameThing* this) asm("?RemoveDance@GameThing@@UAEXXZ");
// win1.41 00401810 mac 100512d0 GameThing::IsAvailable(void)
bool __fastcall IsAvailable__9GameThingFv(struct GameThing* this) asm("?IsAvailable@GameThing@@UAEIXZ");
// win1.41 00401820 mac 10494880 GameThing::IsCreature(Creature *)
...
// win1.41 00401830 mac 1002c400 GameThing::IsCreature(void)
bool __fastcall IsCreature__9GameThingFv(struct GameThing* this) asm("?IsCreature@GameThing@@UAEIXZ");
// win1.41 00401840 mac 104948c0 GameThing::IsCreatureNotTooNear(Creature *)
...
// win1.41 00405130 mac 10169a70 GameThing::GetDrawImportance(void)
float __fastcall GetDrawImportance__9GameThingFv(struct GameThing* this) asm("?GetDrawImportance@GameThing@@UAEMXZ");
// win1.41 00401850 mac 10428ff0 GameThing::GetMaxAlignmentChangePerGameTurn(void)
...
// win1.41 00401860 mac 10425a40 GameThing::GetComputerSeen(void)
bool __fastcall GetComputerSeen__9GameThingFv(struct GameThing* this) asm("?GetComputerSeen@GameThing@@UAEIXZ");
// win1.41 0056ff10 mac 103c22d0 GameThing::GetTown(void)
struct Town* __fastcall GetTown__9GameThingFv(struct GameThing* this) asm("?GetTown@GameThing@@QAEPAVTown@@XZ");
// win1.41 00401870 mac 103f1450 GameThing::GetVillagerActivityDesire(Villager *)
float __fastcall GetVillagerActivityDesire__9GameThingFP8Villager(struct GameThing* this, const void* edx, struct Villager* param_1) asm("?GetVillagerActivityDesire@GameThing@@UAEMPAVVillager@@@Z");
// win1.41 00401880 mac 10389ac0 GameThing::SetVillagerActivity(Villager *)
uint32_t __fastcall SetVillagerActivity__9GameThingFP8Villager(struct GameThing* this, const void* edx, struct Villager* param_1) asm("?SetVillagerActivity@GameThing@@UAEIPAVVillager@@@Z");
// win1.41 00401890 mac 1037f2e0 GameThing::UpdateVillagerActivityEffect(Villager *)
uint32_t __fastcall UpdateVillagerActivityEffect__9GameThingFP8Villager(struct GameThing* this, const void* edx, struct Villager* param_1) asm("?UpdateVillagerActivityEffect@GameThing@@UAEIPAVVillager@@@Z");
// win1.41 0056fed0 mac 10160960 GameThing::MaintainSpell(Spell *, float)
...
// win1.41 00405140 mac 104e9450 GameThing::GetRadius(void)
float __fastcall GetRadius__9GameThingFv(struct GameThing* this) asm("?GetRadius@GameThing@@UAEMXZ");
// win1.41 00405150 mac 1034f3d0 GameThing::Get2DRadius(void)
float __fastcall Get2DRadius__9GameThingFv(struct GameThing* this) asm("?Get2DRadius@GameThing@@UAEMXZ");
// win1.41 004018a0 mac 101664f0 GameThing::GetPlayerWhoLastPickedMeUp(void)
struct GPlayer* __fastcall GetPlayerWhoLastPickedMeUp__9GameThingFv(struct GameThing* this) asm("?GetPlayerWhoLastPickedMeUp@GameThing@@UAEPAVGPlayer@@XZ");
// win1.41 004018b0 mac 10381da0 GameThing::GetPlayerWhoLastDroppedMe(void)
struct GPlayer* __fastcall GetPlayerWhoLastDroppedMe__9GameThingFv(struct GameThing* this) asm("?GetPlayerWhoLastDroppedMe@GameThing@@UAEPAVGPlayer@@XZ");
// win1.41 00405160 mac 103c36e0 GameThing::IsFootpathLink(void)
bool32_t __fastcall IsFootpathLink__9GameThingFv(struct GameThing* this) asm("?IsFootpathLink@GameThing@@UAEIXZ");
// win1.41 00405170 mac 1056c160 GameThing::GetFootpathLink(void)
struct GFootpathLink* __fastcall GetFootpathLink__9GameThingFv(struct GameThing* this) asm("?GetFootpathLink@GameThing@@UAEPAVGFootpathLink@@XZ");
// win1.41 004018c0 mac 101063a0 GameThing::AddFootpathLink(GFootpath *)
uint32_t __fastcall AddFootpathLink__9GameThingFP9GFootpath(struct GameThing* this, const void* edx, struct GFootpath* param_1) asm("?AddFootpathLink@GameThing@@UAEIPAVGFootpath@@@Z");
// win1.41 00405180 mac 104788b0 GameThing::GetNearestPathTo(MapCoords const &, float, int)
uint32_t __fastcall GetNearestPathTo__9GameThingFRC9MapCoordsfi(struct GameThing* this, const void* edx, const struct MapCoords* param_1, float param_2, int param_3) asm("?GetNearestPathTo@GameThing@@UAEIABUMapCoords@@MH@Z");
// win1.41 00570330 mac 100e4740 GameThing::UseFootpathIfNecessary(Living *, MapCoords const &, unsigned char)
...
// win1.41 00405190 mac 103dffc0 GameThing::AddFootpath(GFootpath *)
uint32_t __fastcall AddFootpath__9GameThingFP9GFootpath(struct GameThing* this, const void* edx, struct GFootpath* param_1) asm("?AddFootpath@GameThing@@UAEIPAVGFootpath@@@Z");
// win1.41 004051a0 mac 103dff70 GameThing::RemoveFootpath(GFootpath *)
uint32_t __fastcall RemoveFootpath__9GameThingFP9GFootpath(struct GameThing* this, const void* edx, struct GFootpath* param_1) asm("?RemoveFootpath@GameThing@@UAEIPAVGFootpath@@@Z");
// win1.41 005705f0 mac 10560530 GameThing::JustAddResource(RESOURCE_TYPE, unsigned long, bool)
...
// win1.41 004051b0 mac 1056c950 GameThing::GetResource(RESOURCE_TYPE)
uint32_t __fastcall GetResource__9GameThingF13RESOURCE_TYPE(struct GameThing* this, const void* edx, enum RESOURCE_TYPE type) asm("?GetResource@GameThing@@UAEIW4RESOURCE_TYPE@@@Z");
// win1.41 004051c0 mac 1056c9a0 GameThing::AddResource(RESOURCE_TYPE, unsigned long, GInterfaceStatus *, bool, MapCoords const &, int)
uint32_t __fastcall AddResource__9GameThingF13RESOURCE_TYPEUlP16GInterfaceStatusbRC9MapCoordsi(struct GameThing* this, const void* edx, enum RESOURCE_TYPE type, uint32_t param_2, struct GInterfaceStatus* param_3, bool param_4, const struct MapCoords* coords, int param_6) asm("?AddResource@GameThing@@UAEIW4RESOURCE_TYPE@@IPAVGInterfaceStatus@@_NABUMapCoords@@H@Z");
// win1.41 004051d0 mac 104f8b20 GameThing::RemoveResource(RESOURCE_TYPE, unsigned long, GInterfaceStatus *, bool *)
uint32_t __fastcall RemoveResource__9GameThingF13RESOURCE_TYPEUlP16GInterfaceStatusPb(struct GameThing* this, const void* edx, enum RESOURCE_TYPE type, uint32_t param_2, struct GInterfaceStatus* param_3, bool* param_4) asm("?RemoveResource@GameThing@@UAEIW4RESOURCE_TYPE@@IPAVGInterfaceStatus@@PA_N@Z");
// win1.41 004018d0 mac 103dd790 GameThing::CastCreature(void)
struct Creature* __fastcall CastCreature__9GameThingFv(struct GameThing* this) asm("?CastCreature@GameThing@@UAEPAVCreature@@XZ");
// win1.41 004018e0 mac 103dd5d0 GameThing::CastPlayer(void)
struct GPlayer* __fastcall CastPlayer__9GameThingFv(struct GameThing* this) asm("?CastPlayer@GameThing@@UAEPAVGPlayer@@XZ");
// win1.41 004018f0 mac 104fb790 GameThing::CastOneOffSpellSeed(void)
struct SpellSeed* __fastcall CastOneOffSpellSeed__9GameThingFv(struct GameThing* this) asm("?CastOneOffSpellSeed@GameThing@@UAEPAVSpellSeed@@XZ");
// win1.41 004051e0 mac 1017ebc0 GameThing::CastAbode(void)
struct Abode* __fastcall CastAbode__9GameThingFv(struct GameThing* this) asm("?CastAbode@GameThing@@UAEPAVAbode@@XZ");
// win1.41 004051f0 mac 10199740 GameThing::CastMultiMapFixed(void)
struct MultiMapFixed* __fastcall CastMultiMapFixed__9GameThingFv(struct GameThing* this) asm("?CastMultiMapFixed@GameThing@@UAEPAVMultiMapFixed@@XZ");
// win1.41 00401900 mac 100a0a70 GameThing::CastSpellIcon(void)
struct SpellIcon* __fastcall CastSpellIcon__9GameThingFv(struct GameThing* this) asm("?CastSpellIcon@GameThing@@UAEPAVSpellIcon@@XZ");
// win1.41 00401910 mac 101c8320 GameThing::CastTree(void)
struct Tree* __fastcall CastTree__9GameThingFv(struct GameThing* this) asm("?CastTree@GameThing@@UAEPAVTree@@XZ");
// win1.41 00401920 mac 1019e2b0 GameThing::IsDeletedOnNewMap(void)
bool32_t __fastcall IsDeletedOnNewMap__9GameThingFv(struct GameThing* this) asm("?IsDeletedOnNewMap@GameThing@@UAEIXZ");
// win1.41 00405200 mac 100ac9a0 GameThing::GetNumberOfInstanceForGlobalList(void)
uint16_t __fastcall GetNumberOfInstanceForGlobalList__9GameThingFv(struct GameThing* this) asm("?GetNumberOfInstanceForGlobalList@GameThing@@UAEGXZ");
// win1.41 00405210 mac 1019aa00 GameThing::GetTownArtifactValue(void)
...
// win1.41 00405240 mac 10067860 GameThing::IsFunctional(void)
bool __fastcall IsFunctional__9GameThingFv(struct GameThing* this) asm("?IsFunctional@GameThing@@UAEIXZ");
// win1.41 00425da0 mac 1054ef00 GameThing::GetDebugText(void)
...
// win1.41 00401930 mac 1017a550 GameThing::GetShowNeedsPos(unsigned long, MapCoords *)
uint32_t __fastcall GetShowNeedsPos__9GameThingFUlP9MapCoords(struct GameThing* this, const void* edx, uint32_t param_1, struct MapCoords* param_2) asm("?GetShowNeedsPos@GameThing@@UAEIIPAUMapCoords@@@Z");
// win1.41 0056fcf0 mac 103807f0 GameThing::Load(GameOSFile &)
uint32_t __fastcall Load__9GameThingFR10GameOSFile(struct GameThing* this, const void* edx, struct GameOSFile* file) asm("?Load@GameThing@@UAEIAAVGameOSFile@@@Z");
// win1.41 0056fbe0 mac 101724b0 GameThing::Save(GameOSFile &)
...
// win1.41 00405250 mac 1057b140 GameThing::ResolveLoad(void)
void __fastcall ResolveLoad__9GameThingFv(struct GameThing* this) asm("?ResolveLoad@GameThing@@UAEXXZ");
