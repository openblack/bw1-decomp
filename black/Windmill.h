...
// win1.41 00405920 mac 100cb620 Windmill::_dt(unsigned int)
void __fastcall __dt__8WindmillFUi(struct Base* this, const void* edx, uint32_t param_1) asm("??_GWindmill@@QAEXXZ");
...
// win1.41 0x00405950 mac 102aa970 Windmill::CallVirtualFunctionsForCreation(MapCoords const &)
void __fastcall CallVirtualFunctionsForCreation__8WindmillFRC9MapCoords(struct Object* this, const void* edx, const struct MapCoords* coords) asm("?CallVirtualFunctionsForCreation@Windmill@@UAEXABUMapCoords@@@Z");
