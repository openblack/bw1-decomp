...
extern const struct RTTITypeDescriptor __RTTITypeDescriptor__9PowerSpin asm("??_R0?AVPowerSpin@@@8");
...
extern const struct RTTITypeDescriptor __RTTITypeDescriptor__15PowerSpinRunner asm("??_R0?AVPowerSpinRunner@@@8");
