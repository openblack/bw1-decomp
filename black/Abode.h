...
typedef int (__cdecl* FindVillagerCB)(GameThingWithPos * param_1, SCRIPT_OBJECT_TYPE param_2, uint32_t param_3);
...
public:
    ...
    Villager* FindVillager(FindVillagerCB callback, SCRIPT_OBJECT_TYPE param_2, uint32_t param_3);
    ...
    MapCoords FUN_00407230(bool param_1);
    // win1.41 004072e0 mac 1000cd50 Abode::GetPosOutside(float, float, float)
    MapCoords GetPosOutside(float param_1, float param_2, float param_3);
    ...
    bool32_t TakeVillagerFrom(Abode& other, int param_2);
