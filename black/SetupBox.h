...
extern const struct RTTITypeDescriptor __RTTITypeDescriptor__8SetupBox asm("??_R0?AUSetupBox@@@8");
...
extern const struct RTTICompleteObjectLocator __RTTICompleObjectLocator__8SetupBox asm("??_R4SetupBox@@6B@");
