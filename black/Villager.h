...
struct Villager* __cdecl Create__8VillagerFRC9MapCoordsPC13GVillagerInfoUli(struct MapCoords* coords, struct GVillagerInfo* info, uint32_t age, bool skeleton) asm("?Create@Villager@@SAPAV1@ABUMapCoords@@PBVGVillagerInfo@@I_N@Z");
...
struct Villager* __fastcall __ct__8VillagerFRC9MapCoordsPC13GVillagerInfoUli(struct Villager* this, const void* edx, const struct MapCoords* coords, const struct GVillagerInfo* info, uint32_t age, bool skeleton) asm("??0Villager@@QAE@ABUMapCoords@@PBVGVillagerInfo@@I_N@Z");

// Non-virtual methods

// win1.41 inlined mac inlined Villager::CallValidate(uchar)
uint32_t __fastcall CallValidate__8VillagerFUc(struct Villager* this, const void* edx, enum LIVING_ACTION_INDEX index) asm("?CallValidate@Villager@@QAEIW4LIVING_ACTION_INDEX@@@Z");
...
void __fastcall SetSpeed__8VillagerFli(struct Villager* this, const void* edx, int base_speed, int scale_speed) asm("?SetSpeed@Villager@@QAEXHH@Z");
...
uint32_t __fastcall CanPauseForASecond__8VillagerFUc(struct Villager* this, const void* edx, enum VILLAGER_STATES state) asm("?CanPauseForASecond@Villager@@QAEIW4VILLAGER_STATES@@@Z");
// win1.41 00752160 mac 1000a960 Villager::GetAbode(void)
struct Abode* __fastcall GetAbode__8VillagerFv(struct Villager* this) asm("?GetAbode@Villager@@QAEPAVAbode@@XZ");
...
bool __fastcall CallEntryStateFunction__8VillagerFUc(struct Villager* this, const void* edx, enum VILLAGER_STATES state) asm("?CallEntryStateFunction@Villager@@QAE_NW4VILLAGER_STATES@@@Z");
// win1.41 00752440 mac 1007b1b0 Villager::CallEntryStateFunction(unsigned char, unsigned char)
bool __fastcall CallEntryStateFunction__8VillagerFUcUc(struct Villager* this, const void* edx, enum VILLAGER_STATES current, enum VILLAGER_STATES destination) asm("?CallEntryStateFunction@Villager@@QAE_NW4VILLAGER_STATES@@0@Z");
...
int __fastcall GetPosOutsideMyHouse__8VillagerFR9MapCoords(struct Villager* this, const void* edx, struct MapCoords* coords) asm("?GetPosOutsideMyHouse@Villager@@QAEHAAUMapCoords@@@Z");
...
void __fastcall SetSkeleton__8VillagerFi(struct Villager* this, const void* edx, bool param_1) asm("?SetSkeleton@Villager@@QAEX_N@Z");
...
uint32_t __fastcall Landed__8VillagerFv(struct Villager* this) asm("?Landed@Villager@@QAEIXZ");
...
uint32_t __fastcall AtHome__8VillagerFv(struct Villager* this) asm("?AtHome@Villager@@QAEIXZ");
...
uint32_t __fastcall GotoStoragePitForFood__8VillagerFv(struct Villager* this) asm("?GotoStoragePitForFood@Villager@@QAEIXZ");
// win1.41 007698b0 mac 1059c070 Villager::ArrivesAtStoragePitForFood(void)
uint32_t __fastcall ArrivesAtStoragePitForFood__8VillagerFv(struct Villager* this) asm("?ArrivesAtStoragePitForFood@Villager@@QAEIXZ");
// win1.41 00769b30 mac 1059bbc0 Villager::ArrivesAtHomeWithFood(void)
uint32_t __fastcall ArrivesAtHomeWithFood__8VillagerFv(struct Villager* this) asm("?ArrivesAtHomeWithFood@Villager@@QAEIXZ");
// win1.41 0076a780 mac inlined Villager::Drowning(void)
uint32_t __fastcall Drowning__8VillagerFv(struct Villager* this) asm("?Drowning@Villager@@QAEIXZ");
...
int __fastcall EnterSitAndChillOut__8VillagerFUcUc(struct Villager* this, const void* edx, enum VILLAGER_STATES state_1, enum VILLAGER_STATES state_2) asm("?EnterSitAndChillOut@Villager@@QAEHW4VILLAGER_STATES@@0@Z");
...
void __fastcall GetMeToMyChillOutPos__8VillagerFM8VillagerFPCvPvR9MapCoords_iR9MapCoordsfRC9MapCoords(struct Villager* this, const void* edx, int (__fastcall* callback)(const struct Villager * param_1, const void * param_2, const void * param_3, void * param_4, struct MapCoords * param_5), struct MapCoords* param_2, float param_6, const struct MapCoords* param_7) asm("?GetMeToMyChillOutPos@Villager@@QAEXP6AHPBXPAXAAUMapCoords@@@Z2MABU2@@Z");
...
void __fastcall SetAge__8VillagerFUl(struct Living* this, const void* edx, uint32_t age) asm("?SetAge@Villager@@UAEXI@Z");
// win1.41 007520e0 mac 10087ab0 Villager::SetCurrentAndDestinationState(unsigned char, unsigned char)
bool __fastcall SetCurrentAndDestinationState__8VillagerFUcUc(struct Living* this, const void* edx, enum VILLAGER_STATES current, enum VILLAGER_STATES destination) asm("?SetCurrentAndDestinationState@Villager@@QAE_NW4VILLAGER_STATES@@0@Z");
...
int __fastcall SetTopState__8VillagerFUc(struct Living* this, const void* edx, enum VILLAGER_STATES state) asm("?SetTopState@Villager@@UAEHW4VILLAGER_STATES@@@Z");
...
void __fastcall SetState__8VillagerFUlUc(struct Living* this, const void* edx, enum LIVING_ACTION_INDEX index, enum VILLAGER_STATES state) asm("?SetState@Villager@@UAEXW4LIVING_ACTION_INDEX@@W4VILLAGER_STATES@@@Z");
...
uint8_t __fastcall GetFinalState__8VillagerCFv(const struct Living* this) asm("?GetFinalState@Villager@@UBEEXZ");
