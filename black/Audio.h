...
// win1.41 00429e30 mac 10020580 GAudio::PlaySoundEffect(LH_SamplePlayOptions *)
uint32_t __fastcall PlaySoundEffect__6GAudioFP20LH_SamplePlayOptions(struct GAudio* this, const void* edx, struct LH_SamplePlayOptions* options) asm("?PlaySoundEffect@GAudio@@QAEXPAULH_SamplePlayOptions@@@Z");
// win1.41 0042a210 mac 1017e7d0 GAudio::StopPlayingSoundEffect(unsigned long, unsigned long, AUDIO_SFX_BANK_TYPE) const
