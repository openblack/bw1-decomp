...
float __cdecl GetTextHeight__10SetupThingFiiiiibPwi(int param_1, int param_2, int param_3, int param_4, int param_5, bool param_6, const char16_t* text, int param_8);
// win1.41 00411720 mac 1016ab60 SetupThing::GetTextWidth(wchar_t *, float, int, float)
float __cdecl GetTextWidth__10SetupThingFPwfif(const char16_t* text, float size, int param_3, float param_4);
// win1.41 00411750 mac 1016d490 SetupThing::DrawTextWrap(int, int, int, int, int, bool, wchar_t *, int, LH3DColor *, bool, bool)
float __cdecl DrawTextWrap__10SetupThingFiiiiibPwiP9LH3DColorbb(int x_min, int y_min, int x_max, int y_max, int param_5, bool param_6, const char16_t* text, int param_8, const struct LH3DColor* color, bool param_10, bool param_11);
// win1.41 004119b0 mac 103e1a40 SetupThing::DrawText(int, int, int, TEXTJUSTIFY, wchar_t *, int, LH3DColor *, int)
float __cdecl DrawText__10SetupThingFiii11TEXTJUSTIFYPwiP9LH3DColori(int x, int y, int width, enum TEXTJUSTIFY justify, const char16_t* text, int size, const struct LH3DColor* p_color, int param_8);
...
void __cdecl DrawBox__10SetupThingFiiiiffffP12LH3DMaterialP9LH3DColoriiibf(int x_min, int y_min, int x_max, int y_max, float u_min, float v_min, float u_max, float v_max, struct LH3DMaterial* material, const struct LH3DColor* color, int adjust, int clip_y_start, int clip_y_end, bool depth_test, float inv_w);
...
void __cdecl DrawQuad__10SetupThingFiiiiiiiiUlUlUlUlUlUl(int x_1, int y_1, int x_2, int y_2, int x_3, int y_3, int x_4, int y_4, struct LH3DColor color_1, struct LH3DColor color_2, struct LH3DColor color_3, struct LH3DColor color_4, uint32_t use_alpha, uint32_t adjust);
...
void __cdecl DrawTab__10SetupThingFiiiiiiiPwii(int x_min, int y_min, int x_max, int y_max, bool selected, bool first_in_row, bool last_in_row, const char16_t* label, struct LH3DColor color, bool no_blend);
